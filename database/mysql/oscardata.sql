...
insert into HRMCategory values (null, 'Oscar HRM Category NM:BLDPOL' ,'NM:BLDPOL',null);
insert into HRMCategory values (null, 'Oscar HRM Category US:ABDC' ,'US:ABDC',null);
insert into HRMCategory values (null, 'Oscar HRM Category US:PELVLT' ,'US:PELVLT',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:ABD' ,'RAD:ABD',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:CXR2' ,'RAD:CXR2',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:ABD2' ,'RAD:ABD2',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:ANKB' ,'RAD:ANKB',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:CSP' ,'RAD:CSP',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:TSP' ,'RAD:TSP',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:LSP4ER' ,'RAD:LSP4ER',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:DIGB' ,'RAD:DIGB',null);
insert into HRMCategory values (null, 'Oscar HRM Category RAD:ELBB' ,'RAD:ELBB',null);
insert into HRMCategory values (null, 'Oscar HRM Category MAM:MAMMOB' ,'MAM:MAMMOB',null);
insert into HRMCategory values (null, 'Oscar HRM Category ECHO:ECHO' ,'ECHO:ECHO',null);
insert into HRMCategory values (null, 'Oscar HRM Category ECHOWL:ECH0520' ,'ECHOWL:ECH0520',null);
insert into HRMCategory values (null, 'Oscar HRM Category ECHO:MDAB' ,'ECHO:MDAB',null);
