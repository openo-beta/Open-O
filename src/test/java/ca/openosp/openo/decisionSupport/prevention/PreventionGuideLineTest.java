 ...
 * Ontario, Canada
 */
package ca.openosp.openo.decisionSupport.prevention;
...
public class PreventionGuideLineTest {
    ...
    byte[] getRuleSet() throws Exception {
        InputStream is = this.getClass().getResourceAsStream("/ca/openosp/openo/decisionSupport/prevention/guidelineExample.xml");
