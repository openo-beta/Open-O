...
import ca.openosp.openo.webserv.rest.to.model.DemographicExtTo1;
...
import ca.openosp.openo.webserv.rest.to.model.PharmacyInfoTo1;
import ca.openosp.openo.webserv.rest.to.model.ProviderTo1;
import ca.openosp.openo.webserv.rest.to.model.Sex1;
 ...
 * test.webserv.rest.login.username=oscardoc
 * test.webserv.rest.login.password=mac2002
 * test.webserv.rest.login.pin=1117
 * test.webserv.rest.login.host=http://localhost:8080/oscar
 * </pre>
 */
public abstract class BaseRestServiceTest {
    ...
    public static final String KEY_ENABLED = "test.webserv.rest.enabled";
    public static final String KEY_TYPE = "test.webserv.rest.type";
    public static final String KEY_USERNAME = "test.webserv.rest.login.username";
    public static final String KEY_PASSWORD = "test.webserv.rest.login.password";
    public static final String KEY_PIN = "test.webserv.rest.login.pin";
    public static final String KEY_HOST = "test.webserv.rest.login.host";
    public static final String KEY_PROPNAME = "test.webserv.rest.login.propname";
	...
	/*
	 * 	<bean id="jaxb" class="org.apache.cxf.jaxrs.providers.JAXBElementProvider">
	      <property name="singleJaxbContext" value="true"/>
	      <property name="extraClass">
	         <list>
	         	<value>ca.openosp.openo.webserv.rest.to.model.AddressTo</value>
				<value>ca.openosp.openo.webserv.rest.to.model.DemographicExtTo</value>
				<value>ca.openosp.openo.webserv.rest.to.model.DemographicMergedTo</value>
				<value>ca.openosp.openo.webserv.rest.to.model.DemographicTo</value>
				<value>ca.openosp.openo.webserv.rest.to.model.PharmacyInfoTo</value>
				<value>ca.openosp.openo.webserv.rest.to.model.ProviderTo</value>
				<value>ca.openosp.openo.webserv.rest.to.model.Sex</value>
	         </list>
	      </property>
	</bean>
	 */
