...
@XmlRootElement(name = "CSedatives__not_prescribed_or_not_taken_as_prescribed_e_g__Valium_")
public class CSedativesNotPrescribedOrNotTakenAsPrescribedEGValium {
