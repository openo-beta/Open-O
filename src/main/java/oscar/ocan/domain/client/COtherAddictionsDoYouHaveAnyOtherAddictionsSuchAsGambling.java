...
@XmlRootElement(name = "COther_Addictions__Do_you_have_any_other_addictions__such_as_gambling__")
public class COtherAddictionsDoYouHaveAnyOtherAddictionsSuchAsGambling {
