...
@XmlType(name = "", propOrder = "answerGroup")
@XmlRootElement(name = "C7__Psychotic_symptoms__Do_you_ever_hear_voices_or_have_problems_with_your_thoughts__")
public class C7PsychoticSymptomsDoYouEverHearVoicesOrHaveProblemsWithYourThoughts {
