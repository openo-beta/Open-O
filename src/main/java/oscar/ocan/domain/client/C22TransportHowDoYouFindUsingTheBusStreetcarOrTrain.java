...
@XmlRootElement(name = "C22__Transport__How_do_you_find_using_the_bus__streetcar_or_train__")
public class C22TransportHowDoYouFindUsingTheBusStreetcarOrTrain {
