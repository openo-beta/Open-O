...
@XmlRootElement(name = "C10__Safety_to_Self__Do_you_ever_have_thoughts_of_harming_yourself__")
public class C10SafetyToSelfDoYouEverHaveThoughtsOfHarmingYourself {
