...
@XmlRootElement(name = "C20__Basic_education__Any_difficulty_in_reading__writing_or_understanding_English__")
public class C20BasicEducationAnyDifficultyInReadingWritingOrUnderstandingEnglish {
