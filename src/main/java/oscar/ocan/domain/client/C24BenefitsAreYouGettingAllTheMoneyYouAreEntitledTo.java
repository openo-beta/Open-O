...
@XmlRootElement(name = "C24__Benefits__Are_you_getting_all_the_money_you_are_entitled_to__")
public class C24BenefitsAreYouGettingAllTheMoneyYouAreEntitledTo {
