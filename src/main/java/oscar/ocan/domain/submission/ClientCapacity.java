...
@XmlType(name = "")
@XmlRootElement(name = "clientCapacity")
public class ClientCapacity {

    @XmlAttribute
    protected String property;
    @XmlAttribute
    protected String personalCare;
    @XmlAttribute
    protected String legalGuardian;
