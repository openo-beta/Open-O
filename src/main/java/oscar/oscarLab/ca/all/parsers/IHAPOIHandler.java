    ...
    public String getDiscipline() {
        ...
        if (!sendingApplication.isEmpty()) {
            switch (SENDING_APPLICATION.valueOf(sendingApplication)) {
                case BBK:
                    discipline = SENDING_APPLICATION.BBK.getKey();
                    break;
                case IHARAD:
                    discipline = SENDING_APPLICATION.IHARAD.getKey();
                    break;
                case RAD:
                    discipline = SENDING_APPLICATION.RAD.getKey();
                    break;
                case LAB:
                    discipline = SENDING_APPLICATION.LAB.getKey();
                    break;
                case MB:
                    discipline = SENDING_APPLICATION.MB.getKey();
                    break;
                case OE:
                    discipline = SENDING_APPLICATION.OE.getKey();
                    break;
                case PTH:
                    discipline = SENDING_APPLICATION.PTH.getKey();
                    break;
                default:
                    discipline = "LAB";
            }
