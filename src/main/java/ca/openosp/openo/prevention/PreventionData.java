...
public class PreventionData {
    ...
    public static ca.openosp.openo.prevention.Prevention getLocalandRemotePreventions(LoggedInInfo loggedInInfo, Integer demographicId) {
        ca.openosp.openo.prevention.Prevention prevention = getPrevention(loggedInInfo, demographicId);
    ...
    public static ca.openosp.openo.prevention.Prevention getPrevention(LoggedInInfo loggedInInfo, Integer demoNo) {
        DemographicManager demographicManager = SpringUtils.getBean(DemographicManager.class);
        Demographic dd = demographicManager.getDemographic(loggedInInfo, demoNo);
        ...
        ca.openosp.openo.prevention.Prevention p = new ca.openosp.openo.prevention.Prevention(sex, dob);
    ...
    public static ca.openosp.openo.prevention.Prevention addRemotePreventions(LoggedInInfo loggedInInfo, ca.openosp.openo.prevention.Prevention prevention, Integer demographicId) {
