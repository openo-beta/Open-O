...
package ca.openosp.openo.rx.erx.model.response;

import javax.naming.ServiceUnavailableException;

import ca.openosp.openo.rx.erx.model.WSPatientResult3;
 ...
 * which is returned by the External Prescriber's www service after sending patient data to it.
 */
public class SetPatientImmediate3Result {
     ...
     * from the remote www service if necessary.
     *
     ...
     * @throws IllegalArgumentException Re-throws an IllegalArgumentException if the remote www
     *                                  service reports that it didn't receive data in a format it
     *                                  could recognize.
     * @throws SecurityException        Re-throws a SecurityException if the remote www service
     *                                  reports a sec-related error.
     * @throws Exception                Re-throws an Exception if the remote www service reports an
    ...
    public static void parseSetPatientImmediate3Result(Node node)
        ...
        // Parse the node to see if the www service returned errors
