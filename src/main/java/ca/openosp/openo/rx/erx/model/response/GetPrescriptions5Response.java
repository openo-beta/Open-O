 ...
 * which is returned by the External Prescriber's www service after sending a prescription
 * request to it.
 */
public class GetPrescriptions5Response {
     ...
     * from the remote www service if necessary, and returning a list of
     ...
     * @throws DOMException             Throws a DOMExeption if this function is passed a document
     ...
     *                                  could recognize.
     * @throws SecurityException        Re-throws a SecurityException if the remote www servcice
