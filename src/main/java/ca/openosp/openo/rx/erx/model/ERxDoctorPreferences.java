...
public class ERxDoctorPreferences {
    ...
    public static ERxDoctorPreferences getInstance(String providerId)
        ...
        // Die if the providers was not found
    ...
    /**
     * The doctor's username, which will be used to connect to the www service.
    ...
    /**
     * The doctor's password, which will be used to connect to the www service.
     ...
     * @param connectionURL    The URL of the www service to connect to.
    ...
    /**
     * Returns the URL of the www service to connect to.
     *
    ...
    /**
     * Returns the doctor's password, which will be used to connect to the www
     * service.
     *
    ...
    /**
     * Returns the doctor's username, which will be used to connect to the www
     * service.
     *
    ...
    /**
     * Changes the value of the URL of the www service to connect to.
     *
