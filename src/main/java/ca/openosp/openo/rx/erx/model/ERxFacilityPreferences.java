 ...
 * ca.openosp.openo.rx.erx.model.FacilityPreferences; which should
 * implement a new interface named
 * ca.openosp.openo.rx.erx.model.ERxFacilityPreferences. This new interface
 ...
 * ca.openosp.openo.rx.erx.model.FacilityPreferences should be
 * re-factored as such.
 */
public class ERxFacilityPreferences {
    ...
    /**
     * The URL of the www service to connect to, provided by the External Prescriber.
     */
    private URL remoteURL;
    /**
     * The facility's username, which will be used to connect to the www service
     * and is provided by the External Prescriber.
     */
    private String username;
    /**
     * The facility's password, which will be used to connect to the www service
     * and is provided by the External Prescriber.
     */
     ...
     * @param remoteURL    The URL of the www service to connect to, provided by the External Prescriber.
     * @param username     The facility's username, which will be used to connect to the
     *                     www service and is provided by the External Prescriber.
    ...
    /**
     * Returns the facility's password, which will be used to connect to the www
    ...
    /**
     * Returns the URL of the www service to connect to, provided by the External Prescriber.
     *
    ...
    /**
     * Returns the facility's username, which will be used to connect to the www
     * service and is provided by the External Prescriber.
     *
     ...
     * connect to the www service and is provided by the External Prescriber.
     *
    ...
    /**
     * Changes the value of the URL of the www service to connect to, provided
     * by the External Prescriber.
     *
