...
package ca.openosp.openo.rx.erx.model.request;
...
/**
 * A value type that stores data about a single www transaction with the External Prescriber.
 * <p>
 ...
 * the External Prescriber GetPrescriptions5 www services demo page</a>
 * @see <a
...
public class Transaction3 {
    /**
     * Formats dates in a way that the the External Prescriber www services can understand.
     *
    ...
    /**
     * The name of the software connecting to the www service.
     */
    ...
    /**
     * The version of the software connecting to the www service.
     */
     ...
     *                                       debugging purposes.
     * @param engine                         The name of the software connecting to the www service.
     * @param sender                         The name of the software vendor that created the software
     *                                       connecting to the www service.
     * @param version                        The version of the software connecting to the www service.
