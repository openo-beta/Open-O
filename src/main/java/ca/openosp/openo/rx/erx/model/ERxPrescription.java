...
package ca.openosp.openo.rx.erx.model;
...
public class ERxPrescription {
     ...
     * otherwise.
     * <p>
     * See also {@link ERxPrescription.statusID} =
     * 3, 4.
     *
     * @see ERxPrescription.discontinuedUntil
     * @see ERxPrescription.discontinuedPrescriptionId
     */
    private boolean isDCPrescription;
    /**
     * References the original
     * {@link ERxPrescription.prescriptionId} that
     * is being discontinued/ceased.
     * <p>
     * Is only set if
     * {@link ERxPrescription.isDCPrescription} is
     * set to TRUE.
     */
     ...
     * 2.
     *
     * @see ERxPrescription.renewedPrescriptionId
     */
     ...
     * <p>
     * Is only set if
     * {@link ERxPrescription.isRenewal} is set to
     * TRUE.
     */
     ...
     * <p>
     * The field {@link ERxPrescription.qtyUnitId}
     * refers to this field.
     * <p>
     * In some prescriptions, the
     * {@link ERxPrescription.quantity} and
     * {@link ERxPrescription.treatmentDuration}
     ...
     * {@link ERxPrescription.quantity} and
     * {@link ERxPrescription.treatmentDuration} to
     ...
     * {@link ERxPrescription.quantity} and
     * {@link ERxPrescription.narcoticTotalQuantity}
     * fields.
     * <p>
     ...
     * </table>
     *
     * @see ERxPrescription.qtyUnitToString
     */
    private int qtyUnitId;
    /**
     * A (localized) string representing the
     * {@link ERxPrescription.qtyUnitId}
     * interpretation.
     * <p>
     * This field refers to both
     * {@link ERxPrescription.quantity} and
     ...
     * {@link ERxPrescription.refillsDurationTimeUnit}
     * .
     */
    private int refillsDuration;
    /**
     * This field combines with
     * {@link ERxPrescription.refills}.
     */
     ...
     * <p>
     * - 1 = sig dosage (i.e.:
     * {@link ERxPrescription.sigDosage})
     * <p>
     * - cap. = sig unit (i.e.:
     * {@link ERxPrescription.sigUnitId} and
     * {@link ERxPrescription.sigUnitToString})
     * <p>
     * - daily = sig frequency (i.e.:
     * {@link ERxPrescription.sigFrequencyId} and
     * {@link ERxPrescription.sigFrequencyToString}
     * )
     * <p>
     * - HS = sig specifier (i.e.:
     * {@link ERxPrescription.sigSpecifierId} and
     * {@link ERxPrescription.sigSpecifierToString}
     * )
     */
     ...
     * represented by
     * {@link ERxPrescription.sigUnitId}.
     */
     ...
     * </table>
     *
     * @see ERxPrescription.sigUnitToString
     */
     ...
     * </table>
     *
     * @see ERxPrescription.sigFrequencyToString
     */
    private int sigFrequencyId;
    /**
     * A (localized) string containing the
     * {@link ERxPrescription.sigFrequencyId}
     * interpretation.
     * <p>
     * This field is a fallback in case the intepreting software is missing the
     * {@link ERxPrescription.sigFrequencyId}.
    ...
    /**
     * A (localized) string representing the
     * {@link ERxPrescription.sigSpecifierId}.
     * <p>
     * This field is a fallback in case the intepreting software is missing the
     * {@link ERxPrescription.sigSpecifierId}.
     */
     ...
     * <p>
     * This field combines with
     * {@link ERxPrescription.treatmentDurationTimeUnit}
     * .
     */
     ...
     * <p>
     * - {@link ERxPrescription.sigDosage} = 0
     * <p>
     * - {@link ERxPrescription.sigFrequencyId} = 0
     * <p>
     * - {@link ERxPrescription.sigSpecifierId} = 0
     * <p>
     * - {@link ERxPrescription.sigPRN} = FALSE
     *
     * @see <a
     */
     ...
     * <p>
     * This field combines with
     * {@link ERxPrescription.narcoticIntervalTimeUnit}
     * .
     *
     * @see ERxPrescription.narcoticTotalQuantity
     */
    private int narcoticInterval;
    /**
     * This field combines with
     * {@link ERxPrescription.narcoticInterval}.
     * <p>
     * A table of the possible values for this field and their corresponding
     * interpretations are as follows:
     * <table>
     ...
     * {@link ERxPrescription.narcoticIntervalTimeUnit}
     *
     * @see ERxPrescription.narcoticInterval
     * @see ERxPrescription.narcoticIntervalTimeUnit
     */
    private float narcoticTotalQuantity;
    /**
     * A (localized) string representing the
     * {@link ERxPrescription.statusID}.
     */
