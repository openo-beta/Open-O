...
public class ERxPrescriptionTranslator {
     ...
     * @param providerId
     *            The ID number of the providers issuing the prescription.
     * @param patientId
...
/*    public static Prescription translateToInternal(ERxPrescription in,
         ...
         * fields commons to all prescriptions, and adds information to the note
     ...
     * @param providerId  The ID number of the providers issuing the prescription.
