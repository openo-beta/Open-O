 ...
 * returned by the External Prescriber's www service as part of a GetPrescriptions5Result.
 */
public class Result {
    /**
     * The result code.
    ...
    /**
     * The URL of the www service reporting the result.
     */
    private URL url;
     ...
     * @param url         The URL of the www service reporting the result.
     */
