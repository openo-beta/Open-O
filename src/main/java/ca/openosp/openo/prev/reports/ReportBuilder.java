//CHECKSTYLE:OFF
package ca.openosp.openo.prev.reports;
...
import ca.openosp.openo.webserv.rest.to.model.PreventionSearchConfigTo1;
...
public class ReportBuilder {
    ...
    private List<Integer> getDemographicDenominator(LoggedInInfo loggedInInfo, PreventionSearchTo1 frm, String provider) {
        ...
        // Should this be passed in, or put in the  String providers = frm.getProviderNo();
