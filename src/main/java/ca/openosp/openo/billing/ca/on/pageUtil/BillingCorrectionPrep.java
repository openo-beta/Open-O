 ...
 */
package ca.openosp.openo.billing.ca.on.pageUtil;
...
import ca.openosp.openo.billing.ca.on.data.BillingItemData;
import ca.openosp.openo.billing.ca.on.data.BillingProviderData;
import ca.openosp.openo.billing.ca.on.data.JdbcBilling3rdPartImpl;
import ca.openosp.openo.billing.ca.on.data.JdbcBillingClaimImpl;
import ca.openosp.openo.billing.ca.on.data.JdbcBillingCodeImpl;
import ca.openosp.openo.billing.ca.on.data.JdbcBillingCorrection;
import ca.openosp.openo.billing.ca.on.data.JdbcBillingPageUtil;
import ca.openosp.openo.billing.ca.on.data.JdbcBillingReviewImpl;
...
public class BillingCorrectionPrep {
    ...
    private BillingONItem changeItem(BillingClaimHeader1Data ch1Obj,
        ...
        if (oldObj.getService_code().equals(serviceCode)) {
            ...
            BillingOnTransactionDao billOnTransDao = (BillingOnTransactionDao) SpringUtils
                    .getBean(BillingOnTransactionDao.class);
            ...
            if (serviceCode != null && !serviceCode.isEmpty()) {
                ...
                if (ch1Obj.getPay_program().matches(BillingDataHlp.BILLINGMATCHSTRING_3RDPARTY)) {
                    ...
                    BillingOnItemPaymentDao billOnItemPaymentDao = (BillingOnItemPaymentDao) SpringUtils
                            .getBean(BillingOnItemPaymentDao.class);
