...
package ca.openosp.openo.providers.data;
 ...
 * Used to access data in providers table
 * @deprecated use {@link ca.openosp.openo.commn.model.ProviderData} instead
 */
@Deprecated
public class ProviderData {
	...
	*/
    ...
    private ca.openosp.openo.commn.model.ProviderData toProvider() {
        ca.openosp.openo.commn.model.ProviderData result = new ca.openosp.openo.commn.model.ProviderData();
    ...
    private void fromProvider(ca.openosp.openo.commn.model.ProviderData p) {
        provider_no = p.getId();
    ...
    public List<String> getProviderListWithInsuranceNo(String insurerNo) {
        ...
        List<ca.openosp.openo.commn.model.ProviderData> providers = dao.findByTypeAndOhip(PROVIDER_TYPE_DOCTOR, insurerNo);

        List<String> result = new ArrayList<String>();
        for (ca.openosp.openo.commn.model.ProviderData p : providers) {
            result.add(p.getId());
        }
        return result;
    }
    ...
    public void getProvider(String providerNo) {
        ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
        ca.openosp.openo.commn.model.ProviderData provider = dao.findByProviderNo(providerNo);
        if (provider != null) {
    ...
    public static List<Map<String, String>> getProviderList() {
        ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
        List<ca.openosp.openo.commn.model.ProviderData> providers = dao.findAll(false);
    ...
    private static Map<String, String> toMap(ca.openosp.openo.commn.model.ProviderData p) {
    ...
    public static List<Map<String, String>> searchProvider(String searchStr, boolean onlyActive) {
        ...
        ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
        List<ca.openosp.openo.commn.model.ProviderData> providers = dao.findByName(firstname, lastname, onlyActive);
    ...
    public static List<Map<String, String>> getProviderListOfAllTypes(boolean inactive) {
        ...
        List<ca.openosp.openo.commn.model.ProviderData> providers = dao.findAll(inactive);
        for (ca.openosp.openo.commn.model.ProviderData p : providers) {
            result.add(toMap(p));
        }
        return result;
    ...
    public static String getProviderName(String providerNo) {
        ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
        ca.openosp.openo.commn.model.ProviderData p = dao.findByProviderNo(providerNo);
        if (p == null)
            return "";
    ...
    public void getProviderWithOHIP(String ohipNo) {
        if (filled(ohipNo)) {
            ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
            ca.openosp.openo.commn.model.ProviderData p = dao.findByOhipNumber(ohipNo);
            if (p != null)
                fromProvider(p);
        }
    }
    ...
    public void getProviderWithNames(String firstName, String lastName) {
        if (filled(firstName) && filled(lastName)) {
            ProviderDataDao dao = SpringUtils.getBean(ProviderDataDao.class);
            List<ca.openosp.openo.commn.model.ProviderData> providers = dao.findByName(firstName, lastName, false);
    ...
    public void addExternalProvider(String firstName, String lastName, String ohipNo, String cpsoNo) {
        ...
        // assign new external providers no
        if (lastPN != 0) {
