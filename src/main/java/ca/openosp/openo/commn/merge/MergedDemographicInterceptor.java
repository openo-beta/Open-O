 ...
 * Ontario, Canada
 */
package ca.openosp.openo.commn.merge;
...
public class MergedDemographicInterceptor implements MethodInterceptor {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        if (invocationResult == null)
            throw new IllegalStateException("Invalid result. The wrapped class must return a Collection instance.");
        if (!Collection.class.isAssignableFrom(invocationResult.getClass()))
            throw new IllegalStateException("Invalid return type. The result class must implement Collection interface.");
