...
/**
 * An "Under Authority Of" (UAO) value that a provider may act under when interacting with the
 * ONE ID gateway. Each row is one UAO assigned to one provider; one of a provider's active values
