...
package ca.openosp.openo.commn.hl7.v2.oscar_to_oscar;
...
public final class DataTypeUtils {
     ...
     * @param prd
     * @param provider
     * @param providerRoleId          Note that this is not the oscar providers role, look in the method to see valid values
     * @param providerRoleDescription Note that this is not the oscar providers role, look in the method to see valid values
     */
     ...
     * @param rol
     * @param professionalSpecialist
     * @param actionRole             the role of the given providers with regards to this communcations. There is HL7 table 0443. We will also add DataTypeUtils.ACTION_ROLE_* as roles so we can send and receive arbitrary data under arbitrary conditions.
     * @throws HL7Exception
     */
    ...
    /**
     * The providers returned is just a detached/unmanaged Provider object which may not represent an entry in the db, it is used as a data structure only.
     *
     * @throws HL7Exception
     */
