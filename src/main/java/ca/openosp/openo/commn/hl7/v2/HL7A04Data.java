 ...
 * Ontario, Canada
 */
package ca.openosp.openo.commn.hl7.v2;
...
public class HL7A04Data {
     ...
     * Constructor
     */
    public HL7A04Data(Demographic demograph) {
	...
	*/
     ...
     * Constructor
     */
    public HL7A04Data(Demographic demograph, ApptData appData, ClinicData clinicData, List programs) {
        this.setDemographicData(demograph);
     ...
     * Constructor
     */
    public HL7A04Data(Demographic demograph, ApptData appData, ClinicData clinicData) {
        this.setDemographicData(demograph);
        this.setAppData(appData);
        this.setClinicData(clinicData);
    }
	...
	*/
     ...
     *
     */
    public void setDemographicData(Demographic demograph) {
        this.demoData = new String[6];
    ...
    public void generateA04MessageGuelph() throws HL7Exception {
        ...
        if (appData != null) {
			...
			*/
            ...
            pv1.getAttendingDoctor(0).getIDNumber().setValue(appData.getProviderNo());        // providers number
