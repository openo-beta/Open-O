...
public class ExtractBean extends Object implements Serializable {
    ...
    private String buildHeader1() {
        ...
        referral = SxmlMisc.getXmlContent(content, "<xml_referral>",
                "</xml_referral>");
        referralDoc = SxmlMisc.getXmlContent(content, "<rdohip>",
                "</rdohip>");
        hcType = SxmlMisc.getXmlContent(content, "<hctype>", "</hctype>");
        m_review = SxmlMisc.getXmlContent(content, "<mreview>",
                "</mreview>");
    ...
    private String buildHeader2() {
        ...
        hcFlag = "H";
        healthcardCount++;
        demoSex = SxmlMisc.getXmlContent(content, "<demosex>",
                "</demosex>");
