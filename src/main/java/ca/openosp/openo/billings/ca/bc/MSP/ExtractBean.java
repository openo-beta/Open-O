...
public class ExtractBean extends Object implements Serializable {
    ...
    public synchronized void dbQuery() {
        ...
        if (HasBillingItemsToSubmit()) {
            ...
            htmlFooter = "<tr>    <td colspan='11' class='bodytext'>&nbsp;</td>  </tr>  <tr>    <td colspan='5' class='bodytext'>Billing No: " + Encode.forHtmlContent(String.valueOf(providerNo)) + ": " + pCount + " RECORDS PROCESSED</td>    <td colspan='6' class='bodytext'>TOTAL: " + BigTotal + "</td>  </tr></table></body></html>";
