...
/**
 * A class that references a message senders header information. This Object builds a FHIR
 * MessageSourceComponent
 * <p>
 * Future intentions of this class is for it to auto populate specific data according to its
 * environment. For instance grabbing data from the OscarProperties settings.
 */
public class Sender {
  ...
  private AbstractOscarFhirResource<org.hl7.fhir.r4.model.Organization, Clinic> oscarFhirResource;
  private org.hl7.fhir.r4.model.Organization organization;
  ...
  /**
   * The vendor name for this Oscar Software product ie: Oscar EMR or Oscar Service Provider name.
   */
  ...
  /**
   * The name of this Oscar software product ie: CAISI, Oscar 12, Oscar 15.
   */
  ...
  /**
   * The version signature of this Oscar Software ie: version 15 build 657 2017
   */
  ...
  /**
   * The end point connection to this Oscar server. ie: https://my.oscarserver.ca/oscar/ws/etc
   */
  ...
  public org.hl7.fhir.r4.model.Organization getOrganization() {
    return this.organization;
  }

  public void setOrganization(org.hl7.fhir.r4.model.Organization organization) {
  ...
  public void setClinic(Clinic clinic,
    ...
    if (clinic != null) {
      setSenderName(clinic.getClinicName());
      setOscarFhirResource(new Organization<Clinic>(clinic, configurationManager));
    }
    this.clinic = clinic;
  }

  public AbstractOscarFhirResource<org.hl7.fhir.r4.model.Organization, Clinic> getOscarFhirResource() {
    return oscarFhirResource;
  }

  public void setOscarFhirResource(
      AbstractOscarFhirResource<org.hl7.fhir.r4.model.Organization, Clinic> oscarFhirResource) {
