...
public class BORN {
  ...
  public static synchronized Set<Communication> getCommunicationResources(LoggedInInfo loggedInInfo,
      int[] demographicNos) {
   ...
   */
  public static synchronized Communication getCommunication(LoggedInInfo loggedInInfo,
      int demographicNo) {
    Communication communication = null;
    FhirCommunicationBuilder fhirCommunicationBuilder = getFhirCommunicationBuilder(loggedInInfo,
        demographicNo);
  ...
  public static synchronized FhirCommunicationBuilder getFhirCommunicationBuilder(
      LoggedInInfo loggedInInfo, int demographicNo) {
    OscarFhirConfigurationManager configurationManager = new OscarFhirConfigurationManager(
        loggedInInfo, SETTINGS);
    FhirCommunicationBuilder fhirCommunicationBuilder = new FhirCommunicationBuilder(
    ...
    // Practitioner
    Practitioner practitioner = OscarFhirResourceManager.getDemographicMostResponsiblePractitioner(
        configurationManager, demographicNo);
