...
public class Sender {
  ...
  public ca.openosp.openo.commn.model.Clinic getClinic() {
    return this.clinic;
  }

  public void setClinic(ca.openosp.openo.commn.model.Clinic clinic) {
    if (clinic != null) {
      setSenderName(clinic.getClinicName());
      setOscarFhirResource(new Organization<>(clinic));
    }
    this.clinic = clinic;
  }
  ...
  public void setOscarFhirResource(
      AbstractOscarFhirResource<org.hl7.fhir.dstu3.model.Organization, Clinic> oscarFhirResource) {
