...
public class BIS {
  ...
  public static synchronized FhirCommunicationBuilder getFhirCommunicationBuilder(
      LoggedInInfo loggedInInfo, int demographicNo, String wbData, String wbCsdData, String arData,
      Clinic clinic) {
    ...
    if (wbData != null) {
      ...
      fhirCommunicationBuilder.addAttachment(
          clinicalImpression.copyToAttachment(new Attachment()));
    }
