...
public class Practitioner extends
   ...
   *
   */
  protected void setIdentifier(org.hl7.fhir.dstu3.model.Practitioner fhirResource)
      throws MandatoryAttributeException {
  ...
  protected void setNurseIdentifier(org.hl7.fhir.dstu3.model.Practitioner fhirResource,
  ...
  protected void setDoctorIdentifier(org.hl7.fhir.dstu3.model.Practitioner fhirResource,
      String practitionerNumber) {
    fhirResource.addIdentifier()
  ...
  protected void setPharmacistIdentifier(org.hl7.fhir.dstu3.model.Practitioner fhirResource,
      String practitionerNumber) {
    fhirResource.addIdentifier()
  ...
  protected void setMidwifeIdentifier(org.hl7.fhir.dstu3.model.Practitioner fhirResource,
      String practitionerNumber) {
    fhirResource.addIdentifier()
  ...
  protected void setQualification(org.hl7.fhir.dstu3.model.Practitioner fhirResource) {
    ...
    if (designation != null) {
      fhirResource.addQualification().getCode().addCoding()
          .setSystem(
              "https://ehealthontario.ca/API/FHIR/NamingSystem/ca-on-immunizations-practitioner-designation")
          .setCode(designation)
