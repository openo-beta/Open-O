...
import ca.openosp.openo.integration.fhir.dstu3.interfaces.ContactInterface;
...
public class Organization<T extends AbstractModel<Integer> & ContactInterface> extends
		AbstractOscarFhirResource<org.hl7.fhir.dstu3.model.Organization, T> {
   ...
   * This is the default identifier.  This is overriden by alternative identifiers set after
   * instantiation.
   */
