...
public class RelatedPerson extends
		AbstractOscarFhirResource<org.hl7.fhir.r4.model.RelatedPerson, Contact> {

  public RelatedPerson(Contact contact) {
    super(new org.hl7.fhir.r4.model.RelatedPerson(), contact);
  }

  public RelatedPerson(org.hl7.fhir.r4.model.RelatedPerson relatedPerson) {
  ...
  /**
   * This patient is represents a relationship to another (or the same) patient in focus.
   * <p>
   * Example: if a child's immunization record is being sent to a health authority.
   * <p>
   * The child's responsible parent would be inserted here. The child would be the patient in focus.
   * aka: the patient that this patient refers to.
   * <p>
   * If there is no relationship, then the patient would be inserted here with a relationship to
   * ONESELF and a reference to the data contained within.
   */
  private void setPatient(Patient patient) {
    ...
    setResource(new org.hl7.fhir.r4.model.RelatedPerson(), contact);
  ...
  @Override
  protected void mapAttributes(org.hl7.fhir.r4.model.RelatedPerson relatedPerson) {
  ...
  private void setName(org.hl7.fhir.r4.model.RelatedPerson relatedPerson) {
  ...
  private void setAddress(org.hl7.fhir.r4.model.RelatedPerson relatedPerson) {
  ...
  private void setTelecom(org.hl7.fhir.r4.model.RelatedPerson relatedPerson) {
  ...
  private void setIdentifier(org.hl7.fhir.r4.model.RelatedPerson relatedPerson) {
    if (getOscarResource() instanceof ProfessionalContact) {
      relatedPerson.addIdentifier()
          ...
          .setValue((getOscarResource()).getCpso());
    }
  }

  private void setIdentifier(Contact contact) {
    ((ProfessionalContact) contact).setCpso(
        FhirUtils.getFhirOfficialIdentifier(getFhirResource().getIdentifier()));
  }

  public void setRelationship(org.hl7.fhir.r4.model.RelatedPerson relatedPerson) {
