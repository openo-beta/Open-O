...
public class PatientContact extends
  ...
  private ca.openosp.openo.commn.model.Contact contact;
  private ProfessionalSpecialist professionalSpecialist;
  private ca.openosp.openo.commn.model.DemographicContact demographicContact;
  private ca.openosp.openo.commn.model.DemographicContact[] demographicContacts;
  private ca.openosp.openo.commn.model.Contact[] contacts;
  ...
  public PatientContact(ca.openosp.openo.commn.model.Contact[] contacts) {
    this.setContacts(contacts);
    this.setFhirContacts(new ca.uhn.fhir.model.dstu2.resource.Patient.Contact[contacts.length]);
  }

  public PatientContact(ca.openosp.openo.commn.model.Contact contact) {
    setContact(contact);
   ...
   */
  public PatientContact(ca.openosp.openo.commn.model.DemographicContact demographicContact) {
   ...
   * about the contact, such as relationship and legal status.
   */
  public PatientContact(ca.openosp.openo.commn.model.DemographicContact[] demographicContacts) {
   ...
   */
  public ca.openosp.openo.commn.model.Contact getContact() {
    return contact;
  }

  private void setContact(ca.openosp.openo.commn.model.Contact contact) {
  ...
  public ca.openosp.openo.commn.model.Contact[] getContacts() {
    return contacts;
  }

  private void setContacts(ca.openosp.openo.commn.model.Contact[] contacts) {
    this.contacts = contacts;
  }

  public ca.openosp.openo.commn.model.DemographicContact getDemographicContact() {
    return demographicContact;
  }

  private void setDemographicContact(
      ca.openosp.openo.commn.model.DemographicContact demographicContact) {
    this.demographicContact = demographicContact;
  }

  public ca.openosp.openo.commn.model.DemographicContact[] getDemographicContacts() {
    return demographicContacts;
  }

  private void setDemographicContacts(
      ca.openosp.openo.commn.model.DemographicContact[] demographicContacts) {
