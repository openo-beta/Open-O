...
import ca.openosp.openo.integration.fhir.r4.exception.MandatoryAttributeException;
...
public class Practitioner extends
  ...
  public Practitioner(Provider provider) {
    super(new org.hl7.fhir.r4.model.Practitioner(), provider);
  }

  public Practitioner(Provider provider, OscarFhirConfigurationManager configurationManager) {
    super(new org.hl7.fhir.r4.model.Practitioner(), provider, configurationManager);
  }

  public Practitioner(org.hl7.fhir.r4.model.Practitioner practitioner) {
    super(new Provider(), practitioner);
  }

  @Override
  protected void setId(org.hl7.fhir.r4.model.Practitioner fhirResource) {
    fhirResource.setId(getOscarResource().getProviderNo());
  }

  @Override
  protected final void mapAttributes(org.hl7.fhir.r4.model.Practitioner fhirResource) {
    //Mandatory
    setName(fhirResource);
    try {
      setIdentifier(fhirResource);
    } catch (MandatoryAttributeException e) {
      MiscUtils.getLogger().error("Provider number " + getOscarResource().getProviderNo()
          + " is missing a mandatory attribute value for practitioner number");
    }
  ...
  private final void setName(org.hl7.fhir.r4.model.Practitioner fhirResource) {
   ...
   *
   */
  protected void setIdentifier(org.hl7.fhir.r4.model.Practitioner fhirResource)
      throws MandatoryAttributeException {
    String practitionerNumber = getOscarResource().getPractitionerNo();
    if ((practitionerNumber == null || practitionerNumber.isEmpty()) && isMandatory(
        MandatoryFHIRAttribute.practitionerNo)) {
    ...
    switch (LicenseType.valueOf(licensetype)) {
      ...
      case CNORNP:
        ...
        break;
      case CPSO:
        setDoctorIdentifier(fhirResource, practitionerNumber);
        break;
      case OCP:
        setPharmacistIdentifier(fhirResource, practitionerNumber);
        break;
      case CMO:
        setMidwifeIdentifier(fhirResource, practitionerNumber);
        break;
      case DEFAULT:
  ...
  protected void setNurseIdentifier(org.hl7.fhir.r4.model.Practitioner fhirResource,
      String practitionerNumber) {
    fhirResource.addIdentifier()
        .setSystem(DHIR.ID_SYSTEM_GLOBAL_BASE + "/ca-on-license-nurse")
        .setValue(practitionerNumber);
  }

  protected void setDoctorIdentifier(org.hl7.fhir.r4.model.Practitioner fhirResource,
      String practitionerNumber) {
    fhirResource.addIdentifier()
        .setSystem(DHIR.ID_SYSTEM_GLOBAL_BASE + "/ca-on-license-physician")
        .setValue(practitionerNumber);
  }

  protected void setPharmacistIdentifier(org.hl7.fhir.r4.model.Practitioner fhirResource,
      String practitionerNumber) {
    fhirResource.addIdentifier()
        .setSystem(DHIR.ID_SYSTEM_GLOBAL_BASE + "/ca-on-license-pharmacist")
        .setValue(practitionerNumber);
  }

  protected void setMidwifeIdentifier(org.hl7.fhir.r4.model.Practitioner fhirResource,
      String practitionerNumber) {
    fhirResource.addIdentifier()
        .setSystem(DHIR.ID_SYSTEM_GLOBAL_BASE + "/ca-on-license-midwife")
        .setValue(practitionerNumber);
  }

  protected void setQualification(org.hl7.fhir.r4.model.Practitioner fhirResource) {
    //TODO these codes cannot be hard coded like this. Temporary hack
    String licensetype = getOscarResource().getPractitionerNoType();
    ...
    if (designation != null) {
      fhirResource.addQualification().getCode().addCoding()
          .setSystem(DHIR.CODE_SYSTEM_LOCAL_BASE + "/ca-on-immunizations-practitioner-designation")
          .setCode(designation)
          .setDisplay(designation);
    }
  }

  protected void setWorkPhone(org.hl7.fhir.r4.model.Practitioner fhirResource) {
  ...
  protected void setOtherPhone(org.hl7.fhir.r4.model.Practitioner fhirResource) {
  ...
  protected void setEmail(org.hl7.fhir.r4.model.Practitioner fhirResource) {
