...
import ca.openosp.openo.integration.fhir.dstu3.builder.DestinationFactory;
import ca.openosp.openo.integration.fhir.dstu3.builder.ResourceAttributeFilterFactory;
import ca.openosp.openo.integration.fhir.dstu3.builder.SenderFactory;
...
public final class OscarFhirConfigurationManager {
  ...
  public OscarFhirConfigurationManager(LoggedInInfo loggedInInfo, Settings settings) {
    ...
    this.resourceAttributeFilter = ResourceAttributeFilterFactory.getFilter(
        settings.getFhirDestination());
