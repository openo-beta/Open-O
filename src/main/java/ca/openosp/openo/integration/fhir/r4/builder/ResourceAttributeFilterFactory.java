...
import ca.openosp.openo.integration.fhir.r4.resources.ResourceAttributeFilter;
...
public final class ResourceAttributeFilterFactory {
  ...
  private static final String ROOT_RESOURCE_URL = "/org/oscarehr/integration/fhirR4/filters/";
  private static final String FILE_NAME = "resource_attribute";
  private static final String FILE_APPEND = "filter";

  /**
   * Returns a Resource Attribute Filter class customized specifically for the FHIR destination and
   * FHIR Resource. For Example. A Patient FHIR resource being sent to the Ontario BORN API would
   * have a method signature:
   * <p>
   * getFilter("born", "org.hl7.fhir.r4.model.Patient")
   * <p>
  ...
  private static ResourceAttributeFilter getFilter(String destination) {
    String filterURL = String.format("%s%s%s%s.%s", ROOT_RESOURCE_URL, destination, File.separator,
        FILE_NAME, FILE_APPEND);
