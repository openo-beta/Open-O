...
import ca.openosp.openo.integration.fhir.r4.interfaces.ResourceAttributeFilterInterface;
...
public abstract class AbstractOscarFhirResource<FHIR extends org.hl7.fhir.r4.model.BaseResource, OSCAR extends AbstractModel<?>>
  ...
  public String getReferenceLink() {
    return String.format(
        "%s/%s",
        ((Resource) getFhirResource()).getResourceType(),
  ...
  public String getContainedReferenceLink() {
    ...
    String referenceLink = String.format(
        "%s%s",
        resourceType,
