...
import ca.openosp.openo.integration.fhir.dstu3.builder.FhirBundleBuilder;
...
public class DHIR {
   ...
   */
  public static synchronized FhirBundleBuilder getFhirBundleBuilder(LoggedInInfo loggedInInfo,
                                                                    int demographicNo) {
    ...
    org.hl7.fhir.dstu3.model.Organization publicHealthUnit = OscarFhirResourceManager.getPublicHealthUnit(
        configurationManager, demographicNo);
    ...
    if (publicHealthUnit != null) {
      ...
      reference.setReference(String.format("%s/%s", ((Resource) publicHealthUnit).getResourceType(),
   ...
   */
  public static synchronized FhirBundleBuilder getFhirBundleBuilder(LoggedInInfo loggedInInfo,
                                                                    int demographicNo, int preventionId) {
