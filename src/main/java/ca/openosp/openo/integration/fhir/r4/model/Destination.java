...
/**
 * A class that references a message destination header information. This Object builds a FHIR
 * MessageDestinationComponent.
 * <p>
 * The ultimate intention of this class is to auto populate and translate specific data according to
 * its environment.
 */
public final class Destination {
  ...
  public List<MessageDestinationComponent> getMessageDestinationComponents() {
    if (messageDestinationComponents == null) {
      messageDestinationComponents = new ArrayList<>();
    }
   ...
   */
  private void addMessageDestinationComponent(
      MessageDestinationComponent messageDestinationComponent) {
  ...
  public void addDestination(FhirDestination destination) {
    addDestination(destination.getTitle(), destination.getEndpoint());
  }
