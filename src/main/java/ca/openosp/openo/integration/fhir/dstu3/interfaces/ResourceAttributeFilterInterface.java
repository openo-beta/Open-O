...
public interface ResourceAttributeFilterInterface {
  ...
  /**
   * Indicates if the passed in parameter is optional true = include this parameter in every
   * message. false = do not include this paramter in every message.
   */
   ...
   * <p>
   * parameter = providerNo - default = true - optional = true - mandatory = false
   * <p>
   * practitionerNo = false : this value is mandatory practitionerNo = true : this value is not
   * mandatory empty : this value is not mandatory
   */
