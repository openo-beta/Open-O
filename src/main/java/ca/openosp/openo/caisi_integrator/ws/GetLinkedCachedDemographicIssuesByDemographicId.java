...
@XmlType(name = "getLinkedCachedDemographicIssuesByDemographicId", propOrder = { "caisiDemographicId" })
public class GetLinkedCachedDemographicIssuesByDemographicId implements Serializable
{
