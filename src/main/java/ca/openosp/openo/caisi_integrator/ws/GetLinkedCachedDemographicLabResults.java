...
@XmlType(name = "getLinkedCachedDemographicLabResults", propOrder = { "caisiDemographicId" })
public class GetLinkedCachedDemographicLabResults implements Serializable
{
