...
@XmlType(name = "getLinkedCachedAdmissionsByDemographicId", propOrder = { "caisiDemographicId" })
public class GetLinkedCachedAdmissionsByDemographicId implements Serializable
{
