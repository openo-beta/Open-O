...
@XmlType(name = "getLinkedCachedDemographicMeasurementByDemographicId", propOrder = { "caisiDemographicId" })
public class GetLinkedCachedDemographicMeasurementByDemographicId implements Serializable
{
