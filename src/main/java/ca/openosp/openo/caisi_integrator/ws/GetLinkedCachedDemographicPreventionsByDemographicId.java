...
@XmlType(name = "getLinkedCachedDemographicPreventionsByDemographicId", propOrder = { "caisiDemographicId" })
public class GetLinkedCachedDemographicPreventionsByDemographicId implements Serializable
{
