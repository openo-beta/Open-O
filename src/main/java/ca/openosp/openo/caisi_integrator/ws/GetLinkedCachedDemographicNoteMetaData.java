...
@XmlType(name = "getLinkedCachedDemographicNoteMetaData", propOrder = { "caisiDemographicId" })
public class GetLinkedCachedDemographicNoteMetaData implements Serializable
{
