...
@XmlType(name = "matchingDemographicParameters", propOrder = { "maxEntriesToReturn", "minScore", "firstName", "lastName", "birthDate", "hin" })
public class MatchingDemographicParameters implements Serializable
{
