...
@XmlType(name = "getLinkedCachedDemographicDrugsByDemographicId", propOrder = { "caisiDemographicId" })
public class GetLinkedCachedDemographicDrugsByDemographicId implements Serializable
{
