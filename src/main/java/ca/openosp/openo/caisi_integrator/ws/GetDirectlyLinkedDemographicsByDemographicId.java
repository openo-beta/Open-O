...
@XmlType(name = "getDirectlyLinkedDemographicsByDemographicId", propOrder = { "caisiDemographicId" })
public class GetDirectlyLinkedDemographicsByDemographicId implements Serializable
{
