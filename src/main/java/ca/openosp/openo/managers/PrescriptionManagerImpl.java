...
public class PrescriptionManagerImpl implements PrescriptionManager {
    ...
    public List<Prescription> getPrescriptionByDemographicIdUpdatedAfterDate(LoggedInInfo loggedInInfo,
        ...
        if (patientConsentManager.hasPatientConsented(demographicId, consentType)) {
            results = prescriptionDao.findByDemographicIdUpdatedAfterDateExclusive(demographicId,
                    updatedAfterThisDateExclusive);
            LogAction.addLogSynchronous(loggedInInfo,
                    "PrescriptionManager.getPrescriptionByDemographicIdUpdatedAfterDate", "demographicId="
                            + demographicId + " updatedAfterThisDateExclusive=" + updatedAfterThisDateExclusive);
        }
        return (results);
    }
    ...
    /**
     * ProgramId is currently ignored as oscar does not support tracking by program
     * yet.
     */
    @Override
    public List<Prescription> getPrescriptionsByProgramProviderDemographicDate(LoggedInInfo loggedInInfo,
        ...
        LogAction.addLogSynchronous(loggedInInfo,
                "PrescriptionManager.getPrescriptionsByProgramProviderDemographicDate",
    ...
    public Prescription createNewPrescription(LoggedInInfo info, List<Drug> drugs, Integer demographicNo) {
        ...
        LogAction.addLogSynchronous(info, "PrescriptionManager.createNewPrescription",
    ...
    private String getPrescriptionTextView(LoggedInInfo info, Integer demo, List<Drug> drugs) {
        ...
        // This code uses legacy code from ca.openosp.openo.rx package.
        // Should refactor to change this. Trying best to limit the
        // scope to this method.
        //
        // TODO: Refactor to not use code from ca.openosp.openo.rx
    ...
    public List<Drug> getMedicationsByDemographicNo(LoggedInInfo loggedInInfo, Integer demographicNo,
        ...
        LogAction.addLogSynchronous(loggedInInfo,
                "PrescriptionManager.getMedicationsByDemographicNo Archived=" + archived, drugList.toString());
        return drugList;
    }
    ...
    public Drug findDrugById(LoggedInInfo loggedInInfo, Integer drugId) {
        ...
        LogAction.addLogSynchronous(loggedInInfo, "PrescriptionManager.findDrugById",
                "searching for drug id: " + drugId);
    ...
    public List<Drug> getLongTermDrugs(LoggedInInfo loggedInInfo, Integer demographicId) {
        ...
        LogAction.addLogSynchronous(loggedInInfo, "PrescriptionManager.getLongtermDrugs",
