...
public class ProviderSettings {
    ...
    private Collection<QuickLink> appointmentScreenQuickLinks = new ArrayList<QuickLink>();
    ...
    public void setAppointmentScreenQuickLinks(Collection<QuickLink> appointmentScreenQuickLinks) {
