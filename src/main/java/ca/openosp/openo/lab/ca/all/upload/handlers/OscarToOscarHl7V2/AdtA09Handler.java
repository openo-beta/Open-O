...
package ca.openosp.openo.lab.ca.all.upload.handlers.OscarToOscarHl7V2;
...
public final class AdtA09Handler {
    ...
    private static void checkPv1(PV1 pv1) {
        ...
        if (!PATIENT_CLASS.equals(patientClass))
            throw (new UnsupportedOperationException("PV1 doesn't match expectations : patientClass=" + patientClass));
