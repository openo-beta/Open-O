...
import ca.openosp.openo.commn.model.Tickler.STATUS;
...
import ca.openosp.openo.webserv.rest.to.model.TicklerCommentTo1;
import ca.openosp.openo.webserv.rest.to.model.TicklerTo1;
import ca.openosp.openo.webserv.rest.to.model.TicklerUpdateTo1;
    ...
    public TicklerTo1 getAsTransferObject(LoggedInInfo loggedInInfo, Tickler t) throws ConversionException {
        ...
        if (includeUpdates) {
            for (TicklerUpdate tu : t.getUpdates()) {
                ...
                BeanUtils.copyProperties(tu, tut, new String[]{"id", "providers"});
