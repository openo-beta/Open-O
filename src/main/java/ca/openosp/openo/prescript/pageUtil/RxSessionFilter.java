...
/**
 * Servlet filter that swaps the correct per-patient RxSessionBean into the
 * legacy "RxSessionBean" session key before each Rx-related request.
 * <p>
 * This allows existing action/JSP code that reads
 * {@code session.getAttribute("RxSessionBean")} to transparently get the
