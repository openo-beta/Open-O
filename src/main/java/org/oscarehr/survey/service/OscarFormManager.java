...
public class OscarFormManager {
    ...
    public void generateCSV(Integer formId, OutputStream out) {
        ...
        //print header line
        pout.print(escapeAndQuote("Date"));
        pout.print(",");
        pout.print(escapeAndQuote("Client ID"));
        pout.print(",");
        pout.print(escapeAndQuote("Client First Name"));
        pout.print(",");
        pout.print(escapeAndQuote("Client Last Name"));
        pout.print(",");
        pout.print(escapeAndQuote("Client DOB"));
        pout.print(",");
        int x = 0;
        ...
        for (x = 0; x < result.size(); x++) {
            ...
            if (demographic != null) {
                ...
                pout.print(escapeAndQuote(df.format(ts)));
                pout.print(",");
                pout.print(escapeAndQuote(String.valueOf(clientId)));
                pout.print(",");
                pout.print(escapeAndQuote(demographic.getFirstName()));
                pout.print(",");
                pout.print(escapeAndQuote(demographic.getLastName()));
                pout.print(",");
    ...
    public void generateInverseCSV(Integer formId, OutputStream out) {
        ...
        pout.print(escapeAndQuote("FC MO"));
        pout.print(",");
