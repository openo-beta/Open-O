...
public class AnswerScalarTextOcanClientXmlAdapter extends AbstractAnswerScalarHtmlAdapter {
	
	public AnswerScalarTextOcanClientXmlAdapter(int indent, IntakeNode node, Intake intake) {
