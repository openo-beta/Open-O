...
import ca.openosp.common.KeyConstants;
import ca.openosp.model.security.NoAccessException;
import ca.openosp.service.security.SecurityManager;

import com.opensymphony.xwork2.ActionSupport;
import org.apache.struts2.ServletActionContext;

public class Home2Action extends ActionSupport {
    ...
    private void setMenu(HttpServletRequest request, String currentMenu) throws NoAccessException {
		...
		*/
        ...
        if (request.getAttribute("pageChanged") == null) {
            if (request.getParameter("pageChanged") != null)
                request.setAttribute("pageChanged", request.getParameter("pageChanged"));
        }
