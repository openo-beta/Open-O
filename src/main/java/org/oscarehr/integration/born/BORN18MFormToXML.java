...
public class BORN18MFormToXML {
    ...
    private void propulateRourkeFromRourke18m(RBRM18 rbrm18, Integer fdid) {
        ...
        for (EFormValue var : vars) {
            ...
            else if (name.equals("interestedinchildren_18m_o"))
                rbrm18.setDevelopmentSocialEmotionalInterestedInChildren(1);
            else if (name.equals("interestedinchildren_18m_x"))
                rbrm18.setDevelopmentSocialEmotionalInterestedInChildren(2);
            else if (name.equals("behaviourmanageable_18m_o"))
                rbrm18.setDevelopmentSocialEmotionalManagableBehaviour(1);
            else if (name.equals("behaviourmanageable_18m_x"))
                rbrm18.setDevelopmentSocialEmotionalManagableBehaviour(2);
            else if (name.equals("disciplineparenting_18m_o"))
                rbrm18.setEducationAdviceBehaviourDisciplineParentingSkills(1);
            else if (name.equals("disciplineparenting_18m_x"))
                rbrm18.setEducationAdviceBehaviourDisciplineParentingSkills(2);
            ...
            else if (name.equals("secondhandsmoke_18m_o"))
                rbrm18.setEducationAdviceEnvironmentalHealthSecondHandSmoke(1);
            else if (name.equals("secondhandsmoke_18m_x"))
                rbrm18.setEducationAdviceEnvironmentalHealthSecondHandSmoke(2);
    ...
    private void propulateM18Markers(M18MARKERS m18Markers, Integer fdid) {
        ...
        for (EFormValue var : vars) {
            ...
            else if (name.equals("SecondHandSmokeInUtero"))
                m18Markers.setSecondHandSmokeExposureInUtero(YesNoUnknown.Y);
            else if (name.equals("SecondHandSmokeSinceBirth"))
                m18Markers.setSecondHandSmokeExposureSinceBirth(YesNoUnknown.Y);
            else if (name.equals("SecondHandSmokeNoExposure"))
                m18Markers.setSecondHandSmokeExposureNoExposure(YesNoUnknown.Y);
            ...
            else if (name.equals("MoreThanOneDevAreaAffectedYes"))
                m18Markers.setMoreThanOneDevAreaAffectedYes(YesNoUnknown.Y);
            else if (name.equals("MoreThanOneDevAreaAffectedNo"))
                m18Markers.setMoreThanOneDevAreaAffectedNo(YesNoUnknown.Y);
