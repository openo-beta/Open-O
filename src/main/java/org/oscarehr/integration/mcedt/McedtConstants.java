...
public class McedtConstants {
    ...
    public static final String SESSION_KEY_MCEDT_UPLOADS = "mcedtUploads";
    public static final String SESSION_KEY_MCEDT_UPDATES = "mcedtUpdates";
    public static final String SESSION_KEY_UPLOAD_DETAILS = "mcedtUploadDetails";
