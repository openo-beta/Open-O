...
public class OcanReporting2Action extends ActionSupport {
     ...
     *
     */
    public String getAssessments() throws IOException {
    ...
    public String generateIndividualNeedRatingOverTimeReport() {
        LoggedInInfo loggedInInfo = LoggedInInfo.getLoggedInInfoFromSession(request);
    ...
    public String generateNeedRatingOverTimeReport() {
        LoggedInInfo loggedInInfo = LoggedInInfo.getLoggedInInfoFromSession(request);
    ...
    public String generateSummaryOfActionsAndCommentsReport() {
        LoggedInInfo loggedInInfo = LoggedInInfo.getLoggedInInfoFromSession(request);
    ...
    private String determineBestNeed(String need1, String need2) {
        if (need1 != null && need1.equals("2")) {
            return "unmet";
        }
        if (need2 != null && need2.equals("2")) {
            return "unmet";
        }
        if (need1 != null && need1.equals("1")) {
            return "met";
        }
        if (need2 != null && need2.equals("1")) {
            return "met";
        }
        if (need1 != null && need1.equals("0")) {
            return "no";
        }
        if (need2 != null && need2.equals("0")) {
            return "no";
        }
        if (need1 != null && need1.equals("9")) {
            return "unknown";
        }
        if (need2 != null && need2.equals("9")) {
            return "unknown";
        }
        return "unknown";
    }
