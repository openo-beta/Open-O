...
public class PanelBean {
	...
	// each panel contains one or more IndicatorPanels
	// sorted by Indicator category.
	...
	public void setIndicatorPanelBeans(List<IndicatorPanelBean> indicatorPanelBeans) {
