...
public class ExaminationHistory2Action extends ActionSupport {
    ...
    public String query() {
        ...
        if (fieldList.contains("ar")) {
            ...
            for (Appointment appt : appts) {
                ...
                if (m != null) {
                    map.put(m.getType(), m.getDataField());
                } else {
                    map.put("od_ar_sph", "");
                }
