...
<form method="post" action="">
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="3"><input type="radio" name="feet_sensation_value" value="Yes">Yes</input><input type="radio"
                                                                                                          name="feet_sensation_value"
                                                                                                          value="No">No</input>
            </td>
        ...
        <tr>
            ...
            <td colspan="3"><input type="radio" name="feet_vibration_value" value="Yes">Yes</input><input type="radio"
                                                                                                          name="feet_vibration_value"
                                                                                                          value="No">No</input>
            </td>
        ...
        <tr>
            ...
            <td colspan="3"><input type="radio" name="feet_reflexes_value" value="Yes">Yes</input><input type="radio"
                                                                                                         name="feet_reflexes_value"
                                                                                                         value="No">No</input>
            </td>
        ...
        <tr>
            ...
            <td colspan="3"><input type="radio" name="feet_pulses_value" value="Yes">Yes</input><input type="radio"
                                                                                                       name="feet_pulses_value"
                                                                                                       value="No">No</input>
            </td>
        ...
        <tr>
            ...
            <td colspan="3"><input type="radio" name="feet_infection_value" value="Yes">Yes</input><input type="radio"
                                                                                                          name="feet_infection_value"
                                                                                                          value="No">No</input>
            </td>
        ...
        <tr>
            ...
            <td><input type="text" name="smokingstartage_value" size="5" onchange="calcSmkSYear(); calcPYHX()"/> (age)
            </td>
            <td colspan="2"><input type="text" name="smokingstartyear_value" size="5"
        ...
        <tr>
            ...
            <td><input type="text" name="smokingcessage_value" size="5" onchange="calcSmkCYear(); calcPYHX()"/> (age)
            </td>
            <td colspan="2"><input type="text" name="smokingcessyear_value" size="5"
        ...
        <tr>
            ...
            <td colspan="3"><input type="radio" name="smokingadvised_value" value="Yes">Yes</input><input type="radio"
                                                                                                          name="smokingadvised_value"
                                                                                                          value="No">No</input>
            </td>
        ...
        <tr>
            ...
            <td colspan="3"><input type="radio" name="smokingquit_value" value="Yes">Yes</input><input type="radio"
                                                                                                       name="smokingquit_value"
                                                                                                       value="No">No</input>
            </td>
        ...
        <tr>
            ...
            <td colspan="3"><input type="radio" name="smokingfollowup_value" value="Yes">Yes</input><input type="radio"
                                                                                                           name="smokingfollowup_value"
                                                                                                           value="No">No</input>
            </td>
