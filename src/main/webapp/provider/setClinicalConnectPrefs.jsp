		...
		<table class="MainTable" id="scrollNumber1" name="encounterTable">
			...
			<%if( request.getAttribute("status") == null ){%>
					<html:form action="/setProviderStaleDate.do">
						...
						<html:checkbox property="clinicalConnectDisableCloseWindow.checked">Disable Close Window (when eChart closed)</html:checkbox>
						
						<br/>
						
						<html:checkbox property="clinicalConnectDisableLogoutWarning.checked">Disable Logout Warning</html:checkbox>
