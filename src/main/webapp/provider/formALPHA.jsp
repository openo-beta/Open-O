...
<form name="serviceform" action="providercontrol.jsp" method="POST"
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr bgcolor="#486ebd">
            <th width="15%"
                nowrap><%=bNew ? "<input type='submit' name='saveexit' value='Save to Enc.& Exit' onClick='onSaveExit()'> " : ""%>
            </th>
            ...
            <th width="25%" nowrap
                align='right'><%=bNew ? "<input type='button' name='Button' value=' Exit ' onClick='onExit();'>" : "<input type='button' name='Button' value=' Exit ' onClick='window.close();'>" %>
        ...
        <tr bgcolor="#486ebd">
            <td align="center">
                ...
                <input type="hidden" name="user_no" value='<%=user_no%>'> <input
                    ...
                    value="saveform"> <%=bNew ? "<input type='submit' name='subbutton' value=' Save '>" : ""%>
