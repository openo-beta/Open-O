...
<html>
    <head>
        ...
        <title><fmt:message key="provider.editRxPhone.title"/></title>
    ...
    <table class="MainTable" id="scrollNumber1" name="encounterTable">
        <tr class="MainTableTopRow">
            ...
            <td style="color: white" class="MainTableTopRowRightColumn"><fmt:message key="provider.editRxPhone.msgProviderPhoneNumber"/></td>
        </tr>
        <tr>
			...
			<li> When choosing your letterhead in consult requests, the clinic phone# and your provider record's work phone # will be overridden
                ...
                <input type="text" name="faxNumber" value="<%=Encode.forHtmlAttribute(String.valueOf(phoneNum))%>" size="40"/>
                <br>
            ...
            %> <fmt:message key="provider.editRxPhone.msgSuccess"/> <br>
                <%=Encode.forHtml(String.valueOf(phoneNum))%> <%
                }
            %>
            </td>
        </tr>
