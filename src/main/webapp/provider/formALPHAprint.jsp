...
<TABLE BORDER BORDERCOLOR="#000000" CELLSPACING=1 CELLPADDING=4>
    ...
    <TR>
        ...
        <TD VALIGN="TOP"
            WIDTH="50%"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_ff_socialsupport").equals("") ? "&nbsp;" : request.getParameter("xml_ff_socialsupport")))%>
        </TD>
    </TR>
    <TR>
        ...
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_ff_recentstressfullifeevents").equals("") ? "&nbsp;" : request.getParameter("xml_ff_recentstressfullifeevents")))%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT SIZE="-1"
        ...
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_ff_couplerelationship").equals("") ? "&nbsp;" : request.getParameter("xml_ff_couplerelationship")))%>
        </TD>
    </TR>
    <TR bgcolor="#f9f9f9">
        <TD colspan="2" VALIGN="TOP"><FONT FACE="Arial, Helvetica"
    ...
    <TR>
        ...
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_mf_prenatalcare").equals("") ? "&nbsp;" : request.getParameter("xml_mf_prenatalcare")))%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
                                              Size="-1">Prenatal education (refusal or quit)</FONT></B>
            (<B><I>CA</I></B>)<BR>
            <FONT SIZE="-1" FACE="Arial, Helvetica">�What are your plans
                for prenatal classes?</FONT></TD>
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_mf_prenataleducation").equals("") ? "&nbsp;" : request.getParameter("xml_mf_prenataleducation")))%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
            ...
            <FONT SIZE="-1" FACE="Arial, Helvetica">�How do you feel about
                it now?</FONT></TD>
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_mf_feelingstopregnancy20").equals("") ? "&nbsp;" : request.getParameter("xml_mf_feelingstopregnancy20")))%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
        ...
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_mf_relationshipwithparents").equals("") ? "&nbsp;" : request.getParameter("xml_mf_relationshipwithparents")))%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
                                              Size="-1">Self-esteem</FONT></B> (<B><I>CA,</I></B> <FONT
                SIZE="-1">WA</FONT>)<BR>
            <FONT SIZE="-1" FACE="Arial, Helvetica">�What concerns do you
                have about becoming/being a mother?</FONT></TD>
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_mf_selfesteem").equals("") ? "&nbsp;" : request.getParameter("xml_mf_selfesteem")))%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
        ...
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_mf_historypsychiatricemaotional").equals("") ? "&nbsp;" : request.getParameter("xml_mf_historypsychiatricemaotional")))%>
        </TD>
    </TR>
    <TR>
        <TD WIDTH="50%" VALIGN="TOP"><B><FONT FACE="Arial, Helvetica"
        ...
        <TD VALIGN="TOP"><%=Encode.forHtml(Misc.JSEscape(request.getParameter("xml_mf_depression").equals("") ? "&nbsp;" : request.getParameter("xml_mf_depression")))%>
        </TD>
    </TR>
    <TR>
