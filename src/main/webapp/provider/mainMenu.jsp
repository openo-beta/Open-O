                    ...
                    <ul id="navlistcontents" style="display:none;">
                        ...
                        <caisi:isModuleLoad moduleName="TORONTO_RFQ" reverse="true">
                            <security:oscarSec roleName="<%=roleName$%>" objectName="_msg" rights="r">
                                <li>
                                    <a HREF="#"
                                       ONCLICK="popupOscarRx(600,1024,'<%=request.getContextPath()%>/messenger/DisplayMessages.do?providerNo=<%=Encode.forJavaScript(String.valueOf(curUser_no))%>&userName=<%=Encode.forJavaScript(String.valueOf(loggedInInfo.getLoggedInProvider().getFirstName()+" "+loggedInInfo.getLoggedInProvider().getLastName()))%>')"
                        ...
                        <caisi:isModuleLoad moduleName="TORONTO_RFQ" reverse="true">
                            <security:oscarSec roleName="<%=roleName$%>" objectName="_con" rights="r">
                                <li id="con">
                                    <a HREF="#"
                                       ONCLICK="popupOscarRx(625,1024,'<%=request.getContextPath()%>/oscarEncounter/IncomingConsultation.do?providerNo=<%=Encode.forJavaScript(String.valueOf(curUser_no))%>&userName=<%=Encode.forJavaScript(String.valueOf(loggedInInfo.getLoggedInProvider().getFirstName()+" "+loggedInInfo.getLoggedInProvider().getLastName()))%>')"
