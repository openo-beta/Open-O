    ...
    <tr>
        ...
        <td id="firstMenu">
            <ul id="navlist">
                ...
                <li>
                    <a href='providercontrol.jsp?year=<%=curYear%>&month=<%=curMonth%>&day=<%=curDay%>&view=0&displaymode=day&dboperation=searchappointmentday&caseload=1&clProv=<%=curUser_no%>'><fmt:message key="global.caseload"/></a>
                </li>
                    ...
                    <ul id="navlistcontents" style="display:none;">
                        ...
                        <caisi:isModuleLoad moduleName="TORONTO_RFQ" reverse="true">
                            <security:oscarSec roleName="<%=roleName$%>" objectName="_edoc" rights="r">
                                <li>
                                    <a HREF="#"
                                       onclick="popup('700', '1024', '<%= request.getContextPath() %>/documentManager/documentReport.jsp?function=providers&functionid=<%=curUser_no%>&curUser=<%=curUser_no%>', 'edocView');"
