...
<form name="serviceform" action="../provider/providercontrol.jsp"
    ...
    <%
        ...
        if (request.getParameter("bNew") != null && request.getParameter("bNew").compareTo("1") == 0)
            bNew = true; //here for another ar2 new form, continue from finished previous ar2 form
        if (request.getParameter("bNewForm") != null && request.getParameter("bNewForm").compareTo("1") == 0)
            bNew = true; //here for a total new ar2 form
    %>
            ...
            <th width="25%" nowrap>
                <div align="right">
                    ...
                    <font color='yellow'> New AR2 </font></a--> <input type="hidden"
                                                                       name="oox" value="0"> <input type="hidden"
                                                                                                    name="ooy"
                                                                                                    value="0"> <input
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0"
        ...
        <tr align="center">
            ...
            <td><textarea name="xml_Alert_demographicaccessory"
                    ...
                    <%=bNewList ? "" : "datafld='xml_Alert_demographicaccessory'"%>><%=bNewList ? allergies : ""%></textarea>
            </td>
            <td><textarea name="xml_Medication_demographicaccessory"
                          style="width: 100%" cols="30" rows="3"
                    <%=bNewList ? "" : "datafld='xml_Medication_demographicaccessory'"%>><%=bNewList ? medications : ""%></textarea>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0"
        ...
        <%
            boolean bTemp = bNew;
            if (request.getParameter("bNext") != null && request.getParameter("bNext").compareTo("1") == 0)
                bNew = true; //here for next ar2 form, continue from finished previous ar2 form
        %>
        <tr align="center">
                ...
                if (f != null) {
                    ...
                    for (Enumeration e = savedar1risk1.propertyNames(); e.hasMoreElements(); ) {
                        ...
                        if (SxmlMisc.getXmlContent(temp, savedar1risk1.getProperty(tt.toString())) != null)
                            savedar1risk.setProperty(tt.toString(), savedar1risk1.getProperty(tt.toString()));
                    }
                    ...
                    if (wt != null && ht != null) {
                        ...
                        if (bNum) {
                            if (Float.parseFloat(wt) <= 150 && Float.parseFloat(wt) >= 40 && Float.parseFloat(ht) <= 3 && Float.parseFloat(ht) >= 1) {
                                ...
                                if ((bmi > 0) && (bmi < 20)) {
                                    savedar1risk.setProperty("97", "xml_pew_peh");
                                }
                                if ((bmi > 19) && (bmi < 26)) {
                                    savedar1risk.setProperty("98", "xml_pew_peh");
                                }
                                if (bmi > 25) {
                                    savedar1risk.setProperty("99", "xml_pew_peh");
                                }
                            }
                        }
                    }
                    ...
                    if (SxmlMisc.getXmlContent(temp, "<xml_cp1b>", "</xml_cp1b>") != null)
                        savedar1risk.setProperty("1", "xml_cp1b");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cp2v>", "</xml_cp2v>") != null)
                        savedar1risk.setProperty("2", "xml_cp2v");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cp3s>", "</xml_cp3s>") != null)
                        savedar1risk.setProperty("3", "xml_cp3s");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cp4d>", "</xml_cp4d>") != null)
                        savedar1risk.setProperty("4", "xml_cp4d");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cp5a>", "</xml_cp5a>") != null)
                        savedar1risk.setProperty("5", "xml_cp5a");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cp6i>", "</xml_cp6i>") != null)
                        savedar1risk.setProperty("6", "xml_cp6i");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cp7r>", "</xml_cp7r>") != null)
                        savedar1risk.setProperty("7", "xml_cp7r");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cp8o>", "</xml_cp8o>") != null)
                        savedar1risk.setProperty("8", "xml_cp8o");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m9hy>", "</xml_m9hy>") != null)
                        savedar1risk.setProperty("9", "xml_m9hy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m10ey>", "</xml_m10ey>") != null)
                        savedar1risk.setProperty("10", "xml_m10ey");

                    if (SxmlMisc.getXmlContent(temp, "<xml_m11hy>", "</xml_m11hy>") != null)
                        savedar1risk.setProperty("11", "xml_m11hy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m12ry>", "</xml_m12ry>") != null)
                        savedar1risk.setProperty("12", "xml_m12ry");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m13ry>", "</xml_m13ry>") != null)
                        savedar1risk.setProperty("13", "xml_m13ry");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m14ly>", "</xml_m14ly>") != null)
                        savedar1risk.setProperty("14", "xml_m14ly");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m15ny>", "</xml_m15ny>") != null)
                        savedar1risk.setProperty("15", "xml_m15ny");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m16ay>", "</xml_m16ay>") != null)
                        savedar1risk.setProperty("16", "xml_m16ay");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m17by>", "</xml_m17by>") != null)
                        savedar1risk.setProperty("17", "xml_m17by");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m18gy>", "</xml_m18gy>") != null)
                        savedar1risk.setProperty("18", "xml_m18gy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m19hy>", "</xml_m19hy>") != null)
                        savedar1risk.setProperty("19", "xml_m19hy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m20sy>", "</xml_m20sy>") != null)
                        savedar1risk.setProperty("20", "xml_m20sy");

                    if (SxmlMisc.getXmlContent(temp, "<xml_m21ay>", "</xml_m21ay>") != null)
                        savedar1risk.setProperty("21", "xml_m21ay");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m22hy>", "</xml_m22hy>") != null)
                        savedar1risk.setProperty("22", "xml_m22hy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m23vy>", "</xml_m23vy>") != null)
                        savedar1risk.setProperty("23", "xml_m23vy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m24py>", "</xml_m24py>") != null)
                        savedar1risk.setProperty("24", "xml_m24py");
                    if (SxmlMisc.getXmlContent(temp, "<xml_m25oy>", "</xml_m25oy>") != null)
                        savedar1risk.setProperty("25", "xml_m25oy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_g26ay>", "</xml_g26ay>") != null)
                        savedar1risk.setProperty("26", "xml_g26ay");
                    if (SxmlMisc.getXmlContent(temp, "<xml_g27ay>", "</xml_g27ay>") != null)
                        savedar1risk.setProperty("27", "xml_g27ay");
                    if (SxmlMisc.getXmlContent(temp, "<xml_g28ky>", "</xml_g28ky>") != null)
                        savedar1risk.setProperty("28", "xml_g28ky");
                    if (SxmlMisc.getXmlContent(temp, "<xml_g29py>", "</xml_g29py>") != null)
                        savedar1risk.setProperty("29", "xml_g29py");
                    if (SxmlMisc.getXmlContent(temp, "<xml_fh30ny>", "</xml_fh30ny>") != null)
                        savedar1risk.setProperty("30", "xml_fh30ny");

                    if (SxmlMisc.getXmlContent(temp, "<xml_fh31dy>", "</xml_fh31dy>") != null)
                        savedar1risk.setProperty("31", "xml_fh31dy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_fh32cy>", "</xml_fh32cy>") != null)
                        savedar1risk.setProperty("32", "xml_fh32cy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_fh33cy>", "</xml_fh33cy>") != null)
                        savedar1risk.setProperty("33", "xml_fh33cy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_fh34cy>", "</xml_fh34cy>") != null)
                        savedar1risk.setProperty("34", "xml_fh34cy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_fh35gy>", "</xml_fh35gy>") != null)
                        savedar1risk.setProperty("35", "xml_fh35gy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_fh36fy>", "</xml_fh36fy>") != null)
                        savedar1risk.setProperty("36", "xml_fh36fy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_fh37oy>", "</xml_fh37oy>") != null)
                        savedar1risk.setProperty("37", "xml_fh37oy");
                    if (SxmlMisc.getXmlContent(temp, "<xml_fh37ay>", "</xml_fh37ay>") != null)
                        savedar1risk.setProperty("37", "xml_fh37ay");
                    if (SxmlMisc.getXmlContent(temp, "<xml_idt38s>", "</xml_idt38s>") != null)
                        savedar1risk.setProperty("38", "xml_idt38s");
                    if (SxmlMisc.getXmlContent(temp, "<xml_idt39h>", "</xml_idt39h>") != null)
                        savedar1risk.setProperty("39", "xml_idt39h");
                    if (SxmlMisc.getXmlContent(temp, "<xml_idt40v>", "</xml_idt40v>") != null)
                        savedar1risk.setProperty("40", "xml_idt40v");

                    if (SxmlMisc.getXmlContent(temp, "<xml_idt41t>", "</xml_idt41t>") != null)
                        savedar1risk.setProperty("41", "xml_idt41t");
                    if (SxmlMisc.getXmlContent(temp, "<xml_idt42t>", "</xml_idt42t>") != null)
                        savedar1risk.setProperty("42", "xml_idt42t");
                    if (SxmlMisc.getXmlContent(temp, "<xml_pdt43s>", "</xml_pdt43s>") != null)
                        savedar1risk.setProperty("43", "xml_pdt43s");
                    if (SxmlMisc.getXmlContent(temp, "<xml_pdt44c>", "</xml_pdt44c>") != null)
                        savedar1risk.setProperty("44", "xml_pdt44c");
                    if (SxmlMisc.getXmlContent(temp, "<xml_pdt45e>", "</xml_pdt45e>") != null)
                        savedar1risk.setProperty("45", "xml_pdt45e");
                    if (SxmlMisc.getXmlContent(temp, "<xml_pdt46s>", "</xml_pdt46s>") != null)
                        savedar1risk.setProperty("46", "xml_pdt46s");
                    if (SxmlMisc.getXmlContent(temp, "<xml_pdt47f>", "</xml_pdt47f>") != null)
                        savedar1risk.setProperty("47", "xml_pdt47f");
                    if (SxmlMisc.getXmlContent(temp, "<xml_pdt48p>", "</xml_pdt48p>") != null)
                        savedar1risk.setProperty("48", "xml_pdt48p");

                    if (SxmlMisc.getXmlContent(temp, "<xml_cinhe>", "</xml_cinhe>") != null)
                        savedar1risk.setProperty("51", "xml_cinhe");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinth>", "</xml_cinth>") != null)
                        savedar1risk.setProperty("52", "xml_cinth");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinch>", "</xml_cinch>") != null)
                        savedar1risk.setProperty("53", "xml_cinch");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinbr>", "</xml_cinbr>") != null)
                        savedar1risk.setProperty("54", "xml_cinbr");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinca>", "</xml_cinca>") != null)
                        savedar1risk.setProperty("55", "xml_cinca");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinab>", "</xml_cinab>") != null)
                        savedar1risk.setProperty("56", "xml_cinab");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinva>", "</xml_cinva>") != null)
                        savedar1risk.setProperty("57", "xml_cinva");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinne>", "</xml_cinne>") != null)
                        savedar1risk.setProperty("58", "xml_cinne");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinpe>", "</xml_cinpe>") != null)
                        savedar1risk.setProperty("59", "xml_cinpe");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinex>", "</xml_cinex>") != null)
                        savedar1risk.setProperty("60", "xml_cinex");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cince>", "</xml_cince>") != null)
                        savedar1risk.setProperty("61", "xml_cince");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinut>", "</xml_cinut>") != null)
                        savedar1risk.setProperty("62", "xml_cinut");
                    if (SxmlMisc.getXmlContent(temp, "<xml_cinad>", "</xml_cinad>") != null)
                        savedar1risk.setProperty("63", "xml_cinad");

                    if (SxmlMisc.getXmlContent(temp, "<xml_nafa>", "</xml_nafa>") != null)
                        savedar1risk.setProperty("71", "xml_nafa");
                    if (SxmlMisc.getXmlContent(temp, "<xml_namp>", "</xml_namp>") != null)
                        savedar1risk.setProperty("72", "xml_namp");
                    if (SxmlMisc.getXmlContent(temp, "<xml_nadb>", "</xml_nadb>") != null)
                        savedar1risk.setProperty("73", "xml_nadb");
                    if (SxmlMisc.getXmlContent(temp, "<xml_nadr>", "</xml_nadr>") != null)
                        savedar1risk.setProperty("74", "xml_nadr");
