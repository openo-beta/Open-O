...
<%
    ...
    String providermsgEditFromExisting = (String) request.getAttribute("providermsgEditFromExisting");
    String providermsgEditSaveNew = (String) request.getAttribute("providermsgEditSaveNew");
