...
<div id="">
    <a href="javascript:void(0);" style="font-size: 9pt;" onclick="showOrHideRes('<%=hiddenResources%>');"> <span
            id="showHideWord">show</span> <span id="showHideNumber"><%=numHidden%></span> hidden resources</a>
</div>
<% }
}
%>
