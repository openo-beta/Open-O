                                ...
                                <table>
                                    ...
                                    <tr id="allergySearchCriteraRow">
                                        <td>
                                            ...
                                            <input type="text" name="searchString" value="${ searchString }" size="16"
                                                   id="searchString" maxlength="16"/>
                                            <input type="button" value="Search" id="searchStringButton"
