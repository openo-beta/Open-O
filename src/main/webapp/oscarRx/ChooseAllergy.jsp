                ...
                <table cellpadding="0" cellspacing="2"
                    ...
                    <tr>
                        <td width="0%" valign="top">
                            <div class="DivCCBreadCrumbs"><a href="<%= request.getContextPath() %>/oscarRx/SearchDrug.jsp"> <fmt:message key="SearchDrug.title"/></a>&nbsp;&gt;&nbsp; <a
                                    href="<%= request.getContextPath() %>/oscarRx/ShowAllergies.jsp"> <fmt:message key="EditAllergies.title"/></a>&nbsp;&gt;&nbsp; <b><fmt:message key="ChooseAllergy.title"/></b></div>
                        </td>
                    </tr>
                    <!----Start new rows here-->
                    <tr>
                        <td>
                            <div class="DivContentTitle"><fmt:message key="ChooseAllergy.title"/></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="DivContentSectionHead"><fmt:message key="ChooseAllergy.section1Title"/></div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div class="DivContentSectionHead"><fmt:message key="ChooseAllergy.section2Title"/></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
