                                        ...
                                        <div style="margin-top: 10px; margin-left: 20px; width: 100%">
                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    %> &nbsp;&nbsp;&nbsp; <a
                                                            href="<%= request.getContextPath() %>/oscarRx/SearchDrug.jsp?status=active<%=show%>"><fmt:message key="SearchDrug.msgActive"/></a> - <a
                                                            href="<%= request.getContextPath() %>/oscarRx/SearchDrug.jsp?status=inactive<%=show%>"><fmt:message key="SearchDrug.msgInactive"/></a> - <a
                                                            href="<%= request.getContextPath() %>/oscarRx/SearchDrug.jsp?status=all<%=show%>"><fmt:message key="SearchDrug.msgAll"/></a></td>
                                                    <td align="right">
