...
<table id="phr_drug_div">
    <tr>
        ...
        <td id="successImport" style="color: blue"></td>
    </tr>
    <tr>
    ...
    %>
    <tr>
        <td align="center"><input type="checkbox" id="drug_<%=k%>" name="phrDrugs" value="<%=k%>"
        ...
        <td align="left"><a><%=RxPrescriptionData.getFullOutLine(d.getSpecial()).replaceAll(";", " ")%>
        </a></td>
        <td align="left"><a><%=d.getOutsideProviderName()%>
        </a></td>
    </tr>
    <%
                i++;
