                ...
                <table cellpadding="0" cellspacing="2" style="border-collapse: collapse" bordercolor="#111111"
                    ...
                    <tr>
                        <td width="0%" valign="top">
                            <div class="DivCCBreadCrumbs"><a href="<%= request.getContextPath() %>/oscarRx/SearchDrug3.jsp"> <fmt:message key="SearchDrug.title"/></a> &gt; <b><fmt:message key="StaticScript.title"/></b>
                            </div>
                        </td>
                    </tr>
                    <!----Start new rows here-->
					...
					%>
							...
							*/
                                    ...
                                    <td>
                                        ...
                                        &nbsp;<fmt:message key="WriteScript.msgRxStatus"/>: <%=Encode.forHtml(String.valueOf(drug.rxStatus))%>
                                        <%}%>
