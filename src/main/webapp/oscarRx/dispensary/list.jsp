        ...
        <script>
            ...
            function deleteDispensingEvent(id) {
                if (confirm("Are you sure you want to delete this record?")) {
                    location.href = "<%=request.getContextPath()%>/rx/Dispense.do?method=delete&eventId=" + id + "&id=" + <%=request.getAttribute("id")%>;
                }
            }
        </script>
                        ...
                        <td>
                            ...
                            <form action="<%=request.getContextPath()%>/oscarRx/Dispense.do">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <input type="submit" value="Save" class="ControlPushButton"
