                ...
                <td style="vertical-align:top; width:98%">
                    ...
                    <div class="well">
                        ...
                        <table style="width:99%">
                            ...
                            <tr>
                                <td style="background-color:#CCFFCC" colspan="2"><fmt:message key="schedule.scheduletemplateapplying.msgDate"/> <fmt:message key="schedule.scheduletemplateapplying.msgFrom"/>:
                                    <input
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                ...
                                                                <%=Encode.forHtml(String.valueOf(param2[1]))%>> <fmt:message key="schedule.scheduletemplateapplying.msgMonday"/></td>
                                                        <td><input type="text"
                                                    ...
                                                    <tr style="background-color:#CCFFCC">
                                                        <td><input type="checkbox"
                                                                ...
                                                                <%=Encode.forHtml(String.valueOf(param2[2]))%>> <fmt:message key="schedule.scheduletemplateapplying.msgTuesday"/>
                                                        </td>
                                                        <td><input type="text"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                ...
                                                                <%=Encode.forHtml(String.valueOf(param2[3]))%>> <fmt:message key="schedule.scheduletemplateapplying.msgWednesday"/>
                                                        </td>
                                                        <td><input type="text"
                                                    ...
                                                    <tr style="background-color:#CCFFCC">
                                                        <td><input type="checkbox"
                                                                ...
                                                                <%=Encode.forHtml(String.valueOf(param2[4]))%>> <fmt:message key="schedule.scheduletemplateapplying.msgThursday"/>
                                                        </td>
                                                        <td><input type="text"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                ...
                                                                <%=Encode.forHtml(String.valueOf(param2[5]))%>> <fmt:message key="schedule.scheduletemplateapplying.msgFriday"/></td>
                                                        <td><input type="text"
                                                    ...
                                                    <tr style="background-color:#CCFFCC">
                                                        <td><input type="checkbox"
                                                                ...
                                                                <%=Encode.forHtml(String.valueOf(param2[6]))%>> <fmt:message key="schedule.scheduletemplateapplying.msgSaturday"/>
                                                        </td>
                                                        <td><input type="text"
                                ...
                                <td colspan="2">
                                    <div style="text-align:right"><input type="hidden" name="provider_no"
                                        ...
                                        <input
                                                ...
                                                value='<fmt:message key="schedule.scheduletemplateapplying.btnNext"/>'>
                                    </div>
                                </td>
                            </tr>
                        </table>
