...
<head>
    ...
    <script>
        function addFollowUp() {
            ...
            jQuery.ajax({
                url: 'plan_followup.jsp?id=' + total, async: false, success: function (data) {
        ...
        function addProcedure() {
            ...
            jQuery.ajax({
                url: 'plan_procedure.jsp?id=' + total, async: false, success: function (data) {
        ...
        function addTest() {
            ...
            jQuery.ajax({
                url: 'plan_test.jsp?id=' + total, async: false, success: function (data) {
