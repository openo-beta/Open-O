...
<head>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath() %>/share/javascript/jquery/jquery.autogrow-textarea.js"></script>
    <script type="text/javascript"
            src="<%=request.getContextPath() %>/share/javascript/jquery/jquery-ui-1.8.15.custom.draggable.slider.min.js"></script>
    <link rel="stylesheet" type="text/css"
          href="<%=request.getContextPath() %>/share/css/jquery-ui-1.8.15.custom.draggable.slider.css"/>
...
<div id="formContent">
    ...
    <div class="wideBox" id="impressionBox">
        <div class="title">
            ...
            <span class="uiBarBtn"><span class="text smallerText impressionBtn"
                                         id="copyLastBtn">Copy Last Impression</span></span>
        </div>
        <div class="content" style="overflow: hidden;">
    ...
    <div class="formBoxes">
        <div class="halfBox" id="planHalfBox">
            ...
            <div class="explanation">
                <strong>Sign, Save &amp; Exit</strong>: all users with the <strong>receptionist</strong> role will
                receive this message as a tickler.
            </div>
        </div>
        ...
        <span class="loaderImg floatRight" style="margin: 10px;"><img
                src="<%=request.getContextPath()%>/images/DMSLoader.gif"/></span>
    </div>
            ...
            <div class="content" style="height: auto; font-size: 12px;">
                <div>
                    <div class="billInputItem">
                        <input type="text" id="billDate" placeholder="date"/><img
                            src="<%=request.getContextPath() %>/images/cal.gif" id="billDateBtn">
                    </div>
                    <div class="billInputItem">
...
<div id="measurementsBox" class="popoutBox measurementsBox" style="display: none;">
    <div class="boxContent">
        ...
        <div class="explanation" style="display: none;">The following measurements were recorded on <span
                class="measurementsTime"></span>. To modify, close this box and click "Modify" on the measurements box.
        </div>
    ...
    <div class="boxContent">
        ...
        <table>
            ...
            <tr>
                <td></td>
                <td>
                    <div class="uiBtn" id="uiBoxSendTicklerBtn">Send Tickler</div>
                    <span class="loaderImg"><img src="<%=request.getContextPath()%>/images/DMSLoader.gif"/></span></td>
            </tr>
        </table>
    </div>
...
<div class="popoutBox ticklerBox newTicklerBox openTicklerUiBox" style="display: none;">
    <div class="boxContent">
        <div class="fullBoxContent">
            ...
            <div class="details"><strong>Date</strong> <span class="messageDate"></span> | <strong>From</strong> <span
                    class="messageFrom"></span> | <strong>To</strong> <span class="messageTo"></span></div>
        </div>
    </div>
...
<div id="newSpecsBox" class="popoutBox newSpecsBox" style="display: none;">
    <div class="boxContent">
        ...
        <input type="hidden" name="specs.appointmentNo"
               value="<%=request.getParameter("appointment_no") != null ? request.getParameter("appointment_no") : "" %>"/>
        <table>
            <tr>
                <th>Date</th>
                <td><input type="text" name="specs.dateStr" id="specs.dateStr"/><img
                        src="<%=request.getContextPath() %>/images/cal.gif" id="specs.dateCalBtn"></td>
            </tr>
            <tr>
                <th>Doctor's Name</th>
            ...
            <tr>
                <td></td>
                <td>
                    <div class="uiBtn" id="uiSaveNewSpecsBtn">Save</div>
                    <span class="loaderImg"><img src="<%=request.getContextPath()%>/images/DMSLoader.gif"/></span></td>
            </tr>
        </table>
    </div>
...
<div class="popoutBox newProcedureBox" id="newProcedureBox" style="display: none;">
    <div class="boxContent">
        ...
        <input type="hidden" name="proc.appointmentNo"
               value="<%=request.getParameter("appointment_no") != null ? request.getParameter("appointment_no") : "" %>"/>
        <input type="hidden" name="proc.id" value="0"/>
        <table>
            <tr>
                <th>Date</th>
                <td><input type="text" name="proc.dateStr" id="newProcedureDate"/><img
                        src="<%=request.getContextPath() %>/images/cal.gif" id="proc.dateCalBtn"></td>
            </tr>
            <tr>
                <th>Eye</th>
                <td><select name="proc.eye">
            ...
            <tr>
                <td></td>
                <td>
                    <div class="uiBtn" id="uiSaveNewProcedureBtn">Save</div>
                    <span class="loaderImg"><img src="<%=request.getContextPath()%>/images/DMSLoader.gif"/></span></td>
            </tr>
        </table>
    </div>
                ...
                <td>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="macroControls">
                                    <span class="uiBarBtn" id="macroCopyLastImpressionBtn"><span
                                            class="text smallerText">Copy Last Impression</span></span>
                                </div>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <div class="uiBtn" id="macroSaveBtn">Save</div>
                                <span class="loaderImg"><img src="<%=request.getContextPath()%>/images/DMSLoader.gif"/></span>
                            </td>
                        </tr>
                    </table>
                </td>
