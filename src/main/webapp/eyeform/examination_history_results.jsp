...
<body>
<form action="<%=request.getContextPath()%>/eyeform/ExaminationHistory.do" method="POST" id="inputForm"
      name="inputForm">
        ...
        <tr>
            <table style="background-color: #efefff">
                <tr>
                    <td>Start Date:</td>
                    <td>
                        <input type="text" class="plain" name="sdate" id="sdate" size="12" onfocus="this.blur()"
                               readonly="readonly" value="<%=sdate%>"/>
                    ...
                    <td>End Date:</td>
                    <td>
                        <input type="text" class="plain" name="edate" id="edate" size="12" onfocus="this.blur()"
                               readonly="readonly" value="<%=edate%>"/>
    ...
    <table class="display" style="width:20%">
        <tr style="background-color: rgb(204, 204, 255);">
            ...
            <td align="right">
                <%
                    ...
                    if (pageNumber > 1) {
                %><a href="#"
                     onclick="document.inputForm.refPage.value=<%=(pageNumber-1)%>;return document.inputForm.submit();">prev</a><%
            } else {
            %>prev<%
                }
            %>
                ...
                %><a href="#"
                     onclick="document.inputForm.refPage.value=<%=(pageNumber+1)%>;return document.inputForm.submit();">next</a><%
            } else {
            %>next<%
                }
            %>
        ...
        <table class="display">
            <tr>
                <td><h5>AR history</h5>
                    <display:table name="ars" requestURI="/eyeform/ExaminationHistory.do" class="display"
                                   style="width:100%" id="map" pagesize="5">
                        ...
                        <display:column title="Date" style="width:60px;white-space: nowrap;text-align:center"
            ...
            <tr>
                <td><h5>K history</h5>
                    <display:table name="ks" requestURI="/ExaminationHistory.do" class="display" style="width:100%"
                                   id="map" pagesize="5">
            ...
            <tr>
                <td><h5>Manifest Refraction history</h5>
                    <display:table name="manifestRefraction" requestURI="/eyeform/ExaminationHistory.do" class="display"
                                   style="width:100%" id="map" pagesize="5">
            ...
            <tr>
                <td><h5>Cycloplegic refraction history</h5>
                    <display:table name="cycloplegicRefraction" requestURI="/eyeform/ExaminationHistory.do"
                                   class="display" style="width:100%" id="map" pagesize="5">
            ...
            <tr>
                <td><h5>Angle history</h5>
                    <display:table name="angle" requestURI="/eyeform/ExaminationHistory.do" class="display"
                                   style="width:100%" id="map" pagesize="5">
