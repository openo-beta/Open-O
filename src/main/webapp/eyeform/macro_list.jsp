...
<form name="inputForm" method="post" action="Macro.do">
        ...
        <tr>
            <td>
                ...
                <input type="button" value="Delete"
                       onclick="if(confirm('Are you sure to delete the selected macros?')){this.form.method.value='deleteMacro';this.form.submit();}">
    ...
    <display:table name="requestScope.macros" requestURI="Macro.do?method=list" defaultsort="2" sort="list"
                   defaultorder="ascending" id="macro" pagesize="0">
        <%
        ...
        <display:column title="Label" sortable="true" style="width:120px;">
            <a href="javascript:void(0)" onclick="editMacro(<c:out value="${macro.id}"/>);"><c:out
                    value="${macro.label}"/></a>
        </display:column>
