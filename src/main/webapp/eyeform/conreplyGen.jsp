                        ...
                        <tr>
							...
							%>
                                        <td align="left" class="tite1"><input type="text"
                                                                              name="referral_doc_name"
                                                                              value="<%=referralDocName%>"/><a
                                    ...
                                    <tr>
                                        <td class="tite4">
                                            <select id="fam_doc">
                                                ...
                                                %>
                                                <option value="<%=c.getContactName()%>"><%=c.getRole()%>
                                                    - <%=c.getContactName() %>
                                                </option>
                                                <%
                                                    }
                            ...
                            <td colspan=2 class="tite4">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="button" class="btn" value="current hx" name="chis"
                                                   onclick="clinicalInfoAdd('Current history:',con_cHis)">
                                            <input type="button" class="btn" value="past ocular hx" name="phis"
                                            ...
                                            <input type="button" class="btn" value="family hx" name="fhis"
                                                   onclick="clinicalInfoAdd('Family history:',con_fHis)">
                                            <input type="button" class="btn" value="specs hx" name="shis"
                                                   onclick="clinicalInfoAdd('Specs history:',con_sHis)">

                                            <input type="button" class="btn" value="ocular meds" name="ohis"
                                                   onclick="clinicalInfoAdd('Ocular meds:',con_oMeds)">
                                            <input type="button" class="btn" value="other meds" name="ohis"
                                                   onclick="clinicalInfoAdd('Other meds:',con_oHis)">
                                            <input type="button" class="btn" value="diag notes" name="dnote"
                                            ...
                                            <%
                                                for (String customCppIssue : customCppIssues) {
                                            %><input type="button" class="btn" value="<%=customCppIssue %>"
                                                     name="<%=customCppIssue %>"
                                                     onclick="clinicalInfoAdd('<%=customCppIssue%>:',con_<%=customCppIssue%>)"><%
                                            }
                                        %>
                                    ...
                                    <tr>
                                        <td>
                                            <select name="fromlist1" multiple="multiple" size="9"
                                                    ondblclick="addSection(document.eyeForm.elements['fromlist1'],document.eyeForm.elements['fromlist2']);">
                                        ...
                                        <td valign="middle">
                                            <input type="button" value=">>"
                                                   onclick="addSection(document.eyeForm.elements['fromlist1'],document.eyeForm.elements['fromlist2']);"/>
                                        </td>
                                        <td>
                                            <select id="fromlist2" name="fromlist2" multiple="multiple" size="9"
                                                    ondblclick="addExam(ctx,'fromlist2',document.eyeForm.elements['cp.examination'],appointmentNo);">
                                            ...
                                            <input style="vertical-align: middle;" type="button" value="add"
                                                   onclick="addExam(ctx,'fromlist2',document.eyeForm.elements['cp.examination'],appointmentNo);">
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <tr>
                                <td colspan="2"><input type="checkbox" name="ack" checked>
                                    remind me to complete it <input type="button" name="sendtickler"
                                                                    value="send tickler"
                                                                    onclick="sendConReportTickler(ctx,demoNo);"></td>
                            </tr>
                        </c:if>
                        <tr>
