...
<form name="inputForm" id="inputForm" method="post"
      action="<%=request.getContextPath()%>/eyeform/ExaminationHistory.do">
    ...
    <table>
        ...
        <tr>
            <td colspan=2 style="width: 100%">
                <table>
                    <tr>
                        <td>
                            <select name="fromlist1" multiple="multiple" size="20"
                                    ondblclick="moveToList(document.inputForm.elements['fromlist1'],document.inputForm.elements['fromlist2']);">
                        ...
                        <td valign="middle">
                            <input type="button" value=">>"
                                   onclick="moveToList(document.inputForm.elements['fromlist1'],document.inputForm.elements['fromlist2']);"/>
                            <br/><br/>
                            <input type="button" value="All >>"
                                   onclick="moveAllToList(document.inputForm.elements['fromlist1'],document.inputForm.elements['fromlist2']);"/>
                            <br/><br/>
                            <input type="button" value="<<"
                                   onclick="moveToList(document.inputForm.elements['fromlist2'],document.inputForm.elements['fromlist1']);"/>
                            <br/><br/>
                            <input type="button" value="All <<"
                                   onclick="moveAllToList(document.inputForm.elements['fromlist2'],document.inputForm.elements['fromlist1']);"/>
                        </td>
                        <td>
        ...
        <tr>
            <td colspan="1"></td>
            <td>
                <input name="" value="Submit" onclick="document.inputForm.method.value='query';selectList2();"
                       type="submit">
            </td>
        </tr>
        </tbody>
