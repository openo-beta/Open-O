    ...
    <c:if test="${not empty followUps}">
        <c:forEach var="f" items="${followUps}">
            ...
            <table border="0">
                ...
                <tr>
                    <td colspan="5">
                        Comment:<br/><textarea rows="5" cols="60" name="followup<%=followUp.getId()%>.comment"><c:out
                            value="${f.comment}"/></textarea>
                    </td>
                </tr>
            ...
            <table>
                <tr>
                    ...
                    <td class="genericTableData">
                        <input type="text" name="proc<%=proc.getId()%>.procedureName"
                               value="<c:out value="${proc.procedureName}"/>" size="35"/>*
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="genericTableData">
                        <input type="text" name="proc<%=proc.getId()%>.location" size="35"
                               value="<c:out value="${proc.location}"/>"/>
                    </td>
                </tr>
                <tr>
                    <td class="genericTableHeader">Comment</td>
                    <td class="genericTableData">
                        <textarea rows="5" cols="40" name="proc<%=proc.getId()%>.comment"><c:out
                                value="${proc.comment}"/></textarea>
                    </td>
                </tr>
            </table>
        ...
        <c:forEach var="test" items="${tests}">
            ...
            <table>
                <tr>
                    ...
                    <td class="genericTableData">
                        <input type="text" name="test<%=test.getId()%>.testname" size="35"
                ...
                <tr>
                    <td class="genericTableHeader">Comment</td>
                    <td class="genericTableData">
                        <textarea rows="5" cols="40" name="test<%=test.getId()%>.comment"><c:out
                                value="${test.comment}"/></textarea>
                    </td>
                </tr>
