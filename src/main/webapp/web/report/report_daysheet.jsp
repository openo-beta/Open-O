        ...
        <form role="form">
            ...
            <div class="col-md-4">
                ...
                <div class="bg-danger" ng-show="params.type=='new'">
                    <h4><span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to see new
                        appointments only? (The new appointments status would be changed to 'old')</h4>
                </div>
                <div class="form-group"
                     ng-show="params.type == 'all' || params.type== 'all-nr' || params.type== 'new' || params.type== 'tab'">
                ...
                <div class="form-group"
                     ng-show="params.type == 'all' || params.type== 'all-nr' || params.type== 'new' || params.type== 'lab' || params.type== 'billing' || params.type== 'tab'">
                ...
                <div class="form-group" ng-show="params.type == 'all' || params.type== 'all-nr'">
                    ...
                    <input ng-model="params.endDate" type="text" id="endDate" name="endDate" class="form-control"
                           uib-datepicker-popup="yyyy-MM-dd" datepicker-append-to-body="true" is-open="data.isOpen2"
                           ng-click="data.isOpen2 = true" placeholder="">
                </div>
            ...
            <div class="col-md-4">
                <div class="form-group" ng-show="params.type == 'all' || params.type== 'all-nr'">
                    ...
                    <timepicker ng-model="params.startTime" id="startTime" name="startTime" hour-step="1"
                                minute-step="15" show-meridian="true"></timepicker>
                </div>

                <div class="form-group" ng-show="params.type == 'all' || params.type== 'all-nr'">
                    <label for="endTime">End Time:</label>
                    <timepicker ng-model="params.endTime" id="endTime" name="endTime" hour-step="1" minute-step="15"
