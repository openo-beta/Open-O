...
<div id="left_pane" class="col-md-2" ng-show="consultReadAccess">
    ...
    <div class="demographic">
        ...
        <address>
            ...
            {{consult.demographic.address.city}}, {{consult.demographic.address.province}},
            {{consult.demographic.address.postal}}<br>
        </address>
...
<div id="right_pane" class="col-md-10" ng-show="consultReadAccess">
        ...
        <div class="well">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="dp-responseDate" type="text" class="form-control inline" style="width:60%"
                           ng-model="consult.responseDate" placeholder="Response Date" uib-datepicker-popup="yyyy-MM-dd"
                           datepicker-append-to-body="true" is-open="page.respDatePicker"
                           ng-click="page.respDatePicker=true"/>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Send To:</label>
                    <select id="sendTo" class="form-control inline" style="width:70%" ng-model="consult.sendTo"
                            ng-required="true" ng-options="sendTo for sendTo in consult.sendToList"/>
                </div>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="well">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="dp-referralDate" type="text" class="form-control inline" style="width:60%"
                           ng-model="consult.referralDate" placeholder="Referral Date" uib-datepicker-popup="yyyy-MM-dd"
                           datepicker-append-to-body="true" is-open="page.refDatePicker"
                           ng-click="page.refDatePicker=true"/>
                </div>
                <div class="form-group">
                    <label class="control-label">Urgency:</label>
                    <select id="urgency" class="form-control inline" style="width:70%" ng-model="consult.urgency"
                            ng-required="true" ng-options="urgency.value as urgency.name for urgency in urgencies"/>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Referrer Instructions:</label>
                    <textarea cols="80" rows="2" class="form-control"
                              readOnly>{{consult.referringDoctor.annotation}}</textarea>
                </div>
            </div>
            <div class="clear"></div>
        ...
        <div class="well" id="appointmentDetail">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="dp-appointmentDate" type="text" class="form-control inline" style="width:50%"
                           ng-model="consult.appointmentDate" placeholder="Appointment Date"
                           uib-datepicker-popup="yyyy-MM-dd" datepicker-append-to-body="true"
                           is-open="page.aptDatePicker" ng-click="page.aptDatePicker=true"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input id="dp-followUpDate" type="text" class="form-control inline" style="width:50%"
                           ng-model="consult.followUpDate" placeholder="Follow Up Date"
                           uib-datepicker-popup="yyyy-MM-dd" datepicker-append-to-body="true"
                           is-open="page.lfdDatePicker" ng-click="page.lfdDatePicker=true"/>
                </div>
            </div>
            <div class="col-md-6">
    ...
    <div id="clinical-note" class="col-md-6"><!-- Clinic Notes -->
        <div>
            ...
            <p>
                <button type="button" class="btn btn-tall btn-success" ng-click="getFamilyHistory('clinicalInfo');">
                    Family<br/>History
                </button>
                <button type="button" class="btn btn-tall btn-success" ng-click="getMedicalHistory('clinicalInfo');">
                    Medical<br/>History
                </button>
                <button type="button" class="btn btn-tall btn-success" ng-click="getOngoingConcerns('clinicalInfo');">
                    Ongoing<br/>Concerns
                </button>
                <button type="button" class="btn btn-tall btn-success" ng-click="getOtherMeds('clinicalInfo');">
                    Other<br/>Meds
                </button>
                <button type="button" class="btn btn-tall btn-success" ng-click="getReminders('clinicalInfo');">
                    Reminders
                </button>
            </p>
            <div class="well">
    ...
    <div id="concurrent-problem" class="col-md-6"><!-- Concurrent Problem -->
        <div>
            ...
            <p>
                <button type="button" class="btn btn-tall btn-success"
                        ng-click="getFamilyHistory('concurrentProblems');">Family<br/>History
                </button>
                <button type="button" class="btn btn-tall btn-success"
                        ng-click="getMedicalHistory('concurrentProblems');">Medical<br/>History
                </button>
                <button type="button" class="btn btn-tall btn-success"
                        ng-click="getOngoingConcerns('concurrentProblems');">Ongoing<br/>Concerns
                </button>
                <button type="button" class="btn btn-tall btn-success" ng-click="getOtherMeds('concurrentProblems');">
                    Other<br/>Meds
                </button>
                <button type="button" class="btn btn-tall btn-success" ng-click="getReminders('concurrentProblems');">
                    Reminders
                </button>
            </p>
            <div class="well">
                <div>
					<textarea id="concurrentProblems" cols="80" rows="4" class="form-control"
                              placeholder="Use the buttons above to insert data from the patients chart"
    ...
    <div class="col-md-6">
        <h4>Current Medications:
            <button type="button" class="btn btn-success" style="padding:0px 10px;"
                    ng-click="getOtherMeds('currentMeds');">Other Meds
            </button>
        </h4>

        <div class="well">
            <textarea id="currentMeds" cols="80" rows="4" class="form-control" ng-model="consult.currentMeds"
                      placeholder="Use the button above to insert Other Meds data from the patients chart"></textarea>
        </div>
...
<div class="wrapper-action" ng-show="consultReadAccess"><!-- Action Buttons -->
    <button type="button" class="btn btn-large btn-warning action" ng-click="printPreview()"
            ng-show="consult.id!=null && consultChanged<=0">Print Preview
    </button>&nbsp;
    <button type="button" class="btn btn-large btn-warning action" ng-click="sendFax()"
            ng-show="consult.id!=null && consultChanged<=0">Send Fax
    </button>&nbsp;
    <button type="button" class="btn btn-large btn-primary action" ng-click="save()" ng-show="consultChanged>0">Save
    </button>&nbsp;
