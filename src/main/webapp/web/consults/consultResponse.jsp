		...
		<div class="well">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input id="dp-responseDate" type="text" class="form-control inline" style="width:60%" ng-model="consult.responseDate" placeholder="Response Date" uib-datepicker-popup="yyyy-MM-dd" datepicker-append-to-body="true" is-open="page.respDatePicker" ng-click="page.respDatePicker=true"/>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
		...
		<div class="well" id="appointmentDetail">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input id="dp-appointmentDate" type="text" class="form-control inline" style="width:50%" ng-model="consult.appointmentDate" placeholder="Appointment Date"  uib-datepicker-popup="yyyy-MM-dd" datepicker-append-to-body="true" is-open="page.aptDatePicker" ng-click="page.aptDatePicker=true"/>
				</div>
				<div class="form-group">
