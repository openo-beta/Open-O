...
<div id="right_pane" class="col-md-10" ng-show="consultReadAccess">
    ...
    <div id="concurrent-problem" class="col-md-6"><!-- Concurrent Problem -->
        <div>
            ...
            <div class="well">
                <div>
					<textarea id="concurrentProblems" cols="80" rows="5" class="form-control"
                              placeholder="Use the buttons above to insert data from the patients chart"
    ...
    <div class="col-md-6">
        ...
        <div class="well">
            <textarea id="currentMeds" cols="80" rows="5" class="form-control" ng-model="consult.currentMeds"
...
<div class="wrapper-action" ng-show="consultReadAccess"><!-- Action Buttons -->
    ...
    <button type="button" class="btn btn-large btn-warning action" ng-click="eSend()"
            ng-show="eSendEnabled && consult.id!=null && consultChanged<=0">Send Electronically
    </button>&nbsp;
