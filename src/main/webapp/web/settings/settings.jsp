        ...
        <nav class="navbar navbar-default" role="navigation"
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"
                ...
                <ul class="nav navbar-nav" id="myTabs">
                    <li ng-repeat="tab in tabs" ng-model="currentTab" ng-class="{'active':isActive(tab)}"><a
                            ng-click="changeTab(tab)" class="hand-hover">{{tab.displayName}}</a></li>
    ...
    <div class="row" ng-show="currentTab.path == 'general'" style="margin-left:10px">
        ...
        <div class="col-xs-3">
            ...
            <div class="form-group">
                ...
                <select ng-model="pref.ticklerWarningProvider" class="form-control"
                        ng-options="p.providerNo as p.name for p in providerList">
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select ng-model="pref.workloadManagement" class="form-control"
                        ng-options="item.name as item.type for item in billingServiceTypesMod">
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-0">
                        <input ng-model="pref.newTicklerWarningWindow" name="radios" id="radios-0" value="enabled"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-1">
                        <input ng-model="pref.newTicklerWarningWindow" name="radios" id="radios-1" value="disabled"
                               type="radio">
                        Disable
                    </label>
                </div>
    ...
    <div class="row" ng-show="currentTab.path == 'persona'" style="margin-left:10px">
        <div class="col-xs-3">
            ...
            <label class="radio-inline" for="radios-per-0">
                <input ng-model="pref.useCobaltOnLogin" name="radios-per-0" id="radios-per-0" ng-value="true"
                       type="radio">
                Enable
            </label>
            <label class="radio-inline" for="radios-1">
                <input ng-model="pref.useCobaltOnLogin" name="radios-per-0" id="radios-per-1" ng-value="false"
                       type="radio">
                Disable
            </label>
    ...
    <div class="row" ng-show="currentTab.path == 'schedule'">
        <div class="col-xs-3">
            ...
            <div class="form-group">
                ...
                <input ng-model="pref.appointmentScreenLinkNameDisplayLength" placeholder="Length" class="form-control"
                       type="text">
            </div>
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radioh-0">
                        <input ng-model="pref.hideOldEchartLinkInAppointment" ng-value="true" id="radioh-0"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radioh-1">
                        <input ng-model="pref.hideOldEchartLinkInAppointment" ng-value="false" id="radioh-1"
                               type="radio">
                        Disable
                    </label>
                </div>
        ...
        <div class="col-xs-9">
            ...
            <div style="height:10em;border:solid grey 1px;overflow:auto;white-space:nowrap">
                <span ng-repeat="f in encounterForms"><input type="checkbox" ng-model="f.checked"
                                                             ng-change="selectEncounterForms()">{{f.formName}}<br/></span>

            </div>
            <label>Eforms to display on appointment screen</label>
            <div style="height:10em;border:solid grey 1px;overflow:auto;white-space:nowrap">
                <span ng-repeat="f in eforms"><input type="checkbox" ng-model="f.checked"
                                                     ng-change="selectEForms()">{{f.formName}}<br/></span>
            </div>
            <label>Quick links to display on appointment screen</label>
            <div style="height:10em;border:solid grey 1px;overflow:auto;white-space:nowrap">
                <span ng-repeat="q in pref.appointmentScreenQuickLinks"><input type="checkbox"
                                                                               ng-model="q.checked">{{q.name}}<br/></span>
    ...
    <div class="row" ng-show="currentTab.path == 'billing'" style="margin-left:10px">
        <div class="col-xs-3">
            <div class="form-group">
                ...
                <select class="form-control" ng-model="pref.defaultServiceType"
                        ng-options="item.type as item.name for item in billingServiceTypesMod">
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radiosx-0">
                        <input ng-model="pref.defaultDoNotDeleteBilling" name="radiosx" id="radiosx-0" ng-value="true"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radiosx-1">
                        <input ng-model="pref.defaultDoNotDeleteBilling" name="radiosx" id="radiosx-1" ng-value="false"
                               type="radio">
                        Disable
                    </label>
                </div>
    ...
    <div class="row" ng-show="currentTab.path == 'rx'" style="margin-left:10px">
        <div class="col-xs-3">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-rx-2">
                        <input name="radios-rx-2" id="radios-rx-2" ng-model="pref.showPatientDob" ng-value="true"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-rx-3">
                        <input name="radios-rx-3" id="radios-rx-3" ng-model="pref.showPatientDob" ng-value="false"
                               type="radio">
                        Disable
                    </label>
                </div>
            ...
            <div class="form-group">
                ...
                <select ng-model="pref.rxPageSize" class="form-control"
                        ng-options="p.value as p.label for p in pageSizes">
                </select>
            </div>
            <div class="form-group">
                <label>Rx Interaction Warning Level:</label>
                <select ng-model="pref.rxInteractionWarningLevel" class="form-control"
                        ng-options="p.value as p.label for p in rxInteractionWarningLevels">
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-rx-4">
                        <input name="radios-rx-4" id="radios-rx-4" ng-model="pref.printQrCodeOnPrescription"
                               ng-value="true" type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-rx-5">
                        <input name="radios-rx-5" id="radios-rx-5" ng-model="pref.printQrCodeOnPrescription"
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-rx-6">
                        <input name="radios-rx-6" id="radios-rx-6" ng-model="pref.eRxEnabled" ng-value="true"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-rx-7">
                        <input name="radios-rx-7" id="radios-rx-7" ng-model="pref.eRxEnabled" ng-value="false"
                               type="radio">
                        Disable
                    </label>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-rx-8">
                        <input name="radios-rx-8" id="radios-rx-8" ng-model="pref.eRxTrainingMode" ng-value="true"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-rx-9">
                        <input name="radios-rx-9" id="radios-rx-9" ng-model="pref.eRxTrainingMode" ng-value="false"
                               type="radio">
                        Disable
                    </label>
                </div>
    ...
    <div class="row" ng-show="currentTab.path == 'consults'" style="margin-left:10px">
        <div class="col-xs-3">
            <div class="form-group">
                ...
                <input ng-model="pref.consultationTimePeriodWarning" placeholder="Cutoff Time Warning"
                       class="form-control" type="text">
            </div>
            <div class="form-group">
                <label>Consultation Team Warning:</label>
                <select class="form-control" ng-model="pref.consultationTeamWarning"
                        ng-options="item.value as item.label for item in teams">
                </select>
            </div>
            <div class="form-group">
                <label>Paste Format:</label>
                <select ng-model="pref.consultationPasteFormat" class="form-control"
                        ng-options="p.value as p.label for p in pasteFormats">
                </select>
            </div>

            <div class="form-group">
                <label>Consult Letterhead Name Default:</label>
                <select ng-model="pref.consultationLetterHeadNameDefault" class="form-control"
                        ng-options="l.value as l.label for l in letterHeadNameDefaults">
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="row" ng-show="currentTab.path == 'documents'" style="margin-left:10px">
        <div class="col-xs-3">
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-doc-0">
                        <input name="radios-doc-0" id="radios-doc-0" ng-model="pref.documentBrowserInDocumentReport"
                               ng-value="true" type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-doc-1">
                        <input name="radios-doc-1" id="radios-doc-1" ng-model="pref.documentBrowserInDocumentReport"
                               ng-value="false" type="radio">
                        Disable
                    </label>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-doc-2">
                        <input name="radios-doc-2" id="radios-doc-2" ng-model="pref.documentBrowserInMasterFile"
                               ng-value="true" type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-doc-3">
                        <input name="radios-doc-3" id="radios-doc-3" ng-model="pref.documentBrowserInMasterFile"
                               ng-value="false" type="radio">
                        Disable
                    </label>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <button class="btn btn-default" ng-click="editDocumentTemplates()">Manage Document Templates
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
                ...
                <table class="table table-hover table-condensed">
                        ...
                        <td>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <label class="radio-inline" for="radios-enc-0">
                                    <input name="radios-enc-0" id="radios-enc-0" ng-model="pref.cppSingleLine"
                                           ng-value="true" type="radio">
                                    Enable
                                </label>
                                <label class="radio-inline" for="radios-enc-1">
                                    <input name="radios-enc-1" id="radios-enc-1" ng-model="pref.cppSingleLine"
                                           ng-value="false" type="radio">
                                    Disable
                                </label>
                            </div>
                        ...
                        <td>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <label class="radio-inline" for="radios-enc-2">
                                    <input name="radios-enc-2" id="radios-enc-2" ng-model="pref.cmeNoteFormat"
                                           ng-value="true" type="radio">
                                    Enable
                                </label>
                                <label class="radio-inline" for="radios-enc-3">
                                    <input name="radios-enc-3" id="radios-enc-3" ng-model="pref.cmeNoteFormat"
                                           ng-value="false" type="radio">
                                    Disable
                                </label>
                            </div>
                    ...
                    <tr>
                        <td>
                            Stale Date<br>
                            <small><em>Please set how many months in the past before a Case Management Note is fully
                                visible e.g. Set to 6 will display fully all notes within the last 6 months</em></small>
                        </td>
                        <td>
                            <div class="col-lg-4 col-md-6 col-sm-8">
                                <select ng-model="pref.cmeNoteDate" class="form-control"
                                        ng-options="p.value as p.label for p in staleDates">
                                </select>
                            </div>
                        </td>
                    </tr>
                ...
                <table class="table table-hover table-condensed">
                    ...
                    <tr>
                        <td>
                            ...
                            <small><em>Enabling this feature will allow you to to hide or display CPP and Summary
                                Items.</em></small>
                        </td>
                        <td>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <label class="radio-inline" for="radios-enc-4">
                                    <input name="radios-enc-4" id="radios-enc-4"
                                           ng-model="pref.summaryItemCustomDisplay" ng-value="true" type="radio">
                                    Enable
                                </label>
                                <label class="radio-inline" for="radios-enc-5">
                                    <input name="radios-enc-5" id="radios-enc-5"
                                           ng-model="pref.summaryItemCustomDisplay" ng-value="false" type="radio">
                                    Disable
                                </label>
                            </div>
                        </td>
                ...
                <ng-include ng-if="pref.summaryItemCustomDisplay"
                            src="'settings/partials/patientSummaryItems.html'"></ng-include>
          ...
          <div class="controls">
            ...
            <div class="col-lg-3 col-sm-9">
                <div class="well">
                    ...
                    <a href="javascript:void(0)" ng-click="showDefaultEncounterWindowSizePopup()">Set Default Encounter
                        Window Size</a><br>
    ...
    <div class="row" ng-show="currentTab.path == 'eforms'" style="margin-left:10px">
        <div class="col-xs-3">
            <div class="form-group">
                ...
                <select ng-model="pref.favoriteFormGroup" class="form-control"
                        ng-options="p.value as p.label for p in formGroupNames">
                </select>
            </div>
        </div>
    </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-inb-0">
                        <input name="radios-inb-0" id="radios-inb-0" ng-model="pref.disableCommentOnAck" ng-value="true"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-inb-1">
                        <input name="radios-inb-1" id="radios-inb-1" ng-model="pref.disableCommentOnAck"
                               ng-value="false" type="radio">
                        Disable
                    </label>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-pro-0">
                        <input name="radios-pro-0" id="radios-pro-0" ng-model="pref.defaultPmm" ng-value="true"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-pro-1">
                        <input name="radios-pro-1" id="radios-pro-1" ng-model="pref.defaultPmm" ng-value="false"
                               type="radio">
                        Disable
                    </label>
                </div>
    ...
    <div class="row" ng-show="currentTab.path == 'integration'" style="margin-left:10px">
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <select class="form-control" ng-model="pref.olisDefaultReportingLab"
                        ng-options="item.value as item.label for item in olisLabs">
                </select>
            </div>
            <div class="form-group">
                <label>OLIS Default Exclude Reporting Laboratory:</label>
                <select class="form-control" ng-model="pref.olisDefaultExcludeReportingLab"
                        ng-options="item.value as item.label for item in olisLabs">
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-int-0">
                        <input name="radios-int-0" id="radios-int-0" ng-model="pref.useMyMeds" ng-value="true"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-int-1">
                        <input name="radios-int-1" id="radios-int-1" ng-model="pref.useMyMeds" ng-value="false"
                               type="radio">
                        Disable
                    </label>
                </div>
        ...
        <div class="col-xs-4">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-int-0">
                        <input name="radios-int-0" id="radios-int-0" ng-model="pref.disableBornPrompts" ng-value="true"
                               type="radio">
                        Disable
                    </label>
                    <label class="radio inline" for="radios-int-1">
                        <input name="radios-int-1" id="radios-int-1" ng-model="pref.disableBornPrompts" ng-value="false"
                               type="radio">
                        Enable
                    </label>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <label class="radio inline" for="radios-int-0">
                        <input name="radios-int-0" id="radios-int-0" ng-model="pref.dashboardShare" ng-value="true"
                               type="radio">
                        Enable
                    </label>
                    <label class="radio inline" for="radios-int-1">
                        <input name="radios-int-1" id="radios-int-1" ng-model="pref.dashboardShare" ng-value="false"
                               type="radio">
                        Disable
                    </label>
                </div>
