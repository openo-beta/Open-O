                    ...
                    <table cellpadding="0" cellspacing="2"
                        ...
                        <tr>
                            <td><!-- <b><bean:message key="SearchDrug.nameText" /></b>-->
								...
								<br />
								<c:out value="${patient.city}" />, <c:out value="${patient.province}" /> <c:out value="${patient.postal}" />
								<br />
								<br />
                        ...
                        <tr>
                            <td>
                            <b><bean:message key="SearchDrug.ageText" /></b> <c:out value="${patient.age}" /> <b>Gender:</b> <c:out value="${patient.sex}" /> <b>HC:</b> <c:out value="${patient.hin}" />
							 <br />
