    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <!-- List group -->
                <div class="list-group">
                    <a ng-click="$ctrl.listBrands(drug);" ng-repeat="drug in $ctrl.gen"
                       class="list-group-item list-group-item-success">{{drug.name}}</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <!-- List group -->
                <div class="list-group">
                    <a ng-click="$ctrl.selectDrug(drug)" ng-repeat="drug in $ctrl.brand"
                       class="list-group-item list-group-item-success">{{drug.name}}</a>
                </div>
            </div>
