...
oscarApp.controller('PHRCtrl', function ($scope, $http, $location, $stateParams, demographicService, demo, $state, formService) {
    ...
    console.log("What is the state", { type: $state.params.type, isUndefined: angular.isUndefined($state.params.type), id: $state.params.id, state: $state });
    ...
    $scope.page.currentFormList[0] = [{
        ...
        type: 'frame'
    }, {id: 3, name: 'Open Record', url: '../demographic/viewPhrRecord.do?demographic_no=', type: 'window'}, {
        id: 4,
        name: 'Send a Message',
