...
<div class="page-header" style="margin-top: 0px; margin-bottom: 0px;">
    <h1 class="patientHeaderName" style="margin-top: 0px;" ng-cloak>
        <b>{{demographic.lastName}}, {{demographic.firstName}}</b> <span
...
<div class="row noprint">
    <div id="noteInput2" class="center-block well col-md-4 col-md-offset-3 text-center hand-hover" style="padding:0px;"
         ng-click="toggleNote();" ng-show="!hideNote">
        <span class="glyphicon glyphicon-chevron-up"></span><span class="glyphicon glyphicon-chevron-up"></span><span
    ...
    <div id="noteInput" class="center-block well col-md-4 col-md-offset-3" ng-show="hideNote"
        ...
        <div style="position:absolute;top:0px;Right:0px;font-size:10px">
            ...
            <span class="glyphicon glyphicon-arrow-right hand-hover" ng-click="moveNote('r');"
        ...
        <div class="col-xs-3 text-center hand-hover" style="padding:0px;line-height:1;font-size:14px;"
             ng-click="toggleNote();">
            <span class="glyphicon glyphicon-chevron-down"></span><span class="glyphicon glyphicon-chevron-down"></span><span
        ...
        <textarea class="form-control input-lg col-lg-4" rows="6" ng-model="page.encounterNote.note"
                  ng-disabled="page.cannotChange" id="noteEditor{{demographicNo}}"
                  ng-change="setEditingNoteFlag()"></textarea>
