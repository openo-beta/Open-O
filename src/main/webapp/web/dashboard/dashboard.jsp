    ...
    <div class="row">
        <div class="col-md-9" ng-controller="DashboardCtrl">
            ...
            <div ng-if="inbox.length > 0">
                <table class="table table-condensed table-hover">
                    ...
                    <tr ng-repeat="item in inbox" ng-hide="$index >= 5" ng-click="openInbox()" class="hand-hover">
                        <td><span ng-if="item.properity != null && item.priority != 'Routine'"
                                  class="glyphicon glyphicon-flag" style="color:red"></span></td>
            ...
            <div ng-if="totalMessages > 0">
                <table class="table table-condensed  table-hover">
                    ...
                    <tbody>
                    <tr ng-repeat="item in messages" ng-hide="$index >= 5" ng-click="viewMessage(item)"
                        class="hand-hover">
                        <!-- 	<td></td> -->
                        <td>{{item.fromName}}</td>
                        <td>{{item.subject}}</td>
            ...
            <div ng-if="totalTicklers>0">
                <table class="table table-condensed  table-hover">
                    ...
                    <tr ng-repeat="item in ticklers" ng-hide="$index >= 5" ng-click="viewTickler(item)"
                        class="hand-hover">
                        <td>
                            <span ng-if="isTicklerHighPriority(item)" class="glyphicon glyphicon-flag"
        ...
        <div id="rightColumn" class="col-md-3 hidden-xs" ng-hide="!k2afeed && !authenticatek2a"
            ...
            <div infinite-scroll="updateFeed(k2afeed.length,10)" infinite-scroll-parent="true">
                <blockquote class="pull-right" ng-repeat="item in k2afeed"
                    ...
                    <a href="" style="font-size:14px" data-toggle="modal" data-target="#expandFeed{{item.id}}"
                       ng-if="item.link">{{item.body | cut:true:140 }}</a>
                    <a href="" ng-click="authenticateK2A(item.id)" style="font-size:14px"
                       ng-if="!item.link">{{item.body}}</a>
                    ...
                    <small>
                        <a class="glyphicon glyphicon-thumbs-up"
                           ng-click="agreeWithK2aPost(item)"></a>&nbsp;{{item.agreeCount}}&nbsp;&nbsp;
                        <a class="glyphicon glyphicon-thumbs-down"
                           ng-click="disagreeWithK2aPost(item)"></a>&nbsp;{{item.disagreeCount}}&nbsp;&nbsp;
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <a class="glyphicon glyphicon-thumbs-up"
                                               ng-click="agreeWithK2aPost(item)"></a>&nbsp;<b>{{item.agreeCount}}</b>&nbsp;Agree&nbsp;&nbsp;
                                            <a class="glyphicon glyphicon-thumbs-down"
                                               ng-click="disagreeWithK2aPost(item)"></a>&nbsp;<b>{{item.disagreeCount}}</b>&nbsp;Disagree&nbsp;&nbsp;
                                    ...
                                    <div>
                                        ...
                                        <button ng-click="commentOnK2aPost(item)" class="btn btn-default">Save Comment
                                        </button>
                                    </div>
                                </div>
                            </div>
