...
<html>
    <head>
        ...
        <script type="text/javascript"
                src="${ pageContext.request.contextPath }/web/dashboard/admin/dashboardManagerController.js"></script>
                    ...
                    <form style="form-inline" id="importForm"
                        ...
                        <c:if test="${ not empty param.dashboardId }">
                            <div class="form-group">
                                <button class="btn btn-default backtoDashboardBtn"
                                        id="getDashboard_${ param.dashboardId }" type="button">
                                    <span class="glyphicon glyphicon-circle-arrow-left text-center"
                            ...
                            <div class="dropdown btn-group" id="editDashboardButtonContainer">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="editDashboardMenu">
                                    <c:forEach items="${ dashboards }" var="dashboard" varStatus="loop">
                                        <li>
                                            <a href="javascript:void(0)" id="dashboard_${ dashboard.id }"
                                               class="editDashboardSelect">
                                                <c:out value="${ dashboard.name }"/>
                                                <input type="hidden" name="selectName" id="selectName"
                                                       value="${ dashboard.name }"/>
                                                <input type="hidden" name="selectDescription" id="selectDescription"
                                                       value="${ dashboard.description }"/>
                                                <input type="hidden" name="selectActive" id="selectActive"
                    ...
                    <table class="table table-striped table-condensed" id="libraryTable">
                        ...
                        <c:forEach items="${ indicatorTemplates }" var="indicator">
                            <tr>
                                <td>
                                    <label class="switch">
                                        <input class="form-control toggleActive" type="checkbox"
                                               name="IndicatorTemplate_${ indicator.id }"
                                ...
                                <td>
                                    <form action="${ pageContext.request.contextPath }/web/dashboard/admin/DashboardManager.do?method=exportTemplate"
                                        ...
                                        <button class="btn btn-default exportTemplate text-center"
                                                id="exportTemplate_${ indicator.id }" type="submit">
                                ...
                                <td>
                                    <select class="form-control assignDashboard"
                                            name="assignDashboard_${ indicator.id }"
