                ...
                <th class="donotprint" id="0">
                    <div class="dropdown" id="actionMenu">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="actionMenuLink">
                            <li>
                                <a href="javascript:void(0)" class="dropdown-item" id="selectAllDrilldown"
                                   title="Select all rows in the current view.">
                                    Select All in View
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="dropdown-item" id="selectNoneDrilldown"
                                   title="Deselect all checked rows.">
                                    Select None
                                </a>
                            </li>
                            ...
                            <c:if test="${fn:contains(drilldown.actionIds, 'demoExcl')}">
                                <li>
                                    <a href="javascript:void(0)"
                                       class="dropdown-item"
                                       title="Exclude Checked Patients from Indicator Results."
                                       id="excludePatientsChecked">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        Note that you will have to reload the dashboard before patients are excluded from the results
                        you see (such as the drilldown table).
                    </div>
                </div>
                <div class="modal-footer">
