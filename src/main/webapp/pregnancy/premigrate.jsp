    ...
    <form action="Pregnancy.do">
        ...
        <fieldset>
            <table>
                ...
                <tr>
                    <td>Language:</td>
                    <td><input type="text" name="pg1_language_old" value="<%=props.getProperty("pg1_language","")%>"/>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="pg1_partnerEduLevel_old"
                               value="<%=props.getProperty("pg1_partnerEduLevel","")%>"/></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="pg1_eduLevel_old" value="<%=props.getProperty("pg1_eduLevel","")%>"/>
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="pg1_ethnicBg_old" value="<%=props.getProperty("pg1_ethnicBg","")%>"/>
                    </td>
                    <td>
                        Mother:
                ...
                <tr>
                    <td>Rubella:</td>
                    <td><input type="text" name="pg1_labRubella_old"
                               value="<%=props.getProperty("pg1_labRubella","")%>"/></td>
                ...
                <tr>
                    <td>HbsAg:</td>
                    <td><input type="text" name="pg1_labHBsAg_old" value="<%=props.getProperty("pg1_labHBsAg","")%>"/>
                    </td>
                ...
                <tr>
                    <td>VDRL:</td>
                    <td><input type="text" name="pg1_labVDRL_old" value="<%=props.getProperty("pg1_labVDRL","")%>"/>
                    </td>
                ...
                <tr>
                    <td>Sickle Cell:</td>
                    <td><input type="text" name="pg1_labSickle_old" value="<%=props.getProperty("pg1_labSickle","")%>"/>
                    </td>
                ...
                <tr>
                    <td>AR2 ABO:</td>
                    <td><input type="text" name="ar2_bloodGroup_old"
                               value="<%=props.getProperty("ar2_bloodGroup","")%>"/></td>
                ...
                <tr>
                    <td>2 Hr GTT:</td>
                    <td><input type="text" name="ar2_lab2GTT_old" value="<%=props.getProperty("ar2_lab2GTT","")%>"/>
                    </td>
