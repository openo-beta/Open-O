...
<html>
    ...
    <form action="${ctx}/setProviderStaleDate.do" class="well">
        ...
        <div class="control-group">
            <div class="controls">
                <label class="radio">
                    <input type="radio" name="integrator_full_push" value="1" <%=getChecked(properties[18], true) %> />
                    All Rostered Patients
                </label>
            </div>
        </div>
        <div class="control-group">
...
<%!
    ...
    public String getChecked(UserProperty val, boolean trueBtn, boolean defaultFalse) {
        if ((val != null && val.getValue().equalsIgnoreCase("0") && !trueBtn) || (val != null && val.getValue().equalsIgnoreCase("1") && trueBtn) || (val == null && !trueBtn && defaultFalse))
            return "checked=\"checked\"";
        return "";
    }
%>
