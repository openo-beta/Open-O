...
<table class="table_main_details" width="100%" height="100%" border="1" bordercolor="#C0CBDB">
    ...
    <tr>
        <td class="filter">
            Filter: <span><input type="radio" name="filter" id="filter" value="all" checked="checked"
                                 onclick="onclick_filter('all');">All</span>
        ...
        <td style="padding-left: 1px !important;">
            <table class="table_records" width="100%" height="100%" border="1" bordercolor="#C0CBDB">
                ...
                <tr class="<%=cls%>" onclick="onclick_submission('<%=ocanSubmissionLog.getId()%>');">
                    <td align="center"><%=ocanStaffForm.getClientId() %>
                    </td>
                    <td align="center"><%=ocanStaffForm.getFirstName() %>
                    </td>
                    <td align="center"><%=ocanStaffForm.getLastName() %>
                    </td>
                    <td align="center"><%=admissionDate %>
                    </td>
                    <td align="center"><%=functionalCentre %>
                    </td>
                    <td align="center"><%=dateFormat.format(ocanStaffForm.getCreated()) %>
                    </td>
                    <td align="center"><%=result %>
                    </td>
                    <td align="center"><%=dateFormat.format(ocanSubmissionLog.getSubmitDateTime()) %>
                    </td>
                    <td align="center"><%=ocanSubmissionLog.getResultMessage() %>
                    </td>
                </tr>
                <%
                                }
