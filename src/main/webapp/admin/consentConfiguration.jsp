...
<head>
    <title><fmt:message key="admin.admin.consentConfig"/></title>
...
<div ng-controller="consentConfig">
    <div class="page-header">
        <h4><fmt:message key="admin.admin.consentConfig"/></h4>
    </div>
    ...
    <form>
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-4">
                ...
                <select class="form-control" ng-model="newConsent.providerNo">
                    <option ng-repeat="provider in activeProviders" title="{{getFullProviderName(provider)}}"
        ...
        <div class="row">
            <div class="form-group col-xs-12">
                ...
                <button type="submit" class="btn btn-default" ng-click="saveConsent(newConsent)">Save Consent Type
                </button>
            </div>
        </div>
        ...
        <div class="col-xs-12">
            ...
            <table class="table table-condensed table-striped�">
                ...
                <tr ng-repeat="cType in activeConsentTypes">
                    ...
                    <td>
                        <span ng-if="cType.remoteEnabled" style="color:green" class="glyphicon glyphicon-ok "
