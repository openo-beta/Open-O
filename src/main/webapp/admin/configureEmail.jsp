...
<div class="container mt-5">
   <div class="card shadow-sm rounded">
      <div class="card-body">
         ...
         <p class="card-text mt-3">Please contact your server administrator for assistance. Outgoing email account configuration details must be added manually into the emailConfig table.</p>
