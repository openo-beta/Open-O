...
<head>
    <title><fmt:message key="admin.admin.surveillanceConfig"/></title>
...
<div ng-controller="appointmentSearchConfig">
    <div class="page-header">
        ...
        <h4><fmt:message key="admin.admin.appointmentSearchConfig"/>
    ...
    <div class="row">
        <div class="col-xs-3">
            ...
            <ul class="nav nav-tabs nav-justified">
                <li role="presentation" ng-class="sideTabActive('online')"><a ng-click="setActiveSideTab('online')">Active</a>
                </li>
                <li role="presentation" ng-class="sideTabActive('offline')"><a ng-click="setActiveSideTab('offline')">Archived</a>
                </li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane" ng-class="sideTabActive('online')" id="home">
                    <div class="list-group">
                        <a ng-click="openSearchConfig(searchConfig)" ng-if="searchConfig.active" class="list-group-item"
                           ng-class="itemActive(searchConfig.id)"
                           data-ng-repeat="searchConfig in searchConfigList ">  <%--| limitTo:loadedSurveillanceConfigsQuantity --%>
                            ...
                            <br>
                            <button ng-if="searchConfig.active" class="btn btn-default btn-sm "
                                    ng-click="disableSearchConfig(searchConfig.id);$event.stopPropagation();">Disable
                            </button>
                        </a>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane" ng-class="sideTabActive('offline')" id="profile">
                    <div class="list-group">
                        <a ng-click="openSearchConfig(searchConfig)" ng-if="!searchConfig.active"
                           class="list-group-item" ng-class="itemActive(searchConfig.id)"
                           data-ng-repeat="searchConfig in searchConfigList | limitTo:loadedSurveillanceConfigsQuantity">
                            ...
                            <br>
                            <button ng-if="!searchConfig.active" class="btn btn-default btn-sm"
                                    ng-click="enableSearchConfig(searchConfig.id);$event.stopPropagation();">Enable
                            </button>
                        </a>
                    </div>
                </div>
            ...
            <div class="jumbotron">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Describe Search"
                               ng-model="new.searchName">
                    </div>
                    <div class="form-group">
                        <label for="searchTypeSelect">Search Type <small>(online only available
                            currently)</small></label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" ng-model="new.providerNo">
                            <option value="{{prov.providerNo}}" ng-repeat="prov in activeProviders">{{prov.lastName}},
                                {{prov.firstName}} ({{prov.providerNo}})
                            </option>
                        </select>
                    </div>
        ...
        <div class="col-xs-9" ng-show="currentSearchConfig != null">
            <h4>{{currentApptSearch.searchName}} - {{getProviderName(currentApptSearch.providerNo)}} -
                {{currentApptSearch.searchType}}</h4>
            <div class="form-group">
                <label for="ClinicTitleId">Booking Title</label>
                <input type="text" class="form-control" id="ClinicTitleId" placeholder="Name of Clinic"
                       ng-model="currentSearchConfig.title">
            </div>
            <ul class="nav nav-tabs nav-justified">
                <li role="presentation" ng-class="tabActive('main')"><a ng-click="setActiveTab('main')"><fmt:message key="admin.appointmentSearchConfig.main"/></a></li>
                <li role="presentation" ng-class="tabActive('codes')"><a ng-click="setActiveTab('codes')"><fmt:message key="admin.appointmentSearchConfig.apptCodes"/></a></li>
                <li role="presentation" ng-class="tabActive('types')"><a ng-click="setActiveTab('types')"><fmt:message key="admin.appointmentSearchConfig.apptTypes"/></a></li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane" ng-class="tabActive('main')" id="home">
                    <table class="table table-bordered table-striped table-hover">
                        <tr>
                            <th><fmt:message key="admin.appointmentSearchConfig.provider"/></th>
                            <th><fmt:message key="admin.appointmentSearchConfig.team"/></th>
                        ...
                        <tr ng-repeat-start="provider in currentSearchConfig.bookingProviders">
                            <td><a ng-click="viewProvider(provider,$event)"
                                   class="clickable">{{getProviderName(provider.providerNo)}}</a>
                                <md-icon class="glyphicon glyphicon-trash" aria-label="Trash"
                                         ng-click="removeProvider(provider, currentSearchConfig.bookingProviders, $index, $event)"></md-icon>
                            </td>
                            <td>
                                <%-- button class="btn btn-default" aria-label="Add Appointment Code"  ng-click="cnf.openAddTeamMemberDialog(providers, $event)" style="padding:0px; margin:0px;"><fmt:message key="admin.appointmentSearchConfig.add"/></button> --%>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default btn-xs dropdown-toggle"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <fmt:message key="admin.appointmentSearchConfig.add"/> <span
                                            class="caret"></span>
                                    </button>
                            ...
                            <td ng-repeat="appt in currentSearchConfig.bookingAppointmentTypes"
                                ng-click="editApptTypeForProvider(appt,provider,$event)" style="cursor: pointer;"><span><i
                                    ng-class="{'glyphicon glyphicon-ok' : checkAppt(provider,appt) }"></i><small> {{listAppt(provider, appt) | blankFilter:checkAppt(provider, appt)}}</small></span>
                            </td>
                        </tr>
                        <tr ng-repeat="teamProvider in provider.teamMembers" ng-repeat-end>
                            <td>&nbsp;</td>
                            <td><small><a ng-click="viewProvider(teamProvider, $event)"
                                          class="clickable">{{getProviderName(teamProvider.providerNo)}}</a>
                                <md-icon class="glyphicon glyphicon-trash" aria-label="Trash"
                                         ng-click="removeProvider(teamProvider,provider.teamMembers,$index,$event)"></md-icon>
                            </small></td>
                            <td ng-repeat="appt in currentSearchConfig.bookingAppointmentTypes"
                                ng-click="editApptTypeForProvider(appt,teamProvider,$event)" style="cursor: pointer;">
                                <span><i
                                        ng-class="{'glyphicon glyphicon-ok' : checkAppt(teamProvider,appt) }"></i><small> {{listAppt(teamProvider, appt) | blankFilter:checkAppt(teamProvider, appt)}}</small></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div role="tabpanel" class="tab-pane" ng-class="tabActive('types')" id="profile">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <a ng-click="openSurvey(surveyConfig)"
                               class="list-group-item" <%-- ng-class="itemActive(surveyConfig.id)" --%>
                        ...
                        <div class="col-xs-6">
                               ...
                               data-ng-repeat="appointmentType in oscarAppointmentTypes.types">
                                ...
                                <h4 class="list-group-item-heading">{{appointmentType.name}}
                                    ...
                                    <button class="btn btn-default btn-xs pull-right" aria-label="Add"
                                            ...
                                            class="md-raised md-primary"><fmt:message key="admin.appointmentSearchConfig.add"/></button>
                            ...
                            <button type="button" class="btn btn-default btn-xs" ng-click="addApptType(apptLabelDesc)">
                                <fmt:message key="admin.appointmentSearchConfig.add"/></button>
                                ...
                                <tr ng-repeat="appCode in oscarTemplateCodes">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-xs"
                                                ng-if="isCodeEnabled(currentSearchConfig,appCode)"
                                                ng-click="addOrRemoveFromCodeList(appCode)">Enabled
                                        </button>
                                        <button type="button" class="btn btn-default btn-xs"
                                                ng-if="!isCodeEnabled(currentSearchConfig,appCode)"
                                                ng-click="addOrRemoveFromCodeList(appCode)">Disabled
                                        </button>

                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-success btn-xs"
                                                ng-if="isOnlineBookingEnabled(currentSearchConfig,appCode)"
                                                ng-click="addOrRemoveFromOnlineBookingCodeList(appCode)">Enabled
                                        </button>
                                        <button type="button" class="btn btn-default btn-xs"
                                                ng-if="!isOnlineBookingEnabled(currentSearchConfig,appCode)"
                                                ng-click="addOrRemoveFromOnlineBookingCodeList(appCode)">Disabled
                                        </button>
...
<script type="text/ng-template" id="providerCopy.html">
    <div class="modal-header">
        <h3 class="modal-title" id="modal-title">Copy Provider Configuration
            :{{vp.getProviderName(vp.provider.providerNo)}}</h3>
    </div>
        ...
        <div class="md-dialog-content" id="dialogContentProviderCopy">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr ng-repeat-start="prov in vp.clinic.bookingProviders">
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <button class="btn btn-primary" type="button" ng-click="vp.copyProvidersTemplate(prov)">Copy
                        </button>
                    </td>
                    <td ng-repeat="appt in vp.clinic.bookingAppointmentTypes">
                        <span><small>{{vp.listAppt(prov, appt)}}</small></span></td>
                </tr>
                <tr ng-repeat="teamProvider in prov.teamMembers" ng-repeat-end>
                    ...
                    <td>
                        <button class="btn btn-primary" type="button" ng-click="vp.copyProvidersTemplate(teamProvider)">
                            Copy
                        </button>
                    </td>
                    <td ng-repeat="appt in vp.clinic.bookingAppointmentTypes">
                        <span><small>{{vp.listAppt(teamProvider, appt)}}</small></span>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <table class="table table-bordered table striped">
                        ...
                        <tr ng-repeat="appCode in mpa.apptCodes">
                            ...
                            <td>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" ng-model="appCode.accepting"
                                               aria-label="apptCodeAccepting">
                                    </label>
                                </div>
                            </td>
                        </tr>
...
<script>
    ...
    app.controller("appointmentSearchConfig", function ($scope, scheduleService, providerService, $modal) {
        ...
        */
        ...
        $scope.getProviderName = function (providerNumber) {
            ...
            if (provider == null) {
                return providerNumber + " N/A inactive"
            }
    ...
    app.controller('ModalInstanceCtrl', function ModalInstanceCtrl($scope, $modal, $modalInstance, provider, appt, apptCodes, appointmentCodeDurations) {
        ...
        ctrl.getProviderName = function (prov) {
            return mainService.getProviderName(prov)
        };
