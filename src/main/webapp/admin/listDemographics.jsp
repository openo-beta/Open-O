...
<form method="post" action="../study/ManageStudy.do">
    ...
    <div class="well">
        ...
        <table id="providerTable" class="table table-striped table-condensed table-hover" style="width:500px;">
            ...
            %>
            <tr>
                <td><input type="checkbox" id="p_<%=provider.getProviderNo()%>" name="providerNo"
                           value="<%=provider.getProviderNo()%>"></td>
                <td><%=provider.getProviderNo()%>
                </td>
                <td><%=Encode.forHtml(provider.getFormattedName())%>
                </td>
            </tr>
            <%
                }
    ...
    <div class="well">
        ...
        <table id="demoTable" class="table table-striped table-condensed table-hover">
            ...
            %>
            <tr>
                <td><input type="checkbox" id="d_<%=demo.getDemographicNo()%>" name="demographicNo"
                           value="<%=demo.getDemographicNo()%>"></td>
                <td><%=demo.getDemographicNo()%>
                </td>
                <td><%=Encode.forHtml(demo.getDisplayName())%>
                </td>
                <td><%=Encode.forHtml(demo.getBirthDayAsString())%>
                </td>
                <td><%=demo.getAddress() != null ? Encode.forHtml(demo.getAddress()) : "N/A"%>
                </td>
                <td><%=demo.getProvider() != null ? Encode.forHtml(demo.getProvider().getFormattedName()) : "N/A"%>
                </td>
            </tr>
            <%
                }
