...
<form action="${pageContext.request.contextPath}/Tickler.do" method="post">
    ...
    <tr>
        ...
        <td colspan="3"><a id="pre_print" href='<c:out value="${ctx}"/>/ticklerPlus/ticklerPrint.jsp'
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1"
        ...
        <c:forEach var="tickler" items="${ticklers}">
            ...
            <tr bgcolor="<%=bgcolor%>" align="center">
                ...
                %>
                <td style="<%=style%>"><%=demographic_name%>
                </td>
                <td style="<%=style%>" class=noprint><%=provider_name%>
                </td>
                ...
                <td style="<%=style%>" class=noprint><%=assignee_name%>
                </td>
                <td style="<%=style%>" class=noprint><%=status%>
                </td>
                <td style="<%=style%>" align="left"><c:out escapeXml="false"
                                                           value="${tickler.message}"/></td>
                <td style="<%=style%>" class=noprint><%=program_name%>
                </td>
            </tr>
        </c:forEach>
        <tr>
