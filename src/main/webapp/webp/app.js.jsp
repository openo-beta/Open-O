...
--%>
    ...
    var oscarApp = angular.module('oscarProviderViewModule', ['ui.router', 'ngResource', 'ui.bootstrap', 'demographicServices', 'programServices',
        ...
        , 'consultServices', 'appServices', 'diseaseRegistryServices', 'rxServices', 'angular-loading-bar', 'ngSanitize']);
    ...
    oscarApp.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
        <%--  //
              //Not sure what to do here yet.  One option would be to use this window for all pop ups.
              //The down side of using this for all pop ups is that it loads more than it needs.
              //At this point im not sure how much of an issue this is.  IE. It's still unknown how many windows we would want to pop out.
              //If it's not that many it probably isn't that big of an issue. If it is many we could change this page to be generated and only output what is needed.
              //Or this page could be only for the record sub windows.
              //
