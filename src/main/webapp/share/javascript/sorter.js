...
$(document).ready(function () {
    ...
    $("#picker div").append(function (index, html) {
        return "<span class='num'>" + ++index + "</span>" +
            ...
            "-webkit-box-shadow: none; -moz-box-shadow: none' src="<%= request.getContextPath() %>/images/icons/132.png" />" +
            "<img style=' -box-shadow: none; -webkit-box-shadow: none; " +
            "-moz-box-shadow: none' src="<%= request.getContextPath() %>/images/icons/131.png" />" +
            "<img style=' -box-shadow: none; -webkit-box-shadow: none; " +
            "-moz-box-shadow: none' src="<%= request.getContextPath() %>/images/icons/114.png" /></span>";
    });
