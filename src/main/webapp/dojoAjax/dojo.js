...
dojo.ns = {
    namespaces: {}, failed: {}, loading: {}, loaded: {}, register: function (name, _21c, _21d, _21e) {
...
dojo.widget.Parse = function (_3b7) {
    ...
    this.getDataProvider = function (_3ce, _3cf) {
        dojo.io.bind({
            url: _3cf, load: function (type, _3d1) {
                if (type == "load") {
...
dojo.widget.wai = {
    ...
    setAttr: function (node, ns, attr, _480) {
        if (dojo.render.html.ie) {
...
dojo.declare("dojo.widget.DomWidget", dojo.widget.Widget, function () {
    ...
    addChild: function (_4af, _4b0, pos, ref, _4b3) {
        if (!this.isContainer) {
...
dojo.html.toCoordinateObject = dojo.html.toCoordinateArray = function (_557, _558, _559) {
    if (_557 instanceof Array || typeof _557 == "array") {
        ...
        if (!_557.nodeType && !(_557 instanceof String || typeof _557 == "string") && ("width" in _557 || "height" in _557 || "left" in _557 || "x" in _557 || "top" in _557 || "y" in _557)) {
            var ret = {
                left: _557.left || _557.x || 0,
                top: _557.top || _557.y || 0,
                width: _557.width || 0,
                height: _557.height || 0
            };
        } else {
...
dojo.lang.extend(dojo.lfx.IAnimation, {
    ...
    pause: null,
    stop: null,
    connect: function (evt, _5ff, _600) {
        if (!_600) {
            _600 = _5ff;
            _5ff = this;
        }
...
dojo.lang.extend(dojo.lfx.Animation, {
    _startTime: null, _endTime: null, _timer: null, _percent: 0, _startRepeatCount: 0, play: function (_60d, _60e) {
        if (_60e) {
...
dojo.lang.extend(dojo.lfx.Combine, {
    _animsEnded: 0, play: function (_61d, _61e) {
...
dojo.lang.extend(dojo.lfx.Chain, {
    _currAnim: -1, play: function (_62b, _62c) {
        if (!this._anims.length) {
            return this;
        }
...
dojo.lfx.html.slideTo = function (_68c, _68d, _68e, _68f, _690) {
    ...
    dojo.lang.forEach(_68c, function (node) {
        ...
        init();
        var anim = dojo.lfx.propertyAnimation(node, {
            "top": {start: top, end: (_68d.top || 0)},
            "left": {start: left, end: (_68d.left || 0)}
        }, _68e, _68f, {"beforeBegin": init});
        if (_690) {
            anim.connect("onEnd", function () {
                _690(_68c, anim);
            });
...
dojo.lfx.html.slideBy = function (_69b, _69c, _69d, _69e, _69f) {
    ...
    dojo.lang.forEach(_69b, function (node) {
        ...
        init();
        var anim = dojo.lfx.propertyAnimation(node, {
            "top": {start: top, end: top + (_69c.top || 0)},
            "left": {start: left, end: left + (_69c.left || 0)}
        }, _69d, _69e).connect("beforeBegin", init);
        if (_69f) {
            anim.connect("onEnd", function () {
                _69f(_69b, anim);
            });
...
dojo.lfx.html.explode = function (_6aa, _6ab, _6ac, _6ad, _6ae) {
    ...
    var anim = new dojo.lfx.propertyAnimation(_6b1, _6b4, _6ac, _6ad, {
        "beforeBegin": function () {
...
dojo.lfx.html.implode = function (_6b7, end, _6b9, _6ba, _6bb) {
    ...
    var anim = new dojo.lfx.propertyAnimation(_6bf, _6c0, _6b9, _6ba, {
        "beforeBegin": function () {
            dojo.html.hide(_6b7);
            dojo.html.show(_6bf);
        }, "onEnd": function () {
...
dojo.lfx.html.highlight = function (_6c3, _6c4, _6c5, _6c6, _6c7) {
    ...
    dojo.lang.forEach(_6c3, function (node) {
        ...
        var anim = dojo.lfx.propertyAnimation(node, {"background-color": {start: rgb, end: _6cf}}, _6c5, _6c6, {
            "beforeBegin": function () {
                if (_6cc) {
...
dojo.lfx.html.unhighlight = function (_6d1, _6d2, _6d3, _6d4, _6d5) {
    ...
    dojo.lang.forEach(_6d1, function (node) {
        ...
        var anim = dojo.lfx.propertyAnimation(node, {"background-color": {start: _6d8, end: rgb}}, _6d3, _6d4, {
            "beforeBegin": function () {
                if (_6da) {
                    node.style.backgroundImage = "none";
                }
...
dojo.lfx.toggle.plain = {
    show: function (node, _6dd, _6de, _6df) {
        dojo.html.show(node);
...
dojo.lfx.toggle.fade = {
    show: function (node, _6e5, _6e6, _6e7) {
...
dojo.lfx.toggle.wipe = {
    show: function (node, _6ed, _6ee, _6ef) {
...
dojo.lfx.toggle.explode = {
    show: function (node, _6f5, _6f6, _6f7, _6f8) {
...
dojo.lang.extend(dojo.io.Request, {
    ...
    useCache: false,
    preventCache: false,
    load: function (type, data, _728, _729) {
    },
...
if (!dj_undef("window")) {
    ...
    dojo.io.XMLHTTPTransport = new function () {
        ...
        this.bind = function (_7eb) {
            ...
            var _7fb = false;
            if (_7f6) {
                var _7fc = this.inFlight.push({
                    "req": _7eb,
                    "http": http,
                    "url": url,
                    "query": _7ed,
                    "useCache": _7f8,
                    "startTime": _7eb.timeoutSeconds ? (new Date()).getTime() : 0
                });
