...
<head>
    ...
    <title><%=pd.getPatientName()%> - <fmt:message key="oscarMDS.segmentDisplay.title"/></title>
            ...
            <td valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr>
                        <td align="left" class="MainTableTopRowRightColumn" width="100%">
                            ...
                            <input type="button"
                                   value=" <fmt:message key="oscarMDS.segmentDisplay.btnEChart"/> "
                                   onClick="popupStart(360, 680, '${pageContext.request.contextPath}/oscarMDS/SearchPatient.do?labType=MDS&segmentID=<%= request.getParameter("segmentID")%>&name=<%=java.net.URLEncoder.encode(pd.getPatientName(), StandardCharsets.UTF_8)%>', 'searchPatientWindow')">
                            <% } %> &nbsp; <a
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="3"
                    ...
                    <tr>
                        <td class="Cell" colspan="2" align="middle">
                            ...
                            %><a
                                    href="SegmentDisplay.jsp?segmentID=<%=multiID[i]%>&multiID=<%=multiLabId%>&providerNo=<%=request.getParameter("providerNo")%>&searchProviderNo=<%=request.getParameter("searchProviderNo")%>&status=<%=request.getParameter("status")%>">v<%= i + 1 %>
                            </a>&#160;<%
                            } else {
                            %><a
                                    href="SegmentDisplay.jsp?segmentID=<%=multiID[i]%>&multiID=<%=multiLabId%>&providerNo=<%=request.getParameter("providerNo")%>&status=<%=request.getParameter("status")%>">v<%= i + 1 %>
                            </a>&#160;<%
                                        }
                                    }
                                }
                                            ...
                                            <tr>
                                                <td valign="top" align="left">
                                                    <table valign="top" border="0" cellpadding="3" cellspacing="0"
                                                            ...
                                                            <td colspan="2" nowrap>
                                                                <div class="FieldData" nowrap="nowrap">
                                                                    ...
                                                                    <a href="javascript:window.close()"> <% } else { // we were called from lab module %>
                                                                        ...
                                                                        <a
                                                                                href="javascript:popupStart(360, 680, '${pageContext.request.contextPath}/oscarMDS/SearchPatient.do?labType=MDS&segmentID=<%= request.getParameter("segmentID")%>&name=<%=java.net.URLEncoder.encode(pd.getPatientName(), StandardCharsets.UTF_8) %>', 'searchPatientWindow')">
                                                                            <% } %> <%=pd.getPatientName()%>
                                                                        </a></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" nowrap>
                                                                <div class="FieldData"><strong><fmt:message key="oscarMDS.segmentDisplay.formAge"/>: </strong><%=pd.getAge()%>
                                                                </div>
                                                            </td>
                                                            <td colspan="2" nowrap>
                                                                <div class="FieldData"><strong><fmt:message key="oscarMDS.segmentDisplay.formSex"/>: </strong><%=pd.getSex()%>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="2" nowrap>
                                                                <div class="FieldData"
                                                                     nowrap="nowrap"><%=pd.getHealthNumber().substring(1)%>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td width="33%" valign="top">
                                                    <table valign="top" border="0" cellpadding="3" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td nowrap>
                                                                <div align="left" class="FieldData"
                                                                     nowrap="nowrap"><%=pd.getPatientLocation()%>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <tr>
                        <td bgcolor="white" colspan="2">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td bgcolor="white">
                                        <div class="FieldData"><strong><fmt:message key="oscarMDS.segmentDisplay.formRequestingClient"/>: </strong> <%= mDSSegmentData.providers.referringDoctor %>
                                        </div>
                                    </td>
                                    <td bgcolor="white">
                                        <div class="FieldData"><strong><fmt:message key="oscarMDS.segmentDisplay.formReportToClient"/>: </strong> <%= mDSSegmentData.providers.admittingDoctor %>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td align="center" bgcolor="white">
                                        ...
                                        <div class="FieldData">
                                            ...
                                            <%= rs.getProviderName() %> : <font color="red"><%= rs.getStatus() %>
                                        </font>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="2"
                    ...
                    <tr bgcolor="<%=(linenum % 2 == 1 ? highlight : "")%>"
                        ...
                        <td align="middle"><fmt:message key="oscarMDS.segmentDisplay.msgOrganism"/> <%=m - firstorgindex + 1%>
                        </td>
                        <% }
                            linenum++; %>
