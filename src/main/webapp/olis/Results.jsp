...
<%@page import="com.indivica.olis.queries.*,java.util.*,ca.openosp.openo.lab.ca.all.parsers.Factory, ca.openosp.openo.lab.ca.all.parsers.OLISHL7Handler, ca.openosp.openo.lab.ca.all.parsers.OLISHL7Handler.OLISError, org.oscarehr.util.SpringUtils" %>
        ...
        <td class="MainTableTopRowRightColumn">
            <table class="TopStatusBar">
                ...
                <tr>
                    <td>Results</td>
                    <td>&nbsp;</td>
                    <td style="text-align: right"><a href="javascript:void(0)" onClick="popupPage(800,1000,'log.jsp')">OLIS
                        Log</a>
                </tr>
                </tbody>
            </table>
        ...
        <td colspan="2">
            ...
            <table style="width:90%">
                ...
                <tr>
                    ...
                    <td colspan="3" style="text-align:right"><%=resultList.size() - duplicates.keySet().size() %>
                        result(s) found
                    </td>
                </tr>
                <tr>
