...
<%
    ...
    Integer pollFrequency = olisPreferences.getPollFrequency();
    if (pollFrequency == null) {
        pollFrequency = 30;
    }

    boolean filterPatients = olisPreferences.isFilterPatients();
                ...
                <td class="MainTableRightColumn" valign="top">
                    <table>
                        ...
                        <tr id="startTimeError" style="display:none;">
                            <td> &nbsp;</td>
                            <td style="color:red"> The start time does not match the provided format (e.g., ""1970-01-01
                                00:00:00 - 400".)
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="endTimeError" style="display:none;">
                            <td> &nbsp;</td>
                            <td style="color:red"> The end time does not match the provided format (e.g., ""1970-01-01
                                00:00:00 - 400".)
                            </td>
                        </tr>
                        <tr>
