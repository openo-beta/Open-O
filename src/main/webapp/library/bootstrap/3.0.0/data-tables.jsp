...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<%=request.getContextPath()%>/library/bootstrap/3.0.0/assets/css/DT_bootstrap.css">
...
<div class="container">
    ...
    <h1>Hello, DataTables v1.13.4, jQuery v3.6.4 with Bootstrap v3.0.0 <br><small><a href="index.jsp">view example
        list</a></small></h1>
