    ...
    <table class="MainTable" id="scrollNumber1" name="encounterTable">
        ...
        <tr>
            ...
            <td class="MainTableRightColumn">
                ...
                %>
                <a href="demographiccontrol.jsp?demographic_no=<%=Encode.forUriComponent(request.getParameter("demographic_no"))%>&last_name=<%=Encode.forUriComponent(String.valueOf(URLEncoder.encode(demolastname,"UTF-8")))%>&first_name=<%=Encode.forUriComponent(String.valueOf(URLEncoder.encode(demofirstname,"UTF-8")))%>&displaymode=<%=Encode.forUriComponent(request.getParameter("displaymode"))%>&dboperation=<%=Encode.forUriComponent(request.getParameter("dboperation"))%>&orderby=<%=Encode.forUriComponent(request.getParameter("orderby"))%>&limit1=<%=Encode.forUriComponent(String.valueOf(nPrevPage))%>&limit2=<%=Encode.forUriComponent(String.valueOf(strLimit2))%>&showRemote=<%=Encode.forUriComponent(String.valueOf(showRemoteStr))%>">
                ...
                %>
                <a href="demographiccontrol.jsp?demographic_no=<%=Encode.forUriComponent(request.getParameter("demographic_no"))%>&last_name=<%=Encode.forUriComponent(String.valueOf(URLEncoder.encode(demolastname,"UTF-8")))%>&first_name=<%=Encode.forUriComponent(String.valueOf(URLEncoder.encode(demofirstname,"UTF-8")))%>&displaymode=<%=Encode.forUriComponent(request.getParameter("displaymode"))%>&dboperation=<%=Encode.forUriComponent(request.getParameter("dboperation"))%>&orderby=<%=Encode.forUriComponent(request.getParameter("orderby"))%>&limit1=<%=Encode.forUriComponent(String.valueOf(nNextPage))%>&limit2=<%=Encode.forUriComponent(String.valueOf(strLimit2))%>&showRemote=<%=Encode.forUriComponent(String.valueOf(showRemote))%>">
