...
<html>
    ...
    <center>
        ...
        <form name="add2WLFrm" action="<%= request.getContextPath() %>/oscarWaitingList/Add2WaitingList.jsp">
            <input type="hidden" name="listId" value="<%=Encode.forHtmlAttribute(request.getParameter("list_id"))%>"/>
            <input type="hidden" name="demographicNo" value="<%=Encode.forHtmlAttribute(request.getParameter("demographic_no"))%>"/>
            <input type="hidden" name="demographic_no" value="<%=Encode.forHtmlAttribute(request.getParameter("demographic_no"))%>"/>
            <input type="hidden" name="waitingListNote" value="<%=Encode.forHtmlAttribute(request.getParameter("waiting_list_note"))%>"/>
            <input type="hidden" name="onListSince" value="<%=Encode.forHtmlAttribute(request.getParameter("waiting_list_referral_date"))%>"/>
        ...
        <h2>Update a Provider Record Successfully !
            <p>
                <a href="demographiccontrol.jsp?demographic_no=<%=Encode.forUriComponent(request.getParameter("demographic_no"))%>&displaymode=edit&dboperation=search_detail"><%=Encode.forHtml(request.getParameter("demographic_no"))%>
                </a></p>
        </h2>
