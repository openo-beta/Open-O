                    ...
                    <td class="links"><security:oscarSec roleName="<%=roleName$%>"
                        ...
                        <a class="encounterBtn" title="Encounter" href="javascript:void(0)"
                           onclick="popupEChart(710,1024,'<c:out
                                   value="${ctx}"/>/oscarEncounter/IncomingEncounter.do?providerNo=<%=Encode.forHtml(String.valueOf(curProvider_no))%>&appointmentNo=&demographicNo=<%=Encode.forHtml(String.valueOf(dem_no))%>&curProviderNo=&reason=<%=Encode.forHtml(String.valueOf(noteReason))%>&encType=&curDate=<%=Encode.forHtml(String.valueOf(""+curYear))%>-<%=Encode.forHtml(String.valueOf(""+curMonth))%>-<%=Encode.forHtml(String.valueOf(""+curDay))%>&appointmentDate=&startTime=&status=');return false;">E</a>
