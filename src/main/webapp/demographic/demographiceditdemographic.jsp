                    ...
                    <table border=0 cellspacing=0 width="100%">
                        ...
                        <security:oscarSec roleName="<%=roleName$%>" objectName="_billing" rights="r">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="javascript: function myFunction() {return false; }"
                                       onClick="popupPage(500,800,'<%= request.getContextPath() %>/billing/CA/ON/billinghistory.jsp?demographic_no=<%=Encode.forJavaScript(String.valueOf(demographic.getDemographicNo()))%>&last_name=<%=Encode.forJavaScript(String.valueOf(demographic.getLastName()))%>&first_name=<%=Encode.forJavaScript(String.valueOf(demographic.getFirstName()))%>&orderby=appointment_date&displaymode=appt_history&dboperation=appt_history&limit1=0&limit2=10')">
                                    ...
                                    %>
                                    <a href="#"
                                       onclick="popupPage(800,1000,'<%= request.getContextPath() %>/billing/CA/BC/billStatus.jsp?lastName=<%=Encode.forJavaScript(String.valueOf(demographic.getLastName()))%>&firstName=<%=Encode.forJavaScript(String.valueOf(demographic.getFirstName()))%>&filterPatient=true&demographicNo=<%=Encode.forJavaScript(String.valueOf(demographic.getDemographicNo()))%>');return false;">
                            ...
                            <tr>
                                <td><a
                                        href="javascript: function myFunction() {return false; }"
                                        onClick="window.open('<%= request.getContextPath() %>/billing/CA/ON/specialtyBilling/fluBilling/addFluBilling.jsp?function=demographic&functionid=<%=Encode.forJavaScript(String.valueOf(demographic.getDemographicNo()))%>&creator=<%=Encode.forJavaScript(String.valueOf(curProvider_no))%>&demographic_name=<%=Encode.forJavaScript(String.valueOf(demographic.getLastName()))%>%2C<%=Encode.forJavaScript(String.valueOf(demographic.getFirstName()))%>&hin=<%=Encode.forJavaScript(String.valueOf(demographic.getHin()!=null?demographic.getHin():""))%><%=Encode.forJavaScript(String.valueOf(demographic.getVer()!=null?demographic.getVer():""))%>&demo_sex=<%=Encode.forJavaScript(String.valueOf(demographic.getSex()))%>&demo_hctype=<%=Encode.forJavaScript(String.valueOf(demographic.getHcType()==null?"null":demographic.getHcType()))%>&rd=<%=Encode.forJavaScript(String.valueOf(rd==null?"null":rd))%>&rdohip=<%=Encode.forJavaScript(String.valueOf(rdohip==null?"null":rdohip))%>&dob=<%=Encode.forJavaScript(String.valueOf(MyDateFormat.getStandardDate(Integer.parseInt(birthYear),Integer.parseInt(birthMonth),Integer.parseInt(birthDate))))%>&mrp=<%=Encode.forJavaScript(String.valueOf(demographic.getProviderNo() != null ? demographic.getProviderNo() : ""))%>','', 'scrollbars=yes,resizable=yes,width=720,height=500');return false;"
                            ...
                            <tr>
                                <td><a
                                        href="javascript: function myFunction() {return false; }"
                                        onClick="window.open('<%= request.getContextPath() %>/billing/CA/ON/addBatchBilling.jsp?demographic_no=<%=Encode.forJavaScript(String.valueOf(demographic.getDemographicNo().toString()))%>&creator=<%=Encode.forJavaScript(String.valueOf(curProvider_no))%>&demographic_name=<%=Encode.forJavaScript(String.valueOf(demographic.getLastName()))%>%2C<%=Encode.forJavaScript(String.valueOf(demographic.getFirstName()))%>&hin=<%=Encode.forJavaScript(String.valueOf(demographic.getHin()!=null?demographic.getHin():""))%> <%=Encode.forJavaScript(String.valueOf(demographic.getVer()!=null?demographic.getVer():""))%>&dob=<%=Encode.forJavaScript(String.valueOf(MyDateFormat.getStandardDate(Integer.parseInt(birthYear),Integer.parseInt(birthMonth),Integer.parseInt(birthDate))))%>','', 'scrollbars=yes,resizable=yes,width=600,height=400');return false;"
