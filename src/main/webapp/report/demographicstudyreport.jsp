...
<html>
    ...
    <table width="100%" border="0" bgcolor="white" cellspacing="2"
        ...
        <tr bgcolor="<%=(nItems%2 == 0)?weakcolor:"white"%>">
            ...
            <td
                    title='<%=studyBean.getProperty(ds.getId().getStudyNo().toString()+studyBean.getProperty(ds.getId().getStudyNo().toString()), "")%>'><%=studyBean.getProperty(ds.getId().getStudyNo().toString(), "")%>
            </td>
            <td><%=d.getEmail()%>
            </td>
            <td><%=providerBean.getProperty(d.getProviderNo(), "")%>
            </td>
        </tr>
        <%
            }
