...
<html>
    <head>
        ...
        <title><fmt:message key="report.reportpatientchartlist.title"/></title>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr bgcolor="#CCCCFF">
            <th align=CENTER NOWRAP><font face="Helvetica"><fmt:message key="report.reportpatientchartlist.msgTitle"/></font></th>
            <th width="10%" nowrap>
                <input type="button" name="Button" value="<fmt:message key="global.btnPrint"/>"
                       onClick="window.print()">
                <input type="button" name="Button" value="<fmt:message key="global.btnExit"/>"
    ...
    <table width="100%" border="1" bgcolor="#ffffff" cellspacing="1"
        ...
        <tr bgcolor="#CCCCFF" align="center">
            <TH width="40%"><b><a
                    href="reportpatientchartlist.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&orderby=last_name"><fmt:message key="report.reportpatientchartlist.msgLastName"/></a></b></TH>
            <TH width="40%"><b><a
                    href="reportpatientchartlist.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&orderby=first_name"><fmt:message key="report.reportpatientchartlist.msgFirstName"/></a> </b></TH>
            <TH width="20%"><b><a
                    href="reportpatientchartlist.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&orderby=chart_no"><fmt:message key="report.reportpatientchartlist.msgChart"/></a> </b></TH>
        </tr>
        <%
            }
        %>
