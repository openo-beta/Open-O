    ...
    <table class="MainTable" id="scrollNumber1" name="encounterTable">
        ...
        <tr>
            <td class="MainTableLeftColumn" valign="top">
                ...
                <a style="text-decoration:none;" target="_blank" href="<%= request.getContextPath() %>/report/reportExport.jsp"><fmt:setBundle basename="oscarResources"/><fmt:message key="report.ClinicalReports.msgCSV"/></a>
                <%}%>
            ...
            <td valign="top" class="MainTableRightColumn">
                ...
                <div>
                    ...
                    <ul>
                        <li><fmt:setBundle basename="oscarResources"/><fmt:message key="report.ClinicalReports.msgNumerator"/>:   <%=Encode.forHtml(String.valueOf(request.getAttribute("numerator")))%>
                        </li>
                        <li><fmt:setBundle basename="oscarResources"/><fmt:message key="report.ClinicalReports.msgDenominator"/>: <%=Encode.forHtml(String.valueOf(request.getAttribute("denominator")))%>
                        </li>
                        <li><fmt:setBundle basename="oscarResources"/><fmt:message key="report.ClinicalReports.msgPercentage"/>:  <%=Encode.forHtml(String.valueOf(request.getAttribute("percentage")))%> %
                        </li>
                    </ul>
