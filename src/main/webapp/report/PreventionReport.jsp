...
<div ng-controller="preventionReport">
    <div class="page-header">
        <h4><fmt:message key="oscarprevention.index.oscarpreventiontitre"/> <small><a
    ...
    <div class="container-fluid" style="margin-left:15px;margin-right:15px;" ng-if="showManageReport">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="high" placeholder="age"
                           ng-show="newReport.ageStyle == 4" ng-model="newReport.age2">
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    as of : <input type="date" class="form-control" id="lower" ng-model="newReport.rosterAsOf"
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
				        <button class="btn btn-default" type="button"
                                ng-click="addExclusionCode(exCodeToAdd)">Add</button>
				      </span>
                </div>
                <ul>
                    <li ng-repeat="exCode in newReport.exclusionCodes">{{exCode}} <a
                            ng-click="deleteElement(newReport.exclusionCodes,$index)">-del-</a></li>
                </ul>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm-2">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
				        <button class="btn btn-default" type="button"
                                ng-click="addTrackingCode(trackingCodeToAdd)">Add</button>
				      </span>
                </div>
                <ul>
                    <li ng-repeat="code in newReport.trackingCodes">{{code}}<a
                            ng-click="deleteElement(newReport.trackingCodes,$index)">-del-</a></li>
                </ul>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <div class="col-sm-5"
                             ng-if="newPrevReport.dateCalcType == 1">   <%-- public final static int ASOFDATE = 1; --%>
                            <div class="col-sm-5">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" ng-model="newPrevReport.cutoffTimefromAsOfDate"
                                           class="form-control"/>
                                </div>
                            </div>
                            <%--
                        ...
                        <div class="col-sm-5"
                             ng-if="newPrevReport.dateCalcType == 2"> <%-- public final static int BYAGE = 2;  --%>
                            <div class="col-sm-12">
                                <div class="form-group">
        ...
        <ul>
            <li ng-repeat="preve in newReport.preventions">{{preventionSummary(preve)}} <a
                    ng-click="deleteElement(newReport.preventions,$index)">-del-</a></li>
        </ul>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <a class="pull-right" ng-click="editReport(selectedReport)"
                               ng-if="selectedReport != undefined">-edit-</a>&nbsp;
                            <a class="pull-right" ng-click="dectivateReport(selectedReport)"
                               ng-if="selectedReport != undefined">-deactivate-</a>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" ng-model="selectedProvider">
                                <option ng-repeat="provider in providers" value="{{provider.providerNo}}">
                                    {{provider.lastName}}, {{provider.firstName}} ({{provider.providerNo}})
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-1">
                        <button type="submit" class="btn btn-default"
                                ng-click="runReport(selectedReport,selectedProvider);">Submit
                        </button>
                    </div>
    ...
    <div class="container-fluid" style="margin-left:15px;margin-right:15px;">
        ...
        <table class="table table-bordered table-hover">
            <tr>
                ...
                <th>Up to date</th>
                <td>{{reportData.up2date}} =
                    {{getPercentage(reportData.totalPatients, reportData.ineligiblePatients, reportData.up2date) |
                    number:0}} %
                </td>
            ...
            <tr ng-repeat="line in reportData.items" class="{{getRowColor(line)}}">
                ...
                <td ng-if="reportData.active">
                    <a ng-if="line.nextSuggestedProcedure != '----'"
                       ng-click="openLetterScreen(line.nextSuggestedProcedure,line.demographicNo)">{{line.nextSuggestedProcedure}}</a>
                ...
                <td>
                    ...
                    <a ng-if="reportData.searchConfig.trackingCodes.length > 0"
                       ng-click="openBill(line.demographicNo,reportData.searchConfig.trackingCodes[0])">Track</a>
                    <a ng-if="reportData.searchConfig.exclusionCodes.length > 0"
                       ng-click="openBill(line.demographicNo,reportData.searchConfig.exclusionCodes[0])">Exclude</a>
                    <%--
                        <div class="btn-group">
        ...
        <div class="row">
            <div class="col-sm-3">
                Recall letters:
                <a ng-if="letter1.length > 0 && reportData.active" ng-click='openLetterScreen("L1",letter1)'>Send Letter
                    One</a>
                <a ng-if="letter2.length > 0 && reportData.active" ng-click='openLetterScreen("L1",letter2)'>Send Letter
                    Two</a>
            </div>
    ...
    app.controller("preventionReport", function ($scope, preventionReportService, $filter, $http) {
        ...
        $scope.openLetterScreen = function (followupType, demoarr) {
            ...
            if ("P1" === followupType) {
                ...
                var urlToOpen = "GenerateLetters.jsp?" + $.param({
                    demo: demoarr,
                    message: "Reminder Letter",
                    followupType: $scope.reportData.searchConfig.measurementTrackingType,
                    followupValue: followupType
                });
