    ...
    <form name='report'>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="95%">
            ...
            <tr>
                ...
                <td><a HREF="#"
                       onClick="popupPage(310,430,'<%= request.getContextPath() %>/share/CalendarPopup.jsp?urlfrom=<%= request.getContextPath() %>/report/reportindex.jsp&year=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.YEAR)))%>&month=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.MONTH)+1))%>&param=<%=Encode.forJavaScript(String.valueOf("&formdatebox=document.getElementsByName('startDate')[0].value"))%>')">
                ...
                <td><a HREF="#"
                       onClick="popupPage(310,430,'<%= request.getContextPath() %>/share/CalendarPopup.jsp?urlfrom=<%= request.getContextPath() %>/report/reportindex.jsp&year=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.YEAR)))%>&month=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.MONTH)+1))%>&param=<%=Encode.forJavaScript(String.valueOf("&formdatebox=document.getElementsByName('endDate')[0].value"))%>')">
            ...
            <tr>
                ...
                <td><a HREF="#"
                       onClick="popupPage(310,430,'<%= request.getContextPath() %>/share/CalendarPopup.jsp?urlfrom=<%= request.getContextPath() %>/report/reportindex.jsp&year=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.YEAR)))%>&month=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.MONTH)+1))%>&param=<%=Encode.forJavaScript(String.valueOf("&formdatebox=document.getElementsByName('asdate')[0].value"))%>')"><fmt:setBundle basename="oscarResources"/><fmt:message key="report.reportindex.formFrom"/></a> <input type='text' name="asdate"
                                                                       VALUE="<%=Encode.forHtmlAttribute(String.valueOf(today))%>" size=10></td>
                <td><a HREF="#"
                       onClick="popupPage(310,430,'<%= request.getContextPath() %>/share/CalendarPopup.jsp?urlfrom=<%= request.getContextPath() %>/report/reportindex.jsp&year=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.YEAR)))%>&month=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.MONTH)+1))%>&param=<%=Encode.forJavaScript(String.valueOf("&formdatebox=document.getElementsByName('aedate')[0].value"))%>')"><fmt:setBundle basename="oscarResources"/><fmt:message key="report.reportindex.formTo"/> </a> <input type='text' name="aedate"
                                                                      VALUE="<%=Encode.forHtmlAttribute(String.valueOf(today))%>" size=10></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    %> <fmt:setBundle basename="oscarResources"/><fmt:message key="report.reportindex.msgStart"/>: <input name="nsdate" type="input" size="8"
                        ...
                        HREF="#"
                        onClick="popupPage(310,430,'<%= request.getContextPath() %>/share/CalendarPopup.jsp?urlfrom=<%= request.getContextPath() %>/report/reportindex.jsp&year=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.YEAR)))%>&month=<%=Encode.forJavaScript(String.valueOf(now.get(Calendar.MONTH)+1))%>&param=<%=Encode.forJavaScript(String.valueOf("&formdatebox=document.getElementsByName('nsdate')[0].value"))%>')"><img
