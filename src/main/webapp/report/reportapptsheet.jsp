...
<head>
    ...
    <title><fmt:message key="report.reportapptsheet.title"/></title>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr bgcolor="#CCCCFF">
        <th align=CENTER NOWRAP><font face="Helvetica"><fmt:message key="report.reportapptsheet.title"/></font></th>
...
<table width="100%" border="1" bgcolor="#ffffff" cellspacing="1"
    ...
    <tr bgcolor="#CCCCFF" align="center">
        <TH width="20%"><b><a
                href="reportapptsheet.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&sdate=<%=Encode.forUriComponent(String.valueOf(sdate))%>&orderby=a.appointment_date"><fmt:message key="report.reportapptsheet.msgApptDate"/></a></b></TH>
        <TH width="20%"><b><a
                href="reportapptsheet.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&sdate=<%=Encode.forUriComponent(String.valueOf(sdate))%>&orderby=a.start_time"><fmt:message key="report.reportapptsheet.msgStartTime"/></a> </b></TH>
        <TH width="20%"><b><a
                href="reportapptsheet.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&sdate=<%=Encode.forUriComponent(String.valueOf(sdate))%>&orderby=a.end_time"><fmt:message key="report.reportapptsheet.msgEndTime"/></a> </b></TH>
        <TH width="10%"><b><a
                href="reportapptsheet.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&sdate=<%=Encode.forUriComponent(String.valueOf(sdate))%>&orderby=a.name"><fmt:message key="report.reportapptsheet.msgName"/></a></b></TH>
        <TH width="30%"><b><fmt:message key="report.reportapptsheet.msgComments"/></b></TH>
    </tr>
    <%
        }
    %>
