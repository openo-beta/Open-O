...
<html>
    <head>
        ...
        <title><fmt:message key="report.reportnoshowapptlist.title"/></title>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr bgcolor=<%=deepcolor%>>
            <th><font face="Helvetica"><fmt:message key="report.reportnoshowapptlist.msgTitle"/></font></th>
    ...
    <table width="100%" border="1" bgcolor="#ffffff" cellspacing="1" cellpadding="0">
        <tr bgcolor=<%=deepcolor%> align="center">
            <TH width="20%"><b><a
                    href="reportnoshowapptlist.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&sdate=<%=Encode.forUriComponent(String.valueOf(sdate))%>&orderby=appointment_date"><fmt:message key="report.reportapptsheet.msgApptDate"/></a></b></TH>
            <TH width="20%"><b><a
                    href="reportnoshowapptlist.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&sdate=<%=Encode.forUriComponent(String.valueOf(sdate))%>&orderby=start_time"><fmt:message key="report.reportapptsheet.msgStartTime"/></a> </b></TH>
            <TH width="20%"><b><a
                    href="reportnoshowapptlist.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&sdate=<%=Encode.forUriComponent(String.valueOf(sdate))%>&orderby=end_time"><fmt:message key="report.reportapptsheet.msgEndTime"/></a> </b></TH>
            <TH width="10%"><b><a
                    href="reportnoshowapptlist.jsp?provider_no=<%=Encode.forUriComponent(String.valueOf(provider_no))%>&sdate=<%=Encode.forUriComponent(String.valueOf(sdate))%>&orderby=name"><fmt:message key="report.reportapptsheet.msgName"/></a></b></TH>
        ...
        <tr bgcolor="<%=bodd?weakcolor:"white"%>">
            ...
            <td>&nbsp;<fmt:message key="report.reportnoshowapptlist.msgNoShow"/></td>
        </tr>
        <%
                }
            }
