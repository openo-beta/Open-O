...
<form method="post" id="ocanForm" action="../OcanReporting.do">
        ...
        <tr>
            ...
            <td>
                <select name="client" id="client" onChange="selectClient();">
                    ...
                    %>
                    <option value="<%=d.getDemographicNo()%>"><%=d.getFormattedName() %>
                    </option>
                    <% } %>
                </select>
            </td>
    ...
    <table class="borderedTableAndCells" id="assessment_table" style="display:none;">
        <tr>
            <td colspan="2">Select Assessments</td>
        </tr>
    </table>
    ...
    <table class="borderedTableAndCells" id="domains_table" style="display:none;">
        ...
        <tr>
            <td><input type="checkbox" name="domains_all" id="domains_all" value="domains_all"
                       onChange="toggleDomains();"/></td>
            <td colspan="5">Select All</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="domains" value="1;Accommodation"/></td>
            <td>Accommodation</td>
            <td><input type="checkbox" name="domains" value="9;Psychological Distress"/></td>
            <td>Psychological Distress</td>
            <td><input type="checkbox" name="domains" value="17;Sexual Expression"/></td>
            <td>Sexual Expression</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="domains" value="2;Food"/></td>
            <td>Food</td>
            <td><input type="checkbox" name="domains" value="10;Safety to Self"/></td>
            <td>Safety to Self</td>
            <td><input type="checkbox" name="domains" value="18;Child Care"/></td>
            <td>Child Care</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="domains" value="3;Looking After The Home"/></td>
            <td>Looking after the home</td>
            <td><input type="checkbox" name="domains" value="11;Safety to Others"/></td>
            <td>Safety to Others</td>
            <td><input type="checkbox" name="domains" value="19;Other Dependents"/></td>
            <td>Other Dependents</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="domains" value="4;Self-Care"/></td>
            <td>Self-Care</td>
            <td><input type="checkbox" name="domains" value="12;Alcohol"/></td>
            <td>Alcohol</td>
            <td><input type="checkbox" name="domains" value="20;Basic Education"/></td>
            <td>Basic Education</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="domains" value="5;Daytime Activities"/></td>
            <td>Daytime Activities</td>
            <td><input type="checkbox" name="domains" value="13;Drugs"/></td>
            <td>Drugs</td>
            <td><input type="checkbox" name="domains" value="21;Telephone"/></td>
            <td>Telephone</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="domains" value="6;Physical Health"/></td>
            <td>Physical Health</td>
            <td><input type="checkbox" name="domains" value="14;Other Addictions"/></td>
            <td>Other Addictions</td>
            <td><input type="checkbox" name="domains" value="22;Transport"/></td>
            <td>Transport</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="domains" value="7;Psychotic Symptoms"/></td>
            <td>Psychotic Symptoms</td>
            <td><input type="checkbox" name="domains" value="15;Company"/></td>
            <td>Company</td>
            <td><input type="checkbox" name="domains" value="23;Money"/></td>
            <td>Money</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="domains" value="8;Info on Condition and Treatment"/></td>
            <td>Info on Condition and Treatment</td>
            <td><input type="checkbox" name="domains" value="16;Intimate Relationships"/></td>
            <td>Intimate Relationships</td>
            <td><input type="checkbox" name="domains" value="24;Benefits"/></td>
            <td>Benefits</td>
        </tr>
    ...
    <table id="generate_ind_need_table" style="display:none;">
        <tr>
            <td colspan="2"><input type="button" onClick="generateIndividualNeedRatingOverTimeReport()"
                                   value="Generate Individual Need Rating over Time Report"/></td>
        </tr>
    </table>
    <table id="generate_need_table" style="display:none;">
        <tr>
            <td colspan="2"><input type="button" onClick="generateNeedRatingOverTimeReport()"
                                   value="Generate Need Rating over Time Report"/></td>
        </tr>
    </table>
    <table id="generate_summary_table" style="display:none;">
        <tr>
            <td colspan="2"><input type="button" onClick="generateSummaryOfActionsAndCommentsReport()"
                                   value="Generate Summary of Actions and Comments Report"/></td>
        </tr>
    </table>
</form>
</body>
