        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select id="functionalCentreId" name="functionalCentreId" class="input-large">
                    ...
                    %>
                    <option value="<%=Encode.forHtmlAttribute(String.valueOf(functionalCentre.getAccountId()))%>"><%=Encode.forHtml(String.valueOf(functionalCentre.getAccountId() + ", " + functionalCentre.getDescription()))%>
                    </option>
                    <%
                        }
                    %>
        ...
        <div id="providerOptions" class="control-group">
            ...
            <div class="controls">
                <select name="providerIds" class="input-medium" multiple="multiple">
                    ...
                    %>
                    <option value="<%=Encode.forHtmlAttribute(String.valueOf(provider.getProviderNo()))%>"><%=Encode.forHtml(provider.getFormattedName())%>
                    </option>
                    <%
                        }
                    %>
