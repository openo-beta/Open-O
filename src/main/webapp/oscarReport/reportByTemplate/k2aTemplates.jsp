...
%>
<security:oscarSec roleName="<%=roleName2$%>" objectName="_report,_admin.reporting,_admin" rights="w"
                   reverse="<%=true%>">
    <%authed2 = false; %>
...
<div ng-controller="k2aReportByTemplate">
    <div data-ng-hide="k2aActive">
        A K2A instance is unavailable for this OSCAR instance. Please authenticate a K2A instance or contact an
        ...
        <table class="table table-condensed table-striped" id="k2aReportTbl" datatable="ng" dt-options="dtOptions">
            ...
            <tr ng-repeat-start="k2aReport in k2aReports">
                ...
                <td>{{k2aReport.name}} <a ng-if="k2aReport.postVersions" data-toggle="collapse"
                                          data-target="#k2aReport{{k2aReport.id}}" class="accordion-toggle">+</a></td>
