...
<%@ page
        import="org.apache.commons.lang.StringUtils,org.apache.commons.lang.StringEscapeUtils,java.util.*,oscar.util.*,oscar.oscarReport.data.*,oscar.oscarDB.*,java.sql.*,oscar.oscarDemographic.data.*,oscar.eform.*,org.oscarehr.common.model.Provider,ca.openosp.openo.managers.ProviderManager2,org.oscarehr.util.SpringUtils" %>
...
<table border="1">
    ...
    <tr style="background-color:gainsboro;">
        <td>Other type of move that resulted in Single person moving from homelessness to housing (temporary or
            permanent)
        </td>
