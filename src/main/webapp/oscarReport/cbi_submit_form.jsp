...
<script>
    ...
    function submitPending() {
        ...
        jQuery.ajax({
            url: ctx + "/CbiSubmit.do?method=submit", dataType: "html", success: function (data) {
...
<form method="post" id="cbiForm" action="cbi_submit_action.jsp">
    ...
    <table class="borderedTableAndCells">
        ...
        <tr>
            ...
            <td><%=formatter.format(form.getCreated())%>
            </td>
            <td><%=form.getClientId() %>
            </td>
        ...
        <%} %>
        <tr>
            <td><input type="checkbox" name="checkAll" id="checkAll"/>All</td>
    </table>
    <br/>
