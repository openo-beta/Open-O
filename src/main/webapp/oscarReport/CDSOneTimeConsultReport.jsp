            ...
            <form action="CDSOneTimeConsultReport.jsp">
                <fieldset>
                    ...
                    <label>Start Date:</label> <input type="text" size="9" id="startDate" name="startDate"
                                                      value="<%=Encode.forHtmlAttribute(String.valueOf(startStr))%>"/>
                    ...
                    <label>Form Id:</label><input type="text" size="3" name="formId" value="<%=Encode.forHtmlAttribute(String.valueOf(formId))%>"/>
                    <br><br>
...
<table width="60%" border="1">
    ...
    <tr>
        ...
        <td><%=Encode.forHtml(String.valueOf(count[1]))%>
        </td>
    </tr>
    <tr>
        <td>008-02</td>
