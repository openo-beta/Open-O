...
<%
	...
	boolean authed = true;
%>
<security:oscarSec roleName="<%=roleName$%>" objectName="_dxresearch"
...
<table>
	<tr>
		...
		<td>
			<table>
				<tr>
					<td colspan="2"><b><%=qlBean.getQuickListName()%></b> <%=list.isEmpty() ? "<p><i>All items already in patient's Dx</i></p>" : ""%>
					</td>
				</tr>
				<%
