    ...
    <div class="table-responsive">
        ...
        <div class="col-sm-12">
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        <input type="submit" class="btn btn-primary"
                               value="<%=existingCategory != null ? "Save" : "Add" %>"/>
                    </div>
                </fieldset>
            </form>
            <hr/>
            <table id="tblCategory" class="table table-striped table-hover table-condensed">
                ...
                %>
                <tr>
                    <td><a href="<%=request.getContextPath()%>/hospitalReportManager/hrm_categories_action.jsp?action=delete&id=<%=category.getId()%>"><img
                            src="<%=request.getContextPath()%>/images/icons/101.png" alt="alert"></a></td>
                    <td><a href="<%=request.getContextPath()%>/hospitalReportManager/hrmCategories.jsp?id=<%=category.getId()%>"><%=category.getId()%>
                    </a></td>
