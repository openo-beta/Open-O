                ...
                <div class="col-sm-12">
                    <table style="width:50%;">
                        <tr>
                            ...
                            <td>
                                <select id="providerNo" name="providerNo" class="form-control">
                                    ...
                                    %>
                                    <option value="<%=Encode.forHtmlAttribute(String.valueOf(p.getProviderNo()))%>" <%=Encode.forHtml(String.valueOf(selected))%>><%=Encode.forHtml(String.valueOf(p.getFormattedName()))%>
                                    </option>
                                    <% } %>
                                </select>
                            </td>
                        ...
                        <tr>
                            <td><b>Display</b>:</td>
                            <td colspan="3">
                                <input type="checkbox" name="showAddlPatientInfo" id="showAddlPatientInfo"/>Additional
                                Patient Information &nbsp;&nbsp;
