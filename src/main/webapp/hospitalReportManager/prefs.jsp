                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <textarea class="form-control" id="confidentialityStatement" rows="10"
                                ...
                                <tr>
                                    <td>
                                        <input type="button" value="Save" class="btn btn-primary" id="saveBtn"
                                               onClick="saveConfidentialityStatement()"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="button"
                                   value="I don't want to receive any more HRM outtage messages for this outtage instance"
                                   class="btn btn-default" id="saveBtn2" onClick="addToOutageList()"/>
