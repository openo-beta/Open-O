...
<%@page import="org.jdom2.Element,oscar.oscarEncounter.oscarMeasurements.data.*,org.jdom2.output.Format,org.jdom2.output.XMLOutputter,oscar.oscarEncounter.oscarMeasurements.util.*" %>
