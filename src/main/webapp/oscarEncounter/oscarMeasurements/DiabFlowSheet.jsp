...
<head>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath() %>/share/javascript/jquery/jquery.sparkline.js"></script>

    <script type="text/javascript">
        $(function () {
            $('.inlinesparkline').sparkline('html', {width: "42px"});

            $('.checkmarksparkline').sparkline('html', {
                type: "line",
                lineColor: "#0f0",
                fillColor: "",
                spotRadius: "0",
        ...
        <tr>
            ...
            <td>
                <div class="highlightBox">
                    ...
                    <div id="highlightSliderLengthBox"><strong>Highlight:</strong> <span
        ...
        <tr class="dataRow <%=currentSection%>">
            ...
            <td class="inputData">
                ...
                <input type="text" id="<%=name%>" name="<%=name%>" size="14"
                       ...
                       onDblClick="wtEnglish2Metric(this); calcBMI();"<%}%>
                        <% if (name.equals("Height")) { %>
                       title="Double click to automatically convert from feet and inches to cm"
                       onDblClick="htEnglish2Metric(this); calcBMI();"<%}%>
                        <% if (name.equals("BMI")) { %>
