...
<html>
    <head>
        ...
        <script language="javascript">
            function edit(nodeName) {
                window.open('<%= request.getContextPath() %>/oscarEncounter/immunization/ScheduleEdit.jsp/ScheduleEdit.jsp?node=' + nodeName);
            }
    ...
    <form name="schedule">
        ...
        String genCell(String id, Element cell) {
            ...
            s += "<span style='width:100%; text-align:right'><a href=\"javascript:edit('" + id + "');\"><img border=0 src=\"" + request.getContextPath() + "/oscarEncounter/immunization/img/edit.gif" /></a></span>";
