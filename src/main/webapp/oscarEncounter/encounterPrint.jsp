...
<% } %>
    ...
    <table cellpadding="0" cellspacing="0"
		...
		<span style="font-weight: bold;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.encounterPrint.msgDr"/>. <%=Encode.forHtml(String.valueOf(providerBean.getProperty(bean.familyDoctorNo, "")))%></span>
            </td>
        </tr>
        <tr>
            <td colspan=2
