                        ...
                        <%
                            ...
                            for (int idx = 0; idx < privatedocs.size(); ++idx) {
                                ...
                                url = request.getContextPath() + "/documentManager/"
                                        + "/ManageDocument.do?method=display&documentId=" + curDoc.getDocId() + "&documentDescription=" + curDoc.getDescription() + "&demog=" + curDoc.getModuleId() + (curDoc.getModule().equals("demographic")  ? "&demoName=" + EDocUtil.getDemographicName(loggedInInfo, curDoc.getModuleId()) : "&demoName=" + EDocUtil.getProviderName(curDoc.getModuleId())) + "&docType=" + curDoc.getType() + "&observationDate=" + curDoc.getObservationDate() + "&providerNo=" + user_no + "&status=" + curDoc.getStatus()
                                String onClick = "";
