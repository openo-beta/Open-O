...
////
            ...
            //function sign(){
            //        document.encForm.enTextarea.value =document.encForm.enTextarea.value +"\n[<fmt:message key="oscarEncounter.Index.signed"/> <%=dateConvert.DateToString(bean.currentDate)%> <fmt:message key="oscarEncounter.Index.by"/> <%=bean.userName%>]";
            //}
...
<% } %>
                    ...
                    <tr>
                        <td>
                            <a
                                    ...
                                    onClick="popup(700,1000,'<%= request.getContextPath() %>/demographic/demographiccontrol.jsp?demographic_no=<%=bean.demographicNo%>&displaymode=edit&dboperation=search_detail','master')"
                            ...
                            <!--a href=# onClick='onUnbilled("<%= request.getContextPath() %>/billing/billingDeleteWithoutNo.jsp?appointment_no=<%=bean.appointmentNo%>");return false;' title="<fmt:message key="global.unbil"/>">-<fmt:message key="global.billing"/></a-->
                            <a href=#
                               onClick='onUnbilled("<%= request.getContextPath() %>/billing/CA/<%=province%>/billingDeleteWithoutNo.jsp?status=<%=bean.status%>&appointment_no=<%=bean.appointmentNo%>");return false;'
                               title="<fmt:message key="global.unbil"/>">-<fmt:message key="global.billing"/></a> <% } %> <br>
                            <a href=#
                               onClick="popupOscarRx(700,1027,'<%=request.getContextPath()%>/oscarRx/choosePatient.do?providerNo=<%=bean.providerNo%>&demographicNo=<%=bean.demographicNo%>');return false;"><fmt:message key="global.prescriptions"/></a><br>
                            <a href=#
                               onClick="popupOscarCon(700,960,'<rewrite:reWrite
                                       jspPage="oscarConsultationRequest/DisplayDemographicConsultationRequests.jsp"/>?de=<%=bean.demographicNo%>');return false;"><fmt:message key="global.consultations"/></a><br>
                            ...
                            <a
                                    href="javascript:popUpImmunizations(700,960,'<%= request.getContextPath() %>/oscarPrevention/index.jsp?demographic_no=<%=bean.demographicNo%>')">
                        ...
                        <tr>
                            <td><select name="selectForm"
                                        ...
                                        onMouseOver="javascript:window.status='
                                            <fmt:message key="oscarEncounter.Index.createForm"/> <%=patientName%>.'; return true;">
                    ...
                    <form name="msgForm">
                        ...
                        <tr>
                         ...
                         %>
                                ...
                                <option value="<%=j%>"><%=msgSubject + " - " + msgDate %>
                                </option>
                                <% }%>
                            </select></td>
            </td>
        ...
        <form name="insertTemplateForm"><caisi:isModuleLoad
            ...
            <tr>
                <td><select name="templateSelect" class="ControlSelect"
                    ...
                    <option value="<%=encounterTmp%>"><%=encounterTmp %>
                    </option>
                    <% }%>
                </select></td>
            </tr>
    ...
    <table class="LeftTable">
        ...
        <tr>
            <td>
                ...
                %> <a
                    href="javascript: function myFunction() {return false; }"
                    onClick="popup(700,1000,'oscarMeasurements/TemplateFlowSheet.jsp?demographic_no=<%=bean.demographicNo%>&template=<%=flowsheetName%>','flowsheet')"><%=MeasurementTemplateFlowSheetConfig.getInstance().getDisplayName(flowsheetName)%>
            </a>
                <%}%>
    ...
    <table class="LeftTable">
        ...
        <tr>
            <td><a href="#"
                ...
                <a href="#"
                   onClick="popupPage(710,970,'<%= request.getContextPath() %>/documentManager/documentReport.jsp?function=demographic&doctype=lab&functionid=<%=bean.demographicNo%>&curUser=<%=bean.curProviderNo%>');return false;"><fmt:message key="oscarEncounter.Index.msgDocuments"/></a><br>
                <a href="#"
                   onClick="popupPage(500,950, '<%= request.getContextPath() %>/eform/efmpatientformlist.jsp?demographic_no=<%=bean.demographicNo%>');return false;"><fmt:message key="global.eForms"/></a><br>
                <a href="#"
                   onClick="popupPage(700,1000, '<%= request.getContextPath() %>/tickler/ticklerMain.jsp?demoview=<%=bean.demographicNo%>');return false;"><fmt:message key="global.viewTickler"/></a><br>
                <a href="javascript: function myFunction() {return false; }"
                   onClick="popupPage(150,200,'calculators.jsp?sex=<%=bean.patientSex%>&age=<%=pAge%>'); return false;"><fmt:message key="oscarEncounter.Index.calculators"/></a><br>
                ...
                <select name="selectCurrentForms"
                    ...
                    <option
                        ...
                        <%=result.getDateTime()%> <%=result.getDiscipline()%>
                    </option>
                    <% } else {%>
                    <option
    ...
    <table class="LeftTable">
        <form name="ksearch"><caisi:isModuleLoad moduleName="caisi">
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.Index.searchFor"/><%= request.getParameter("userName")%>
                </td>
            </tr>
            <tr>
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <div class="RowTop"><a href=#
                                                           onClick="popupOscarRx(700,960,'<%=request.getContextPath()%>/oscarRx/showAllergy.do?demographicNo=<%=bean.demographicNo%>');return false;"><fmt:message key="global.allergies"/></a>:&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;
                                    </div>
                                    ...
                                    <table width="100%" cellpadding=0 cellspacing=0 border="0">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="RowTop">
                                                    <div class="RowTop"><a href=#
                                                                           onClick="popupOscarRx(700,1027,'<%=request.getContextPath()%>/oscarRx/choosePatient.do?providerNo=<%=bean.providerNo%>&demographicNo=<%=bean.demographicNo%>');return false;"><fmt:message key="global.prescriptions"/></a></div>
                                                </div>
                                            </td>
                                            <td align=right>
                                                <div
                                ...
                                <td nowrap>
                                    <table border="0" cellpadding="0" cellspacing="0" width='100%'>
                                        <tr>
                                            <td width='75%'>
                                                <div class="RowTop"><a href=#
                                                                       onClick="popupPage2('<%= request.getContextPath() %>/report/reportecharthistory.jsp?demographic_no=<%=bean.demographicNo%>');return false;">
                                                    <fmt:message key="global.encounter"/>: <%=bean.patientLastName %>,
