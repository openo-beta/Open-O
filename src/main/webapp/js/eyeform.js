...
function saveEyeform(fn, signAndExit, bill, closeForm) {
    ...
    saveInterval = setInterval(function () {
        afterSave(fn, signAndExit, bill, closeForm);
    }, 1000);
}
...
$(document).ready(function () {
     ...
     */
    Calendar.setup({
        inputField: "specs.dateStr",
        ifFormat: "%Y-%m-%d",
        showsTime: false,
        button: "specs.dateCalBtn",
        singleClick: true,
        step: 1
    });
    Calendar.setup({
        inputField: "newProcedureDate",
        ifFormat: "%Y-%m-%d",
        showsTime: false,
        button: "proc.dateCalBtn",
        singleClick: true,
        step: 1
    });
    Calendar.setup({
