jQuery(document).ajaxError(function (event, request, options, error) {
    /*
    * Ignoring any alert messages generated because of '/oscar/webserv/rs/ocean/getSettings' endpoint.
    ...
    * When a user opens the consultation request form, Ocean's dynamically added script invokes the '/oscar/webserv/rs/ocean/getSettings' endpoint.
