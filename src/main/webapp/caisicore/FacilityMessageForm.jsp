...
<form action="${pageContext.request.contextPath}/FacilityMessage.do" method="post">
    ...
    <table width="60%" border="0" cellpadding="0" cellspacing="1"
        ...
        <tr>
            ...
            %> <a href="#"
                  onClick="openBrWindow('calendar/oscarCalendarPopup.jsp?type=caisi&openerForm=facilityMessageForm&amp;openerElement=facility_message.expiry_day&amp;year=<%=Encode.forJavaScript(String.valueOf(year))%>&amp;month=<%=Encode.forJavaScript(String.valueOf(month))%>','','width=300,height=300')"><img
