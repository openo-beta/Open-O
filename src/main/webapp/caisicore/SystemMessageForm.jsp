...
<form action="<%=request.getContextPath() %>/SystemMessage.do" onsubmit="return validateRequiredFieldByName('system_message.message', 'Message', 4000);">
    ...
    <table width="60%" border="0" cellpadding="0" cellspacing="1"
        ...
        <tr>
            ...
            %> <a href="#"
                  onClick="openBrWindow('calendar/oscarCalendarPopup.jsp?type=caisi&openerForm=systemMessageForm&amp;openerElement=system_message.expiry_day&amp;year=<%=Encode.forUriComponent(String.valueOf(year))%>&amp;month=<%=Encode.forUriComponent(String.valueOf(month))%>','','width=300,height=300')"><img
