		...
		<div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <div class="input-group">
							<input name="serviceDate" id="datePickerServiceDate" type="text" class="date-picker form-control required" required="true"/>
			...
			<div class="col-xs-6">
			    <div class="form-group">
                    ...
                    <div class="controls">
                        <div class="input-group">
                            <input type="text" name="serviceTime" id="ticklerTime" class="time-picker form-control required" required="true"/>
					...
					<div class="input-group-btn">
					    ...
					    <ul class="dropdown-menu" style="height:300px;overflow-y:scroll;">
					        <c:forEach items="${ textSuggestions }" var="textSuggestion" >
					            <li>
					            <a class="select-tickler-message" href="#"><c:out value="${ textSuggestion.suggestedText }" /></a>
					            </li>
					        </c:forEach>
					    </ul>
                    </div>
