...
<div>
    * You may select a maximum of 5 files at a time to upload to MC-EDT
    ...
    <table>
        <tr>
            <td>
                <button type="button" id="unSelUpload" class="noBorder blackBox flatLink font12 rightMargin5"
                        disabled="true">Un-Select All
                </button>
                <button type="button" id="submitUpload" class="noBorder blackBox flatLink font12 rightMargin5"
                        disabled="true" onclick="ShowSpin(true);return setForm(this,'uploadSubmitToMcedt');">Submit
                </button>
                <button type="button" id="deleteUpload" class="noBorder blackBox flatLink font12 rightMargin5"
                        disabled="true" onclick="return setForm(this,'deleteUpload');">Delete Selected
                </button>
