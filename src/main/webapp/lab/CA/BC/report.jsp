...
<form name="signForm" action="report.jsp" method="post">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td class="Text"><%=Encode.forHtml(String.valueOf(hl7pid.getPatientName()))%>
            </td>
            <td class="Text" align="right">DOB:</td>
            <td class="Text" width="100px"><%=Encode.forHtml(String.valueOf(ConversionUtils.toDateString(hl7pid.getDateOfBirth())))%>
            </td>
        </tr>
        <tr>
            <td class="Text">PHN:</td>
            <td class="Text"><%=Encode.forHtml(String.valueOf(hl7pid.getExternalId()))%>
            </td>
            <td class="Text" align="right">Age:</td>
            <td class="Text"><%=Encode.forHtml(String.valueOf(age))%>
            </td>
        </tr>
        <tr>
            <td class="Text"></td>
            ...
            <td class="Text"><%=Encode.forHtml(String.valueOf(hl7pid.getSex()))%>
            </td>
        </tr>
        <tr>
            <td class="Text">Address:</td>
            <td class="Text" colspan="3"><%=Encode.forHtml(String.valueOf(hl7pid.getPatientAddress().replaceAll("\\\\\\.br\\\\", " ")))%>
            </td>
        </tr>
        <tr>
            <td class="Text">Phone:</td>
            <td class="Text"><%=Encode.forHtml(String.valueOf(hl7pid.getHomeNumber()))%>
            </td>
            <td class="Text"></td>
            <td class="Text"></td>
        </tr>
        ...
        <tr>
            ...
            <td class="Text"
                colspan="3"><%=Encode.forHtml(String.valueOf(hl7obr.getFillerOrderNumber().substring(0, hl7obr.getFillerOrderNumber().indexOf("-", 3))))%>
            </td>
        </tr>
        <tr>
            <td class="Text">Ordered By:</td>
            <td class="Text"><%=Encode.forHtml(String.valueOf(hl7obr.getOrderingProvider().replaceAll("~", ",<br/>")))%>
            </td>
        ...
        <tr>
            ...
            <td class="Text"><%=Encode.forHtml(String.valueOf(hl7obr.getResultCopiesTo().replaceAll("~", ",<br/>")))%>
            </td>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td class="Section"
                colspan="7"><%=Encode.forHtml(String.valueOf(((hl7_obr.getDiagnosticServiceSectId() != null) ? hl7_obr.getDiagnosticServiceSectId() : "Other")))%>
            </td>
        </tr>
        <%
            }
        ...
        <tr>
            <td class="Text" colspan="3"><b>Service
                Id:</b><%=Encode.forHtml(String.valueOf(hl7_obr.getUniversalServiceId().substring(hl7_obr.getUniversalServiceId().indexOf(" "))))%>
            </td>
            ...
            <td class="Text" nowrap colspan="3"><b>Result
                Status:</b><%=Encode.forHtml(String.valueOf((hl7_obr.getResultStatus().equalsIgnoreCase("f") ? "Final" : "Pending")))%>
            </td>
        </tr>
        <tr>
            <td class="Text" valign="top">Note:</td>
            <td class="Text" colspan="6"><%=Encode.forHtml(String.valueOf(hl7_obx.getNote().replaceAll("\\\\\\.br\\\\", " ")))%>&nbsp;</td>
        </tr>
        <%
            }
        ...
        <tr>
            ...
            <td class="Text" nowrap class="<%=Encode.forHtmlAttribute(String.valueOf((other? "LightBG" : "WhiteBG")))%>"><%=Encode.forHtml(String.valueOf(hl7_obx.getUnits()))%>
            </td>
            <td class="Text" nowrap
                title="<%=Encode.forHtmlAttribute(String.valueOf(hl7_obx.getNote().replaceAll("\\\\\\.br\\\\", " ")))%>"
                class="<%=Encode.forHtmlAttribute(String.valueOf((other? "LightBG" : "WhiteBG")))%>"><%=Encode.forHtml(String.valueOf(((hl7_obx.getNote().length() < 20) ? hl7_obx.getNote() : hl7_obx.getNote().substring(0, 20)).replaceAll("\\\\\\.br\\\\", " ")))%>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            <td colspan="7"><textarea name="notes" rows="7"
                                      style="width: 100%;"><%=Encode.forHtml(String.valueOf(Misc.check(hl7_message.getNotes(), "")))%></textarea>
            </td>
        </tr>
        <tr class="LightBG">
