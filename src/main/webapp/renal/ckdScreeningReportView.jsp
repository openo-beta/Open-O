...
<html>
    ...
    <br/>
    <div class="info">This table includes the set of patients which the ORN CKD algorithm has flagged as candidates for
        CKD screening
    </div>
    <br/>
    <div id="demo">
        <table id="ckdTable" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
            ...
            <tr>
                ...
                <th style="text-align:center" title="Current or previous use of hypertensive medications">Medication
                </th>
