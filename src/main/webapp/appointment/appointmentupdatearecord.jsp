...
<%@ page import="java.sql.*, java.util.*, ca.openosp.*, ca.openosp.openo.util.*, ca.openosp.openo.commn.OtherIdManager" %>
...
<html>
    ...
    <center>
        ...
        <script LANGUAGE="JavaScript">
            ...
            %>
            popupPage(350, 750, 'printappointment.jsp?appointment_no=<%=Encode.forUriComponent(request.getParameter("appointment_no"))%>');
            <%}%>
            self.opener.refresh();
            self.close();
        </script>
