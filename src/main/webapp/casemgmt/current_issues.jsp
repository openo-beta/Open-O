    ...
    <c:forEach var="issue" items="${Issues}">
        ...
        <tr bgcolor="<%=bgcolor %>" align="center">
            ...
            %><span
                    ...
                    onclick="document.caseManagementViewForm.hideActiveIssue.value='false';document.caseManagementViewForm.method.value='addToDx';document.caseManagementViewForm.issue_code.value='
                        <c:out value="${issue.issueDisplay.code}"/>';document.caseManagementViewForm.submit(); return false;">+Dx</span>
                <%
                        }
                    }
                %>
