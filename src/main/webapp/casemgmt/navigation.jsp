    ...
    <table style="font:bold small-caps 10pt/12pt">
        <form name="navigationForm" method="get">
            ...
            <caisi:isModuleLoad moduleName="TORONTO_RFQ" reverse="true">
                ...
                <!-- allergies -->
                <!-- tr><td><a href="javascript:void(0)" onClick="popupPage('<%=bsurl%>/rx/ShowAllergies.jsp?providerNo=<%=bean.providerNo%>&demographicNo=<%=bean.demographicNo%>');return false;">Allergies</a></td></tr -->
