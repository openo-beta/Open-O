...
%>
<div>Abstract: <%=XmlUtils.getChildNodeTextContents(test, "Abstract")%>
</div>
<%}%>
...
<table>
    ...
    <tr>
        <td><%=getDis(XmlUtils.getChildNodeTextContents(rating, "DisciplineId"))%>
        </td>
        <td><%=writeStars(XmlUtils.getChildNodeTextContents(rating, "RelevanceAvg"))%>
        </td>
        <td><%=writeStars(XmlUtils.getChildNodeTextContents(rating, "Newsworthiness"))%>
        </td>
    </tr>
    <%}%>
</table>
...
<div><b>Comment from Doctor in: <%=getDis(XmlUtils.getChildNodeTextContents(comments, "DisciplineId"))%>
</b>
    <br>
