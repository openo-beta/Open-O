...
<table class="sample">
    ...
    <tr>
        <td>
            ...
            <span class="readmore"><a href="javascript:void(0);"
                                      onclick="callReplacementWebService('macplusdetail.jsp','id<%=counter%>','<%=URLEncoder.encode(sKey, "UTF-8") %>','<%=URLEncoder.encode(sEnc, "UTF-8") %>');">More</a></span>
