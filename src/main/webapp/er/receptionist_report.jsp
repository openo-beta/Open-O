...
<table width="100%" cellspacing="3" cellpadding="3">
    ...
    <tr>
        <td colspan="2"><a href="javascript:void(0);"
                           onclick="window.open('oscarPrevention/index.jsp?demographic_no=<c:out
                                   value="${demographicNo}"/>','prevention','width=600,height=600');return false;">Immunization
            Record</a></td>
    </tr>
    <tr>
        <td colspan="2"><input type="button" value="Print"
                               onclick="window.print()"/> &nbsp; <input type="button"
                                                                        ...
                                                                        onclick="location.href='provider/er_clerk.jsp'"/>
        </td>
    </tr>
</table>
