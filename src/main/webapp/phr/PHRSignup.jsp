                ...
                <form method="POST">
                    <fieldset>
                        <div class="form-group col-xs-10">
                            ...
                            <div class="controls">
                                <input class="form-control" name="comments" ng-model="newProvider.lastName"
                                       type="text"/> <br/>
                            </div>

                            <label>Email</label>
                            <div class="controls">
                                <input class="form-control" name="comments" ng-model="newProvider.email" type="text"/>
                                <br/>
                            </div>

                            <button type="button" class="btn btn-primary btn-block" ng-click="createPHRAccount()"
                                    ng-disabled="working">{{initButtonText}}
                            </button>
                        </div>
                    </fieldset>
                </form>
