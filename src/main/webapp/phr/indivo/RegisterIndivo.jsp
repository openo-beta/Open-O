...
<form style="form form-horizontal" action="<%= request.getContextPath() %>/phr/UserManagement.do" styleId="registrationForm" method="POST">
    ...
    <table class="table table-condensed table-striped">
        ...
        <tr>
            ...
            <td><%=RegistrationHelper.renderRelationshipSelect(session, "primary_relation_" + curProviderID)%>
            </td>
            <td align="center"><input type="checkbox" name="reverse_relation_<%=curProviderID%>"
                                      value="PATIENT" <%=RegistrationHelper.getCheckedStringWithValueString(session, "reverse_relation_"+curProviderID,"PATIENT")%> >
            </td>
            <%} else { %>
            <td>&nbsp</td>
            <td class="error">
        ...
        <tr>
            ...
            <td><%=RegistrationHelper.renderRelationshipSelect(session, "primary_relation_" + providerMyOscarId)%>
            </td>
            <td align="center"><input type="checkbox" name="reverse_relation_<%=providerMyOscarId%>"
                                      value="PATIENT" <%=RegistrationHelper.getCheckedStringWithValueString(session, "reverse_relation_"+providerMyOscarId,"PATIENT")%> >
            </td>
            <%} else { %>
            <td>&nbsp</td>
