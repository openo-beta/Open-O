...
<body>
<p>
<h3><%=LocaleUtils.getMessage(request, "WarningNotVerified")%>
</h3>
<h3><%=LocaleUtils.getMessage(request, "AreYouSureYouWantToSend")%>&nbsp;<%=LocaleUtils.getMessage(request, medicalDataType)%>&nbsp;<%=LocaleUtils.getMessage(request, "ToPHR")%>
    ?</h3>
<p>
