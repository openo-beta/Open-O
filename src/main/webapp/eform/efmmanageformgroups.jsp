...
<html>
    ...
    <div class="row-fluid">
        ...
        <div class="well span6">
            <h4><fmt:message key="eform.groups.contents"/>: <%=Encode.forHtml(String.valueOf(groupView))%>
            </h4>
        ...
        <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-header">
                ...
                <h3 id="myModalLabel"><fmt:message key="eform.groups.addToGroup"/> <%=Encode.forHtml(String.valueOf(groupView))%>
                </h3>
            </div>
