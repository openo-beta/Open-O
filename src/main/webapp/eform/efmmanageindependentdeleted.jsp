...
<p>View: <a href="<%=request.getContextPath()%>/eform/efmmanageindependent.jsp" class="contentLink"><bean:message key="eform.independent.btnCurrent"/></a> | <bean:message key="eform.independent.btnDeleted"/></p>
...
<tbody>
		...
		<tr bgcolor="<%=((i % 2) == 1)?"#F2F2F2":"white"%>">
			...
			<td align='center'>
				<a href="<%=request.getContextPath()%>/eform/unRemoveEForm.do?callpage=independent&fdid=<%=curform.get("fdid")%>" onClick="javascript: return confirm('Are you sure you want to restore this eform?');" class="contentLink"><bean:message key="global.btnRestore" /></a>
			</td>
		</tr>
		<%
			}
