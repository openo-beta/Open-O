...
<html>
    ...
    <head>
        ...
        <script type="text/javascript"
                src="<%=request.getContextPath()%>/library/DataTables/datatables.min.js"></script>
        <style>
            body {
    ...
    <%
        ...
        if (k2aApp == null) { %>
    <div>
        <p>A K2A instance is unavailable for this OSCAR instance. Please authenticate a K2A instance or contact an
            administrator for support.</p>
    </div>
    <% } else {
    ...
    <table class="table table-condensed table-striped" id="k2aEFormTbl">
        ...
        <tr>
            ...
            <td><%=eform.getString("creator")%>
            </td>
            <td><%=eform.getString("category")%>
            </td>
