                    ...
                    <div class="control-group">
                        <div class="input-group">
                            <span class="input-group-addon">Alias:</span> <input type="text"
                                                                                 class="form-control" name="form_alias"
                                                                                 id="form_alias" readonly
                                                                                 required/>
                        </div>
                    ...
                    <div class="control-group">
                        <div class="input-group">
                            <span class="input-group-addon">CN:</span> <input type="text"
                                                                              class="form-control"
                                                                              name="form_commonName"
                                                                              id="form_commonName" readonly required/>
                            <span
                    ...
                    <div class="control-group">
                        <div class="input-group">
                            <span class="input-group-addon">OU:</span> <input type="text"
                                                                              class="form-control"
                                                                              name="form_organizationalUnit"
                                                                              id="form_organizationalUnit" readonly
                                                                              required/> <span
                    ...
                    <div class="control-group">
                        <div class="input-group">
                            <span class="input-group-addon">O:</span> <input type="text"
                                                                             ...
                                                                             id="form_organization" readonly required/>
                            <span
                    ...
                    <div class="control-group">
                        <div class="input-group">
                            <span class="input-group-addon">L:</span> <input type="text"
                                                                             class="form-control" name="form_locality"
                                                                             id="form_locality"
                                                                             readonly required/> <span
                                class="input-group-addon">Locality</span>
                        </div>
                        <p class="help-block"></p>
                    </div>
                    <br/>
                    ...
                    <div class="control-group">
                        <div class="input-group">
                            <span class="input-group-addon">ST:</span> <input type="text"
                                                                              class="form-control" name="form_state"
                                                                              id="form_state" readonly
                                                                              required/> <span
                                class="input-group-addon">State/Province</span>
                        </div>
                        <p class="help-block"></p>
                    </div>
                    <br/>
                    ...
                    <div class="control-group">
                        <div class="input-group">
                            <span class="input-group-addon">C:</span> <input type="text"
                                                                             class="form-control" name="form_country"
                                                                             id="form_country"
                                                                             readonly required/> <span
                                class="input-group-addon">Country</span>
                        </div>
                        <p class="help-block"></p>
                    </div>
