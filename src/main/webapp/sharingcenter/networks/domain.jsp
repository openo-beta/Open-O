...
<div class="container" width="500px">
    ...
    <div id="statusPanel" class="panel panel-default">
        <div class="panel-body">
            <h3 class="panel-title">Status: <span
                    class="label <%= (sharingEnabled) ? "label-success" : "label-danger"%>">Sharing is <%= (sharingEnabled) ? "enabled" : "disabled"%></span>
            </h3>
        </div>
    </div>
    ...
    <form id="sharedomainform" action="ShareDomain.do" method="POST" role="form">
        ...
        <div id="sharingInfoPanel" class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><%= (sharingEnabled) ? "Sharing Key" : String.format("Share With %s", network.getName())%>
                </h3>
            </div>
            <div class="panel-body">
                <p><%= (sharingEnabled) ? "The following number is your OSCAR sharing key. Provide this number to your physician to enable sharing of your OSCAR information."
                        : String.format("To share patient information, enter your %s sharing key below (if available) and click 'Enable Sharing'", network.getName())%>
                </p>

                <div class="input-group">
                    <span class="input-group-addon">Sharing Key:</span>
                    <input id="sharingKey" name="sharingKey" type="text" class="form-control"
                           value="<%= (sharingKey != null) ? sharingKey : ""%>">
                    <span class="input-group-btn">
                                <% if (sharingEnabled) { %>
                                <button id="updateSharingKeyButton" type="submit" onClick="return false;"
                                        class="btn btn-primary">Update</button>
                                <% } else { %>
                                <button id="enableViaSharingKeyButton" type="submit" onClick="return false;"
                                        class="btn btn-primary">Enable Sharing</button>
                                <% } %>
                            </span>
                </div>
        ...
        <div id="registrationPanel" class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="input-group">
                    <button id="enableViaRegisterButton" type="submit" onClick="return false;"
                            class="btn btn-primary pull-right">Enable Sharing
                    </button>
                </div>
            </div>
        </div>
        ...
        <div id="registrationPanel" class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="input-group">
                    <button id="updatePatientButton" type="submit" onClick="return false;"
                            class="btn btn-primary pull-right">Update Demographic
                    </button>
                </div>
            </div>
        </div>
        ...
        <a href="#"><span class="glyphicon glyphicon-print"></span> Print Page</a>
        <button id="disableSharingButton" type="submit" onClick="return false;" class="btn btn-danger pull-right">
            Disable Sharing
        </button>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <h3 class="panel-title">Error: <span class="label label-danger">Unable to locate patient or network</span>
            </h3>
        </div>
    </div>
