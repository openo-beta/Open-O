...
<div class="container" width="500px">
    ...
    <div id="affinityDomainsPanel" class="panel panel-primary">
        ...
        <div class="panel-body">
            <p>The following is a list of healthcare networks (Affinity Domains) that the patient is able to share
                information with.</p>
            <ul id="affinityDomainList" class="list-group">
                ...
                <li class="list-group-item"><span
                        class="glyphicon <%= (sharingEnabled) ? "glyphicon-ok" : "glyphicon-remove"%>"></span> <a
                        href="domain.jsp?demographic_no=<%= demographic.getDemographicNo()%>&id=<%=domain.getId()%>"><%=domain.getName()%>
                </a></li>
