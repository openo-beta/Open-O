...
<div class="container">
    ...
    <form id="mappingform" action="${ctx}/sharingcenter/affinitydomain/DomainMappings.do" method="POST" role="form">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select id="site_facilityType" name="site_facilityType" class="form-control">
                                ...
                                <option value="<%= cv.getDisplayName()%>" <%= (siteMapping != null && siteMapping.getFacilityTypeCode() != null && cv.getDisplayName().equals(siteMapping.getFacilityTypeCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="site_practiceSetting" name="site_practiceSetting" class="form-control">
                                ...
                                <option value="<%= cv.getDisplayName()%>" <%= (siteMapping != null && siteMapping.getPracticeSettingCode() != null && cv.getDisplayName().equals(siteMapping.getPracticeSettingCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select id="edoc_typeCode" name="edoc_typeCode" class="form-control">
                                ...
                                <option value="<%= cv.getDisplayName()%>" <%= (eDocMapping != null && eDocMapping.getTypeCode() != null && cv.getDisplayName().equals(eDocMapping.getTypeCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="edoc_classCode" name="edoc_classCode" class="form-control">
                                ...
                                <option value="<%= cv.getDisplayName()%>" <%= (eDocMapping != null && eDocMapping.getClassCode() != null && cv.getDisplayName().equals(eDocMapping.getClassCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="edoc_formatCode" name="edoc_formatCode" class="form-control">
                                ...
                                <option value="<%= cv.getDisplayName()%>" <%= (eDocMapping != null && eDocMapping.getFormatCode() != null && cv.getDisplayName().equals(eDocMapping.getFormatCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="edoc_contentTypeCode" name="edoc_contentTypeCode" class="form-control">
                                ...
                                <option value="<%= cv.getDisplayName()%>" <%= (eDocMapping != null && eDocMapping.getContentTypeCode() != null && cv.getDisplayName().equals(eDocMapping.getContentTypeCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="edoc_folderCodeList" name="edoc_folderCodeList" class="form-control">
                                ...
                                <option value="<%= cv.getDisplayName()%>" <%= (eDocMapping != null && eDocMapping.getFolderCodeList() != null && cv.getDisplayName().equals(eDocMapping.getFolderCodeList().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select id="eform_typeCode" name="eform_typeCode" class="form-control">
                                <% for (CodeValueDataObject cv : typeCodes) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (eFormMapping != null && eFormMapping.getTypeCode() != null && cv.getDisplayName().equals(eFormMapping.getTypeCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="eform_classCode" name="eform_classCode" class="form-control">
                                <% for (CodeValueDataObject cv : classCodes) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (eFormMapping != null && eFormMapping.getClassCode() != null && cv.getDisplayName().equals(eFormMapping.getClassCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="eform_formatCode" name="eform_formatCode" class="form-control">
                                <% for (CodeValueDataObject cv : formatCodes) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (eFormMapping != null && eFormMapping.getFormatCode() != null && cv.getDisplayName().equals(eFormMapping.getFormatCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="eform_contentTypeCode" name="eform_contentTypeCode" class="form-control">
                                <% for (CodeValueDataObject cv : contentTypeCodes) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (eFormMapping != null && eFormMapping.getContentTypeCode() != null && cv.getDisplayName().equals(eFormMapping.getContentTypeCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="eform_folderCodeList" name="eform_folderCodeList" class="form-control">
                                <% for (CodeValueDataObject cv : folderCodeList) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (eFormMapping != null && eFormMapping.getFolderCodeList() != null && cv.getDisplayName().equals(eFormMapping.getFolderCodeList().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select id="misc_typeCode" name="misc_typeCode" class="form-control">
                                <% for (CodeValueDataObject cv : typeCodes) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (miscMapping != null && miscMapping.getTypeCode() != null && cv.getDisplayName().equals(miscMapping.getTypeCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="misc_classCode" name="misc_classCode" class="form-control">
                                <% for (CodeValueDataObject cv : classCodes) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (miscMapping != null && miscMapping.getClassCode() != null && cv.getDisplayName().equals(miscMapping.getClassCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="misc_formatCode" name="misc_formatCode" class="form-control">
                                <% for (CodeValueDataObject cv : formatCodes) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (miscMapping != null && miscMapping.getFormatCode() != null && cv.getDisplayName().equals(miscMapping.getFormatCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="misc_contentTypeCode" name="misc_contentTypeCode" class="form-control">
                                <% for (CodeValueDataObject cv : contentTypeCodes) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (miscMapping != null && miscMapping.getContentTypeCode() != null && cv.getDisplayName().equals(miscMapping.getContentTypeCode().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
                        ...
                        <td>
                            ...
                            <select id="misc_folderCodeList" name="misc_folderCodeList" class="form-control">
                                <% for (CodeValueDataObject cv : folderCodeList) {%>
                                <option value="<%= cv.getDisplayName()%>" <%= (miscMapping != null && miscMapping.getFolderCodeList() != null && cv.getDisplayName().equals(miscMapping.getFolderCodeList().getDisplayName())) ? "selected" : ""%>><%= cv.getDisplayName()%>
                                </option>
                                <% } %>
                            </select>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <h3 class="panel-title">Error: <span class="label label-danger">Problem with the affinity domain or there are no codes to display</span>
                </h3>
            </div>
        </div>
