        ...
        $(document).ready(function () {
            ...
            $("#sendButton").on("click", function () {
                ...
                $.each(selectedPolicies, function (index, value) {
                    ...
                    var consentData = {
                        "domain": $("#network_id").val(),
                        "patient": $("#demographic_no").val(),
                        "policy": value
                    };
...
<div class="container">
    ...
    <form id="documentexportform" action="DocumentExport.do" method="POST" role="form">
        ...
        <div id="documentExportPanel" class="panel panel-primary">
            ...
            <div class="panel-body">
                <p>You are about to share the following documents with the "<%= network.getName()%>" affinity
                    domain.</p>
                <table class="table">
                    <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong class="text-primary"><a href="#"
                                                            onclick="window.open('DocumentPreview.do?doc_type=<%=docSubType%>&doc_no=<%=documentsArray[i]%>&prov_no=<%=user_no%>', 'View Document: <%= documentsArray[i]%>', 'width=' + popupWidth + ', scrollbars=yes, height=' + popupHeight + ', top=' + popupTop + ', left=' + popupLeft);
                    ...
                    <tr>
                        <td><span class="glyphicon glyphicon-file"></span> Document:</td>
                        <td><strong class="text-primary"><a href="#"
                                                            onclick="window.open('DocumentPreview.do?doc_type=<%=docSubType%>&doc_no=<%=documentsArray[i]%>&prov_no=<%=user_no%>', 'View Document', 'width=' + popupWidth + ', scrollbars=yes, height=' + popupHeight + ', top=' + popupTop + ', left=' + popupLeft);
                                                                    return false;"><%= SharingCenterUtil.retrieveEdoc(documentsArray[i]).getDocdesc()%>
                        </a></strong></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><strong class="text-primary"><a href="#"
                                                            onclick="window.open('DocumentPreview.do?doc_type=<%=docSubType%>&doc_no=<%=documentsArray[i]%>&prov_no=<%=user_no%>', 'View Document', 'width=' + popupWidth + ', scrollbars=yes, height=' + popupHeight + ', top=' + popupTop + ', left=' + popupLeft);
                                                                    return false;"><%= SharingCenterUtil.retrieveEform(documentsArray[i]).getFormName()%>
                        </a></strong></td>
                    </tr>
                ...
                <p>Add document(s) to folder: <a href="#" id="newFolderLink" onclick="return false;" class="pull-right"><span
                        class="glyphicon glyphicon-plus"></span> new</a></p>
                ...
                <div class="input-group">
                    ...
                    <select id="folderSelect" name="folderSelect" class="form-control">
                        ...
                        <option value="<%= folder.getUniqueId()%>"><%= folder.getTitle()%>
                        </option>
                        <% } %>
                    </select>
                </div><!-- /input-group -->
                ...
                <div id="policyGroup" class="input-group">
                    ...
                    <select id="policySelect" name="policySelect" class="form-control multiselect" multiple="multiple">
                        ...
                        <option value="<%= policy.getId()%>"><%= policy.getDisplayName()%>
                        </option>
                        <% }%>
                    </select>
                </div><!-- init group -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-group">
                            ...
                            <input type="text" id="newFolderTitle" name="newFolderTitle" class="form-control"
                                   placeholder="Folder name"/>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" id="dismissFolderModalButton" name="dismissFolderModalButton"
                                class="btn btn-default" data-dismiss="modal">Close
                        </button>
                        <button type="button" id="addFolderButton" name="addFolderButton" class="btn btn-primary">Add
                        </button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="checkbox">
                            <label><input type="checkbox" id="consentGiven" name="consentGiven" value="yes"> I give
                                consent to the policy(ies) above</label>
                        </div>
                        <br/>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="<%= demographic.getDisplayName()%>"
                                       disabled/>
                            </div>
                            <br/>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control"
                                       placeholder="<%= String.format("%s, %s", provider.getLastName(), provider.getFirstName())%>"
                                       disabled/>
                            </div>
                            <br/>
                            ...
                            <div class="input-group">
                                ...
                                <select id="authenticatorSelect" name="authenticatorSelect" class="form-control">
                                    <option value="<%= demographic.getDemographicNo()%>"><%= demographic.getDisplayName()%>
                                    </option>
                                    <% for (Demographic decisionMaker : decisionMakers) {%>
                                    <option value="<%=decisionMaker.getDemographicNo()%>"><%= decisionMaker.getFullName()%>
                                    </option>
                                    <% } %>
                                </select>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" id="dismissConfirmationModalButton" name="dismissConfirmationModalButton"
                                class="btn btn-default" data-dismiss="modal">Cancel
                        </button>
                        <button type="button" id="confirmButton" name="confirmButton" class="btn btn-primary"
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <h3 class="panel-title">Error: <span
                        class="label label-danger">Unable to locate patient or network</span></h3>
            </div>
        </div>
