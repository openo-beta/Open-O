...
<body bgcolor="#c4e9f6" bgproperties="fixed" topmargin="0"
...
<table width="60%" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<input type="text" name="xml_dob" style="width: 100%" size="10"
			maxlength="10"
			<%=bNew?"value='"+dob+"'":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_dob"))+"\""%>>
		</td>
		<td width="8%">Age<br>
		<input type="text" name="xml_age" style="width: 100%" size="10"
			maxlength="10"
			<%=bNew?"value='"+age+"'":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_age"))+"\""%>>
		</td>
		<td width="25%" nowrap>Marital status <br>
		<input type="checkbox" name="xml_msm" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_msm"))%>>
		M <input type="checkbox" name="xml_mscl" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_mscl"))%>>
		CL <input type="checkbox" name="xml_mss" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_mss"))%>>
		S</td>
		<td>Education level <br>
		<input type="text" name="xml_el" size="15" style="width: 100%"
			maxlength="25"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_el"))+"\""%>>
		</td>
	</tr>
</table>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		<input type="text" name="xml_occp" size="15" style="width: 100%"
			maxlength="25"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_occp"))+"\""%>>
		</td>
		<td>Language<br>
		<input type="text" name="xml_lang" size="15" style="width: 100%"
			maxlength="25"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_lang"))+"\""%>>
		</td>
		<td>Home phone<br>
		<input type="text" name="xml_hp" size="15" style="width: 100%"
			maxlength="20"
			<%=bNew?"value='"+homephone+"'":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_hp"))+"\""%>>
		</td>
		<td>Work phone<br>
		<input type="text" name="xml_wp" size="15" style="width: 100%"
			maxlength="20"
			<%=bNew?"value='"+workphone+"'":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_wp"))+"\""%>>
		</td>
		<td>Name of partner<br>
		<input type="text" name="xml_nop" size="15" style="width: 100%"
			maxlength="50"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_nop"))+"\""%>>
		</td>
		<td>Age<br>
		<input type="text" name="xml_page" size="2" style="width: 100%"
			maxlength="2"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_page"))+"\""%>>
		</td>
		<td valign="top">Occupation<br>
		<input type="text" name="xml_poccp" size="15" style="width: 100%"
			maxlength="25"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_poccp"))+"\""%>>
		</td>
	</tr>
</table>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		<input type="checkbox" name="xml_baobs" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_baobs"))%>>OBS
		<input type="checkbox" name="xml_bafp" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_bafp"))%>>FP
		<input type="checkbox" name="xml_bam" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_bam"))%>>Midwife<br>
		...
		<div align="center"><textarea name="xml_fphy"
			...
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fphy"))+"\""%>></textarea></div>
		</td>
		<td nowrap>Newborn care<br>
		<input type="checkbox" name="xml_ncp" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_ncp"))%>>Ped.
		<input type="checkbox" name="xml_ncfp" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_ncfp"))%>>FP
		<input type="checkbox" name="xml_ncm" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_ncm"))%>>Midwife<br>
		...
		<div align="center"><textarea name="xml_ebmf"
			style="width: 100%" cols="30" rows="2"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_ebmf"))+"\""%>></textarea></div>
		</td>
	</tr>
</table>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		<td width="12%"><input type="checkbox" name="xml_vbac"
			value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_vbac"))%>>
		VBAC<br>
		<input type="checkbox" name="xml_rcs" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_rcs"))%>>
		Repeat CS<br>
		</td>
		...
		<div align="center"><textarea
			...
			rows="2"
			<%=bNewList?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_Alert_demographicaccessory"))+"\""%>><%=bNewList?allergies:""%></textarea>
		</div>
		</td>
		...
		<div align="center"><textarea
			...
			cols="30" rows="2"
			<%=bNewList?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_Medication_demographicaccessory"))+"\""%>><%=bNewList?medications:""%></textarea></div>
		</td>
	</tr>
</table>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="top" nowrap>Menstrual history (LMP): <input
			...
			<%=bNew?"value='yyyy/mm/dd'":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_lmp"))+"\""%>>
		&nbsp; &nbsp; &nbsp; Cycle <input type="text" name="xml_c" size="7"
			maxlength="7"
			<%=bNew?"value='  /  '":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_c"))+"\""%>>
		&nbsp; &nbsp; &nbsp; <input type="checkbox" name="xml_r"
			value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_r"))%>>
		Regular &nbsp; &nbsp; &nbsp; EDB <input type="text" name="xml_edb"
			size="10" maxlength="10"
			<%=bNew?"value='yyyy/mm/dd'":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_edb"))+"\""%>>
		<br>
		Contraception:<br>
		<input type="checkbox" name="xml_iud" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_iud"))%>>
		IUD <input type="checkbox" name="xml_ht" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_ht"))%>>
		Hormonal(type) <input type="text" name="xml_htt" size="15"
			maxlength="25"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_htt"))+"\""%>>
		<input type="checkbox" name="xml_oc" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oc"))%>>
		Other <input type="text" name="xml_ot" size="15" maxlength="25"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_ot"))+"\""%>>
		Last used <input type="text" name="xml_lu" size="10" maxlength="10"
			<%=bNew?"value='yyyy/mm/dd'":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_lu"))+"\""%>>
		</td>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		&nbsp; &nbsp; <input type="checkbox" name="xml_ecc" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_ecc"))%>>
		Ectopic <input type="text" name="xml_ect" size="2" maxlength="2"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_ect"))+"\""%>>
		&nbsp; &nbsp; <input type="checkbox" name="xml_tec" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_tec"))%>>
		Termination <input type="text" name="xml_tet" size="2" maxlength="2"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_tet"))+"\""%>>
		&nbsp; &nbsp; <input type="checkbox" name="xml_spc" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_spc"))%>>
		Spontaneous <input type="text" name="xml_spt" size="2" maxlength="2"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_spt"))+"\""%>>
		&nbsp; &nbsp; <input type="checkbox" name="xml_stc" value="checked"
			<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_stc"))%>>
		Stillborn <input type="text" name="xml_stt" size="2" maxlength="2"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_stt"))+"\""%>>
		</td>
		<td>Living<br>
		...
		No.<input type="text" name="xml_mul" size="5" style="width: 100%"
			maxlength="10"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_mul"))+"\""%>>
		</td>
	</tr>
</table>
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr align="center">
				...
				<td><input type="text" name="xml_oh1ye" size="5" maxlength="8"
					style="width: 90%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1ye"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh1se" size="1" maxlength="1"
					style="width: 50%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1se"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh1ge" size="3" maxlength="5"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1ge"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh1bi" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1bi"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh1le" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1le"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh1pl" size="8" maxlength="20"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1pl"))+"\""%>>
				</td>
				<td><input type="checkbox" name="xml_oh1sv" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1sv"))%>>
				<input type="checkbox" name="xml_oh1cs" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1cs"))%>>
				<input type="checkbox" name="xml_oh1as" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1as"))%>>
				</td>
				<td align="left"><input type="text" name="xml_oh1co" size="20"
					maxlength="80" style="width: 100%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh1co"))+"\""%>>
				</td>
			</tr>
			<tr align="center">
				<td>2</td>
				<td><input type="text" name="xml_oh2ye" size="5" maxlength="8"
					style="width: 90%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2ye"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh2se" size="1" maxlength="1"
					style="width: 50%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2se"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh2ge" size="3" maxlength="5"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2ge"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh2bi" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2bi"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh2le" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2le"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh2pl" size="8" maxlength="20"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2pl"))+"\""%>>
				</td>
				<td><input type="checkbox" name="xml_oh2sv" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2sv"))%>>
				<input type="checkbox" name="xml_oh2cs" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2cs"))%>>
				<input type="checkbox" name="xml_oh2as" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2as"))%>>
				</td>
				<td align="left"><input type="text" name="xml_oh2co" size="20"
					maxlength="80" style="width: 100%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh2co"))+"\""%>>
				</td>
			</tr>
			<tr align="center">
				<td>3</td>
				<td><input type="text" name="xml_oh3ye" size="5" maxlength="8"
					style="width: 90%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3ye"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh3se" size="1" maxlength="1"
					style="width: 50%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3se"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh3ge" size="3" maxlength="5"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3ge"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh3bi" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3bi"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh3le" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3le"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh3pl" size="8" maxlength="20"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3pl"))+"\""%>>
				</td>
				<td><input type="checkbox" name="xml_oh3sv" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3sv"))%>>
				<input type="checkbox" name="xml_oh3cs" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3cs"))%>>
				<input type="checkbox" name="xml_oh3as" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3as"))%>>
				</td>
				<td align="left"><input type="text" name="xml_oh3co" size="20"
					maxlength="80" style="width: 100%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh3co"))+"\""%>>
				</td>
			</tr>
			<tr align="center">
				<td>4</td>
				<td><input type="text" name="xml_oh4ye" size="5" maxlength="8"
					style="width: 90%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4ye"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh4se" size="1" maxlength="1"
					style="width: 50%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4se"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh4ge" size="3" maxlength="5"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4ge"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh4bi" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4bi"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh4le" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4le"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh4pl" size="8" maxlength="20"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4pl"))+"\""%>>
				</td>
				<td><input type="checkbox" name="xml_oh4sv" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4sv"))%>>
				<input type="checkbox" name="xml_oh4cs" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4cs"))%>>
				<input type="checkbox" name="xml_oh4as" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4as"))%>>
				</td>
				<td align="left"><input type="text" name="xml_oh4co" size="20"
					maxlength="80" style="width: 100%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh4co"))+"\""%>>
				</td>
			</tr>
			<tr align="center">
				<td>5</td>
				<td><input type="text" name="xml_oh5ye" size="5" maxlength="8"
					style="width: 90%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5ye"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh5se" size="1" maxlength="1"
					style="width: 50%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5se"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh5ge" size="3" maxlength="5"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5ge"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh5bi" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5bi"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh5le" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5le"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh5pl" size="8" maxlength="20"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5pl"))+"\""%>>
				</td>
				<td><input type="checkbox" name="xml_oh5sv" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5sv"))%>>
				<input type="checkbox" name="xml_oh5cs" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5cs"))%>>
				<input type="checkbox" name="xml_oh5as" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5as"))%>>
				</td>
				<td align="left"><input type="text" name="xml_oh5co" size="20"
					maxlength="80" style="width: 100%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh5co"))+"\""%>>
				</td>
			</tr>
			<tr align="center">
				<td>6</td>
				<td><input type="text" name="xml_oh6ye" size="5" maxlength="8"
					style="width: 90%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6ye"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh6se" size="1" maxlength="1"
					style="width: 50%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6se"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh6ge" size="3" maxlength="5"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6ge"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh6bi" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6bi"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh6le" size="5" maxlength="6"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6le"))+"\""%>>
				</td>
				<td><input type="text" name="xml_oh6pl" size="8" maxlength="20"
					style="width: 80%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6pl"))+"\""%>>
				</td>
				<td><input type="checkbox" name="xml_oh6sv" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6sv"))%>>
				<input type="checkbox" name="xml_oh6cs" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6cs"))%>>
				<input type="checkbox" name="xml_oh6as" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6as"))%>>
				</td>
				<td align="left"><input type="text" name="xml_oh6co" size="20"
					maxlength="80" style="width: 100%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_oh6co"))+"\""%>>
				</td>
			</tr>
		</table>
		</td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td width="15%"><input type="checkbox" name="xml_cp1b"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp1b")) %>>
				</td>
			</tr>
			<tr>
				<td>2.</td>
				...
				<td><input type="checkbox" name="xml_cp2v" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp2v")) %>>
				</td>
			</tr>
			<tr>
				<td valign="top">3.</td>
				...
				cig/day <input type="text" name="xml_cp3c" size="2" maxlength="3"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp3c"))+"\"" %>>
				</font></td>
				<td valign="bottom"><input type="checkbox" name="xml_cp3s"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp3s")) %>>
				</td>
			</tr>
			<tr>
				<td>4.</td>
				...
				<td><input type="checkbox" name="xml_cp4d" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp4d")) %>>
				</td>
			</tr>
			<tr>
				<td valign="top">5.</td>
				...
				drinks/day <font size=1> <input type="text" name="xml_cp5d"
					size="2" maxlength="3"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp5d"))+"\"" %>>
				</font></td>
				<td valign="bottom"><input type="checkbox" name="xml_cp5a"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp5a")) %>>
				</td>
			</tr>
			<tr>
				<td>6.</td>
				...
				<td><input type="checkbox" name="xml_cp6i" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp6i")) %>>
				</td>
			</tr>
			<tr>
				<td>7.</td>
				...
				<td><input type="checkbox" name="xml_cp7r" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp7r")) %>>
				</td>
			</tr>
			<tr>
				<td valign="top">8.</td>
				...
				<td><input type="checkbox" name="xml_cp8o" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cp8o")) %>>
				</td>
			</tr>
			<tr>
				<td colspan="3" nowrap>
			...
			<tr>
				...
				<td><input type="checkbox" name="xml_nafa" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_nafa")) %>>
				</td>
			</tr>
			<tr>
				<td colspan="2">Milk products</td>
				<td><input type="checkbox" name="xml_namp" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_namp")) %>>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="checkbox" name="xml_nadb" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_nadb")) %>>
				</td>
			</tr>
			<tr>
				<td colspan="2">&nbsp; &nbsp; &nbsp;Restricted</td>
				<td><input type="checkbox" name="xml_nadr" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_nadr")) %>>
				</td>
			</tr>
			<tr>
				<td colspan="2">Dietitian referral</td>
				<td><input type="checkbox" name="xml_nadref" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_nadref")) %>>
				</td>
			</tr>
		</table>
		</td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td><input type="checkbox" name="xml_m9hy" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m9hy")) %>>
				</td>
				<td><input type="checkbox" name="xml_m9hn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m9hn")) %>>
				</td>
			</tr>
			<tr>
				<td>10.</td>
				...
				<td><input type="checkbox" name="xml_m10ey" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m10ey")) %>>
				</td>
				<td><input type="checkbox" name="xml_m10en" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m10en")) %>>
				</td>
			</tr>
			<tr>
				<td>11.</td>
				...
				<td><input type="checkbox" name="xml_m11hy" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m11hy")) %>>
				</td>
				<td><input type="checkbox" name="xml_m11hn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m11hn")) %>>
				</td>
			</tr>
			<tr>
				<td>12.</td>
				...
				<td><input type="checkbox" name="xml_m12ry" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m12ry")) %>>
				</td>
				<td><input type="checkbox" name="xml_m12rn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m12rn")) %>>
				</td>
			</tr>
			<tr>
				<td>13.</td>
				...
				<td><input type="checkbox" name="xml_m13ry" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m13ry")) %>>
				</td>
				<td><input type="checkbox" name="xml_m13rn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m13rn")) %>>
				</td>
			</tr>
			<tr>
				<td>14.</td>
				...
				<td><input type="checkbox" name="xml_m14ly" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m14ly")) %>>
				</td>
				<td><input type="checkbox" name="xml_m14ln" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m14ln")) %>>
				</td>
			</tr>
			<tr>
				<td>15.</td>
				...
				<td><input type="checkbox" name="xml_m15ny" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m15ny")) %>>
				</td>
				<td><input type="checkbox" name="xml_m15nn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m15nn")) %>>
				</td>
			</tr>
			<tr>
				<td>16.</td>
				...
				<td><input type="checkbox" name="xml_m16ay" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m16ay")) %>>
				</td>
				<td><input type="checkbox" name="xml_m16an" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m16an")) %>>
				</td>
			</tr>
			<tr>
				<td>17.</td>
				...
				<td><input type="checkbox" name="xml_m17by" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m17by")) %>>
				</td>
				<td><input type="checkbox" name="xml_m17bn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m17bn")) %>>
				</td>
			</tr>
			<tr>
				<td>18.</td>
				...
				<td><input type="checkbox" name="xml_m18gy" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m18gy")) %>>
				</td>
				<td><input type="checkbox" name="xml_m18gn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m18gn")) %>>
				</td>
			</tr>
			<tr>
				<td>19.</td>
				...
				<td><input type="checkbox" name="xml_m19hy" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m19hy")) %>>
				</td>
				<td><input type="checkbox" name="xml_m19hn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m19hn")) %>>
				</td>
			</tr>
			<tr>
				<td>20.</td>
				...
				<td><input type="checkbox" name="xml_m20sy" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m20sy")) %>>
				</td>
				<td><input type="checkbox" name="xml_m20sn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m20sn")) %>>
				</td>
			</tr>
			<tr>
				<td>21.</td>
				...
				<td><input type="checkbox" name="xml_m21ay" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m21ay")) %>>
				</td>
				<td><input type="checkbox" name="xml_m21an" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m21an")) %>>
				</td>
			</tr>
			<tr>
				<td>22.</td>
				...
				<td><input type="checkbox" name="xml_m22hy" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m22hy")) %>>
				</td>
				<td><input type="checkbox" name="xml_m22hn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m22hn")) %>>
				</td>
			</tr>
			<tr>
				<td>23.</td>
				...
				<td><input type="checkbox" name="xml_m23vy" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m23vy")) %>>
				</td>
				<td><input type="checkbox" name="xml_m23vn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m23vn")) %>>
				</td>
			</tr>
			<tr>
				<td>24.</td>
				...
				<td><input type="checkbox" name="xml_m24py" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m24py")) %>>
				</td>
				<td><input type="checkbox" name="xml_m24pn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m24pn")) %>>
				</td>
			</tr>
			<tr>
				<td>25.</td>
				...
				<td><input type="checkbox" name="xml_m25oy" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m25oy")) %>>
				</td>
				<td><input type="checkbox" name="xml_m25on" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m25on")) %>>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><input type="text" name="xml_m25" size="15" maxlength="25"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_m25"))+"\"" %>>
				</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="15%" align="center"><input type="checkbox"
					name="xml_g26ay" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_g26ay")) %>>
				</td>
				<td width="15%" align="center"><input type="checkbox"
					name="xml_g26an" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_g26an")) %>>
				</td>
			</tr>
			<tr>
				<td valign="top">27.</td>
				...
				<td align="center" valign="top"><input type="checkbox"
					name="xml_g27ay" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_g27ay")) %>>
				</td>
				<td align="center" valign="top"><input type="checkbox"
					name="xml_g27an" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_g27an")) %>>
				</td>
			</tr>
			<tr>
				<td valign="top">28.</td>
				...
				<td align="center"><input type="checkbox" name="xml_g28ky"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_g28ky")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_g28kn"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_g28kn")) %>>
				</td>
			</tr>
			<tr>
				<td>29.</td>
				...
				<td align="center"><input type="checkbox" name="xml_g29py"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_g29py")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_g29pn"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_g29pn")) %>>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="center"><input type="checkbox" name="xml_fh30ny"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh30ny")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_fh30nn"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh30nn")) %>>
				</td>
			</tr>
			<tr>
				<td>31.</td>
				...
				<td align="center"><input type="checkbox" name="xml_fh31dy"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh31dy")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_fh31dn"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh31dn")) %>>
				</td>
			</tr>
			<tr>
				<td valign="top">32.</td>
				...
				<td align="center" valign="top"><input type="checkbox"
					...
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh32cy")) %>>
				</td>
				<td align="center" valign="top"><input type="checkbox"
					name="xml_fh32cn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh32cn")) %>>
				</td>
			</tr>
			<tr>
				<td>33.</td>
				...
				<td align="center"><input type="checkbox" name="xml_fh33cy"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh33cy")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_fh33cn"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh33cn")) %>>
				</td>
			</tr>
			<tr>
				<td valign="top">34.</td>
				...
				<td align="center"><input type="checkbox" name="xml_fh34cy"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh34cy")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_fh34cn"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh34cn")) %>>
				</td>
			</tr>
			<tr>
				<td valign="top">35.</td>
				...
				<td align="center" valign="top"><input type="checkbox"
					...
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh35gy")) %>>
				</td>
				<td align="center" valign="top"><input type="checkbox"
					name="xml_fh35gn" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh35gn")) %>>
				</td>
			</tr>
			<tr>
				<td>36.</td>
				...
				<td align="center"><input type="checkbox" name="xml_fh36fy"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh36fy")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_fh36fn"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh36fn")) %>>
				</td>
			</tr>
			<tr>
				<td>37.</td>
			...
			<tr>
				...
				<td align="center"><input type="checkbox" name="xml_fh37oy"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh37oy")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_fh37on"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh37on")) %>>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				...
				<td align="center"><input type="checkbox" name="xml_fh37ay"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh37ay")) %>>
				</td>
				<td align="center"><input type="checkbox" name="xml_fh37an"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_fh37an")) %>>
				</td>
			</tr>
		</table>
		</td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td><input type="checkbox" name="xml_idt38s" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_idt38s")) %>>
				</td>
			</tr>
			<tr>
				<td>39.</td>
				...
				<td><input type="checkbox" name="xml_idt39h" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_idt39h")) %>>
				</td>
			</tr>
			<tr>
				<td>40.</td>
				...
				<td><input type="checkbox" name="xml_idt40v" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_idt40v")) %>>
				</td>
			</tr>
			<tr>
				<td>41.</td>
				...
				<td><input type="checkbox" name="xml_idt41t" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_idt41t")) %>>
				</td>
			</tr>
			<tr>
				<td>42.</td>
				<td>TB/Other <input type="text" name="xml_idt42o" size="10"
					maxlength="20"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_idt42o"))+"\"" %>>
				</td>
				<td><input type="checkbox" name="xml_idt42t" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_idt42t")) %>>
				</td>
			</tr>
			<tr>
				<td colspan="3">
			...
			<tr>
				...
				<td><input type="checkbox" name="xml_pdt43s" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_pdt43s")) %>>
				</td>
			</tr>
			<tr>
				<td>44.</td>
				...
				<td><input type="checkbox" name="xml_pdt44c" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_pdt44c")) %>>
				</td>
			</tr>
			<tr>
				<td>45.</td>
				...
				<td><input type="checkbox" name="xml_pdt45e" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_pdt45e")) %>>
				</td>
			</tr>
			<tr>
				<td>46.</td>
				...
				<td><input type="checkbox" name="xml_pdt46s" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_pdt46s")) %>>
				</td>
			</tr>
			<tr>
				<td>47.</td>
				...
				<td><input type="checkbox" name="xml_pdt47f" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_pdt47f")) %>>
				</td>
			</tr>
			<tr>
				<td>48.</td>
				...
				<td><input type="checkbox" name="xml_pdt48p" value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_pdt48p")) %>>
				</td>
			</tr>
			<tr>
				<td colspan="3">
			...
			<tr>
				<td colspan="3"><textarea name="xml_rfi" cols="20" rows="5"
					style="width: 100%"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_rfi"))+"\"" %>><%=bNewList?riskFactors:""%></textarea>
				</td>
			</tr>
		</table>
		</td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td colspan="2">Ht. <input type="text" name="xml_peh" size="5"
					maxlength="6"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_peh"))+"\"" %>
					onChange="checkTypeInUnit(this)"> Wt. <input type="text"
					name="xml_pew" size="5" maxlength="6"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_pew"))+"\"" %>
					onChange="checkTypeInUnit(this)"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2">BP <input type="text" name="xml_pebp" size="10"
					maxlength="10"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_pebp"))+"\"" %>>
				</td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				...
				<td align="right"><input type="checkbox" name="xml_cinhe"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinhe")) %>>
				</td>
			</tr>
			<tr>
				<td>Thyroid</td>
				<td align="right"><input type="checkbox" name="xml_cinth"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinth")) %>>
				</td>
			</tr>
			<tr>
				<td>Chest</td>
				<td align="right"><input type="checkbox" name="xml_cinch"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinch")) %>>
				</td>
			</tr>
			<tr>
				<td>Breasts</td>
				<td align="right"><input type="checkbox" name="xml_cinbr"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinbr")) %>>
				</td>
			</tr>
			<tr>
				...
				<td align="right"><input type="checkbox" name="xml_cinca"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinca")) %>>
				</td>
			</tr>
			<tr>
				<td>Abdomen</td>
				<td align="right"><input type="checkbox" name="xml_cinab"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinab")) %>>
				</td>
			</tr>
			<tr>
				...
				<td align="right"><input type="checkbox" name="xml_cinva"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinva")) %>>
				</td>
			</tr>
			<tr>
				<td>Neurological</td>
				<td align="right"><input type="checkbox" name="xml_cinne"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinne")) %>>
				</td>
			</tr>
			<tr>
				...
				<td align="right"><input type="checkbox" name="xml_cinpe"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinpe")) %>>
				</td>
			</tr>
			<tr>
				<td>Ext. genitalia</td>
				<td align="right"><input type="checkbox" name="xml_cinex"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinex")) %>>
				</td>
			</tr>
			<tr>
				<td>Cervix, vagina</td>
				<td align="right"><input type="checkbox" name="xml_cince"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cince")) %>>
				</td>
			</tr>
			<tr>
				<td nowrap>Uterus <input type="text" name="xml_cinun" size="3"
					maxlength="3"
					<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinun"))+"\"" %>>
				<span class="small"> (no. of wks.)</span></td>
				<td align="right"><input type="checkbox" name="xml_cinut"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinut")) %>>
				</td>
			</tr>
			<tr>
				<td>Adnexa</td>
				<td align="right"><input type="checkbox" name="xml_cinad"
					value="checked"
					<%=bNew?"":SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_cinad")) %>>
				</td>
			</tr>
		</table>
		</td>
...
<table width="100%" border="0">
	...
	<tr>
		<td colspan="2"><textarea name="xml_comments" style="width: 100%"
			cols="80"
			<%=bNew?"":"value=\""+SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content,"xml_comments"))+"\"" %>
			rows="5"></textarea></td>
	</tr>
	<%
