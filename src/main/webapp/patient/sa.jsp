    ...
    <tr>
        ...
        <td nowrap valign="top">Family physician<br>
            <div align="center"><textarea name="xml_fphy"
                    ...
                    <%=bNew ? "" : "value=\"" + SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content, "xml_fphy")) + "\""%>></textarea>
            </div>
        </td>
        ...
        <td nowrap valign="top">Ethnic background of mother/father<br>
            <div align="center"><textarea name="xml_ebmf"
                                          style="width: 100%" cols="30" rows="2"
                    <%=bNew ? "" : "value=\"" + SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content, "xml_ebmf")) + "\""%>></textarea>
            </div>
        </td>
    </tr>
</table>
    ...
    <tr>
        ...
        <td width="44%">Medications (list)<br>
            <div align="center"><textarea
                    ...
                    cols="30" rows="2"
                    <%=bNewList ? "" : "value=\"" + SxmlMisc.getReadableString(SxmlMisc.getXmlContent(content, "xml_Medication_demographicaccessory")) + "\""%>><%=bNewList ? medications : ""%></textarea>
            </div>
        </td>
    </tr>
</table>
