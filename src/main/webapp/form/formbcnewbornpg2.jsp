...
// Declaring valid date character, minimum year and maximum year
    ...
    <script type="text/javascript">
        ...
        Calendar.setup({
            inputField: "pg2_11Date1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date8",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date8_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date9",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date9_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date10",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date10_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date11",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date11_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date12",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date12_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_11Date13",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_11Date13_cal",
            singleClick: true,
            step: 1
        });
