                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="45%" nowrap><span class="small9"> <input
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labSpontaneous1", "")))%> @oscar.formDB
                                    dbType="tinyint(1)"/> SPONTANEOUS &nbsp;&nbsp; <input
                                    type="checkbox" name="labAugmented1"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labAugmented1", "")))%> @oscar.formDB
                                    dbType="tinyint(1)"/> AUGMENTED: &nbsp;&nbsp; <input
                                    type="checkbox" name="labArm1"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labArm1", "")))%> @oscar.formDB
                                    dbType="tinyint(1)"/> ARM &nbsp;&nbsp; <input type="checkbox"
                                                                                  name="labOxytocin1"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labOxytocin1", "")))%> @oscar.formDB
                                                                                  dbType="tinyint(1)"/> OXYTOCIN &nbsp;&nbsp; </span>
                            </td>
                            <td nowrap><span class="small9"> <input type="checkbox"
                                                                    name="labOtherChk1"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labOtherChk1", "")))%> @oscar.formDB
                                                                    dbType="tinyint(1)"/> OTHER: </span></td>
                            <td width="10%"><input type="text" name="labOther1"
                                                   style="width: 100%" size="15" maxlength="60"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("labOther1", "")))%>" @oscar.formDB/>
                            </td>
                            ...
                            <td width="30%"><input type="text" name="labIndication1"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("labIndication1", "")))%>"
                        ...
                        <tr>
                            <td nowrap><span class="small8"> <input type="checkbox"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labInduced2", "")))%> @oscar.formDB
                                                                    dbType="tinyint(1)"/> INDUCED &nbsp;&nbsp; <input
                                    type="checkbox"
                                    name="labArm2"
                            ...
                            <td><input type="text" name="labIndication2"
                                       style="width: 100%" size="50" maxlength="80"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("labIndication2", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><span class="small9"> <B>MEMBRANE RUPTURE:</B> <input
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labMemRupSpont", "")))%> @oscar.formDB
                                    dbType="tinyint(1)"/> SPONTANEOUS &nbsp;&nbsp; <input
                                    type="checkbox" name="labMemRupObv"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labMemRupObv", "")))%> @oscar.formDB
                                    dbType="tinyint(1)"/> OBVIOUS &nbsp;&nbsp; <input type="checkbox"
                                                                                      name="labMemRupQuer"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labMemRupQuer", "")))%> @oscar.formDB
                                                                                      dbType="tinyint(1)"/> QUERIED &nbsp;&nbsp; <input
                                    type="checkbox"
                                    name="labMemRupConf"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labMemRupConf", "")))%> @oscar.formDB
                        ...
                        <tr>
                            <td><span class="small9"> <B>AMNIOTIC FLUID:</B> <input
                                    ...
                                    value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("labAmnFluTimeMeco", "")))%>"
            ...
            <tr>
                <td>
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><span class="small9"> <B>FETAL SURVEILLANCE:</B> <input
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("labFetalEcg", "")))%> @oscar.formDB
					...
					<B>FETAL BLOOD SAMPLING:</B> NO. OF TIMES <input type="text"
                                                                     ...
                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("labFetalBldNo", "")))%>"
                                                                     @oscar.formDB/> LOWEST: pH <input type="text"
                                                                                                       name="labFetalBldPh"
                                                                                                       size="10"
                                                                                                       maxlength="10"
                                                                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("labFetalBldPh", "")))%>"
                                                                                                       @oscar.formDB/> B.E. <input
                                        type="text" name="labFetalBldBe"
                            ...
                            <td width="30%"><B>INTRAPARTUM ANTIBIOTICS:</B><br>
                                <input type="checkbox" name="labIntAntibioN"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("labIntAntibioN", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> NO &nbsp;&nbsp; <input type="checkbox"
                                                                                    name="labIntAntibioY"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("labIntAntibioY", "")))%> @oscar.formDB
                                                                                    dbType="tinyint(1)"/> YES <I>(specify)</I>:
                                <input type="text"
                                       name="labIntAntibio" size="30" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("labIntAntibio", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                    </table>
                    ...
                    <table class="small8" width="100%" border="0" cellspacing="0"
                        ...
                        <tr>
                            <td colspan="4" nowrap><input type="checkbox" name="delSvd"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delSvd", "")))%> @oscar.formDB
                                                          dbType="tinyint(1)"/> SVD &nbsp;FETAL POSITION IN LABOUR:
                                <input
                                        type="text" name="delFetalPosLab" size="30" maxlength="60"
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delFetalPosLab", "")))%>"
                                        @oscar.formDB/> <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FETAL POSITION AT
                                DELIVERY:&nbsp;&nbsp;&nbsp; <input type="text"
                                                                   name="delFetalPosDel" size="30" maxlength="60"
                                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delFetalPosDel", "")))%>"
                                                                   @oscar.formDB/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="delAssiDel"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delAssiDel", "")))%> @oscar.formDB
                                                    dbType="tinyint(1)"/> ASSISTED DELIVERY:
                            </td>
                            <td valign="top"><input type="checkbox" name="delVacuum"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delVacuum", "")))%> @oscar.formDB
                                                    dbType="tinyint(1)"/> VACUUM <br>
                                <input type="checkbox" name="delForceps"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delForceps", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> FORCEPS
                            </td>
                            <td valign="top"><input type="checkbox" name="delOutlet"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delOutlet", "")))%> @oscar.formDB
                                                    dbType="tinyint(1)"/> OUTLET <br>
                                <input type="checkbox" name="delLow"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delLow", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> LOW <br>
                                <input type="checkbox" name="delMid"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delMid", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> MID
                            </td>
                            <td valign="top"><input type="checkbox" name="delEasy"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delEasy", "")))%> @oscar.formDB
                                                    dbType="tinyint(1)"/> EASY <br>
                                <input type="checkbox" name="delModDiff"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delModDiff", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> MOD. DIFFICULT <br>
                                <input type="checkbox" name="delDiff"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delDiff", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> DIFFICULT
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2"><input type="checkbox" name="delForcRot"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delForcRot", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> FORCEPS ROTATION
                            </td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="delVBACAttep"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delVBACAttep", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> VBAC ATTEMPTED
                            </td>
                            <td colspan="2"><input type="checkbox" name="delVBACDecl"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delVBACDecl", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> VBAC DECLINED
                            </td>
                            <td><input type="checkbox" name="delNotCandi"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delNotCandi", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> NOT A CANDIDATE
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><input type="checkbox" name="delCesSect"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delCesSect", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> CESARIAN SECTION # <input type="text"
                                                                                                   name="delCesSectNo"
                                                                                                   size="6"
                                                                                                   maxlength="20"
                                                                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delCesSectNo", "")))%>"
                                                                                                   @oscar.formDB/>
                            </td>
                            <td><input type="checkbox" name="delPrim"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delPrim", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> PRIMARY
                            </td>
                            <td><input type="checkbox" name="delElect"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delElect", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> ELECTIVE
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td><input type="checkbox" name="delRepeat"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delRepeat", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> REPEAT
                            </td>
                            <td><input type="checkbox" name="delEmergy"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delEmergy", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> EMERGENCY
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2"><input type="checkbox" name="delLowTranInc"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delLowTranInc", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> LOW TRANSVERSE INCISION
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2"><input type="checkbox" name="delOther"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delOther", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> OTHER (<I>specify</I>) <input type="text"
                                                                                                       name="delOtherSpec"
                                                                                                       size="20"
                                                                                                       maxlength="60"
                                                                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delOtherSpec", "")))%>"
                                                                                                       @oscar.formDB/>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="delBreech"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delBreech", "")))%> @oscar.formDB
                                                    dbType="tinyint(1)"/> BREECH
                            </td>
                            <td colspan="2" valign="top"><input type="checkbox"
                                                                name="delFrank"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delFrank", "")))%> @oscar.formDB
                                                                dbType="tinyint(1)"/> FRANK<br>
                                <input type="checkbox" name="delComplete"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delComplete", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> COMPLETE<br>
                                <input type="checkbox" name="delIncomplete"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delIncomplete", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> INCOMPLETE<br>
                                <input type="checkbox" name="delFootling"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delFootling", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> FOOTLING<br>
                            </td>
                            <td valign="top"><input type="checkbox" name="delSpont"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delSpont", "")))%> @oscar.formDB
                                                    dbType="tinyint(1)"/> SPONTANEOUS<br>
                                <input type="checkbox" name="delAssit"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delAssit", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> ASSISTED<br>
                                <input type="checkbox" name="delForHead"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delForHead", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> FORCEPS TO HEAD<br>
                                <input type="checkbox" name="delExtracted"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delExtracted", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> EXTRACTED<br>
                                <input type="checkbox" name="delVersion"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("delVersion", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> VERSION
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4" valign="top"><input type="checkbox"
                                                                name="delOtherPres"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delOtherPres", "")))%> @oscar.formDB
                                                                dbType="tinyint(1)"/> OTHER PRESENTATION (<I>specify</I>)
                                <input
                                        type="text" name="delOtherPresSpec" size="20" maxlength="60"
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delOtherPresSpec", "")))%>"
                                        @oscar.formDB/></td>
                        </tr>
                    </table>
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td width="33%"><input type="checkbox" name="delAnaNone"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaNone", "")))%> @oscar.formDB
                                                               dbType="tinyint(1)"/> NONE
                                        </td>
                                        <td width="33%"><input type="checkbox"
                                                               name="delAnaNarcotics"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaNarcotics", "")))%> @oscar.formDB
                                                               dbType="tinyint(1)"/> NARCOTICS
                                        </td>
                                        <td width="33%"><input type="checkbox" name="delAnaEpidu"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaEpidu", "")))%> @oscar.formDB
                                                               dbType="tinyint(1)"/> EPIDURAL
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="delAnaN2O2"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaN2O2", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> N2O2/O2
                                        </td>
                                        <td><input type="checkbox" name="delAnaLocal"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaLocal", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> LOCAL
                                        </td>
                                        <td><input type="checkbox" name="delAnaSpinal"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaSpinal", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> SPINAL
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="delAnaCSE"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaCSE", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> CSE
                                        </td>
                                        <td><input type="checkbox" name="delAnaPudendal"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaPudendal", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> PUDENDAL
                                        </td>
                                        <td><input type="checkbox" name="delAnaGen"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaGen", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> GENERAL
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"><input type="checkbox" name="delAnaOther"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delAnaOther", "")))%> @oscar.formDB
                                                               dbType="tinyint(1)"/> OTHER (<I>specify</I>) <input
                                                type="text"
                                                name="delAnaOtherSpec" size="20" maxlength="60"
                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delAnaOtherSpec", "")))%>"
                                                @oscar.formDB/></td>
                                    </tr>
                                </table>
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="delOxyIV"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delOxyIV", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> IV <input type="checkbox" name="delOxyIM"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delOxyIM", "")))%> @oscar.formDB
                                                                                   dbType="tinyint(1)"/> IM DOSE(S)
                                            <input type="text"
                                                   name="delOxyIMDose" size="20" maxlength="60"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delOxyIMDose", "")))%>"
                                                   @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="delOxyOther"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delOxyOther", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> OTHER (<I>specify</I>) <input type="text"
                                                                                                       name="delOxyOtherSpec"
                                                                                                       size="15"
                                                                                                       maxlength="60"
                                                                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delOxyOtherSpec", "")))%>"
                                                                                                       @oscar.formDB/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>SIGNATURE: <input type="text" name="delOxySign"
                                                              ...
                                                              value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delOxySign", "")))%>"
                                                              @oscar.formDB/>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="delPlaSpont"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaSpont", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> SPONTANEOUS &nbsp;&nbsp; <input
                                                type="checkbox" name="delPlaAssis"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaAssis", "")))%> @oscar.formDB
                                                dbType="tinyint(1)"/> ASSISTED
                                        </td>
                                        <td align="right">COMPLETE</td>
                                        <td><input type="checkbox" name="delPlaCompN"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaCompN", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> NO
                                        </td>
                                        <td><input type="checkbox" name="delPlaCompY"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaCompY", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> YES
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><input type="checkbox" name="delPlaManOper"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaManOper", "")))%> @oscar.formDB
                                                               dbType="tinyint(1)"/> MANUAL/OPERATIVE REMOVAL
                                        </td>
                                        <td align="right">CORD VESSELS</td>
                                        <td><input type="checkbox" name="delPla2"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPla2", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> 2
                                        </td>
                                        <td><input type="checkbox" name="delPla3"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPla3", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> 3
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="delPlaCGSN"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaCGSN", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> NO
                                        </td>
                                        <td><input type="checkbox" name="delPlaCGSY"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaCGSY", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> YES
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><input type="text" name="delPlaAbnormal"
                                                               ...
                                                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delPlaAbnormal", "")))%>"
                                                               @oscar.formDB/></td>
                                        <td align="right">PLACENTA SENT TO PATHOLOGY</td>
                                        <td><input type="checkbox" name="delPlaPSPN"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaPSPN", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> NO
                                        </td>
                                        <td><input type="checkbox" name="delPlaPSPY"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPlaPSPY", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> YES
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="checkbox" name="delPerIntact"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPerIntact", "")))%> @oscar.formDB
                                                               dbType="tinyint(1)"/> INTACT <br>
                                            <input type="checkbox" name="delPerLaceration"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delPerLaceration", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> LACERATION <br>
                                            &nbsp;&nbsp;&nbsp; <input type="checkbox" name="delPer1"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delPer1", "")))%> @oscar.formDB
                                                                      dbType="tinyint(1)"/> 1st <input type="checkbox"
                                                                                                       name="delPer2"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delPer2", "")))%> @oscar.formDB
                                                                                                       dbType="tinyint(1)"/>
                                            2nd <input type="checkbox" name="delPer3"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delPer3", "")))%> @oscar.formDB
                                                       dbType="tinyint(1)"/> 3rd <input type="checkbox" name="delPer4"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delPer4", "")))%> @oscar.formDB
                                                                                        dbType="tinyint(1)"/> 4th <br>
                                            <input type="checkbox" name="delPerCerTear"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delPerCerTear", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> CERVICAL TEAR <br>
                                            <input type="checkbox" name="delPerOthTrau"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delPerOthTrau", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> OTHER TRAUMA <input type="text"
                                                                                             name="delPerOthTrauSpec"
                                                                                             size="12" maxlength="60"
                                                                                             value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delPerOthTrauSpec", "")))%>"
                                                                                             @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="delPerEpisio"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPerEpisio", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> EPISIOTOMY
                                        </td>
                                        <td><input type="checkbox" name="delPerMidline"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPerMidline", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> MIDLINE
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><input type="checkbox" name="delPerMedio"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delPerMedio", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> MEDIOLATERAL
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Sutured by: <input type="text"
                                                                           name="delPerSutu" size="12" maxlength="60"
                                                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delPerSutu", "")))%>"
                                                                           @oscar.formDB/>
                                            MD/RM
                                        </td>
                                    </tr>
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="delEstBld1"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delEstBld1", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> &lt;500 cc &nbsp;&nbsp; <input
                                                type="checkbox" name="delEstBld2"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delEstBld2", "")))%> @oscar.formDB
                                                dbType="tinyint(1)"/> &lt;500-1000 cc &nbsp;&nbsp; <input
                                                type="checkbox" name="delEstBld3"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delEstBld3", "")))%> @oscar.formDB
                                                dbType="tinyint(1)"/> &gt;1000 cc <BR>
                                            BLOOD TRANSFUSION <BR>
                                            <input type="checkbox" name="delEstBldN"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delEstBldN", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> NO <input type="checkbox"
                                                                                   name="delEstBldY"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delEstBldY", "")))%> @oscar.formDB
                                                                                   dbType="tinyint(1)"/> YES &nbsp;&nbsp;
                                            No. of units <input
                                                    type="text" name="delEstBldUnit" size="6" maxlength="8"
                                                    value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delEstBldUnit", "")))%>"
                                                    @oscar.formDB/> <BR>
                                            <input type="checkbox" name="delEstBldOther"
                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("delEstBldOther", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/> OTHER (specify): <input type="text"
                                                                                                 name="delEstBldOtherSpec"
                                                                                                 size="15"
                                                                                                 maxlength="30"
                                ...
                                <table class="small8" width="100%" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="delEstSpoN1"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delEstSpoN1", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><input type="checkbox" name="delEstSpoY1"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delEstSpoY1", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="delEstSpoN2"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delEstSpoN2", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><input type="checkbox" name="delEstSpoY2"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("delEstSpoY2", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td width="50%">PRINCIPAL <input type="text"
                                                             name="delIndPrinc" style="width: 100%" size="60"
                                                             maxlength="80"
                                                             value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delIndPrinc", "")))%>"
                                                             @oscar.formDB/>
                            </td>
                            <td>OTHER: <input type="text" name="delIndOther"
                                              style="width: 100%" size="60" maxlength="80"
                                              value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("delIndOther", "")))%>" @oscar.formDB/>
                            </td>
                        </tr>
                    </table>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" rowspan="2"><B>STILLBIRTH</B>
                                            ...
                                            Last FHR <img src="<%= request.getContextPath() %>/images/cal.gif" id="birFHR_cal"> <input
                                                    ...
                                                    value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("birFHR", "")))%>" @oscar.formDB
                                                    dbType="date"/></td>
                                    </tr>
                                    <tr>
                ...
                <td>PLACE OF BIRTH: <input type="checkbox" name="comLabPlaHosp"
                    ...
                    &nbsp;&nbsp; <input type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("comLabPlaTran", "")))%> @oscar.formDB
                                        dbType="tinyint(1)"/> TRANSFER IN LABOUR
                </td>
            </tr>
            <tr>
                <td colspan="2"><textarea name="comLabBirth" style="width: 100%"
                                          cols="100" rows="2" @oscar.formDB
                ...
                <td><input type="checkbox" name="conPedia"
                        ...
                        @oscar.formDB/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                             id="dischargeDateTime_cal"> | PP LOS <input type="text"
                                                                                         ...
                                                                                         class="spe" size="3"
                                                                                         maxlength="3"
                                                                                         value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ppLos", "")))%>"
                                                                                         @oscar.formDB/> hr
                </td>
