                ...
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td>Your sex is: <%= props.getProperty("sex", "") %>
                            </td>
                        </tr>
                        <tr bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>Your birth date is: <%= props.getProperty("dob", "") %>
                            </td>
                        </tr>
                    </table>
                </td>
