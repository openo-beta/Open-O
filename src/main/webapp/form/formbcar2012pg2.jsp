        ...
        <table class="Head" class="hidePrint">
            <tr>
                ...
                <td align="right"><b>Edit:</b>
                    ...
                    <a href="formbcar2012pg3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>">AR2
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                ...
                <tr>
                	...
                	<textarea name="pg2_followUpCmnt"
                              cols="70" rows="5"
                              @oscar.formDB
                              dbType="varchar(255)"><%= props.getProperty("pg2_followUpCmnt", "") %></textarea>
                    </td>
                </tr>
                <tr>
                    <td height="10px"></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ar2_proPreg"
                                           ...
                                           maxlength="50" value="<%= props.getProperty("ar2_proPreg", "") %>"
                                           @oscar.formDB/>
                                </td>
                            </tr>
