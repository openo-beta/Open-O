...
<%
    ...
    if (props.getProperty("sv_num", "0").equals("")) {
        props.setProperty("sv_num", "0");
    }
    if (props.getProperty("us_num", "0").equals("")) {
    ...
    <head>
        ...
        <style type="text/css">
            ...
            * html #maincontent { /*IE6 hack*/
            ...
            #bottomContent td, th, input, select {
                font-size: 12px
            }
        </style>
 ...
 */
        ...
        <div id="content_bar" class="innertube">
            ...
            <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" rowspan="4" width="25%">Allergies or
                            Sensitivities<br/>
                            <textarea name="c_allergies" style="width: 100%" cols="30" rows="3" maxlength="150"
                                      class="limit-text"
                                      data-msg="allergies_size"><%= UtilMisc.htmlEscape(props.getProperty("c_allergies", "")) %></textarea>
                            <span id="allergies_size">150 Characters left</span>
                        </td>
                        <td valign="top" rowspan="4">Medications / Herbals<br/>
                            <textarea name="c_meds" style="width: 100%" cols="30" rows="3" maxlength="146"
                                      class="limit-text"
                                      data-msg="meds_size"><%= UtilMisc.htmlEscape(props.getProperty("c_meds", "")) %></textarea>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td colspan="3"><input id="rf_add_btn" type="button" value="Add New"
                                               onclick="addRiskFactor();"/></td>
                    </tr>
                </table>
 	 		...
 	 		%>
				...
				<span id="rhNegSpan">
					<b>Rh neg.</b>
					<input type="checkbox"
                           name="ar2_rhNeg" <%= UtilMisc.htmlEscape(props.getProperty("ar2_rhNeg", "")) %> />
				</span>
                            &nbsp;&nbsp;&nbsp;
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td colspan="10"><input id="sv_add_btn" type="button" value="Add New"
                                                onclick="addSubsequentVisit();"/>&nbsp;<input id="sv_badd_btn"
                                                                                              type="button"
                                                                                              value="Add 5"
                                                                                              onclick="addBulkSubsequentVisit(5);"/>
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="bottomContent">
                    <tr>
                        <td>
                            ...
                            <br>
                            <a href="javascript:void(0)" id="fundalImageLink"><img id="fundalImage" src="" width="98%"
                                                                                   style="max-width:340px;min-width:170px"></a>
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td colspan="3" align="center">
                                        <div style="height:10em;overflow-y:auto;width:100%">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td colspan="4"><input id="us_add_btn" type="button" value="Add New"
                                                                           onclick="addUltraSound();"/></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </td>
                                        ...
                                        <table border="1" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="ar2_hb" size="10" maxlength="10"
                                                           value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_hb", "")) %>">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="ar2_labABS" size="10"
                                                           maxlength="10"
                                                           value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_labABS", "")) %>">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="text" name="ar2_lab1GCT" size="10"
                                                           maxlength="10"
                                                           value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_lab1GCT", "")) %>">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" nowrap="nowrap">2 hr. GTT &nbsp;
                                        ...
                                        <input type="hidden" name="ar2_lab2GTT"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_lab2GTT", "")) %>"/>
                                        <input style="width:50px" type="text" name="ar2_lab2GTT1" size="4"
                                               maxlength="4">/
                                        <input style="width:50px" type="text" name="ar2_lab2GTT2" size="4"
                                               maxlength="4">/
                                        <input style="width:50px" type="text" name="ar2_lab2GTT3" size="4"
                                               maxlength="4">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" size="10" name="ar2_labCustom1Result"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_labCustom1Result", "")) %>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td><input type="text" size="10" name="ar2_labCustom2Result"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_labCustom2Result", "")) %>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td><input type="text" size="10" name="ar2_labCustom3Label"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_labCustom3Label", "")) %>"/>
                                    </td>
                                    <td><input type="text" size="10" name="ar2_labCustom3Result"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_labCustom3Result", "")) %>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td><input type="text" size="10" name="ar2_labCustom4Label"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_labCustom4Label", "")) %>"/>
                                    </td>
                                    <td><input type="text" size="10" name="ar2_labCustom4Result"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("ar2_labCustom4Result", "")) %>"/>
                                    </td>
                                </tr>
                            </table>
    ...
    <div id="gct-req-form" title="Create Lab Requisition">
        ...
        <form>
            <fieldset>
                <input type="checkbox" name="gct_hb" id="gct_hb" checked="checked"
                       class="text ui-widget-content ui-corner-all"/>
                <label for="gct_hb">Hb</label>
                <br/>
                <input type="checkbox" name="gct_urine" id="gct_urine" checked="checked" value=""
                       class="text ui-widget-content ui-corner-all"/>
                <label for="gct_urine">Urine C&S</label>
                <br/>
                <input type="checkbox" name="gct_ab" id="gct_ab" checked="checked" value=""
                       class="text ui-widget-content ui-corner-all"/>
                <label for="gct_ab">Repeat antibody screen</label>
                <br/>
                <input type="checkbox" name="gct_glu" id="gct_glu" checked="checked" value=""
                       class="text ui-widget-content ui-corner-all"/>
    ...
    <div id="gtt-req-form" title="Create Lab Requisition">
        ...
        <form>
            <fieldset>
                <input type="checkbox" name="gtt_glu" id="gtt_glu" checked="checked"
                       class="text ui-widget-content ui-corner-all"/>
    ...
    <div id="edb-update-form" title="EDB Update">
        <p>The EDB should be updated according to SOGC guideline (<a target="_sogc"
                                                                     href="http://sogc.org/guidelines/documents/gui214CPG0809.pdf">link</a>)
        </p>
        <form>
            <fieldset>
