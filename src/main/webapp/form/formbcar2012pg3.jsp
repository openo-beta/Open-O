            ...
            <td>
                <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td>Given Name<br>
                            <input type="text" name="c_givenName" reasonly style="width:100%" size="30" maxlength="30" value="<%= props.getProperty("c_givenName", "") %>" @oscar.formDB />
                               </td>
                    </tr><tr>
                        <td colspan="2">Address<br>
                            <input type="text" name="c_address" readonly style="width:100%" size="50" maxlength="60" value="<%= props.getProperty("c_address", "") %>" @oscar.formDB />
                                   ...
                                   <input type="text" name="c_postal" readonly size="7" maxlength="8" value="<%= props.getProperty("c_postal", "") %>" @oscar.formDB />
                               </td>
                    </tr><tr>
