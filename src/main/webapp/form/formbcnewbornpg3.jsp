...
// Declaring valid date character, minimum year and maximum year
    ...
    <input type="hidden" name="commonField" value="ar2_"/>
        ...
        <table class="Head" class="hidePrint">
            ...
            <a href="javascript: popupPage('form/formbcnewbornpg2.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&view=1');">Part2 <font size=-2>(pg.1)</font></a> |
            &nbsp;--></td>
                <td align="right"><b>Edit:</b> <a
                    ...
                    | <a
                            href="form/formbcnewbornpg2.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>">Part2
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td rowspan="2" valign="bottom"><input type="checkbox"
                                                                   name="ar2_9Test1" <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_9Test1", "")))%> />
                                PKU. TSH. GALACTOSEMIA &nbsp; <input type="checkbox"
                                                                     name="ar2_9Test1a" <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_9Test1a", "")))%> />
                        ...
                        <tr>
                            <td nowrap><input type="text" name="ar2_9Date1"
                                              ...
                                              value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_9Date1", "")))%>"/> <img
                        ...
                        <tr>
                            <td nowrap><input type="text" name="ar2_9Date2"
                                              ...
                                              value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_9Date2", "")))%>"/> <img
                                    src="<%= request.getContextPath() %>/images/cal.gif" id="ar2_9Date2_cal"></td>
                            <td><input type="checkbox" name="ar2_9Test2"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_9Test2", "")))%> /> POSITIVE MATERNAL
                                HBsAg STATUS
                            </td>
                        </tr>
                        <tr>
                            <td nowrap><input type="text" name="ar2_9Date3"
                                              ...
                                              value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_9Date3", "")))%>"/> <img
                                    src="<%= request.getContextPath() %>/images/cal.gif" id="ar2_9Date3_cal"></td>
                            <td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ar2_9Test3"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_9Test3", "")))%> /> HBIG GIVEN
                            </td>
                        </tr>
                        <tr>
                            <td nowrap><input type="text" name="ar2_9Date4"
                                              id="ar2_9Date4" size="8" maxlength="10"
                                              value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_9Date4", "")))%>"/> <img
                                    src="<%= request.getContextPath() %>/images/cal.gif" id="ar2_9Date4_cal"></td>
                            <td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ar2_9Test4"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_9Test4", "")))%> /> HEPATITIS B
                                VACCINE GIVEN
                            </td>
                        </tr>
                        <tr>
                            <td nowrap><input type="text" name="ar2_9Date5"
                                              ...
                                              value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_9Date5", "")))%>"/> <img
                                    src="<%= request.getContextPath() %>/images/cal.gif" id="ar2_9Date5_cal"></td>
                            <td><input type="checkbox" name="ar2_9Test5"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_9Test5", "")))%> /> POSITIVE MATERNAL
                                HIV STATUS
                            </td>
                        </tr>
                        <tr>
                            <td nowrap><input type="text" name="ar2_9Date6"
                                              ...
                                              value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_9Date6", "")))%>"/> <img
                                    src="<%= request.getContextPath() %>/images/cal.gif" id="ar2_9Date6_cal"></td>
                            <td><input type="checkbox" name="ar2_9Test6"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_9Test6", "")))%> /> OTHER
                        </tr>
                    </table>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td nowrap><input type="text" name="ar2_10Date1"
                                  ...
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10Date1", "")))%>"/> <img
                ...
                <td><input type="text" name="ar2_10List1" style="width: 100%"
                           ...
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10List1", "")))%>"/></td>
                <td nowrap><input type="text" name="ar2_10DateRes1"
                                  id="ar2_10DateRes1" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10DateRes1", "")))%>"/> <img
            ...
            <tr>
                <td nowrap><input type="text" name="ar2_10Date2"
                                  ...
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10Date2", "")))%>"/> <img
                ...
                <td nowrap><input type="text" name="ar2_10List2"
                                  ...
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10List2", "")))%>"/></td>
                <td><input type="text" name="ar2_10DateRes2" id="ar2_10DateRes2"
                           size="8" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10DateRes2", "")))%>"/> <img
            ...
            <tr>
                <td nowrap><input type="text" name="ar2_10Date3"
                                  ...
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10Date3", "")))%>"/> <img
                        src="<%= request.getContextPath() %>/images/cal.gif" id="ar2_10Date3_cal"></td>
                <td><input type="text" name="ar2_10List3" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10List3", "")))%>"/></td>
                <td nowrap><input type="text" name="ar2_10DateRes3"
                                  id="ar2_10DateRes3" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_10DateRes3", "")))%>"/> <img
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td nowrap><input type="text" name="pg3_11Date1"
                                  ...
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date1", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List1" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List1", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date2"
                                  id="pg3_11Date2" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date2", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List2" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List2", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date3"
                                  id="pg3_11Date3" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date3", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List3" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List3", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date4"
                                  id="pg3_11Date4" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date4", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List4" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List4", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date5"
                                  id="pg3_11Date5" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date5", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List5" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List5", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date6"
                                  id="pg3_11Date6" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date6", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List6" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List6", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date7"
                                  id="pg3_11Date7" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date7", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List7" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List7", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date8"
                                  id="pg3_11Date8" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date8", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List8" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List8", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date9"
                                  id="pg3_11Date9" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date9", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List9" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List9", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date10"
                                  id="pg3_11Date10" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date10", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List10" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List10", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date11"
                                  id="pg3_11Date11" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date11", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List11" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List11", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date12"
                                  id="pg3_11Date12" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date12", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List12" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List12", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td nowrap><input type="text" name="pg3_11Date13"
                                  id="pg3_11Date13" size="8" maxlength="10"
                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11Date13", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg3_11List13" style="width: 100%"
                           size="90" maxlength="200"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_11List13", "")))%>" @oscar.formDB/>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="12%" nowrap><B>CIRCUMCISION</B> <input
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_12Done", "")))%> /></td>
                <td colspan="3%">DONE</td>
            </tr>
            <tr>
                <td colspan="2%"><input type="text" name="ar2_12Date"
                                        id="ar2_12Date" size="8" maxlength="10"
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_12Date", "")))%>"/> <img
                ...
                <td width="22%" nowrap><span class="small8">METHOD</span> <input
                        ...
                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_12Method", "")))%>"/></td>
                <td width="28%" nowrap><span class="small8">ANALGESIA
			USED</span> <input type="text" name="ar2_12Analg" size="20" maxlength="30"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_12Analg", "")))%>"/></td>
                <td nowrap><span class="small8">SIGNATURE <input
                        type="text" name="ar2_12Signature" size="20" maxlength="60"
                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_12Signature", "")))%>"/> MD</span></td>
            </tr>
        </table>
        ...
        <table class="small9" width="100%" border="1" cellspacing="0"
            ...
            <tr>
                                    ...
                                    <tr>
                                        <td width="40%"><B>13. DISCHARGE EXAMINATION</B><br>
                                            Date <input type="text" name="ar2_13ExamDate" id="ar2_13ExamDate"
                                                        ...
                                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13ExamDate", "")))%>"/> <img
                                        ...
                                        <td width="18%" nowrap>WEIGHT<br>
                                            <input type="text" name="ar2_13Weight" size="6" maxlength="6"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Weight", "")))%>"/>g
                                        </td>
                                        <td>HEAD CIRCUMFERENCE<br>
                                            <input type="text" name="ar2_13HeadLen" size="6" maxlength="6"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13HeadLen", "")))%>"/>cm
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            ...
                            <td width="8%">NORMAL<br>
                                <input type="checkbox" name="ar2_13Normal1"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal1", "")))%> /></td>
                            <td width="10%">ABNORMAL<br>
                                <input type="checkbox" name="ar2_13Abnormal1"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal1", "")))%> /></td>
                            <td>COMMENT<br>
                                <input type="text" name="ar2_13Comment1" style="width: 100%"
                                       size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment1", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>2. SKIN</td>
                            <td><input type="checkbox" name="ar2_13Normal2"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal2", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal2"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal2", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment2"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment2", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>3. HEAD</td>
                            <td><input type="checkbox" name="ar2_13Normal3"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal3", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal3"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal3", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment3"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment3", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>4. EENT</td>
                            <td><input type="checkbox" name="ar2_13Normal4"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal4", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal4"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal4", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment4"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment4", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>5. RESPIRATORY</td>
                            <td><input type="checkbox" name="ar2_13Normal5"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal5", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal5"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal5", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment5"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment5", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>6. CVS</td>
                            <td><input type="checkbox" name="ar2_13Normal6"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal6", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal6"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal6", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment6"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment6", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>7. ABDOMEN</td>
                            <td><input type="checkbox" name="ar2_13Normal7"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal7", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal7"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal7", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment7"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment7", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>8. UMBILICAL CORD</td>
                            <td><input type="checkbox" name="ar2_13Normal8"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal8", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal8"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal8", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment8"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment8", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>9. GENITORECTAL</td>
                            <td><input type="checkbox" name="ar2_13Normal9"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal9", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal9"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal9", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment9"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment9", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>10. MUSCULOSKELETAL</td>
                            <td><input type="checkbox" name="ar2_13Normal10"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal10", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal10"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal10", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment10"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment10", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>11. NEUROLOGICAL</td>
                            <td><input type="checkbox" name="ar2_13Normal11"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal11", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal11"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal11", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment11"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment11", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td>12. OTHER</td>
                            <td><input type="checkbox" name="ar2_13Normal12"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Normal12", "")))%> /></td>
                            <td><input type="checkbox" name="ar2_13Abnormal12"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_13Abnormal12", "")))%> /></td>
                            <td><input type="text" name="ar2_13Comment12"
                                       style="width: 100%" size="40" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_13Comment12", "")))%>"/></td>
                        </tr>
                    </table>
                ...
                <td colspan="2"><B>14. STATUS AT DISCHARGE</B> <textarea
                        ...
                        rows="3"> <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_14", "")))%> </textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">PROBLEMS REQUIRING FOLLOWUP<br>
                    <textarea name="ar2_14Problem" style="width: 100%" cols="30"
                              rows="3"> <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_14Problem", "")))%> </textarea>
                    FEEDING: <input type="checkbox" name="ar2_14Breast"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_14Breast", "")))%> />
                    BREAST&nbsp;&nbsp;&nbsp; <input type="checkbox" name="ar2_14VitD"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_14VitD", "")))%> /> VIT. D<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="ar2_14Formula"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_14Formula", "")))%> /> FORMULA
                </td>
            </tr>
            <tr>
                <td width="12%"><B>15. DISCHARGED</B><br>
                    <input type="checkbox" name="ar2_15Home"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_15Home", "")))%> /> HOME<br>
                    <input type="checkbox" name="ar2_15Adoption"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_15Adoption", "")))%> /> ADOPTION<br>
                    <input type="checkbox" name="ar2_15Foster"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_15Foster", "")))%> /> FOSTER HOME<br>
                    <input type="checkbox" name="ar2_15OtherHosp"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_15OtherHosp", "")))%> /> <span
                            class="small8">OTHER HOSPITAL</span><br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<I>(specify)</I><br>
                    <textarea name="ar2_15OtherHospSpec" style="width: 100%" cols="15"
                              rows="2"> <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_15OtherHospSpec", "")))%> </textarea>
                </td>
                <td>
                    ...
                    <table class="small8" width="100%" border="0" cellspacing="0"
                        ...
                        <tr>
                            <td width="2%"><input type="checkbox" name="ar2_16FamPhy"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_16FamPhy", "")))%> /></td>
                            <td width="60%">FAMILY PHYSICIAN</td>
                            <td><input type="text" name="ar2_16FamPhyWhen" size="10"
                                       maxlength="20"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_16FamPhyWhen", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ar2_16Midwife"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_16Midwife", "")))%> /></td>
                            <td>MIDWIFE</td>
                            <td><input type="text" name="ar2_16MidwifeWhen" size="10"
                                       maxlength="20"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_16MidwifeWhen", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ar2_16Pediat"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_16Pediat", "")))%> /></td>
                            <td>PEDIATRICIAN</td>
                            <td><input type="text" name="ar2_16PediatWhen" size="10"
                                       maxlength="20"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_16PediatWhen", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ar2_16OtherConsul"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_16OtherConsul", "")))%> /></td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="ar2_16ComNurse"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_16ComNurse", "")))%> /></td>
                            <td>COMMUNITY HEALTH NURSE</td>
                            <td><input type="text" name="ar2_16ComNurseWhen" size="10"
                                       maxlength="20"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_16ComNurseWhen", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="ar2_16Ministry"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_16Ministry", "")))%> /></td>
                            <td>MINISTRY FOR</td>
                            <td><input type="text" name="ar2_16MinistryWhen" size="10"
                                       maxlength="20"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_16MinistryWhen", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td></td>
        ...
        <table class="small9" width="100%" border="1" cellspacing="0"
            ...
            <tr>
                ...
                <td><input type="checkbox" name="ar2_NeoDeath"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_NeoDeath", "")))%> /> NEONATAL DEATH
                    &nbsp;&nbsp;&nbsp; <input type="checkbox" name="ar2_Autopsy"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_Autopsy", "")))%> /> AUTOPSY PERFORMED
                </td>
            </tr>
        </table>
