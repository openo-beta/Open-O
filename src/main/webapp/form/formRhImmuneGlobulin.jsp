...
<html>
    ...
    <div>
        <fieldset>
            ...
            <span style="margin-right: 20px;">Current State:<%=Encode.forHtml(String.valueOf(flow.getState("" + h.get("current_state"))))%>
</span> <span style="margin-right: 20px;">Weeks: <%=Encode.forHtml(String.valueOf(gestAge))%></span> <%} else {%> <span
            ...
            <select name="state">
                ...
                %>
                <option value="<%=Encode.forHtmlAttribute(String.valueOf(state.getKey()))%>"
                        <%=Encode.forHtml(String.valueOf((state.getKey().equals(h.get("current_state")) ? " selected" : "")))%>><%=Encode.forHtml(String.valueOf(state.getName()))%>
                </option>
        ...
        <fieldset>
            ...
            <label>Date
                of Referral:</label> <input type="text" name="dateOfReferral"
                                            ...
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("dateOfReferral","")))%>"/> <a
                id="dateOfRefButton"><img title="Calendar" src="<%= request.getContextPath() %>/images/cal.gif"
                                          alt="Calendar" border="0"/></a> <label>EDD:</label> <input type="text"
                                                                                                     ...
                                                                                                     id="end_date"
                                                                                                     size="9"
                                                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("edd","")))%>">
            <a id="date"><img
            ...
            <label>Last Name:</label> <input type="text" name="motherSurname"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("motherSurname","")))%>"/> <label>First
            Name:</label> <input type="text" name="motherFirstname"
                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("motherFirstname","")))%>"/> <br/>
            <label>Date of Birth:</label> <input type="text" name="dob" size="9"
                                                 id="dob" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("dob","")))%>"/> <a id="dateOB"><img
                title="Calendar" src="<%= request.getContextPath() %>/images/cal.gif" alt="Calendar" border="0"/></a>
            <br/>

            <label>Health Card #:</label> <input type="text" name="motherHIN"
                                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("motherHIN","")))%>"/> <label>VC:</label>
            <input
                    type="text" name="motherVC" size="3"
                    value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("motherVC","")))%>"/> <br/>
            <label>Address:</label> <input type="text" name="motherAddress"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("motherAddress","")))%>"/> <label>City:</label>
            <input type="text" name="motherCity"
                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("motherCity","")))%>"/> <br/>
            <label>Province:</label> <input type="text" name="motherProvince"
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("motherProvince","")))%>"/> <label>Postal
            Code:</label> <input type="text" name="motherPostalCode"
                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("motherPostalCode","")))%>"/> <br/>
            ...
            <label>Hospital for Delivery:</label> <input type="text"
                                                         ...
                                                         value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("hospitalForDelivery","")))%>"/>
        </fieldset>
        ...
        <fieldset>
            ...
            <label>Last
                Name:</label> <input type="text" name="refPhySurname"
                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("refPhySurname","")))%>"/> <label>First
            Name:</label> <input type="text" name="refPhyFirstname"
                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("refPhyFirstname","")))%>"/> <br/>
            <label>Address:</label> <input type="text" name="refPhyAddress"
                                           size="20" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("refPhyAddress","")))%>"/>
            <label>City:</label>
            <input type="text" name="refPhyCity"
                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("refPhyCity","")))%>"/> <br/>
            <label>Province:</label> <input type="text" name="refPhyProvince"
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("refPhyProvince","")))%>"/> <label>Postal
            Code:</label> <input type="text" name="refPhyPostalCode"
                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("refPhyPostalCode","")))%>"/> <br/>
            <label>Telephone:</label> <input type="text" name="refPhyPhone"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("refPhyPhone","")))%>"/> <label>Fax:</label>
            <input type="text" name="refPhyFax"
                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("refPhyFax","")))%>"/> <br/>
        </fieldset>
        ...
        <fieldset>
            ...
            <label>Last
                Name:</label> <input type="text" name="famPhySurname"
                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("famPhySurname","")))%>"/> <label>First
            Name:</label> <input type="text" name="famPhyFirstname"
                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("famPhyFirstname","")))%>"/> <br/>
            <label>Address:</label> <input type="text" name="famPhyAddress"
                                           size="20" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("famPhyAddress","")))%>"/>
            <label>City:</label>
            <input type="text" name="famPhyCity"
                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("famPhyCity","")))%>"/> <br/>
            <label>Province:</label> <input type="text" name="famPhyProvince"
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("famPhyProvince","")))%>"/> <label>Postal
            Code:</label> <input type="text" name="famPhyPostalCode"
                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("famPhyPostalCode","")))%>"/> <br/>
            <label>Telephone:</label> <input type="text" name="famPhyPhone"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("famPhyPhone","")))%>"/> <label>Fax:</label>
            <input type="text" name="famPhyFax"
                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("famPhyFax","")))%>"/> <br/>
        </fieldset>
        ...
        <fieldset class="obsHist">
            ...
            <label>G</label> <input type="text" name="obsHisG" size="2"
                                    value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("obsHisG","")))%>"/> <label>P</label> <input
                type="text" name="obsHisP" size="2"
                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("obsHisP","")))%>"/> <label>T</label> <input
                type="text" name="obsHisT" size="2"
                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("obsHisT","")))%>"/> <label>A</label> <input
                type="text" name="obsHisA" size="2"
                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("obsHisA","")))%>"/> <label>L</label> <input
                type="text" name="obsHisL" size="2"
                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("obsHisL","")))%>"/> <br/>

            <input type="checkbox" name="obsHisTubMolPregYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("obsHisTubMolPregYes","")))%>>Yes</input> <input
                type="checkbox" name="obsHisTubMolPregNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("obsHisTubMolPregNo","")))%>>No</input> <label>Any
            previous tubal or molar pregnancy?</label> <br/>
            <input type="checkbox" name="obsHisMisAbortionYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("obsHisMisAbortionYes","")))%>>Yes</input> <input
                type="checkbox" name="obsHisMisAbortionNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("obsHisMisAbortionNo","")))%>>No</input> <label
            ...
            <input type="checkbox" name="obsHisReceiveAntiDYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("obsHisReceiveAntiDYes","")))%>>Yes</input> <input
                type="checkbox" name="obsHisReceiveAntiDNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("obsHisReceiveAntiDNo","")))%>>No</input> <label>Did
        ...
        <fieldset class="obsHist">
            ...
            <input type="checkbox" name="pmHisBlClDisordersYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("pmHisBlClDisordersYes","")))%>>Yes</input> <input
                type="checkbox" name="pmHisBlClDisordersNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("pmHisBlClDisordersNo","")))%>>No</input> <label>Do
            you have any bleeding or clotting disorders?</label> If yes, describe<input
                type="text" name="pmHisBlClDisordersComment"
                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pmHisBlClDisordersComment","")))%>"/> <br/>
            <input type="checkbox" name="pmHisBlPlTransfusYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("pmHisBlPlTransfusYes","")))%>>Yes</input> <input
                type="checkbox" name="pmHisBlPlTransfusNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("pmHisBlPlTransfusNo","")))%>>No</input> <label>Have
            you had any blood or platelet transfusions?</label> If yes, when<input
                type="text" name="pmHisBlPlTransfusComment"
                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pmHisBlPlTransfusComment","")))%>"/></fieldset>
        ...
        <fieldset class="obsHist">
            ...
            <input
                    ...
                    <%=Encode.forHtml(String.valueOf(props.getProperty("allReactionsYes","")))%>>Yes</input> <input
                type="checkbox" name="allReactionsNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("allReactionsNo","")))%>>No</input> <label>Any
            ...
            If yes, describe<input type="text" name="allReactionsComment"
                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("allReactionsComment","")))%>"/> <br/>
        </fieldset>
        ...
        <fieldset class="obsHist">
            ...
            <input type="checkbox" name="curPregDueDateChangeYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("curPregDueDateChangeYes","")))%>>Yes</input> <input
                type="checkbox" name="curPregDueDateChangeNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("curPregDueDateChangeNo","")))%>>No</input> <label>Has
            your due date changed during this pregnancy?</label> Comment<input type="text"
                                                                               name="curPregDueDateChangeComment"
                                                                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("curPregDueDateChangeComment","")))%>"/>
            <br/>

            <input type="checkbox" name="curPregProceduresYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("curPregProceduresYes","")))%>>Yes</input> <input
                type="checkbox" name="curPregProceduresNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("curPregProceduresNo","")))%>>No</input> <label>Any
            ...
            when<input type="text" name="curPregProceduresComment"
                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("curPregProceduresComment","")))%>"/> <br/>

            <input type="checkbox" name="curPregBleedingYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("curPregBleedingYes","")))%>>Yes</input> <input
                type="checkbox" name="curPregBleedingNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("curPregBleedingNo","")))%>>No</input> <label>Any
            bleeding or threatened miscarriage during this pregnancy?</label> <br/>
            If yes, when<input type="text" name="curPregBleedingComment"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("curPregBleedingComment","")))%>"/> <br/>

            <input type="checkbox" name="curPregBleedingContYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("curPregBleedingContYes","")))%>>Yes</input> <input
                type="checkbox" name="curPregBleedingContNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("curPregBleedingContNo","")))%>>No</input> <label>Has
            the bleeding continued?</label> <br/>


            <input type="checkbox" name="curPregTraumaYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("curPregTraumaYes","")))%>>Yes</input> <input
                type="checkbox" name="curPregTraumaNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("curPregTraumaNo","")))%>>No</input> <label>Any
            abdominal trauma, serious fall or car accident?</label> <br/>

            <input type="checkbox" name="curPregAntiDYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("curPregAntiDYes","")))%>>Yes</input> <input
                type="checkbox" name="curPregAntiDNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("curPregAntiDNo","")))%>>No</input> <label>Have
            you received any Anti-D during this pregnancy?</label> If yes, when<input
                type="text" name="curPregAntiDComment"
                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("curPregAntiDComment","")))%>"/> <br/>

            <input type="checkbox" name="curPregAntiDReactionYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("curPregAntiDReactionYes","")))%>>Yes</input> <input
                type="checkbox" name="curPregAntiDReactionNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("curPregAntiDReactionNo","")))%>>No</input> <label>Any
            adverse reaction?</label> <br/>

            <input type="checkbox" name="curPregBloodDrawnYes"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("curPregBloodDrawnYes","")))%>>Yes</input> <input
                type="checkbox" name="curPregBloodDrawnNo"
                <%=Encode.forHtml(String.valueOf(props.getProperty("curPregBloodDrawnNo","")))%>>No</input> <label>Blood
        ...
        <fieldset>
            ...
            <textarea name="comments"
                      style="width: 45em;"><%=Encode.forHtml(String.valueOf(props.getProperty("comments", "")))%></textarea></fieldset>
