...
<html>
    ...
    <input type="hidden" name="demographic_no" value="<%= props.getProperty("demographic_no", "0") %>"/>
        ...
        <div style="font-size: 19px; font-family: arial, helvetica, sans-serif;">
            <center>
                <b><i><%=props.getProperty("clinicName", "")%>
                </i></b>
            </center>
        </div>
        <font face="Arial, Helvetica, sans-serif">
            <TABLE WIDTH="100%" align="center" cellpadding="0" cellspacing="0" style="font-size: 13px;">
                <TR>
                    <TD><%=props.getProperty("clinicAddress", "")%>
                    </TD>
                    <TD ALIGN="right">Phone: <%=props.getProperty("clinicPhone", "")%>
                    </TD>
                </TR>

                <TR>
                    <TD><%=props.getProperty("clinicCity", "")%>
                    </TD>
                    <TD ALIGN="right">Fax: <%=props.getProperty("clinicFax", "")%>
                    </TD>
                </TR>
                            ...
                            <TR>
                                ...
                                <TD align="left">
                                    ...
                                    <INPUT NAME="p_name"
                                           ...
                                           TYPE="text" value="<%=demo.getFormattedName() %>">
                                    </INPUT>
                            ...
                            <TR>
                                ...
                                <TD align="left">
                                    ...
                                    <INPUT NAME="p_address1"
                                           style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
                                           TYPE="text" value="<%=demo.getAddress() %>, <%=demo.getCity() %>">
                                    </INPUT>
                            ...
                            <TR>
                                ...
                                <TD align="left">
                                    ...
                                    <INPUT NAME="p_address2"
                                           style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
                                           TYPE="text" value="<%=demo.getProvince() %>, <%=demo.getPostal() %>">
                                    </INPUT>
                            ...
                            <TR>
                                ...
                                <TD align="left">
                                    <INPUT NAME="p_birthdate"
                                           style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
                                           TYPE="text" value="<%=demo.getFormattedDob() %>">
                                    </INPUT>
                                </TD>
                            </TR>
                            <TR>
            ...
            <div id="textareaDiv" style="position: relative;width:800px">
                <textarea id="comments" name="comments" cols="100" rows="60"
                          style="overflow:hidden; font-family:courier new; font-size:12px;"><%=props.getProperty("comments", "")%></textarea>
            </div>
