...
<html>
    ...
    <input type="hidden" name="demographic_no" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("demographic_no", "0")))%>"/>
        ...
        <input type="hidden" name="cl_name" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("clinicName", "")))%>"/>
        <input type="hidden" name="cl_address1" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("clinicAddress","")))%>"/>
        <input type="hidden" name="cl_address2" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("clinicCity","")))%>"/>
        <input type="hidden" name="cl_phone" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("clinicPhone","")))%>"/>
        <input type="hidden" name="cl_fax" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("clinicFax","")))%>"/>
        ...
        <div style="font-size: 19px; font-family: arial, helvetica, sans-serif;">
            <center>
                <b><i><%=Encode.forHtml(String.valueOf(props.getProperty("clinicName", "")))%>
                </i></b>
            </center>
        </div>
        <font face="Arial, Helvetica, sans-serif">
            <TABLE WIDTH="100%" align="center" cellpadding="0" cellspacing="0" style="font-size: 13px;">
                <TR>
                    <TD><%=Encode.forHtml(String.valueOf(props.getProperty("clinicAddress", "")))%>
                    </TD>
                    <TD ALIGN="right">Phone: <%=Encode.forHtml(String.valueOf(props.getProperty("clinicPhone", "")))%>
                    </TD>
                </TR>

                <TR>
                    <TD><%=Encode.forHtml(String.valueOf(props.getProperty("clinicCity", "")))%>
                    </TD>
                    <TD ALIGN="right">Fax: <%=Encode.forHtml(String.valueOf(props.getProperty("clinicFax", "")))%>
                    </TD>
                </TR>
                        ...
                        <TABLE WIDTH="100%" align="center" style="border: 1px solid;">
                            <TR>
                                ...
                                <TD align="left">
                                    ...
                                    <INPUT NAME="p_name"
                                           ...
                                           TYPE="text" value="<%=Encode.forHtmlAttribute(String.valueOf(demo.getFormattedName()))%>">
                                    </INPUT>
                            ...
                            <TR>
                                ...
                                <TD align="left">
                                    ...
                                    <INPUT NAME="p_address1"
                                           style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
                                           TYPE="text" value="<%=Encode.forHtmlAttribute(String.valueOf(demo.getAddress()))%>, <%=Encode.forHtmlAttribute(String.valueOf(demo.getCity()))%>">
                                    </INPUT>
                            ...
                            <TR>
                                ...
                                <TD align="left">
                                    ...
                                    <INPUT NAME="p_address2"
                                           style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
                                           TYPE="text" value="<%=Encode.forHtmlAttribute(String.valueOf(demo.getProvince()))%>, <%=Encode.forHtmlAttribute(String.valueOf(demo.getPostal()))%>">
                                    </INPUT>
                            ...
                            <TR>
                                ...
                                <TD align="left">
                                    <INPUT NAME="p_phone"
                                           style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
                                           TYPE="text" value="<%=Encode.forHtmlAttribute(String.valueOf(demo.getPhone()))%>">
                                    </INPUT>
                            ...
                            <TR>
                                ...
                                <TD align="left">
                                    <INPUT NAME="p_birthdate"
                                           style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
                                           TYPE="text" value="<%=Encode.forHtmlAttribute(String.valueOf(demo.getFormattedDob()))%>">
                                    </INPUT>
                                </TD>
                            </TR>
                            <TR>
                                ...
                                <TD align="left">
                                    <INPUT NAME="p_healthcard"
                                           style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
                                           TYPE="text" value="<%=Encode.forHtmlAttribute(String.valueOf(demo.getHin()))%>">
                                    </INPUT>
                                </TD>
                            </TR>
                        </TABLE>
            ...
            <div id="textareaDiv" style="position: relative;width:800px">
                <textarea id="comments" name="comments" cols="100" rows="60"
                          style="overflow:hidden; font-family:courier new; font-size:12px;"><%=Encode.forHtml(String.valueOf(props.getProperty("comments", "")))%></textarea>
            </div>
