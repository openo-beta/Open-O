    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
            <tr>
                ...
                <td nowrap="true"><a
                        ...
                        href="form/formrourke2006p2.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.Pg2"/></a>&nbsp;|&nbsp; <a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.Pg3"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourke2006p4.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.Pg4"/></a></td>
            </tr>
        </table>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="1">
            ...
            <tr align="center">
                ...
                <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHdCirc12m"/></td>
                <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHt"/></td>
                <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formWt"/></td>
                <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHdCirc"/></td>
            </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding9m", "")))%> /></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_formulaFeeding9m", "")))%> /></td>
                            <td><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.msgFormulaFeeding"/></i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_bottle9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_bottle9m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgBottle"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_liquids9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_liquids9m", "")))%>>
                            </td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgLiquids"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_cereal9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cereal9m", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_introCowMilk9m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.msgIntroCowMilk"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_egg9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_egg9m", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p3_choking9m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking9m", "")))%>></td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr align="center">
                            <td colspan="2"><textarea id="p3_nutrition12m"
                                                      name="p3_nutrition12m" class="wide" rows="5"
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding12m", "")))%>></td>
                            <td><b><a href="javascript:showNotes()"
                                      onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                      onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnBreastFeeding"/>*</a></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_homoMilk12m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk12m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2.formHomogenizedMilk"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_cup12m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cup12m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formEncourageCup"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_appetite12m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_appetite12m", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p3_choking12m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking12m", "")))%>></td>
                            <td><a href="javascript:showNotes()"
                                   onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                   onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgChoking"/>*</a></td>
                        </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                        <tr align="center">
                            <td colspan="2"><textarea id="p3_nutrition15m"
                                                      name="p3_nutrition15m" class="wide" rows="5"
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding15m", "")))%>></td>
                            <td><b><a href="javascript:showNotes()"
                                      onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                      onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnBreastFeeding"/>*</a></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_homoMilk15m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk15m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2.formHomogenizedMilk"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p3_choking15m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking15m", "")))%>></td>
                            <td><a href="javascript:showNotes()"
                                   onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                   onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgChoking"/>*</a></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_cup15m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cup15m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formEncourageCup"/></td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td colspan="9" valign="top">
                    <table style="font-size: 8pt;" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td valign="top" colspan="15"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formInjuryPrev"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_carSeatNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_carSeatNo", "")))%>></td>
                            <td colspan="4" valign="top"><b><a
                                    href="javascript:showNotes()"
                                    onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                    onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formCarSeat"/></a>*</b></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_poisonsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_poisonsNo", "")))%>></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_firearmSafetyNo"
                                                    ...
                                                    onclick="onCheck(this,'p3_firearmSafety')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_firearmSafetyNo", "")))%>></td>
                            <td colspan="4" valign="top"><b><a
                                    href="javascript:showNotes()"
                                    onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_smokeSafetyNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_smokeSafetyNo", "")))%>></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_hotWaterNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hotWaterNo", "")))%>></td>
                        ...
                        <tr>
                            <td colspan="3" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formChildProof"/>
                            ...
                            <td valign="top"><input type="radio" id="p3_electricNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_electricNo", "")))%>></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_fallsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fallsNo", "")))%>></td>
                            <td valign="top"><i><a href="javascript:showNotes()"
                                                   onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_safeToysNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_safeToysNo", "")))%>></td>
                            <td colspan="4" valign="top"><a href="javascript:showNotes()"
                                                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                        ...
                        <tr>
                            ...
                            <td class="edcol" colspan="3" valign="top"><input
                                    class="delete" type="button" value="Del"
                                    onclick="del('p3_poisonsOk,p3_poisonsNo,p3_hotWaterOk,p3_hotWaterNo,p3_fallsOk,p3_fallsNo');"/>
                            </td>
                            <td class="edcol" colspan="3" valign="top"><input
                                    class="delete" type="button" value="Del"
                                    onclick="del('p3_firearmSafetyOk,p3_firearmSafetyNo,p3_safeToysOk,p3_safeToysNo');"/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="15">&nbsp;</td>
                        ...
                        <tr>
                            <td valign="top" colspan="15"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formBehaviour"/></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_sleepCryNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sleepCryNo", "")))%>></td>
                            <td colspan="4" valign="top"><a href="javascript:showNotes()"
                            ...
                            <td valign="top"><input type="radio" id="p3_soothabilityNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_soothabilityNo", "")))%>></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_homeVisitNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homeVisitNo", "")))%>></td>
                            <td colspan="4" valign="top"><b><a
                                    href="javascript:showNotes()"
                                    onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_parentingNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_parentingNo", "")))%>></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_pFatigueNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pFatigueNo", "")))%>></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_famConflictNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_famConflictNo", "")))%>></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_siblingsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_siblingsNo", "")))%>></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_childCareNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_childCareNo", "")))%>></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="edcol" colspan="2" valign="top"><input
                                    class="delete" type="button" value="Del"
                                    onclick="del('p3_soothabilityOk,p3_soothabilityNo,p3_famConflictOk,p3_famConflictNo');"/>
                            </td>
                            <td colspan="3" class="edcol" colspan="2" valign="top"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            <td valign="top" colspan="15"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formOtherIssues"/></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_2ndSmokeNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_2ndSmokeNo", "")))%>></td>
                            <td valign="top"><b><a href="javascript:showNotes()"
                                                   onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_teethingNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_teethingNo", "")))%>></td>
                            <td valign="top"><a href="javascript:showNotes()"
                                                onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_altMedNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_altMedNo", "")))%>></td>
                            <td valign="top"><a href="javascript:showNotes()"
                                                onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_pacifierNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pacifierNo", "")))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_feverNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_feverNo", "")))%>></td>
                            <td valign="top"><a href="javascript:showNotes()"
                                                onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_activeNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_activeNo", "")))%>></td>
                            <td valign="top"><a href="javascript:showNotes()"
                                                onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_readingNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_readingNo", "")))%>></td>
                            <td valign="top"><b><a href="javascript:showNotes()"
                                                   onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_footwearNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_footwearNo", "")))%>></td>
                            <td colspan="4" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formFootwear"/></td>
                        </tr>
                        <tr>
                            <td colspan="3" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formEnvHealth"/></td>
                            ...
                            <td valign="top"><input type="radio" id="p3_sunExposureNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sunExposureNo", "")))%>></td>
                            <td valign="top"><a href="javascript:showNotes()"
                                                onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_checkSerumNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_checkSerumNo", "")))%>></td>
                            <td valign="top"><i><a href="javascript:showNotes()"
                                                   onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            ...
                            <td valign="top"><input type="radio" id="p3_pesticidesNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pesticidesNo", "")))%>></td>
                            <td colspan="4" valign="top"><i><a
                                    href="javascript:showNotes()"
                                    onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="edcol" colspan="2" valign="top"><input
                                    class="delete" type="button" value="Del"
                                    onclick="del('p3_teethingOk,p3_teethingNo,p3_activeOk,p3_activeNo,p3_sunExposureOk,p3_sunExposureNo');"/>
                            </td>
                            <td colspan="3" class="edcol" colspan="2" valign="top"><input
                                    class="delete" type="button" value="Del"
                                    onclick="del('p3_altMedOk,p3_altMedNo,p3_readingOk,p3_readingNo,p3_checkSerumOk,p3_checkSerumNo');"/>
                            </td>
                            <td colspan="3" class="edcol" colspan="2" valign="top"><input
                                    class="delete" type="button" value="Del"
                                    onclick="del('p3_pacifierOk,p3_pacifierNo,p3_footwearOk,p3_footwearNo,p3_pesticidesOk,p3_pesticidesNo');"/>
                            </td>
                            <td colspan="3">&nbsp;</td>
                        </tr>
                        <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_hiddenToyNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hiddenToyNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formhiddenToy"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_soundsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_soundsNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formSounds"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_makeSoundsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_makeSoundsNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formMakeSounds"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_sitsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sitsNo", "")))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_standsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_standsNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formStands"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_thumbNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_thumbNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formThumb&Index"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p3_pickedupOk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pickedupOk", "")))%>></td>
                            <td valign="top"><input type="radio" id="p3_pickedupNo"
                                                    name="p3_pickedupNo" onclick="onCheck(this,'p3_pickedup')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pickedupNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formPickedUp"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio"
                                                    ...
                                                    onclick="onCheck(this,'p3_noParentsConcerns9m')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns9mNo", "")))%>></td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_respondsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_respondsNo", "")))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_simpleRequestsNo"
                                                    ...
                                                    onclick="onCheck(this,'p3_simpleRequests')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_simpleRequestsNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formSimpleReq"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p3_chattersOk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_chattersOk", "")))%>></td>
                            <td valign="top"><input type="radio" id="p3_chattersNo"
                                                    name="p3_chattersNo" onclick="onCheck(this,'p3_chatters')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_chattersNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formChatters"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_shufflesNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_shufflesNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formCrawls"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_pull2standNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pull2standNo", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p3_emotionsOk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_emotionsOk", "")))%>></td>
                            <td valign="top"><input type="radio" id="p3_emotionsNo"
                                                    name="p3_emotionsNo" onclick="onCheck(this,'p3_emotions')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_emotionsNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formShowEmotions"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio"
                                                    ...
                                                    onclick="onCheck(this,'p3_noParentsConcerns12m')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns12mNo", "")))%>></td>
                            <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formNoparentConcerns"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p3_says2wordsOk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_says2wordsOk", "")))%>></td>
                            <td valign="top"><input type="radio" id="p3_says2wordsNo"
                                                    name="p3_says2wordsNo" onclick="onCheck(this,'p3_says2words')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_says2wordsNo", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formSays2words"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p3_reachesOk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_reachesOk", "")))%>></td>
                            <td valign="top"><input type="radio" id="p3_reachesNo"
                                                    name="p3_reachesNo" onclick="onCheck(this,'p3_reaches')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_reachesNo", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formReaches"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_fingerFoodsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fingerFoodsNo", "")))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_crawlsStairsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_crawlsStairsNo", "")))%>></td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio" id="p3_squatsNo"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_squatsNo", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p3_tieShoesOk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tieShoesOk", "")))%>></td>
                            <td valign="top"><input type="radio" id="p3_tieShoesNo"
                                                    name="p3_tieShoesNo" onclick="onCheck(this,'p3_tieShoes')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tieShoesNo", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formTieShoes"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p3_stacks2blocksOk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_stacks2blocksOk", "")))%>></td>
                            <td valign="top"><input type="radio" id="p3_stacks2blocksNo"
                                                    name="p3_stacks2blocksNo"
                                                    onclick="onCheck(this,'p3_stacks2blocks')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_stacks2blocksNo", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formStacks2Blocks"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            <td valign="top"><input type="radio" id="p3_howToReactOk"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_howToReactOk", "")))%>></td>
                            <td valign="top"><input type="radio" id="p3_howToReactNo"
                                                    name="p3_howToReactNo" onclick="onCheck(this,'p3_howToReact')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_howToReactNo", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHowToReact"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="radio"
                                                    ...
                                                    onclick="onCheck(this,'p3_noParentsConcerns15m')"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns15mNo", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formNoparentConcerns"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
            ...
            <tr>
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p3_eyes9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes9m", "")))%>></td>
                            <td
            ...
            <tr>
                <td valign="top"><input type="checkbox" class="chk"
                                        name="p3_corneal9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal9m", "")))%>></td>
            ...
            <tr>
                <td valign="top"><input type="checkbox" class="chk"
                                        name="p3_hearing9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing9m", "")))%>></td>
                <td><i><a href="javascript:showNotes()"
                          onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
            ...
            <tr>
                <td valign="top"><input type="checkbox" class="chk"
                                        name="p3_hips9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips9m", "")))%>></td>
                <td><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHips"/></i></td>
            </tr>
        </table>
        </td>
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_eyes12m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes12m", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a></i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_corneal12m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal12m", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_hearing12m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing12m", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHearingInquiry"/>*</a></i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_tonsil12m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tonsil12m", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_hips12m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips12m", "")))%>></td>
                    <td><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHips"/></i></td>
                </tr>
            </table>
        </td>
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_eyes15m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes15m", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a></i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_corneal15m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal15m", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formCornealReflex"/>*</a></i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_hearing15m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing15m", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHearingInquiry"/>*</a></i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_tonsil15m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tonsil15m", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formTonsilSize"/>*</a></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"
                                            name="p3_hips15m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips15m", "")))%>></td>
                    <td><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHips"/></i></td>
                </tr>
            </table>
        </td>
        ...
        <tr>
            ...
            <td colspan="3" valign="top">
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td valign="top"><input type="checkbox" class="chk"
                                                name="p3_antiHB9m" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_antiHB9m", "")))%>></td>
                        <td><b><a href="javascript:showNotes()"
                                  onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                    ...
                    <tr>
                        <td valign="top"><input type="checkbox" class="chk"
                                ...
                                <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hemoglobin9m", "")))%>></td>
                        <td><i><a href="javascript:showNotes()"
                                  onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td valign="top"><input type="checkbox" class="chk"
                                ...
                                <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hemoglobin12m", "")))%>></td>
                        <td><i><a href="javascript:showNotes()"
                                  onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                  onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHemoglobin"/>*</a></i></td>
                    </tr>
