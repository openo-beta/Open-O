...
<table width="100%" border="0">
    <tr>
        <td align="left"><%=request.getParameter("name") != null ? request.getParameter("name") : ""%>
        </td>
    </tr>
</table>
...
%>
            <tr bgcolor="<%=bgcolor%>">
                <td align="center"><%=s.getId()%>
                </td>
                <td><a
                        href="<%=s.getStudyLink()%>?demographic_no=<%=request.getParameter("demographic_no")%>&study_no=<%=s.getId()%>"><%=s.getStudyName()%>
                </a></td>
                <td><%=s.getDescription()%>
                </td>
            </tr>
