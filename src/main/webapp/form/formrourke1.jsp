...
// Declaring valid date character, minimum year and maximum year
    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <input type="hidden" name="c_lastVisited"
               value="<%=Encode.forHtml(String.valueOf(props.getProperty("c_lastVisited", "1")))%>"/>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr align="center">
                ...
                <td colspan="3">(yyyy/mm/dd) <input type="text" name="p1_date1w"
                                                    size="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_date1w", "")))%>"/></td>
                <td colspan="3">(yyyy/mm/dd) <input type="text" name="p1_date2w"
                                                    size="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_date2w", "")))%>"/></td>
                <td colspan="3">(yyyy/mm/dd) <input type="text" name="p1_date1m"
                                                    size="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_date1m", "")))%>"/></td>
                <td colspan="3">(yyyy/mm/dd) <input type="text" name="p1_date2m"
                                                    size="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_date2m", "")))%>"/></td>
            </tr>
            <tr align="center">
                    ...
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_nutrition1w"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_nutrition1w", "")))%>"/></td>
                        </tr>
                        <tr>
                ...
                <td colspan="3" valign="top">
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_nutrition2w"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_nutrition2w", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                ...
                <td colspan="3" valign="top">
                    <table height="100%">
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_nutrition1m"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_nutrition1m", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                ...
                <td colspan="3" valign="top">
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_nutrition2m"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_nutrition2m", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                            ...
                            <td nowrap="true"><b><a
                                    href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>n_breastFeeding">Breast feeding</a>*<br>
                                &nbsp;&nbsp;Vit.D 10ug=400IU/day*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                    ...
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_educationAdvice1w", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_carSeat1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_carSeat1w", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_sleepPos1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sleepPos1w", "")))%>></td>
                            <td><b><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>o_sleepPosition">Sleep
                                position</a>*</b>
                            <td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_temp1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_temp1w", "")))%>></td>
                            <td><i>Temperature control &amp; overdressing</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_smoke1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_smoke1w", "")))%>></td>
                    ...
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_educationAdvice2w", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_carSeat2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_carSeat2w", "")))%>></td>
                            <td><b><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>s_motorVehicleAccidents">Car
                                seat (infant)</a>*</b></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_sleeping2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sleeping2w", "")))%>></td>
                            <td>Sleeping/crying</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_sooth2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sooth2w", "")))%>></td>
                            <td>Soothability/ responsiveness</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_bonding2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_bonding2w", "")))%>></td>
                            <td>Parenting/bonding</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_fatigue2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fatigue2w", "")))%>></td>
                            <td>Fatigue/depression</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_family2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_family2w", "")))%>></td>
                            <td>Family conflict/stress</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_siblings2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_siblings2w", "")))%>></td>
                            <td>Siblings</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_sleepPos2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sleepPos2w", "")))%>></td>
                            <td><b><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>o_sleepPosition">Sleep
                                position</a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_temp2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_temp2w", "")))%>></td>
                            <td><i>Temperature control &amp; overdressing</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_smoke2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_smoke2w", "")))%>></td>
                            <td><b><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>o_secondHandSmoke">Second
                                hand smoke</a>* </b></td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_educationAdvice1m", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                        ...
                        <tr>
                            ...
                            <td><i><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>s_burns">Non-inflam.
                                sleepwear</a></i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hotWater1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hotWater1m", "")))%>></td>
                            <td><i><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>s_burns">Hot water &lt;
                                54&deg;C</a>*</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_toys1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_toys1m", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_crying1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_crying1m", "")))%>></td>
                            <td>Sleep/crying</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_sooth1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sooth1m", "")))%>></td>
                            <td>Soothability/ responsiveness</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_supports1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_supports1m", "")))%>></td>
                    ...
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_educationAdvice2m", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_falls2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_falls2m", "")))%>></td>
                            <td><i><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>s_falls">Falls</a>*</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_toys2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_toys2m", "")))%>></td>
                            <td><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>s_choking">Choking/safe toys</a>*</td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_crying2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_crying2m", "")))%>></td>
                            <td>Sleep/crying</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_sooth2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sooth2m", "")))%>></td>
                            <td>Soothability/ responsiveness</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_stress2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stress2m", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_fever2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fever2m", "")))%>></td>
                            <td>Fever control</td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table width="100%">
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_development1w", "")))%>"/></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top" align="center">
                    <table width="100%">
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_development2w", "")))%>"/></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_development1m", "")))%>"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_startles1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_startles1m", "")))%>></td>
                            <td>Startles to loud or sudden noise</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_sucks1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sucks1m", "")))%>></td>
                    ...
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_development2m", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_sounds2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sounds2m", "")))%>></td>
                            <td>Has a variety of sounds &amp; cries</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_headUp2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_headUp2m", "")))%>></td>
                            <td>Holds head up when held at adult&#146;s shoulder</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_cuddled2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_cuddled2m", "")))%>></td>
                ...
                <td colspan="3" valign="top">
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_physical1w"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_physical1w", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_skin1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_skin1w", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_eyes1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_eyes1w", "")))%>></td>
                            <td><i>Eyes (red reflex)</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_ears1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_ears1w", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hips1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips1w", "")))%>></td>
                            <td><b>Hips</b></td>
                        </tr>
                        <tr>
                ...
                <td colspan="3" valign="top">
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_physical2w"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_physical2w", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_skin2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_skin2w", "")))%>></td>
                            <td><i>Skin (jaundice, dry)</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_eyes2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_eyes2w", "")))%>></td>
                            <td><i>Eyes (red reflex)</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_ears2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_ears2w", "")))%>></td>
                            <td><i>Ears (drums)</i></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hips2w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips2w", "")))%>></td>
                            <td><b>Hips</b></td>
                        </tr>
                        <tr>
                ...
                <td colspan="3" valign="top">
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_physical1m"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_physical1m", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_eyes1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_eyes1m", "")))%>></td>
                            <td><i>Eyes (red reflex)</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_cover1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_cover1m", "")))%>></td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hearing1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hearing1m", "")))%>></td>
                            <td><b>Hearing inquiry</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_heart1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heart1m", "")))%>></td>
                            <td>Heart</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hips1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips1m", "")))%>></td>
                            <td><b>Hips</b></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_physical2m"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_physical2m", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_eyes2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_eyes2m", "")))%>></td>
                            <td><i>Eyes (red reflex)</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_cover2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_cover2m", "")))%>></td>
                            <td></i><b><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>pe_cover">Cover/uncover
                                test &amp; inquiry</a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hearing2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hearing2m", "")))%>></td>
                            <td><b>Hearing inquiry</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_heart2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heart2m", "")))%>></td>
                            <td>Heart</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hips2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips2m", "")))%>></td>
                            <td><b>Hips</b></td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="3" valign="top">
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_problems1w"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_problems1w", "")))%>"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><b><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>pp_hemoglobinopathyScreening">Hemoglobinopathy
                ...
                <td colspan="3" valign="top">
                    <table width="100%">
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_problems2w"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_problems2w", "")))%>"/></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table width="100%">
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_problems1m"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_problems1m", "")))%>"/></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table width="100%">
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   name="p1_problems2m"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_problems2m", "")))%>"/></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_immunization1w", "")))%>"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><input type="checkbox" name="p1_hepB1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hepB1w", "")))%>></td>
                            <td width="100%"><b><a href="<%=Encode.forHtmlAttribute(String.valueOf(resource))%>i_hepB">Hep.
                                B vaccine</a>*</b></td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table width="100%">
                        <tr>
                            <td colspan="2" align="center"><input type="text" class="wide"
                                                                  ...
                                                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_immunization2w", "")))%>"/>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table>
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_immunization1m", "")))%>"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_immuniz1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_immuniz1m", "")))%>></td>
                            <td width="100%">Immunization</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                                                    name="p1_acetaminophen1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_acetaminophen1m", "")))%>></td>
                            <td>Acetaminophen</td>
                        </tr>
                        <tr>
                            <td colspan="2">If HBsAg-positive parent or sibling:</td>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hepB1m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hepB1m", "")))%>></td>
                    ...
                    <table width="100%">
                        <tr align="center">
                            <td colspan="2"><input type="text" class="wide"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p1_immunization2m", "")))%>"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox"
                                                    name="p1_acetaminophen2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_acetaminophen2m", "")))%>></td>
                            <td width="100%">Acetaminophen</td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_hib2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hib2m", "")))%>></td>
                            <td><b>HIB</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" name="p1_polio2m"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_polio2m", "")))%>></td>
