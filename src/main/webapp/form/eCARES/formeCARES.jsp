...
<body>
	...
	<div class="container main-container" style="padding-bottom: 80px;">
		...
		<form name="formeCARES" class="form-inline" role="form" method="post" action="${pageContext.servletContext.contextPath}/formeCARES.do" id="formeCARES">
			<input type="hidden" name="demographicNo" value="${ not empty param.demographicNo ? param.demographicNo : param.demographic_no }" />
			<input type="hidden" name="appointmentNo" value="${ not empty param.appointmentNo ? param.appointmentNo : param.appointment_no }" />
						...
						<div>
						    <div class="flex items-center">
                                <div>
                                    ...
                                    </svg><input type="checkbox" class="action-required" name="adj_required" data-score="1">
                                    <strong class="highlight" data-field-name="adj_required">Adjustment Required</strong>
                                </div>
					...
					<div class="flex-2">
						...
						<div id="frailty-index-container">
                            <div class="flex pl-2 items-center" >
                                ...
                                Extreme (Over 0.5)">
                                <input style="width: 40px; color:black; border: 1px solid gray; background-color: rgb(223, 223, 223);" name="deficit_based_frailty_score" readonly type="text"  />
                                </span>
                            </div>
                        </div>
					</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default continueButton" data-dismiss="modal">No, continue editing</button>
