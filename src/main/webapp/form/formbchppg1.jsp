...
<html>
        ...
        <table class="Head" class="hidePrint">
            <tr>
                ...
                <td align="right"><b>Edit:</b>HP <font size=-2>(pg.1)</font> | <a
                        href="form/formbchppg2.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>">HP
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="2">
                        <tr>
                            ...
                            <td><input type="text" name="pg1_patientName"
                                       ...
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_patientName", "")))%>"
                                       @oscar.formDB/></td>
                            <td>Date:</td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="pg1_phn" id="pg1_phn"
                                       ...
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_phn", "")))%>" @oscar.formDB/>
                            </td>
                            <td>Tel:</td>
                            <td><input type="text" name="pg1_phone" id="pg1_phone"
                                       style="width: 100%" size="15" maxlength="15"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_phone", "")))%>" @oscar.formDB/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="pg1_emergContact"
                                       ...
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_emergContact", "")))%>"
                                       @oscar.formDB/></td>
                            <td>Tel:</td>
                            <td><input type="text" name="pg1_emergContactPhone"
                                       id="pg1_emergContactPhone" style="width: 100%" size="15"
                                       maxlength="15"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_emergContactPhone", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                        <tr>
                            <td>Allergies:</td>
                            <td colspan="3"><input type="text" name="pg1_allergies"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_allergies", "")))%>"
                                                   @oscar.formDB/></td>
                        </tr>
                        <tr>
                            <td colspan="2">MD: <input type="text" name="pg1_md"
                                                       id="pg1_md" style="width: 60%" size="30" maxlength="40"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_md", "")))%>" @oscar.formDB/>
                                MSP for lab cc: <input type="text" name="pg1_msp" id="pg1_msp"
                                                       style="width: 15%" size="10" maxlength="9"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_msp", "")))%>" @oscar.formDB/>
                            </td>
                            <td>Tel:</td>
                            <td><input type="text" name="pg1_mdPhone" id="pg1_mdPhone"
                                       style="width: 100%" size="15" maxlength="15"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_mdPhone", "")))%>" @oscar.formDB/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">Living Will / Advanced Care Directive:
                                &nbsp;&nbsp;Yes <input type="checkbox" name="pg1_livingWillY"
                                                       id="pg1_livingWillY"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_livingWillY", "")))%> @oscar.formDB
                                                       dbType="tinyint(1)"/> &nbsp;&nbsp;No <input type="checkbox"
                                                                                                   name="pg1_livingWillN"
                                                                                                   id="pg1_livingWillN"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_livingWillN", "")))%> @oscar.formDB
                                                                                                   dbType="tinyint(1)"/>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="2">
                        <tr>
                            <td width="1%"><input type="checkbox" name="pg1_diabetes"
                                                  id="pg1_diabetes"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_diabetes", "")))%> @oscar.formDB
                                                  dbType="tinyint(1)"/></td>
                            <td width="24%">Diabetes</td>
                            <td width="1%"><input type="checkbox" name="pg1_atrialFib"
                                                  id="pg1_atrialFib"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_atrialFib", "")))%> @oscar.formDB
                                                  dbType="tinyint(1)"/></td>
                            <td width="24%">Atrial fibrillation</td>
                            <td width="1%"><input type="checkbox" name="pg1_coronary"
                                                  id="pg1_coronary"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_coronary", "")))%> @oscar.formDB
                                                  dbType="tinyint(1)"/></td>
                            <td width="34%">Coronary heart disease</td>
                            <td width="1%"><input type="checkbox" name="pg1_highBP"
                                                  id="pg1_highBP"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_highBP", "")))%> @oscar.formDB
                                                  dbType="tinyint(1)"/></td>
                            <td width="14%">High BP</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="pg1_chf" id="pg1_chf"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_chf", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td>CHF</td>
                            <td><input type="checkbox" name="pg1_stroke" id="pg1_stroke"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_stroke", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td>Stroke</td>
                            <td><input type="checkbox" name="pg1_kidneyDisease"
                                       id="pg1_kidneyDisease"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_kidneyDisease", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td>Kidney disease / low GFR <input type="text"
                                                                name="pg1_lowGFR" id="pg1_lowGFR" size="5"
                                                                maxlength="10"
                                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_lowGFR", "")))%>"
                                                                @oscar.formDB/>
                            </td>
                            <td><input type="checkbox" name="pg1_asthma" id="pg1_asthma"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_asthma", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td>Asthma</td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="pg1_copd" id="pg1_copd"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_copd", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td>COPD</td>
                            <td><input type="checkbox" name="pg1_co2retainer"
                                       id="pg1_co2retainer"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_co2retainer", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td>CO2 retainer</td>
                            <td><input type="checkbox" name="pg1_cancer" id="pg1_cancer"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_cancer", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td colspan="3">Cancer <input type="text"
                                                          name="pg1_cancerSpec" id="pg1_cancerSpec" size="48"
                                                          maxlength="40"
                                                          value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_cancerSpec", "")))%>"
                                                          @oscar.formDB/></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="pg1_other" id="pg1_other"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_other", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td colspan="7">Other <input type="text" name="pg1_otherSpec"
                                                         id="pg1_otherSpec" size="108" maxlength="90"
                                                         value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_otherSpec", "")))%>"
                                                         @oscar.formDB/></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="pg1_majorSurg"
                                       id="pg1_majorSurg"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_majorSurg", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td colspan="7">Major surg.&nbsp; <input type="text"
                                                                     name="pg1_majorSurgSpec" id="pg1_majorSurgSpec"
                                                                     size="103"
                                                                     maxlength="80"
                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_majorSurgSpec", "")))%>"
                                                                     @oscar.formDB/></td>
                        </tr>
                    </table>
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td><input type="text" name="pg1_date1" id="pg1_date1"
                           ...
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date1", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date1_cal">
                </td>
                <td><input type="text" name="pg1_medName1" id="pg1_medName1"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName1", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose1" id="pg1_dose1"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose1", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften1" id="pg1_howOften1"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften1", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason1" id="pg1_reason1"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason1", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date2" id="pg1_date2"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date2", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date2_cal">
                </td>
                <td><input type="text" name="pg1_medName2" id="pg1_medName2"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName2", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose2" id="pg1_dose2"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose2", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften2" id="pg1_howOften2"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften2", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason2" id="pg1_reason2"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason2", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date3" id="pg1_date3"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date3", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date3_cal">
                </td>
                <td><input type="text" name="pg1_medName3" id="pg1_medName3"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName3", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose3" id="pg1_dose3"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose3", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften3" id="pg1_howOften3"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften3", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason3" id="pg1_reason3"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason3", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date4" id="pg1_date4"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date4", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date4_cal">
                </td>
                <td><input type="text" name="pg1_medName4" id="pg1_medName4"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName4", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose4" id="pg1_dose4"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose4", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften4" id="pg1_howOften4"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften4", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason4" id="pg1_reason4"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason4", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date5" id="pg1_date5"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date5", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date5_cal">
                </td>
                <td><input type="text" name="pg1_medName5" id="pg1_medName5"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName5", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose5" id="pg1_dose5"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose5", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften5" id="pg1_howOften5"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften5", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason5" id="pg1_reason5"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason5", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date6" id="pg1_date6"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date6", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date6_cal">
                </td>
                <td><input type="text" name="pg1_medName6" id="pg1_medName6"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName6", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose6" id="pg1_dose6"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose6", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften6" id="pg1_howOften6"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften6", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason6" id="pg1_reason6"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason6", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date7" id="pg1_date7"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date7", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date7_cal">
                </td>
                <td><input type="text" name="pg1_medName7" id="pg1_medName7"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName7", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose7" id="pg1_dose7"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose7", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften7" id="pg1_howOften7"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften7", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason7" id="pg1_reason7"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason7", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date8" id="pg1_date8"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date8", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date8_cal">
                </td>
                <td><input type="text" name="pg1_medName8" id="pg1_medName8"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName8", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose8" id="pg1_dose8"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose8", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften8" id="pg1_howOften8"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften8", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason8" id="pg1_reason8"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason8", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date9" id="pg1_date9"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date9", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date9_cal">
                </td>
                <td><input type="text" name="pg1_medName9" id="pg1_medName9"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName9", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_dose9" id="pg1_dose9"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose9", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften9" id="pg1_howOften9"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften9", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason9" id="pg1_reason9"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason9", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date10" id="pg1_date10"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date10", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date10_cal">
                </td>
                <td><input type="text" name="pg1_medName10" id="pg1_medName10"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName10", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_dose10" id="pg1_dose10"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose10", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften10"
                           id="pg1_howOften10" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften10", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason10" id="pg1_reason10"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason10", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date11" id="pg1_date11"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date11", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date11_cal">
                </td>
                <td><input type="text" name="pg1_medName11" id="pg1_medName11"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName11", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_dose11" id="pg1_dose11"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose11", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften11"
                           id="pg1_howOften11" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften11", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason11" id="pg1_reason11"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason11", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date12" id="pg1_date12"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date12", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date12_cal">
                </td>
                <td><input type="text" name="pg1_medName12" id="pg1_medName12"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName12", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_dose12" id="pg1_dose12"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose12", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften12"
                           id="pg1_howOften12" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften12", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason12" id="pg1_reason12"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason12", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date13" id="pg1_date13"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date13", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date13_cal">
                </td>
                <td><input type="text" name="pg1_medName13" id="pg1_medName13"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName13", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_dose13" id="pg1_dose13"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose13", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften13"
                           id="pg1_howOften13" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften13", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason13" id="pg1_reason13"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason13", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg1_date14" id="pg1_date14"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_date14", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_date14_cal">
                </td>
                <td><input type="text" name="pg1_medName14" id="pg1_medName14"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_medName14", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_dose14" id="pg1_dose14"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_dose14", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg1_howOften14"
                           id="pg1_howOften14" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_howOften14", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg1_reason14" id="pg1_reason14"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_reason14", "")))%>" @oscar.formDB/>
                </td>
            </tr>
        </table>
        <table width="100%" border="0" cellpadding="0" cellspacing="10">
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><input type="text" name="pg1_fluDate1" id="pg1_fluDate1"
                           ...
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_fluDate1", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg1_fluDate2" id="pg1_fluDate2"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_fluDate2", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg1_fluDate2_cal"></td>
                <td><input type="text" name="pg1_fluDate3" id="pg1_fluDate3"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_fluDate3", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg1_fluDate3_cal"></td>
                <td><input type="text" name="pg1_fluDate4" id="pg1_fluDate4"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_fluDate4", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg1_fluDate4_cal"></td>
                <td><input type="text" name="pg1_fluDate5" id="pg1_fluDate5"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_fluDate5", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg1_fluDate5_cal"></td>
                <td><input type="text" name="pg1_fluDate6" id="pg1_fluDate6"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_fluDate6", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg1_fluDate6_cal"></td>
                <td><input type="text" name="pg1_fluDate7" id="pg1_fluDate7"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_fluDate7", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
            ...
            <tr onmouseover="showHideBox('comment1Div',1)"
                ...
                <td><input type="text" name="pg1_pneumoVaccDate1"
                           ...
                           maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_pneumoVaccDate1", "")))%>"
            ...
            <tr onmouseover="showHideBox('comment2Div',1)"
                ...
                <td><input type="text" name="pg1_tdDate1" id="pg1_tdDate1"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_tdDate1", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_tdDate1_cal">
                </td>
                <td><input type="text" name="pg1_tdDate2" id="pg1_tdDate2"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_tdDate2", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_tdDate2_cal">
                </td>
                <td><input type="text" name="pg1_tdDate3" id="pg1_tdDate3"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_tdDate3", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_tdDate3_cal">
                </td>
                <td><input type="text" name="pg1_tdDate4" id="pg1_tdDate4"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_tdDate4", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_tdDate4_cal">
                </td>
                <td><input type="text" name="pg1_tdDate5" id="pg1_tdDate5"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_tdDate5", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_tdDate5_cal">
                </td>
                <td><input type="text" name="pg1_tdDate6" id="pg1_tdDate6"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_tdDate6", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_tdDate6_cal">
                </td>
                <td><input type="text" name="pg1_tdDate7" id="pg1_tdDate7"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_tdDate7", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_tdDate7_cal">
                </td>
            </tr>
            <tr onmouseover="showHideBox('comment3Div',1)"
                ...
                <td><input type="text" name="pg1_hepaDate1" id="pg1_hepaDate1"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepaDate1", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepaDate1_cal"></td>
                <td><input type="text" name="pg1_hepaDate2" id="pg1_hepaDate2"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepaDate2", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepaDate2_cal"></td>
                <td><input type="text" name="pg1_hepaDate3" id="pg1_hepaDate3"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepaDate3", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepaDate3_cal"></td>
                <td><input type="text" name="pg1_hepaDate4" id="pg1_hepaDate4"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepaDate4", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepaDate4_cal"></td>
                <td><input type="text" name="pg1_hepaDate5" id="pg1_hepaDate5"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepaDate5", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepaDate5_cal"></td>
                <td><input type="text" name="pg1_hepaDate6" id="pg1_hepaDate6"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepaDate6", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepaDate6_cal"></td>
                <td><input type="text" name="pg1_hepaDate7" id="pg1_hepaDate7"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepaDate7", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
            ...
            <tr onmouseover="showHideBox('comment4Div',1)"
                ...
                <td><input type="text" name="pg1_hepbDate1" id="pg1_hepbDate1"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepbDate1", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepbDate1_cal"></td>
                <td><input type="text" name="pg1_hepbDate2" id="pg1_hepbDate2"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepbDate2", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepbDate2_cal"></td>
                <td><input type="text" name="pg1_hepbDate3" id="pg1_hepbDate3"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepbDate3", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepbDate3_cal"></td>
                <td><input type="text" name="pg1_hepbDate4" id="pg1_hepbDate4"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepbDate4", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepbDate4_cal"></td>
                <td><input type="text" name="pg1_hepbDate5" id="pg1_hepbDate5"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepbDate5", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepbDate5_cal"></td>
                <td><input type="text" name="pg1_hepbDate6" id="pg1_hepbDate6"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepbDate6", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                              id="pg1_hepbDate6_cal"></td>
                <td><input type="text" name="pg1_hepbDate7" id="pg1_hepbDate7"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_hepbDate7", "")))%>"
                           @oscar.formDB dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
    ...
    <script type="text/javascript">
        Calendar.setup({
            inputField: "pg1_date1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date8",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date8_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date9",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date9_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date10",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date10_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date11",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date11_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date12",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date12_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date13",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date13_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_date14",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_date14_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_fluDate1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_fluDate1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_fluDate2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_fluDate2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_fluDate3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_fluDate3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_fluDate4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_fluDate4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_fluDate5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_fluDate5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_fluDate6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_fluDate6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_fluDate7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_fluDate7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_pneumoVaccDate1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_pneumoVaccDate1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_pneumoVaccDate2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_pneumoVaccDate2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_pneumoVaccDate3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_pneumoVaccDate3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_pneumoVaccDate4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_pneumoVaccDate4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_pneumoVaccDate5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_pneumoVaccDate5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_pneumoVaccDate6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_pneumoVaccDate6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_pneumoVaccDate7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_pneumoVaccDate7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_tdDate1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_tdDate1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_tdDate2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_tdDate2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_tdDate3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_tdDate3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_tdDate4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_tdDate4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_tdDate5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_tdDate5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_tdDate6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_tdDate6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_tdDate7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_tdDate7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepaDate1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepaDate1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepaDate2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepaDate2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepaDate3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepaDate3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepaDate4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepaDate4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepaDate5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepaDate5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepaDate6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepaDate6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepaDate7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepaDate7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepbDate1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepbDate1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepbDate2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepbDate2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepbDate3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepbDate3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepbDate4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepbDate4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepbDate5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepbDate5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepbDate6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepbDate6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_hepbDate7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_hepbDate7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_otherDate1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_otherDate1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_otherDate2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_otherDate2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_otherDate3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_otherDate3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_otherDate4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_otherDate4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_otherDate5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_otherDate5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_otherDate6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_otherDate6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg1_otherDate7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg1_otherDate7_cal",
            singleClick: true,
            step: 1
        });
    </script>
