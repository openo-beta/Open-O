                                        ...
                                        <table width="100%" height="590px" border="0" cellspacing="1"
                                            ...
                                            <tr>
                                                <td class="question" colspan="5">Currently, how much
                                                    difficulty do you have in doing the activity without the help of
                                                    someone else, and without the use of a cane, walker or any other
                                                    assistive walking device? <br>
                                                    <br>
                                                </td>
                                            </tr>
                                            <tr bgcolor="white">
                                            ...
                                            <tr bgcolor="white">
                                                <td align="center" valign="top" width="10%">You have no
                                                    difficulty doing the activity alone
                                                </td>
                                                <td align="center" valign="top" width="20%">You can do it
                                                    alone with a little bit of difficult
                                                </td>
                                                <td align="center" valign="top" width="25%">You can do it,
                                                    but you have a moderate amount of difficulty doing it alone
                                                </td>
                                                <td align="center" valign="top" width="31%">You can manage
                                                    without help, but you have quite a lot of difficulty doing it
                                                </td>
                                                <td align="center" valign="top" width="34%">It is so
                                                    difficult, that you cannot do it unless you have help
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
