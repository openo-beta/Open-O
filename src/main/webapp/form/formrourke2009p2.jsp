...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    ...
    <tr align="center" id="growthAp2">
        ...
        <td colspan="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHdCirc"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHt"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formWt6m"/></td>
        <td colspan="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHdCirc"/></td>
    </tr>
    <tr align="center" id="growthBp2">
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p2_ht2m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_ht2m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p2_wt2m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_wt2m", "")))%>"></td>
        <td colspan="2"><input type="text" class="wide"
                               ondblclick="htEnglish2Metric(this);" name="p2_hc2m" size="4"
                               maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_hc2m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p2_ht4m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_ht4m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p2_wt4m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_wt4m", "")))%>"></td>
        <td colspan="2"><input type="text" class="wide"
                               ondblclick="htEnglish2Metric(this);" name="p2_hc4m" size="4"
                               maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_hc4m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p2_ht6m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_ht6m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p2_wt6m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_wt6m", "")))%>"></td>
        <td colspan="2"><input type="text" class="wide"
                               ondblclick="htEnglish2Metric(this);" name="p2_hc6m" size="4"
                               maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_hc6m", "")))%>"></td>
    </tr>
    <tr align="center">
        ...
        <td colspan="4"><textarea id="p2_pConcern2m"
                                  ...
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_pConcern2m", "")))%></textarea>
        </td>
        <td colspan="4"><textarea id="p2_pConcern4m"
                                  name="p2_pConcern4m" class="wide" cols="10"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_pConcern4m", "")))%></textarea>
        </td>
        <td colspan="4"><textarea id="p2_pConcern6m"
                                  name="p2_pConcern6m" class="wide" cols="10"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_pConcern6m", "")))%></textarea>
        </td>
    </tr>
            ...
            <table id="ntp21" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_breastFeeding2mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding2mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding2mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding2mNo"
                                            name="p2_breastFeeding2mNo" onclick="onCheck(this,'p2_breastFeeding2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding2mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding2mNotDiscussed"
                                            name="p2_breastFeeding2mNotDiscussed"
                                            onclick="onCheck(this,'p2_breastFeeding2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding2mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              ...
                              onMouseOut="hideLayer()"
                              onclick="popPage('<%=Encode.forJavaScript(String.valueOf(resource))%>n_breastFeeding');return false"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.btnBreastFeeding"/><br/>
                    </a><span
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding2mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding2mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding2mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding2mNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding2mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding2mNotDiscussed"
                                            name="p2_formulaFeeding2mNotDiscussed"
                                            onclick="onCheck(this,'p2_formulaFeeding2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding2mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()" href="javascript:showNotes()"><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.msgFormulaFeeding2m"/></i></a></td>
                </tr>
                ...
                <tr>
                    <td style="vertical-align: bottom;" colspan="5">
						<textarea id="p2_nutrition2m"
                                  ...
                                  cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_nutrition2m", "")))%></textarea>
                    </td>
                </tr>
            </table>
            ...
            <table id="ntp22" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_breastFeeding4mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding4mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding4mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding4mNo"
                                            name="p2_breastFeeding4mNo" onclick="onCheck(this,'p2_breastFeeding4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding4mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding4mNotDiscussed"
                                            name="p2_breastFeeding4mNotDiscussed"
                                            onclick="onCheck(this,'p2_breastFeeding4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding4mNotDiscussed", "")))%>></td>
                    <td><b><a
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding4mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding4mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding4mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding4mNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding4mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding4mNotDiscussed"
                                            name="p2_formulaFeeding4mNotDiscussed"
                                            onclick="onCheck(this,'p2_formulaFeeding4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding4mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()" href="javascript:showNotes()"><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.msgFormulaFeeding4m"/></i></a></td>
                </tr>
                ...
                <tr>
                    <td style="vertical-align: bottom;" colspan="5"><textarea id="p2_nutrition4m"
                                                                              ...
                                                                              rows="5"
                                                                              cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_nutrition4m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="ntp23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_breastFeeding6mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding6mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding6mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding6mNo"
                                            name="p2_breastFeeding6mNo" onclick="onCheck(this,'p2_breastFeeding6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding6mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_breastFeeding6mNotDiscussed"
                                            name="p2_breastFeeding6mNotDiscussed"
                                            onclick="onCheck(this,'p2_breastFeeding6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_breastFeeding6mNotDiscussed", "")))%>></td>
                    <td><b><a
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()" href="javascript:showNotes()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.btnBreastFeeding"/></a><br/>
                        <span
                                onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.msgBreastFeedingDescr6m"/></span></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding6mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding6mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding6mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding6mNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding6mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_formulaFeeding6mNotDiscussed"
                                            name="p2_formulaFeeding6mNotDiscussed"
                                            onclick="onCheck(this,'p2_formulaFeeding6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_formulaFeeding6mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.msgFormulaFeedingLong6m"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p2_bottle6mOk"
                                            name="p2_bottle6mOk" onclick="onCheck(this,'p2_bottle6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_bottle6mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_bottle6mOkConcerns"
                                            name="p2_bottle6mOkConcerns" onclick="onCheck(this,'p2_bottle6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_bottle6mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p2_bottle6mNotDiscussed"
                                            name="p2_bottle6mNotDiscussed" onclick="onCheck(this,'p2_bottle6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_bottle6mNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_liquids6mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_liquids6mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_liquids6mOkConcerns"
                                            name="p2_liquids6mOkConcerns" onclick="onCheck(this,'p2_liquids6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_liquids6mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p2_liquids6mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_liquids6mNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_iron6mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_iron6mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_iron6mOkConcerns"
                                            name="p2_iron6mOkConcerns" onclick="onCheck(this,'p2_iron6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_iron6mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p2_iron6mNotDiscussed"
                                            name="p2_iron6mNotDiscussed" onclick="onCheck(this,'p2_iron6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_iron6mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgIronFoods"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p2_vegFruit6mOk"
                                            name="p2_vegFruit6mOk" onclick="onCheck(this,'p2_vegFruit6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_vegFruit6mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_vegFruit6mOkConcerns"
                                            name="p2_vegFruit6mOkConcerns" onclick="onCheck(this,'p2_vegFruit6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_vegFruit6mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p2_vegFruit6mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_vegFruit6mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgVegFruits"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p2_egg6mOk"
                                            name="p2_egg6mOk" onclick="onCheck(this,'p2_egg6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_egg6mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_egg6mOkConcerns"
                                            name="p2_egg6mOkConcerns" onclick="onCheck(this,'p2_egg6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_egg6mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p2_egg6mNotDiscussed"
                                            name="p2_egg6mNotDiscussed" onclick="onCheck(this,'p2_egg6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_egg6mNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_choking6mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_choking6mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_choking6mOkConcerns"
                                            name="p2_choking6mOkConcerns" onclick="onCheck(this,'p2_choking6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_choking6mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p2_choking6mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_choking6mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr align="center" style="vertical-align:bottom;">
                    <td colspan="5"><textarea id="p2_nutrition6m"
                                              ...
                                              cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_nutrition6m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="edt2" style="font-size: 8pt;" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    ...
                    <td valign="top"><input type="radio" id="p2_firearmSafetyOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_firearmSafetyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_firearmSafetyOkConcerns"
                                            name="p2_firearmSafetyOkConcerns"
                                            onclick="onCheck(this,'p2_firearmSafety')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_firearmSafetyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_firearmSafetyNotDiscussed"
                                            name="p2_firearmSafetyNotDiscussed"
                                            onclick="onCheck(this,'p2_firearmSafety')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_firearmSafetyNotDiscussed", "")))%>></td>
                    <td valign="top"><b><a
                ...
                <tr>
                    ...
                    <td valign="top"><input type="radio" id="p2_smokeSafetyOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_smokeSafetyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_smokeSafetyOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_smokeSafetyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_smokeSafetyNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_smokeSafetyNotDiscussed", "")))%>></td>
          ...
          -->
                ...
                <tr>
                    ...
                    <td valign="top"><input type="radio" id="p2_soothabilityOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_soothabilityOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_soothabilityOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_soothabilityOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_soothabilityNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_soothabilityNotDiscussed", "")))%>></td>
                    ...
                    <td valign="top"><input type="radio" id="p2_homeVisitOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_homeVisitOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_homeVisitOkConcerns"
                                            name="p2_homeVisitOkConcerns" onclick="onCheck(this,'p2_homeVisit')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_homeVisitOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_homeVisitNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_homeVisitNotDiscussed", "")))%>></td>
                    <td colspan="7" valign="top"><b><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.formHomeVisit"/>**</a></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p2_bondingOk"
                                            name="p2_bondingOk" onclick="onCheck(this,'p2_bonding')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_bondingOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_bondingOkConcerns"
                                            name="p2_bondingOkConcerns" onclick="onCheck(this,'p2_bonding')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_bondingOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_bondingNotDiscussed"
                                            name="p2_bondingNotDiscussed" onclick="onCheck(this,'p2_bonding')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_bondingNotDiscussed", "")))%>></td>
                    ...
                    <td valign="top"><input type="radio" id="p2_famConflictOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_famConflictOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_famConflictOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_famConflictOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_famConflictNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_famConflictNotDiscussed", "")))%>></td>
                    ...
                    <td valign="top"><input type="radio" id="p2_childCareOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_childCareOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_childCareOkConcerns"
                                            name="p2_childCareOkConcerns" onclick="onCheck(this,'p2_childCare')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_childCareOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_childCareNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_childCareNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                                        onMouseOut="hideLayer()"><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.formChildCare"/></i></a></td>
                </tr>
             ...
             -->
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_tmpControlOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_tmpControlOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_tmpControlOkConcerns"
                                            name="p2_tmpControlOkConcerns" onclick="onCheck(this,'p2_tmpControl')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_tmpControlOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_tmpControlNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_tmpControlNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                    ...
                    <td valign="top"><input type="radio" id="p2_sunExposureOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_sunExposureOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_sunExposureOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_sunExposureOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_sunExposureNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_sunExposureNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                    ...
                    <td valign="top"><input type="radio" id="p2_pesticidesOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_pesticidesOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_pesticidesOkConcerns"
                                            name="p2_pesticidesOkConcerns" onclick="onCheck(this,'p2_pesticides')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_pesticidesOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_pesticidesNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_pesticidesNotDiscussed", "")))%>></td>
                    <td colspan="5" valign="top"><i><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_readingOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_readingOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_readingOkConcerns"
                                            name="p2_readingOkConcerns" onclick="onCheck(this,'p2_reading')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_readingOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_readingNotDiscussed"
                                            name="p2_readingNotDiscussed" onclick="onCheck(this,'p2_reading')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_readingNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.formReading"/>**</a></td>
                    <td valign="top"><input type="radio" id="p2_noCoughMedOk"
                                            name="p2_noCoughMedOk" onclick="onCheck(this,'p2_noCoughMed')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noCoughMedOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_noCoughMedOkConcerns"
                                            name="p2_noCoughMedOkConcerns" onclick="onCheck(this,'p2_noCoughMed')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noCoughMedOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_noCoughMedNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noCoughMedNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td colspan="20" style="vertical-align:bottom;">
						<textarea id="p2_education"
                                  ...
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_education", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="dt21" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_headUpTummyOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_headUpTummyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_headUpTummyOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_headUpTummyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_headUpTummyNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_headUpTummyNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns2mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_noParentsConcerns2mOkConcerns"
                                            name="p2_noParentsConcerns2mOkConcerns"
                                            onclick="onCheck(this,'p2_noParentsConcerns2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_noParentsConcerns2mNotDiscussed"
                                            name="p2_noParentsConcerns2mNotDiscussed"
                                            onclick="onCheck(this,'p2_noParentsConcerns2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns2mNotDiscussed", "")))%>></td>
                ...
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_development2m"
                                                                             ...
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_development2m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="dt22" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_movingObjOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_movingObjOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_movingObjOkConcerns"
                                            name="p2_movingObjOkConcerns" onclick="onCheck(this,'p2_movingObj')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_movingObjOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_movingObjNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_movingObjNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_headSteadyOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_headSteadyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_headSteadyOkConcerns"
                                            name="p2_headSteadyOkConcerns" onclick="onCheck(this,'p2_headSteady')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_headSteadyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_headSteadyNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_headSteadyNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns4mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_noParentsConcerns4mOkConcerns"
                                            name="p2_noParentsConcerns4mOkConcerns"
                                            onclick="onCheck(this,'p2_noParentsConcerns4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_noParentsConcerns4mNotDiscussed"
                                            name="p2_noParentsConcerns4mNotDiscussed"
                                            onclick="onCheck(this,'p2_noParentsConcerns4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns4mNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formNoparentConcerns"/></td>
                </tr>
                ...
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_development4m"
                                                                             ...
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_development4m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="dt23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_turnsHeadOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_turnsHeadOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_turnsHeadOkConcerns"
                                            name="p2_turnsHeadOkConcerns" onclick="onCheck(this,'p2_turnsHead')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_turnsHeadOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_turnsHeadNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_turnsHeadNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_makesSoundOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_makesSoundOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_makesSoundOkConcerns"
                                            name="p2_makesSoundOkConcerns" onclick="onCheck(this,'p2_makesSound')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_makesSoundOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_makesSoundNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_makesSoundNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_vocalizesOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_vocalizesOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_vocalizesOkConcerns"
                                            name="p2_vocalizesOkConcerns" onclick="onCheck(this,'p2_vocalizes')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_vocalizesOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_vocalizesNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_vocalizesNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_reachesGraspsOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_reachesGraspsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_reachesGraspsOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_reachesGraspsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p2_reachesGraspsNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_reachesGraspsNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.formreachesGrasps"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns6mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_noParentsConcerns6mOkConcerns"
                                            name="p2_noParentsConcerns6mOkConcerns"
                                            onclick="onCheck(this,'p2_noParentsConcerns6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_noParentsConcerns6mNotDiscussed"
                                            name="p2_noParentsConcerns6mNotDiscussed"
                                            onclick="onCheck(this,'p2_noParentsConcerns6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_noParentsConcerns6mNotDiscussed", "")))%>></td>
                ...
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_development6m"
                                                                             ...
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_development6m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="physicalExamp2">
        <!-- td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgPhysicalExamination"/></a><br>
			...
			<img height="15" width="20" src="graphics/Checkmark_Lwhite.gif"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.msgPhysicalExaminationLegend"/>
			</td-->
        <td colspan="4">
            <table id="pt21" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles2mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_fontanelles2mOkConcerns" name="p2_fontanelles2mOkConcerns"
                                            onclick="onCheck(this,'p2_fontanelles2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_fontanelles2mNotDiscussed" name="p2_fontanelles2mNotDiscussed"
                                            onclick="onCheck(this,'p2_fontanelles2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles2mNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes2mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_eyes2mOkConcerns" name="p2_eyes2mOkConcerns"
                                            onclick="onCheck(this,'p2_eyes2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_eyes2mNotDiscussed" name="p2_eyes2mNotDiscussed"
                                            onclick="onCheck(this,'p2_eyes2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes2mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a></b></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal2mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_corneal2mOkConcerns" name="p2_corneal2mOkConcerns"
                                            onclick="onCheck(this,'p2_corneal2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_corneal2mNotDiscussed" name="p2_corneal2mNotDiscussed"
                                            onclick="onCheck(this,'p2_corneal2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal2mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formCornealReflex"/>*</a></b></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing2mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hearing2mOkConcerns" name="p2_hearing2mOkConcerns"
                                            onclick="onCheck(this,'p2_hearing2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hearing2mNotDiscussed" name="p2_hearing2mNotDiscussed"
                                            onclick="onCheck(this,'p2_hearing2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing2mNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_heart2mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_heart2mOkConcerns" name="p2_heart2mOkConcerns"
                                            onclick="onCheck(this,'p2_heart2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_heart2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_heart2mNotDiscussed" name="p2_heart2mNotDiscussed"
                                            onclick="onCheck(this,'p2_heart2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_heart2mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHeart"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips2mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hips2mOkConcerns" name="p2_hips2mOkConcerns"
                                            onclick="onCheck(this,'p2_hips2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hips2mNotDiscussed" name="p2_hips2mNotDiscussed"
                                            onclick="onCheck(this,'p2_hips2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips2mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone2mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_muscleTone2mOkConcerns" name="p2_muscleTone2mOkConcerns"
                                            onclick="onCheck(this,'p2_muscleTone2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone2mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_muscleTone2mNotDiscussed" name="p2_muscleTone2mNotDiscussed"
                                            onclick="onCheck(this,'p2_muscleTone2m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone2mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formMuscleTone"/>*</a>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p2_physical2m"
                                  ...
                                  class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_physical2m", "")))%></textarea>
            ...
            <table id="pt22" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles4mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_fontanelles4mOkConcerns" name="p2_fontanelles4mOkConcerns"
                                            onclick="onCheck(this,'p2_fontanelles4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_fontanelles4mNotDiscussed" name="p2_fontanelles4mNotDiscussed"
                                            onclick="onCheck(this,'p2_fontanelles4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles4mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFontanelles"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes4mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_eyes4mOkConcerns" name="p2_eyes4mOkConcerns"
                                            onclick="onCheck(this,'p2_eyes4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_eyes4mNotDiscussed" name="p2_eyes4mNotDiscussed"
                                            onclick="onCheck(this,'p2_eyes4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes4mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a></b></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal4mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_corneal4mOkConcerns" name="p2_corneal4mOkConcerns"
                                            onclick="onCheck(this,'p2_corneal4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_corneal4mNotDiscussed" name="p2_corneal4mNotDiscussed"
                                            onclick="onCheck(this,'p2_corneal4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal4mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formCornealReflex"/>*</a></b></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing4mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hearing4mOkConcerns" name="p2_hearing4mOkConcerns"
                                            onclick="onCheck(this,'p2_hearing4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hearing4mNotDiscussed" name="p2_hearing4mNotDiscussed"
                                            onclick="onCheck(this,'p2_hearing4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing4mNotDiscussed", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHearingInquiry"/>*</a></i></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips4mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hips4mOkConcerns" name="p2_hips4mOkConcerns"
                                            onclick="onCheck(this,'p2_hips4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hips4mNotDiscussed" name="p2_hips4mNotDiscussed"
                                            onclick="onCheck(this,'p2_hips4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips4mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHips"/>*</a>
                    </td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone4mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_muscleTone4mOkConcerns" name="p2_muscleTone4mOkConcerns"
                                            onclick="onCheck(this,'p2_muscleTone4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone4mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_muscleTone4mNotDiscussed" name="p2_muscleTone4mNotDiscussed"
                                            onclick="onCheck(this,'p2_muscleTone4m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone4mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formMuscleTone"/>*</a>
                    </td>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p2_physical4m"
                                  ...
                                  class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_physical4m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="pt23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles6mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_fontanelles6mOkConcerns" name="p2_fontanelles6mOkConcerns"
                                            onclick="onCheck(this,'p2_fontanelles6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_fontanelles6mNotDiscussed" name="p2_fontanelles6mNotDiscussed"
                                            onclick="onCheck(this,'p2_fontanelles6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_fontanelles6mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFontanelles"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes6mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_eyes6mOkConcerns" name="p2_eyes6mOkConcerns"
                                            onclick="onCheck(this,'p2_eyes6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_eyes6mNotDiscussed" name="p2_eyes6mNotDiscussed"
                                            onclick="onCheck(this,'p2_eyes6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_eyes6mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a></b></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal6mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_corneal6mOkConcerns" name="p2_corneal6mOkConcerns"
                                            onclick="onCheck(this,'p2_corneal6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_corneal6mNotDiscussed" name="p2_corneal6mNotDiscussed"
                                            onclick="onCheck(this,'p2_corneal6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_corneal6mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formCornealReflex"/>*</a></b></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing6mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hearing6mOkConcerns" name="p2_hearing6mOkConcerns"
                                            onclick="onCheck(this,'p2_hearing6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hearing6mNotDiscussed" name="p2_hearing6mNotDiscussed"
                                            onclick="onCheck(this,'p2_hearing6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hearing6mNotDiscussed", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHearingInquiry"/>*</a></i></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips6mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hips6mOkConcerns" name="p2_hips6mOkConcerns"
                                            onclick="onCheck(this,'p2_hips6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_hips6mNotDiscussed" name="p2_hips6mNotDiscussed"
                                            onclick="onCheck(this,'p2_hips6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hips6mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHips"/>*</a>
                    </td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone6mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_muscleTone6mOkConcerns" name="p2_muscleTone6mOkConcerns"
                                            onclick="onCheck(this,'p2_muscleTone6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone6mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p2_muscleTone6mNotDiscussed" name="p2_muscleTone6mNotDiscussed"
                                            onclick="onCheck(this,'p2_muscleTone6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_muscleTone6mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formMuscleTone"/>*</a>
                    </td>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p2_physical6m"
                                  ...
                                  class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_physical6m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="problemsPlansp2">
        ...
        <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems2m"
                                                                 ...
                                                                 class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_problems2m", "")))%></textarea>
        </td>

        <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems4m"
                                                                 name="p2_problems4m" rows="5" cols="25"
                                                                 class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_problems4m", "")))%></textarea>
        </td>
            ...
            <table id="prbt23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p2_tb6mOk"
                                            name="p2_tb6mOk"
                                            onclick="onCheck(this,'p2_tb6m')" <%=Encode.forHtml(String.valueOf(props.getProperty("p2_tb6mOk", "")))%>>
                    </td>
                    <td valign="top"><input type="radio" id="p2_tb6mOkConcerns"
                                            name="p2_tb6mOkConcerns"
                                            onclick="onCheck(this,'p2_tb6m')" <%=Encode.forHtml(String.valueOf(props.getProperty("p2_tb6mOkConcerns", "")))%>>
                    </td>
                    <td valign="top"><input type="radio" id="p2_tb6mNotDiscussed"
                                            name="p2_tb6mNotDiscussed"
                                            onclick="onCheck(this,'p2_tb6m')" <%=Encode.forHtml(String.valueOf(props.getProperty("p2_tb6mNotDiscussed", "")))%>>
                    </td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formTB"/></td>
                </tr>

                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p2_problems6m"
                                                                             name="p2_problems6m" rows="5" cols="25"
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_problems6m", "")))%></textarea>
                    </td>
                </tr>
    ...
    <tr id="immunizationp2">
        ...
        <td colspan="4" style="text-align: center" colspan="3" valign="top"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgImmunizationColTitle"/></b></td>
        <td colspan="4" style="text-align: center" colspan="3" valign="top"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgImmunizationColTitle"/></b></td>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                ...
                <tr>
                    <td><input type="radio" id="p2_hepatitisVaccine6mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hepatitisVaccine6mOk", "")))%>></td>
                    <td><input type="radio" id="p2_hepatitisVaccine6mNo"
                               name="p2_hepatitisVaccine6mNo" onclick="onCheck(this,'p2_hepatitisVaccine6m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p2_hepatitisVaccine6mNo", "")))%>></td>
                ...
                <tr>
                    <td colspan="3">
						<textarea id="p2_immunization6m"
                                  ...
                                  class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p2_immunization6m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        ...
        <td colspan="4"><input type="text" class="wide"
                               ...
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_signature2m", "")))%>"/></td>
        <td colspan="4"><input type="text" class="wide" maxlength="42"
                               style="width: 100%" name="p2_signature4m"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_signature4m", "")))%>"/></td>
        <td colspan="4"><input type="text" class="wide"
                               style="width: 100%" name="p2_signature6m"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p2_signature6m", "")))%>"/></td>
    </tr>
