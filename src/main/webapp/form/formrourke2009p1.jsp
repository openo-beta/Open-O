...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr class="titleBar">
        <th><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgRourkeBabyRecord"/></th>
    </tr>
</table>
<div id="patientInfop1" style="height:10%; overflow:auto;">
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr valign="top">
            <td align="center"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formBirhtRemarks"/><br>
                <input type="radio" id="p1_birthRemarksr1"
                       name="p1_birthRemarksr1" onclick="onCheck(this,'p1_birthRemarksr')"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_birthRemarksr1", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formPremature"/>&nbsp;
                <input type="radio" id="p1_birthRemarksr2"
                       name="p1_birthRemarksr2" onclick="onCheck(this,'p1_birthRemarksr')"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_birthRemarksr2", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formHighRisk"/>&nbsp;<br>
                <input type="radio" id="p1_birthRemarksr3"
                       name="p1_birthRemarksr3" onclick="onCheck(this,'p1_birthRemarksr')"
                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_birthRemarksr3", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formNoConcerns"/>&nbsp;
            ...
            <td width="65%" nowrap align="center">
                <p><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgName"/>: <input
                    ...
                    %>
                    &nbsp;&nbsp;<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formFSA"/> <input type="text"
                                                                                 name="c_fsa" size="3" maxlength="3"
                                                                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_fsa", "")))%>">
                </p>
                <p><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgLenght"/>: <input
                        type="text" ondblclick="htEnglish2Metric(this);" name="c_length"
                        size="6" maxlength="6"
                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_length", "")))%>"/> <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgLenghtUnit"/> &nbsp;&nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgHeadCirc"/>: <input type="text"
                                                                               ondblclick="htEnglish2Metric(this);"
                    ...
                    &nbsp;&nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgBirthWt"/>: <input type="text"
                                                                                  ondblclick="wtEnglish2Metric(this);"
                    ...
                    &nbsp;&nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgDischargeWt"/>: <input
                            type="text" ondblclick="wtEnglish2Metric(this);"
                            name="c_dischargeWeight" size="6" maxlength="7"
                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_dischargeWeight", "")))%>"> <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgDischargeWtUnit"/></p>
            </td>
        </tr>
        <tr>
            <td style="padding:10px;" align="center">
                        <textarea wrap="physical" id="c_birthRemarks" name="c_birthRemarks"
                                  rows="6" cols="17"><%=Encode.forHtml(String.valueOf(props.getProperty("c_birthRemarks", "")))%></textarea>
            </td>
            <td style="padding:10px;" align="center">
                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tr>
                        <td align="center">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formRiksFactors"/>
                        ...
                        <td nowrap align="center">
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formAPGAR"/><br>
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.form1min"/><select name="c_APGAR1min">
                            <option <%= props.getProperty("c_APGAR1min", "").equals("") || props.getProperty("c_APGAR1min", "").equals("-1") ? "selected='selected'" : ""%>
                                    value="-1"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formNotSet"/></option>
                            <% for (Integer idx = 0; idx <= 10; ++idx) { %>
                            <option <%= props.getProperty("c_APGAR1min", "").equals(idx.toString()) ? "selected='selected'" : ""%>
                                    value="<%=idx%>"><%=idx%>
                            </option>
                            <%}%></select><br>
                            <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.form5min"/><select name="c_APGAR5min">
                        ...
                        <td align="center">
                            ...
                            <textarea id="c_riskFactors" name="c_riskFactors" rows="5"
...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    <tr align="center">
        ...
        <td colspan="3" class="row"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgWithin"/> <a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btn1Week"/></a></td>
        <td colspan="3" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btn2Weeks"/></a> <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgOptional"/></td>
        <td colspan="3" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btn1month"/></a> <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgOptional"/></td>
    </tr>
    <tr align="center">
        ...
        <td colspan="3"><input readonly type="text" id="p1_date1w"
            ...
            <img src="<%= request.getContextPath() %>/images/cal.gif" id="p1_date1w_cal"></td>
        <td colspan="3"><input readonly type="text" id="p1_date2w"
            ...
            <img src="<%= request.getContextPath() %>/images/cal.gif" id="p1_date2w_cal"></td>
        <td colspan="3"><input readonly type="text" id="p1_date1m"
            ...
            <img src="<%= request.getContextPath() %>/images/cal.gif" id="p1_date1m_cal"></td>
    </tr>
    <tr align="center" id="growthAp1">
        <td class="column" rowspan="2"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnGrowth"/>*<br/>
            <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.btnGrowthmsg"/></a></td>
    ...
    <tr align="center">
        ...
        <td colspan="3"><textarea id="p1_pConcern1w"
                                  name="p1_pConcern1w" style="width: 100%" cols="10"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p1_pConcern1w", "")))%></textarea>
        </td>
        <td colspan="3"><textarea wrap="physical" id="p1_pConcern2w"
                                  name="p1_pConcern2w" style="width: 100%" cols="10"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p1_pConcern2w", "")))%></textarea>
        </td>
        <td colspan="3"><textarea id="p1_pConcern1m"
                                  name="p1_pConcern1m" style="width: 100%" cols="10"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p1_pConcern1m", "")))%></textarea>
        </td>
    </tr>
            ...
            <table id="ntp11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_breastFeeding1wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding1wOkConcerns"
                                            name="p1_breastFeeding1wOkConcerns"
                                            onclick="onCheck(this,'p1_breastFeeding1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding1wOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding1wNo"
                                            name="p1_breastFeeding1wNo" onclick="onCheck(this,'p1_breastFeeding1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding1wNotDiscussed"
                                            name="p1_breastFeeding1wNotDiscussed"
                                            onclick="onCheck(this,'p1_breastFeeding1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding1wNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                            ...
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.msgBreastFeedingDescr"/></span></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding1wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding1wOkConcerns"
                                            name="p1_formulaFeeding1wOkConcerns"
                                            onclick="onCheck(this,'p1_formulaFeeding1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1wOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding1wNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding1wNotDiscussed"
                                            name="p1_formulaFeeding1wNotDiscussed"
                                            onclick="onCheck(this,'p1_formulaFeeding1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1wNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgFormulaFeeding"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_stoolUrine1wOk"
                                            name="p1_stoolUrine1wOk" onclick="onCheck(this,'p1_stoolUrine1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_stoolUrine1wOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine1wOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p1_stoolUrine1wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine1wNotDiscussed", "")))%>></td>

                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formStoolPatern"/></td>
                </tr>

                <tr style="vertical-align: bottom;">
                    <td style="vertical-align: bottom;" colspan="5">
							<textarea id="p1_pNutrution1w"
                                      name="p1_pNutrition1w" style="width: 100%" cols="10"
            ...
            <table id="ntp12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_breastFeeding2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding2wOkConcerns"
                                            name="p1_breastFeeding2wOkConcerns"
                                            onclick="onCheck(this,'p1_breastFeeding2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding2wOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding2wNo"
                                            name="p1_breastFeeding2wNo" onclick="onCheck(this,'p1_breastFeeding2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding2wNotDiscussed"
                                            name="p1_breastFeeding2wNotDiscussed"
                                            onclick="onCheck(this,'p1_breastFeeding2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding2wNotDiscussed", "")))%>></td>
                    <td><b><a
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()" href="javascript:showNotes()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.btnBreastFeeding"/></a><br/>
                        <span
                                onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.msgBreastFeedingDescr"/></span></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding2wOkConcerns"
                                            name="p1_formulaFeeding2wOkConcerns"
                                            onclick="onCheck(this,'p1_formulaFeeding2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding2wOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding2wNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding2wNotDiscussed"
                                            name="p1_formulaFeeding2wNotDiscussed"
                                            onclick="onCheck(this,'p1_formulaFeeding2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding2wNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgFormulaFeeding"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_stoolUrine2wOk"
                                            name="p1_stoolUrine2wOk" onclick="onCheck(this,'p1_stoolUrine2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_stoolUrine2wOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine2wOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p1_stoolUrine2wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine2wNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formStoolPatern"/></td>
                </tr>
                ...
                <tr>
                    <td style="vertical-align: bottom;" colspan="5">
						<textarea id="p1_pNutrution2w"
                                  name="p1_pNutrition2w" style="width: 100%" cols="10"
            ...
            <table id="ntp13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_breastFeeding1mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding1mOkConcerns"
                                            name="p1_breastFeeding1mOkConcerns"
                                            onclick="onCheck(this,'p1_breastFeeding1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding1mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding1mNo"
                                            name="p1_breastFeeding1mNo" onclick="onCheck(this,'p1_breastFeeding1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_breastFeeding1mNotDiscussed"
                                            name="p1_breastFeeding1mNotDiscussed"
                                            onclick="onCheck(this,'p1_breastFeeding1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_breastFeeding1mNotDiscussed", "")))%>></td>
                    <td><b><a
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()" href="javascript:showNotes()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.btnBreastFeeding"/></a><br/>
                        <span
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding1mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding1mOkConcerns"
                                            name="p1_formulaFeeding1mOkConcerns"
                                            onclick="onCheck(this,'p1_formulaFeeding1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding1mNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_formulaFeeding1mNotDiscussed"
                                            name="p1_formulaFeeding1mNotDiscussed"
                                            onclick="onCheck(this,'p1_formulaFeeding1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.msgFormulaFeeding"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_stoolUrine1mOk"
                                            name="p1_stoolUrine1mOk" onclick="onCheck(this,'p1_stoolUrine1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_stoolUrine1mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine1mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p1_stoolUrine1mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_stoolUrine1mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formStoolPatern"/></td>
                </tr>
                ...
                <tr>
                    <td style="vertical-align: bottom;" colspan="5">
						<textarea id="p1_pNutrution1m"
                                  name="p1_pNutrition1m" style="width: 100%" cols="10"
        ...
        <td colspan="9">
            <table id="edt1" style="font-size: 9pt;" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_carSeatOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_carSeatOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_carSeatOkConcerns"
                                            name="p1_carSeatOkConcerns" onclick="onCheck(this,'p1_carSeat')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_carSeatOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_carSeatNotDiscussed"
                                            name="p1_carSeatNotDiscussed" onclick="onCheck(this,'p1_carSeat')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_carSeatNotDiscussed", "")))%>></td>
                    <td valign="top"><b><a
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()" href="javascript:showNotes()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formCarSeat"/></a>*</b></td>
                    <td valign="top"><input type="radio" id="p1_sleepPosOk"
                                            name="p1_sleepPosOk" onclick="onCheck(this,'p1_sleepPos')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sleepPosOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_sleepPosOkConcerns"
                                            name="p1_sleepPosOkConcerns" onclick="onCheck(this,'p1_sleepPos')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sleepPosOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_sleepPosNotDiscussed"
                                            name="p1_sleepPosNotDiscussed" onclick="onCheck(this,'p1_sleepPos')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sleepPosNotDiscussed", "")))%>></td>
                    <td valign="top"><b><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.formSleepPos"/></a></b></td>
                    <td valign="top"><input type="radio" id="p1_cribSafetyOk"
                                            name="p1_cribSafetyOk" onclick="onCheck(this,'p1_cribSafety')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_cribSafetyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_cribSafetyOkConcerns"
                                            name="p1_cribSafetyOkConcerns" onclick="onCheck(this,'p1_cribSafety')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_cribSafetyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_cribSafetyNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_cribSafetyNotDiscussed", "")))%>></td>
                    <td valign="top"><b><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formCribSafety"/>*</a></b></td>
                    <td valign="top"><input type="radio" id="p1_firearmSafetyOk"
                                            name="p1_firearmSafetyOk"
                                            onclick="onCheck(this,'p1_firearmSafety')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_firearmSafetyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_firearmSafetyOkConcerns"
                                            name="p1_firearmSafetyOkConcerns"
                                            onclick="onCheck(this,'p1_firearmSafety')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_firearmSafetyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_firearmSafetyNotDiscussed"
                                            name="p1_firearmSafetyNotDiscussed"
                                            onclick="onCheck(this,'p1_firearmSafety')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_firearmSafetyNotDiscussed", "")))%>></td>
                    <td valign="top"><b><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_smokeSafetyOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_smokeSafetyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_smokeSafetyOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_smokeSafetyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_smokeSafetyNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_smokeSafetyNotDiscussed", "")))%>></td>
          ...
          -->
                ...
                <tr>
                    ...
                    <td valign="top"><input type="radio" id="p1_soothabilityOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_soothabilityOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_soothabilityNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_soothabilityNotDiscussed", "")))%>></td>
                    ...
                    <td valign="top"><input type="radio" id="p1_homeVisitOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_homeVisitOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_homeVisitOkConcerns"
                                            name="p1_homeVisitOkConcerns" onclick="onCheck(this,'p1_homeVisit')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_homeVisitOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_homeVisitNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_homeVisitNotDiscussed", "")))%>></td>
                    <td colspan="5" valign="top"><b><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHomeVisit"/>**</a></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_bondingOk"
                                            name="p1_bondingOk" onclick="onCheck(this,'p1_bonding')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_bondingOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_bondingOkConcerns"
                                            name="p1_bondingOkConcerns" onclick="onCheck(this,'p1_bonding')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_bondingOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_bondingNotDiscussed"
                                            name="p1_bondingNotDiscussed" onclick="onCheck(this,'p1_bonding')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_bondingNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formBonding"/></td>
                    <td valign="top"><input type="radio" id="p1_pFatigueOk"
                                            name="p1_pFatigueOk" onclick="onCheck(this,'p1_pFatigue')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pFatigueOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_pFatigueOkConcerns"
                                            name="p1_pFatigueOkConcerns" onclick="onCheck(this,'p1_pFatigue')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pFatigueOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_pFatigueNotDiscussed"
                                            name="p1_pFatigueNotDiscussed" onclick="onCheck(this,'p1_pFatigue')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pFatigueNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formParentFatigue"/>**</a></td>
                    <td valign="top"><input type="radio" id="p1_famConflictOk"
                                            name="p1_famConflictOk" onclick="onCheck(this,'p1_famConflict')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_famConflictOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_famConflictOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_famConflictOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_famConflictNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_famConflictNotDiscussed", "")))%>></td>
          ...
          <table style="font-size:9pt;" cellpadding="0" cellspacing="0" width="100%"  >
             -->
                ...
                <tr>
                    <td valign="top" colspan="16"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formOtherIssues"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_2ndSmokeOk"
                                            name="p1_2ndSmokeOk" onclick="onCheck(this,'p1_2ndSmoke')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_2ndSmokeOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_2ndSmokeOkConcerns"
                                            name="p1_2ndSmokeOkConcerns" onclick="onCheck(this,'p1_2ndSmoke')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_2ndSmokeOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_2ndSmokeNotDiscussed"
                                            name="p1_2ndSmokeNotDiscussed" onclick="onCheck(this,'p1_2ndSmoke')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_2ndSmokeNotDiscussed", "")))%>></td>
                    <td valign="top"><b><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                    ...
                    <td valign="top"><input type="radio" id="p1_altMedOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_altMedOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_altMedOkConcerns"
                                            name="p1_altMedOkConcerns" onclick="onCheck(this,'p1_altMed')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_altMedOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_altMedNotDiscussed"
                                            name="p1_altMedNotDiscussed" onclick="onCheck(this,'p1_altMed')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_altMedNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formAltMed"/>*</a></td>
                    <td valign="top"><input type="radio" id="p1_pacifierOk"
                                            name="p1_pacifierOk" onclick="onCheck(this,'p1_pacifier')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pacifierOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_pacifierOkConcerns"
                                            name="p1_pacifierOkConcerns" onclick="onCheck(this,'p1_pacifier')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pacifierOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_pacifierNotDiscussed"
                                            name="p1_pacifierNotDiscussed" onclick="onCheck(this,'p1_pacifier')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pacifierNotDiscussed", "")))%>></td>
                    <td colspan="5" valign="top"><b><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formPacifierUse"/>*</a></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_feverOk"
                                            name="p1_feverOk" onclick="onCheck(this,'p1_fever')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_feverOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_feverOkConcerns"
                                            name="p1_feverOkConcerns" onclick="onCheck(this,'p1_fever')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_feverOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_feverNotDiscussed"
                                            name="p1_feverNotDiscussed" onclick="onCheck(this,'p1_fever')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_feverNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                    ...
                    <td valign="top"><input type="radio" id="p1_tmpControlOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_tmpControlOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_tmpControlOkConcerns"
                                            name="p1_tmpControlOkConcerns" onclick="onCheck(this,'p1_tmpControl')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_tmpControlOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_tmpControlNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_tmpControlNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formTempCtrl"/>*</a></td>
                    <td valign="top"><input type="radio" id="p1_sunExposureOk"
                                            name="p1_sunExposureOk" onclick="onCheck(this,'p1_sunExposure')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sunExposureOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_sunExposureOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sunExposureOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_sunExposureNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sunExposureNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_noCoughMedOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noCoughMedOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_noCoughMedOkConcerns"
                                            name="p1_noCoughMedOkConcerns" onclick="onCheck(this,'p1_noCoughMed')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noCoughMedOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_noCoughMedNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noCoughMedNotDiscussed", "")))%>></td>
                    <td valign="top" colspan="13"><b><a href="javascript:showNotes()"
                                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.formCough"/>*</a></b></td>
                </tr>
                <tr>
                    <td colspan="16" style="vertical-align:bottom;">
						<textarea id="p1_pEducation"
                                  name="p1_pEducation" style="width: 100%"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p1_pEducation", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="developmentp1">
        <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.msgDevelopment"/>**</a><br>
            ...
            <table id="dt12" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15"
                                                                     width="20" src="graphics/Checkmark_L.gif"></td>
                    <td class="edcol" valign="top">X</td>
                    <td class="edcol" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formNotDiscussed"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_sucks2wOk"
                                            name="p1_sucks2wOk" onclick="onCheck(this,'p1_sucks2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sucks2wOk", "")))%>></td>
                    <td><input type="radio" id="p1_sucks2wNo" name="p1_sucks2wNo"
                               onclick="onCheck(this,'p1_sucks2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sucks2wNo", "")))%>></td>
                    <td><input type="radio" id="p1_sucks2wNotDiscussed" name="p1_sucks2wNotDiscussed"
                               onclick="onCheck(this,'p1_sucks2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sucks2wNotDiscussed", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSucksWell"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noParentsConcerns2wOk", "")))%>></td>
                    <td><input type="radio" id="p1_noParentsConcerns2wNo"
                               name="p1_noParentsConcerns2wNo"
                               onclick="onCheck(this,'p1_noParentsConcerns2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noParentsConcerns2wNo", "")))%>></td>
                    <td><input type="radio" id="p1_noParentsConcerns2wNotDiscussed"
                               name="p1_noParentsConcerns2wNotDiscussed"
                               onclick="onCheck(this,'p1_noParentsConcerns2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noParentsConcerns2wNotDiscussed", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formNoparentConcerns"/></td>
                </tr>
                <tr align="center">
                    <td colspan="3" style="vertical-align:bottom;"><textarea id="p1_development2w"
                                                                             name="p1_development2w" rows="5" cols="25"
            ...
            <table id="dt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_focusGaze1mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_focusGaze1mOk", "")))%>></td>
                    <td><input type="radio" id="p1_focusGaze1mNo"
                               name="p1_focusGaze1mNo" onclick="onCheck(this,'p1_focusGaze1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_focusGaze1mNo", "")))%>></td>
                    <td><input type="radio" id="p1_focusGaze1mNotDiscussed"
                               name="p1_focusGaze1mNotDiscussed" onclick="onCheck(this,'p1_focusGaze1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_focusGaze1mNotDiscussed", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFocusesGaze"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_startles1mOk"
                                            name="p1_startles1mOk" onclick="onCheck(this,'p1_startles1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_startles1mOk", "")))%>></td>
                    <td><input type="radio" id="p1_startles1mNo"
                               name="p1_startles1mNo" onclick="onCheck(this,'p1_startles1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_startles1mNo", "")))%>></td>
                    <td><input type="radio" id="p1_startles1mNotDiscussed"
                               name="p1_startles1mNotDiscussed" onclick="onCheck(this,'p1_startles1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_startles1mNotDiscussed", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSuddenNoise"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_calms1mOk"
                                            name="p1_calms1mOk" onclick="onCheck(this,'p1_calms1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_calms1mOk", "")))%>></td>
                    <td><input type="radio" id="p1_calms1mNo"
                               name="p1_calms1mNo" onclick="onCheck(this,'p1_calms1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_calms1mNo", "")))%>></td>
                    <td><input type="radio" id="p1_calms1mNotDiscussed"
                               name="p1_calms1mNotDiscussed" onclick="onCheck(this,'p1_calms1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_calms1mNotDiscussed", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.formCalmes"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_sucks1mOk"
                                            name="p1_sucks1mOk" onclick="onCheck(this,'p1_sucks1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sucks1mOk", "")))%>></td>
                    <td><input type="radio" id="p1_sucks1mNo" name="p1_sucks1mNo"
                               onclick="onCheck(this,'p1_sucks1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sucks1mNo", "")))%>></td>
                    <td><input type="radio" id="p1_sucks1mNotDiscussed" name="p1_sucks1mNotDiscussed"
                               onclick="onCheck(this,'p1_sucks1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sucks1mNotDiscussed", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSucksWell"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noParentsConcerns1mOk", "")))%>></td>
                    <td><input type="radio" id="p1_noParentsConcerns1mNo"
                               name="p1_noParentsConcerns1mNo"
                               onclick="onCheck(this,'p1_noParentsConcerns1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noParentsConcerns1mNo", "")))%>></td>
                    <td><input type="radio" id="p1_noParentsConcerns1mNotDiscussed"
                               name="p1_noParentsConcerns1mNotDiscussed"
                               onclick="onCheck(this,'p1_noParentsConcerns1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_noParentsConcerns1mNotDiscussed", "")))%>><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formNoparentConcerns"/></td>
                </tr>

                <tr align="center">
                    <td colspan="3" style="vertical-align:bottom;"><textarea id="p1_development1m"
                                                                             name="p1_development1m" rows="5" cols="25"
            ...
            <table id="pt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_skin1wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_skin1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_skin1wNo"
                                            name="p1_skin1wNo" onclick="onCheck(this,'p1_skin1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_skin1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_skin1wNotDiscussed"
                                            name="p1_skin1wNotDiscussed" onclick="onCheck(this,'p1_skin1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_skin1wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formDrySkin"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_fontanelles1wOk"
                                            name="p1_fontanelles1wOk" onclick="onCheck(this,'p1_fontanelles1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_fontanelles1wNo"
                                            name="p1_fontanelles1wNo" onclick="onCheck(this,'p1_fontanelles1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_fontanelles1wNotDiscussed"
                                            name="p1_fontanelles1wNotDiscussed"
                                            onclick="onCheck(this,'p1_fontanelles1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles1wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFontanelles"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_eyes1wOk"
                                            name="p1_eyes1wOk" onclick="onCheck(this,'p1_eyes1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_eyes1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_eyes1wNo"
                                            name="p1_eyes1wNo" onclick="onCheck(this,'p1_eyes1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_eyes1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_eyes1wNotDiscussed"
                                            name="p1_eyes1wNotDiscussed" onclick="onCheck(this,'p1_eyes1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_eyes1wNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_ears1wOk"
                                            name="p1_ears1wOk" onclick="onCheck(this,'p1_ears1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_ears1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_ears1wNo"
                                            name="p1_ears1wNo" onclick="onCheck(this,'p1_ears1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_ears1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_ears1wNotDiscussed"
                                            name="p1_ears1wNotDiscussed" onclick="onCheck(this,'p1_ears1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_ears1wNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formEarDrums"/>*</i></a></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_heartLungs1wOk"
                                            name="p1_heartLungs1wOk" onclick="onCheck(this,'p1_heartLungs1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heartLungs1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_heartLungs1wNo"
                                            name="p1_heartLungs1wNo" onclick="onCheck(this,'p1_heartLungs1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heartLungs1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_heartLungs1wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heartLungs1wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHeart"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_umbilicus1wOk"
                                            name="p1_umbilicus1wOk" onclick="onCheck(this,'p1_umbilicus1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_umbilicus1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_umbilicus1wNo"
                                            name="p1_umbilicus1wNo" onclick="onCheck(this,'p1_umbilicus1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_umbilicus1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_umbilicus1wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_umbilicus1wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formUmbilicus"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_femoralPulses1wOk"
                                            name="p1_femoralPulses1wOk" onclick="onCheck(this,'p1_femoralPulses1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_femoralPulses1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_femoralPulses1wNo"
                                            name="p1_femoralPulses1wNo" onclick="onCheck(this,'p1_femoralPulses1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_femoralPulses1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_femoralPulses1wNotDiscussed"
                                            name="p1_femoralPulses1wNotDiscussed"
                                            onclick="onCheck(this,'p1_femoralPulses1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_femoralPulses1wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFemoralPulses"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_hips1wOk"
                                            name="p1_hips1wOk" onclick="onCheck(this,'p1_hips1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_hips1wNo"
                                            name="p1_hips1wNo" onclick="onCheck(this,'p1_hips1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_hips1wNotDiscussed"
                                            name="p1_hips1wNotDiscussed" onclick="onCheck(this,'p1_hips1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips1wNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formHips"/>*</a></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_muscleTone1wOk"
                                            name="p1_muscleTone1wOk" onclick="onCheck(this,'p1_muscleTone1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_muscleTone1wNo"
                                            name="p1_muscleTone1wNo" onclick="onCheck(this,'p1_muscleTone1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_muscleTone1wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone1wNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formMuscleTone"/>*</a></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_testicles1wOk"
                                            name="p1_testicles1wOk" onclick="onCheck(this,'p1_testicles1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_testicles1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_testicles1wNo"
                                            name="p1_testicles1wNo" onclick="onCheck(this,'p1_testicles1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_testicles1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_testicles1wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_testicles1wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formTescicles"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_maleUrinary1wOk"
                                            name="p1_maleUrinary1wOk" onclick="onCheck(this,'p1_maleUrinary1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_maleUrinary1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_maleUrinary1wNo"
                                            name="p1_maleUrinary1wNo" onclick="onCheck(this,'p1_maleUrinary1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_maleUrinary1wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_maleUrinary1wNotDiscussed"
                                            name="p1_maleUrinary1wNotDiscussed"
                                            onclick="onCheck(this,'p1_maleUrinary1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_maleUrinary1wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formMaleUrinaryStream"/></td>
                </tr>

                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p1_pPhysical1w"
                                  name="p1_pPhysical1w" style="width: 100%" cols="10"
            ...
            <table id="pt12" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_fontanelles2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_fontanelles2wNo"
                                            name="p1_fontanelles2wNo" onclick="onCheck(this,'p1_fontanelles2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_fontanelles2wNotDiscussed"
                                            name="p1_fontanelles2wNotDiscussed"
                                            onclick="onCheck(this,'p1_fontanelles2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles2wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFontanelles"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_heartLungs2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heartLungs2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_heartLungs2wNo"
                                            name="p1_heartLungs2wNo" onclick="onCheck(this,'p1_heartLungs2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heartLungs2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_heartLungs2wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heartLungs2wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHeart"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_umbilicus2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_umbilicus2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_umbilicus2wNo"
                                            name="p1_umbilicus2wNo" onclick="onCheck(this,'p1_umbilicus2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_umbilicus2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_umbilicus2wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_umbilicus2wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formUmbilicus"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_femoralPulses2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_femoralPulses2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_femoralPulses2wNo"
                                            name="p1_femoralPulses2wNo" onclick="onCheck(this,'p1_femoralPulses2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_femoralPulses2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_femoralPulses2wNotDiscussed"
                                            name="p1_femoralPulses2wNotDiscussed"
                                            onclick="onCheck(this,'p1_femoralPulses2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_femoralPulses2wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFemoralPulses"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_muscleTone2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_muscleTone2wNo"
                                            name="p1_muscleTone2wNo" onclick="onCheck(this,'p1_muscleTone2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_muscleTone2wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone2wNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formMuscleTone"/>*</a></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_testicles2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_testicles2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_testicles2wNo"
                                            name="p1_testicles2wNo" onclick="onCheck(this,'p1_testicles2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_testicles2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_testicles2wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_testicles2wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formTescicles"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_maleUrinary2wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_maleUrinary2wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_maleUrinary2wNo"
                                            name="p1_maleUrinary2wNo" onclick="onCheck(this,'p1_maleUrinary2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_maleUrinary2wNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_maleUrinary2wNotDiscussed"
                                            name="p1_maleUrinary2wNotDiscussed"
                                            onclick="onCheck(this,'p1_maleUrinary2w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_maleUrinary2wNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formMaleUrinaryStream"/></td>
                </tr>
            ...
            <table id="pt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_skin1mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_skin1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_skin1mNo"
                                            name="p1_skin1mNo" onclick="onCheck(this,'p1_skin1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_skin1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_skin1mNotDiscussed"
                                            name="p1_skin1mNotDiscussed" onclick="onCheck(this,'p1_skin1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_skin1mNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.formSkin"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_fontanelles1mOk"
                                            name="p1_fontanelles1mOk" onclick="onCheck(this,'p1_fontanelles1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_fontanelles1mNo"
                                            name="p1_fontanelles1mNo" onclick="onCheck(this,'p1_fontanelles1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_fontanelles1mNotDiscussed"
                                            name="p1_fontanelles1mNotDiscussed"
                                            onclick="onCheck(this,'p1_fontanelles1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fontanelles1mNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFontanelles"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_corneal1mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_corneal1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_corneal1mNo"
                                            name="p1_corneal1mNo" onclick="onCheck(this,'p1_corneal1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_corneal1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_corneal1mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_corneal1mNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formCornealReflex"/>*</a></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_hearing1mOk"
                                            name="p1_hearing1mOk" onclick="onCheck(this,'p1_hearing1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hearing1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_hearing1mNo"
                                            name="p1_hearing1mNo" onclick="onCheck(this,'p1_hearing1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hearing1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_hearing1mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hearing1mNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHearingInquiry"/>*</i></a></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_heart1mOk"
                                            name="p1_heart1mOk" onclick="onCheck(this,'p1_heart1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heart1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_heart1mNo"
                                            name="p1_heart1mNo" onclick="onCheck(this,'p1_heart1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heart1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_heart1mNotDiscussed"
                                            name="p1_heart1mNotDiscussed" onclick="onCheck(this,'p1_heart1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_heart1mNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHeart1"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p1_hips1mOk"
                                            name="p1_hips1mOk" onclick="onCheck(this,'p1_hips1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_hips1mNo"
                                            name="p1_hips1mNo" onclick="onCheck(this,'p1_hips1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_hips1mNotDiscussed"
                                            name="p1_hips1mNotDiscussed" onclick="onCheck(this,'p1_hips1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hips1mNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formHips"/>*</a></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_muscleTone1mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone1mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_muscleTone1mNo"
                                            name="p1_muscleTone1mNo" onclick="onCheck(this,'p1_muscleTone1m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone1mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_muscleTone1mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_muscleTone1mNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formMuscleTone"/>*</a></td>
                </tr>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p1_pPhysical1m"
                                  name="p1_pPhysical1m" style="width: 100%" cols="10"
            ...
            <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p1_pkuThyroid1wOk" name="p1_pkuThyroid1wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pkuThyroid1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_pkuThyroid1wOkConcerns" name="p1_pkuThyroid1wOkConcerns"
                                            onclick="onCheck(this,'p1_pkuThyroid1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pkuThyroid1wOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_pkuThyroid1wNotDiscussed"
                                            name="p1_pkuThyroid1wNotDiscussed"
                                            onclick="onCheck(this,'p1_pkuThyroid1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_pkuThyroid1wNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formThyroid"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p1_hemoScreen1wOk"
                                            name="p1_hemoScreen1wOk" onclick="onCheck(this,'p1_hemoScreen1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hemoScreen1wOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_hemoScreen1wOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hemoScreen1wOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p1_hemoScreen1wNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hemoScreen1wNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHemoglobinopathy"/></a> (if at
                        risk)*</b></td>
                </tr>

                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p1_problems1w"
                                                                             name="p1_problems1w" rows="5" cols="25"
    ...
    <tr id="immunizationp1">
        ...
        <td colspan="3">
            <table id="immt11" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="text-align: center" colspan="3"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgImmunizationColTitle"/></b><br/>
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgImmunizationHepatitis"/>
                    </td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15"
                ...
                <tr>
                    <td><input type="radio" id="p1_hepatitisVaccine1wOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hepatitisVaccine1wOk", "")))%>></td>
                    <td><input type="radio" id="p1_hepatitisVaccine1wNo"
                               name="p1_hepatitisVaccine1wNo" onclick="onCheck(this,'p1_hepatitisVaccine1w')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hepatitisVaccine1wNo", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgImmunizationHepatitisVaccine"/></td>
                </tr>

                <tr>
                    <td colspan="3" style="vertical-align:bottom;">
								<textarea id="p1_immunization1w"
                                          name="p1_immunization1w" rows="5" cols="25"
        ...
        <td colspan="3">
            <table id="immt12" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="text-align: center"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgImmunizationColTitle"/></b></td>
                </tr>
                <tr>
                    <td style="vertical-align:bottom;">
						<textarea id="p1_immunization2w"
                                  name="p1_immunization2w" rows="5" cols="25"
            ...
            <table id="immt13" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td><input type="radio" id="p1_hepatitisVaccine1mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hepatitisVaccine1mOk", "")))%>></td>
                    <td><input type="radio" id="p1_hepatitisVaccine1mNo"
                               name="p1_hepatitisVaccine1mNo" onclick="onCheck(this,'p1_hepatitisVaccine1mNo')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hepatitisVaccine1mNo", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgImmunizationHepatitisVaccine"/></td>
                </tr>
                ...
                <tr>
                    <td colspan="3" style="vertical-align:bottom;">
							<textarea id="p1_immunization1m"
                                      name="p1_immunization1m" rows="5" cols="25"
