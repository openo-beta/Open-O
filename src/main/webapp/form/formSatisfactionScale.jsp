                                ...
                                <table width="740px" height="620px" border="0" cellspacing="0"
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td valign="top" width="95%">These next questions are
                                                        ...
                                                        service like home care, or a clinic.
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="question" colspan="3">Did you receive
                                            physiotherapy or occupational therapy in the past 18 months?
                                        </th>
                                    </tr>
                                    <tr bgcolor="white">
                                        <td width="5%"></td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="question" colspan="3">How many treatments or
                                            visits would you estimate that you had with each?
                                        </th>
                                    </tr>
                                    <tr bgcolor="white">
                                        <td width="5%">&nbsp;</dh>
                                ...
                                <table width="740px" height="620px" border="0" cellspacing="0"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">Rehabilitation professionals
                                            are good about explaining the reason for tests and assessments
                                        </td>
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">I feel confident that I can get
                                            the rehabilitation I need without being set back financially
                                        </td>
                                        <td valign="top" align="center"><input type="text"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">I have to pay for more of my
                                            rehabilitation than I can afford
                                        </td>
                                        <td valign="top" align="center"><input type="text"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">Where I get rehabilitation,
                                            people have to wait too long for treatment
                                        </td>
                                        <td valign="top" align="center"><input type="text"
                            ...
                            <td colspan="2">
                                <table width="740px" height="520px" border="0" cellspacing="0"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">Rehabilitation professionals
                                            act too businesslike and impersonal toward me
                                        </td>
                                        <td valign="top" align="center" width="5%"><input
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">Those who provide my
                                            rehabilitation sometimes hurry too much when they treat me
                                        </td>
                                        <td valign="top" align="center"><input type="text"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">I have some doubts about the
                                            ability of the rehabilitation professionals who treat me
                                        </td>
                                        <td valign="top" align="center"><input type="text"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">Rehabilitation professionals
                                            usually spend plenty of time with me
                                        </td>
                                        <td valign="top" align="center"><input type="text"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">I find it hard to get an
                                            appointment for rehabilitation right away
                                        </td>
                                        <td valign="top" align="center"><input type="text"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td valign="top" colspan="2">I am dissatisfied with some
                                            things about the rehabilitation I receive
                                        </td>
                                        <td valign="top" align="center"><input type="text"
                        ...
                        <tr>
                            <td align="left">
                                ...
                                %> <input type="submit" value="Save"
                                          onclick="if(checkBeforeSave()==true) return onSave(); else return false;"/>
