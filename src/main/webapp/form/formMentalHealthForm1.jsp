...
// Declaring valid date character, minimum year and maximum year
    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <table width="100%" border="0">
            ...
            <tr>
                <td height="26">
                    <div align="left">Physician address</div>
                </td>
                <td>
                    <label>
        ...
        <div>
            <p>You may only sign this <strong>Form 1</strong> if you have personally examined the person within the past
                seven days. In deciding if a Form 1 is appropriate, you must complete <strong>either </strong>Box A
                (serious harm test) <strong>or </strong>Box B (persons who are incapable of consenting to treatment and
                meet the specified criteria test) below.</p>
            <p>&nbsp;</p>
        </div>
        <table width="100%" border="1">
            ...
            <tr>
                <td>I base this belief on the following information (you may, as appropriate in the circumstances, rely
                    on any combination of your own observations and information communicated to you by others.)
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>I am of the opinion that the person is apparently suffering from mental disorder of a nature or
            ...
            <tr>
                <td><p>I base this opnion on the following information (you may, as appropriate in the circumstances,
                    rely on any combination of your own observations and information communicated to you by others.)</p>
                </td>
            </tr>
            <tr>
        ...
        <table width="100%" border="1">
            ...
            <tr>
                <td>1. Has previously received treatment for mental disorder of an ongoing or recurring nature that,
                    when not treated, is of a nature or quality that likely will result in one or more of the following:
            ...
            <tr>
                <td>3. Is incapable, within the meaning of the <em>Health Care Consent Act, 1996</em>, of consenting to
                    his or her treatment in a psychiatric facility and the consent of his or her substitute
            ...
            <tr>
                <td>4. Is apparently suffering from the same mental disorder as the one for which he or she previously
            ...
            <tr>
                <td>5. Given the person's history of mental disorder and current mental or physical condition, is likely
            ...
            <tr>
                <td height="44">I base this opinion on the following information (you may, as appropriate in the
                    circumstances, rely on any combination of your own observations and information communicated to you
                    by others.)
                </td>
            </tr>
            <tr>
        ...
        <table width="100%" height="490" border="0">
            <tr>
                <td colspan="2" scope="col">I have made careful inquiry into all the facts necessary for me to form my
                    opinion as to the nature and quality of the person's mental disorder. I hereby make application for
                    a psychiatric assessment of the person named.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">This form authorizes, for a period of 7 days including the date of signature, the
                    apprehension of the person named and his or her detention in a psychiatirc facility for a maximum of
                    72 hours.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td height="53" colspan="2">Once the period of detention at the psychiatric facility begins, the
                    attending physician should note the date and time this occurs and must promptly give the person a
                    Form 42.
                </td>
            </tr>
            <tr>
