    ...
    <head>
        ...
        <script type="text/javascript" language="Javascript">
            ...
            function onPrint() {
                ...
                document.forms[0].action = "<%= request.getContextPath() %>/form/formmhreferralprint.jsp";
        ...
        <table class="Head" class="hidePrint">
            <tr>
                ...
                <td align="right">Referral &nbsp;|&nbsp; <a
                        href="<%= request.getContextPath() %>/form/formmhassessment.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>">Assessment</a>
                    &nbsp;|&nbsp; <a
                ...
                <table class="TableWithBorder" cellpadding="2" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="c_referralDate" size="40"
                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_referralDate", "")))%>"/></td>
                        <td>Referred By:</td>
                        <td align="right"><input type="text" name="c_referredBy"
                                                 size="40" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_referredBy", "")))%>"/></td>
                    </tr>
                </table>
            </td>
        </tr>
                    ...
                    <tr>
                        <td class="mhList" valign="top">Psychiatric Symptoms: <br>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. <input type="text" name="r_rps1"
                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rps1", "")))%>"
                                                                     size="2"/> &nbsp;
                            2. <input type="text" name="r_rps2"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rps2", "")))%>" size="2"/> &nbsp;
                            3. <input type="text" name="r_rps3"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rps3", "")))%>" size="2"/> <br>
                            <br>
                            ...
                            %> <a
                                    ...
                                    class="mhlink" onclick="javascript:insert('r_rps', <%=Encode.forJavaScript(String.valueOf(i+1))%>);"><%=Encode.forHtml(String.valueOf(i + 1))%>.
                                <%=Encode.forHtml(String.valueOf(rps[i]))%>
                            </a><br>
                            <%
                                    }
                                }
                            %> &nbsp;<input type="text" name="r_rpsOther"
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rpsOther", "")))%>"/></td>
                        <td class="mhList" valign="top">Psychosocial Issues:<br>
                            <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. <input type="text" name="r_rpi1"
                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rpi1", "")))%>"
                                                                     size="2"/> &nbsp;
                            2. <input type="text" name="r_rpi2"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rpi2", "")))%>" size="2"/> &nbsp;
                            3. <input type="text" name="r_rpi3"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rpi3", "")))%>" size="2"/> <br>
                            <br>
                            ...
                            %> <a
                                    href="javascript: function myFunction() {return false; }"
                                    class="mhlink" onclick="javascript:insert('r_rpi', <%=Encode.forJavaScript(String.valueOf(i+1))%>);"><%=Encode.forHtml(String.valueOf(i + 1))%>.
                                <%=Encode.forHtml(String.valueOf(rpi[i]))%>
                            </a><br>
                            <%
                                    }
                                }
                            %> &nbsp;<input type="text" name="r_rpiOther"
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rpiOther", "")))%>"/></td>
                        <td class="mhList" valign="top">Med/Phy Issues:<br>
                            <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. <input type="text" name="r_rmpi1"
                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rmpi1", "")))%>"
                                                                     size="2"/>
                            &nbsp; 2. <input type="text" name="r_rmpi2"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rmpi2", "")))%>" size="2"/> &nbsp;
                            3. <input type="text" name="r_rmpi3"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rmpi3", "")))%>" size="2"/> <br>
                            <br>
                            ...
                            %> <a
                                    href="javascript: function myFunction() {return false; }"
                                    class="mhlink" onclick="javascript:insert('r_rmpi', <%=Encode.forJavaScript(String.valueOf(i+1))%>);"><%=Encode.forHtml(String.valueOf(i + 1))%>.
                                <%=Encode.forHtml(String.valueOf(rmpi[i]))%>
                            </a><br>
                            <%
                                    }
                                }
                            %> &nbsp;<input type="text" name="r_rmpiOther"
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_rmpiOther", "")))%>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="mhList" valign="top">Interventions Requested:<br>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. <input type="text" name="r_ir1"
                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_ir1", "")))%>"
                                                                     size="2"/> &nbsp;
                            2. <input type="text" name="r_ir2"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_ir2", "")))%>" size="2"/> &nbsp;
                            3. <input type="text" name="r_ir3"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_ir3", "")))%>" size="2"/> <br>
                            <br>
                            ...
                            %> <a
                                    href="javascript: function myFunction() {return false; }"
                                    class="mhlink" onclick="javascript:insert('r_ir', <%=Encode.forJavaScript(String.valueOf(i+1))%>);"><%=Encode.forHtml(String.valueOf(i + 1))%>.
                                <%=Encode.forHtml(String.valueOf(ir[i]))%>
                            </a><br>
                            <%
                                    }
                                }
                            %> &nbsp;<input type="text" name="r_irOther"
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_irOther", "")))%>"/></td>
                        <td class="mhList" valign="top">Advice Regarding Management:<br>
                            <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. <input type="text" name="r_arm1"
                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_arm1", "")))%>"
                                                                     size="2"/> &nbsp;
                            2. <input type="text" name="r_arm2"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_arm2", "")))%>" size="2"/> &nbsp;
                            3. <input type="text" name="r_arm3"
                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_arm3", "")))%>" size="2"/> <br>
                            <br>
                            ...
                            %> <a
                                    href="javascript: function myFunction() {return false; }"
                                    class="mhlink" onclick="javascript:insert('r_arm', <%=Encode.forJavaScript(String.valueOf(i+1))%>);"><%=Encode.forHtml(String.valueOf(i + 1))%>.
                                <%=Encode.forHtml(String.valueOf(arm[i]))%>
                            </a><br>
                            <%
                                    }
                                }
                            %> &nbsp;<input type="text" name="r_armOther"
                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("r_armOther", "")))%>"/></td>
                        <td class="mhList" rowspan="2" valign="top">Comments:<br>
                            <textarea class="mhRefTextarea"
                                      name="r_refComments"><%=Encode.forHtml(String.valueOf(props.getProperty("r_refComments", "")))%></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="mhSelect"><br>
