    ...
    <table width="82%" border="0" cellpadding="1" cellspacing="0"
        ...
        <tr bgcolor="#FFFFFF">
            <td width="40%" height="87" class="formtd">
                <p><font size="4"
                         face="Arial, Helvetica, sans-serif"><%--img src="./images/hsfologo.jpg" width="200" height="85" /--%></font>
                </p>
            </td>
 ...
 %> <input name="goback" type="hidden" value="<%= goback%>"> <%} %>
                ...
                <td>
                    <div align="right"><strong><font size="3"
                        ...
                        the visit record for: <font
                                color="#990000"><%=UtilDateUtilities.DateToString(visitData.getVisitDate_Id(), "yyyy-MMM-dd")%>
                    ...
                    <table width="100%" height="100%" border="0" cellpadding="1"
                        ...
                        <tr>
                            <td height="18" valign="top" class="formtd">
                                <div align="center"><font size="2"
                                                          face="Arial, Helvetica, sans-serif"><strong>BMI </strong></font>
                                    <img
                                    ...
                                    <tr>
                                        <td colspan="2"><font size="2"
                                            ...
                                            (self reported)</strong><span class="style1">* </span></font><font size="2"
                                                                                                               face="Arial, Helvetica, sans-serif">(fill
                                            ALL that apply)</font></td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table width="224" border="0">
                                                ...
                                                <tr class="dash">
                                                    <td height="20" class="coldash"><font size="2"
                                                                                          face="Arial, Helvetica, sans-serif">
                                                        <input
                                                                type="checkbox" name="Risk_activity"
                                                                value="Risk_activity"
                                ...
                                <table width="367" height="100%" border="0" cellpadding="1"
                                            ...
                                            <table width="100%" border="0">
                                                <tr>
                                                    ...
                                                    <td colspan="3"><font size="2"
                                                        ...
                                                        <option value="2007"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getYear() + 1900 == 2007) ? "selected" : ""%>>
                                                            2007
                                                        </option>
                                                        <option value="2008"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getYear() + 1900 == 2008) ? "selected" : ""%>>
                                                            2008
                                                        </option>
                                                        <option value="2009"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getYear() + 1900 == 2009) ? "selected" : ""%>>
                                                            2009
                                                        </option>
                                                    </select> - <select name="VisitDate_Id_month">
                                                        <option value="1"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 1) ? "selected" : ""%>>
                                                            Jan
                                                        </option>
                                                        <option value="2"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 2) ? "selected" : ""%>>
                                                            Feb
                                                        </option>
                                                        <option value="3"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 3) ? "selected" : ""%>>
                                                            Mar
                                                        </option>
                                                        <option value="4"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 4) ? "selected" : ""%>>
                                                            Apr
                                                        </option>
                                                        <option value="5"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 5) ? "selected" : ""%>>
                                                            May
                                                        </option>
                                                        <option value="6"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 6) ? "selected" : ""%>>
                                                            Jun
                                                        </option>
                                                        <option value="7"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 7) ? "selected" : ""%>>
                                                            Jul
                                                        </option>
                                                        <option value="8"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 8) ? "selected" : ""%>>
                                                            Aug
                                                        </option>
                                                        <option value="9"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 9) ? "selected" : ""%>>
                                                            Sep
                                                        </option>
                                                        <option value="10"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 10) ? "selected" : ""%>>
                                                            Oct
                                                        </option>
                                                        <option value="11"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 11) ? "selected" : ""%>>
                                                            Nov
                                                        </option>
                                                        <option value="12"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getMonth() + 1 == 12) ? "selected" : ""%>>
                                                            Dec
                                                        </option>
                                                    </select> - <select name="VisitDate_Id_day">
                                                        <option value="1"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 1) ? "selected" : ""%>>
                                                            1
                                                        </option>
                                                        <option value="2"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 2) ? "selected" : ""%>>
                                                            2
                                                        </option>
                                                        <option value="3"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 3) ? "selected" : ""%>>
                                                            3
                                                        </option>
                                                        <option value="4"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 4) ? "selected" : ""%>>
                                                            4
                                                        </option>
                                                        <option value="5"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 5) ? "selected" : ""%>>
                                                            5
                                                        </option>
                                                        <option value="6"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 6) ? "selected" : ""%>>
                                                            6
                                                        </option>
                                                        <option value="7"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 7) ? "selected" : ""%>>
                                                            7
                                                        </option>
                                                        <option value="8"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 8) ? "selected" : ""%>>
                                                            8
                                                        </option>
                                                        <option value="9"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 9) ? "selected" : ""%>>
                                                            9
                                                        </option>
                                                        <option value="10"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 10) ? "selected" : ""%>>
                                                            10
                                                        </option>
                                                        <option value="11"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 11) ? "selected" : ""%>>
                                                            11
                                                        </option>
                                                        <option value="12"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 12) ? "selected" : ""%>>
                                                            12
                                                        </option>
                                                        <option value="13"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 13) ? "selected" : ""%>>
                                                            13
                                                        </option>
                                                        <option value="14"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 14) ? "selected" : ""%>>
                                                            14
                                                        </option>
                                                        <option value="15"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 15) ? "selected" : ""%>>
                                                            15
                                                        </option>
                                                        <option value="16"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 16) ? "selected" : ""%>>
                                                            16
                                                        </option>
                                                        <option value="17"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 17) ? "selected" : ""%>>
                                                            17
                                                        </option>
                                                        <option value="18"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 18) ? "selected" : ""%>>
                                                            18
                                                        </option>
                                                        <option value="19"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 19) ? "selected" : ""%>>
                                                            19
                                                        </option>
                                                        <option value="20"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 20) ? "selected" : ""%>>
                                                            20
                                                        </option>
                                                        <option value="21"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 21) ? "selected" : ""%>>
                                                            21
                                                        </option>
                                                        <option value="22"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 22) ? "selected" : ""%>>
                                                            22
                                                        </option>
                                                        <option value="23"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 23) ? "selected" : ""%>>
                                                            23
                                                        </option>
                                                        <option value="24"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 24) ? "selected" : ""%>>
                                                            24
                                                        </option>
                                                        <option value="25"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 25) ? "selected" : ""%>>
                                                            25
                                                        </option>
                                                        <option value="26"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 26) ? "selected" : ""%>>
                                                            26
                                                        </option>
                                                        <option value="27"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 27) ? "selected" : ""%>>
                                                            27
                                                        </option>
                                                        <option value="28"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 28) ? "selected" : ""%>>
                                                            28
                                                        </option>
                                                        <option value="29"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 29) ? "selected" : ""%>>
                                                            29
                                                        </option>
                                                        <option value="30"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 30) ? "selected" : ""%>>
                                                            30
                                                        </option>
                                                        <option value="31"
                                                                <%= (visitData.getVisitDate_Id() != null && visitData.getVisitDate_Id().getDate() == 31) ? "selected" : ""%>>
                                                            31
                                                        </option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="71"><font size="2"
                                                                         face="Arial, Helvetica, sans-serif">Year</font>
                                                    </td>
                                                    <td width="78"><font size="2"
                                                                         face="Arial, Helvetica, sans-serif">month</font>
                                                    </td>
                                                    <td width="89"><font size="2"
                                                                         face="Arial, Helvetica, sans-serif">day</font>
                                                    </td>
                                                </tr>
                                            </table>
                                            <font size="2" face="Arial, Helvetica, sans-serif"><strong>Adequate
                                                drug coverage</strong> <input type="radio" name="Drugcoverage"
                                                                              value="yes"
                                    ...
                                    <tr valign="top">
                                        <td width="58" height="23"><font size="2"
                                                                         face="Arial, Helvetica, sans-serif">SBP </font>
                                        </td>
                                    ...
                                    <tr valign="top">
                                        <td height="26" colspan="3"><font size="2"
                                                                          face="Arial, Helvetica, sans-serif">BpTRU
                                            used: </font><font
                                            ...
                                            <table width="100%" border="0">
                                                <tr class="dash">
                                                    <td height="22" colspan="2"><font size="2"
                                                        ...
                                                        work </strong>(date and results of most recent)</font><font
                                                            size="2"
                                                            face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                                                </tr>
                                                <tr>
                                                    <td width="68"><font size="2"
                                                                         face="Arial, Helvetica, sans-serif">TC/HDL</font>
                                                    </td>
                                                ...
                                                <tr class="dash">
                                                    <td>
                                                        <div align="right"><font size="2"
                                                                                 face="Arial, Helvetica, sans-serif"><em>Date</em></font>
                                                        </div>
                                                    </td>
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif"><em>
                                                    </em></font><font size="2" face="Arial, Helvetica, sans-serif">
                                                        <input
                                                        ...
                                                        <option value="1"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 1) ? "selected" : ""%>>
                                                            Jan

                                                        <option value="2"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 2) ? "selected" : ""%>>
                                                            Feb

                                                        <option value="3"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 3) ? "selected" : ""%>>
                                                            Mar

                                                        <option value="4"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 4) ? "selected" : ""%>>
                                                            Apr

                                                        <option value="5"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 5) ? "selected" : ""%>>
                                                            May

                                                        <option value="6"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 6) ? "selected" : ""%>>
                                                            Jun

                                                        <option value="7"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 7) ? "selected" : ""%>>
                                                            Jul

                                                        <option value="8"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 8) ? "selected" : ""%>>
                                                            Aug

                                                        <option value="9"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 9) ? "selected" : ""%>>
                                                            Sep

                                                        <option value="10"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 10) ? "selected" : ""%>>
                                                            Oct

                                                        <option value="11"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 11) ? "selected" : ""%>>
                                                            Nov

                                                        <option value="12"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getMonth()+1 == 12) ? "selected" : ""%>>
                                                            Dec

                                                    </select> - <select name="TC_HDL_LabresultsDate_day">
                                                        <option value="1"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 1) ? "selected" : ""%>>
                                                            1

                                                        <option value="2"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 2) ? "selected" : ""%>>
                                                            2

                                                        <option value="3"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 3) ? "selected" : ""%>>
                                                            3

                                                        <option value="4"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 4) ? "selected" : ""%>>
                                                            4

                                                        <option value="5"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 5) ? "selected" : ""%>>
                                                            5

                                                        <option value="6"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 6) ? "selected" : ""%>>
                                                            6

                                                        <option value="7"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 7) ? "selected" : ""%>>
                                                            7

                                                        <option value="8"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 8) ? "selected" : ""%>>
                                                            8

                                                        <option value="9"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 9) ? "selected" : ""%>>
                                                            9

                                                        <option value="10"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 10) ? "selected" : ""%>>
                                                            10

                                                        <option value="11"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 11) ? "selected" : ""%>>
                                                            11

                                                        <option value="12"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 12) ? "selected" : ""%>>
                                                            12

                                                        <option value="13"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 13) ? "selected" : ""%>>
                                                            13

                                                        <option value="14"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 14) ? "selected" : ""%>>
                                                            14


                                                        <option value="15"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 15) ? "selected" : ""%>>
                                                            15

                                                        <option value="16"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 16) ? "selected" : ""%>>
                                                            16

                                                        <option value="17"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 17) ? "selected" : ""%>>
                                                            17

                                                        <option value="18"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 18) ? "selected" : ""%>>
                                                            18

                                                        <option value="19"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 19) ? "selected" : ""%>>
                                                            19

                                                        <option value="20"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 20) ? "selected" : ""%>>
                                                            20

                                                        <option value="21"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 21) ? "selected" : ""%>>
                                                            21

                                                        <option value="22"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 22) ? "selected" : ""%>>
                                                            22

                                                        <option value="23"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 23) ? "selected" : ""%>>
                                                            23

                                                        <option value="24"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 24) ? "selected" : ""%>>
                                                            24

                                                        <option value="25"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 25) ? "selected" : ""%>>
                                                            25

                                                        <option value="26"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 26) ? "selected" : ""%>>
                                                            26

                                                        <option value="27"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 27) ? "selected" : ""%>>
                                                            27

                                                        <option value="28"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 28) ? "selected" : ""%>>
                                                            28

                                                        <option value="29"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 29) ? "selected" : ""%>>
                                                            29

                                                        <option value="30"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 30) ? "selected" : ""%>>
                                                            30

                                                        <option value="31"
                                                                <%= (visitData.getTC_HDL_LabresultsDate() != null && visitData.getTC_HDL_LabresultsDate().getDate() == 31) ? "selected" : ""%>>
                                                            31

                                                    </select> </font></td>
                                                </tr>
                                                <tr>
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif">LDL</font>
                                                    </td>
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif">
                                                ...
                                                <tr class="dash">
                                                    ...
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif"><em>
                                                        ...
                                                        <option value="1"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 1) ? "selected" : ""%>>
                                                            Jan

                                                        <option value="2"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 2) ? "selected" : ""%>>
                                                            Feb

                                                        <option value="3"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 3) ? "selected" : ""%>>
                                                            Mar

                                                        <option value="4"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 4) ? "selected" : ""%>>
                                                            Apr

                                                        <option value="5"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 5) ? "selected" : ""%>>
                                                            May

                                                        <option value="6"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 6) ? "selected" : ""%>>
                                                            Jun

                                                        <option value="7"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 7) ? "selected" : ""%>>
                                                            Jul

                                                        <option value="8"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 8) ? "selected" : ""%>>
                                                            Aug

                                                        <option value="9"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 9) ? "selected" : ""%>>
                                                            Sep

                                                        <option value="10"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 10) ? "selected" : ""%>>
                                                            Oct

                                                        <option value="11"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 11) ? "selected" : ""%>>
                                                            Nov

                                                        <option value="12"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getMonth()+1 == 12) ? "selected" : ""%>>
                                                            Dec

                                                    </select> - <select name="LDL_LabresultsDate_day">
                                                        <option value="1"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 1) ? "selected" : ""%>>
                                                            1

                                                        <option value="2"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 2) ? "selected" : ""%>>
                                                            2

                                                        <option value="3"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 3) ? "selected" : ""%>>
                                                            3

                                                        <option value="4"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 4) ? "selected" : ""%>>
                                                            4

                                                        <option value="5"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 5) ? "selected" : ""%>>
                                                            5

                                                        <option value="6"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 6) ? "selected" : ""%>>
                                                            6

                                                        <option value="7"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 7) ? "selected" : ""%>>
                                                            7

                                                        <option value="8"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 8) ? "selected" : ""%>>
                                                            8

                                                        <option value="9"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 9) ? "selected" : ""%>>
                                                            9

                                                        <option value="10"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 10) ? "selected" : ""%>>
                                                            10

                                                        <option value="11"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 11) ? "selected" : ""%>>
                                                            11

                                                        <option value="12"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 12) ? "selected" : ""%>>
                                                            12

                                                        <option value="13"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 13) ? "selected" : ""%>>
                                                            13

                                                        <option value="14"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 14) ? "selected" : ""%>>
                                                            14

                                                        <option value="15"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 15) ? "selected" : ""%>>
                                                            15

                                                        <option value="16"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 16) ? "selected" : ""%>>
                                                            16

                                                        <option value="17"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 17) ? "selected" : ""%>>
                                                            17

                                                        <option value="18"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 18) ? "selected" : ""%>>
                                                            18

                                                        <option value="19"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 19) ? "selected" : ""%>>
                                                            19

                                                        <option value="20"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 20) ? "selected" : ""%>>
                                                            20

                                                        <option value="21"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 21) ? "selected" : ""%>>
                                                            21

                                                        <option value="22"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 22) ? "selected" : ""%>>
                                                            22

                                                        <option value="23"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 23) ? "selected" : ""%>>
                                                            23

                                                        <option value="24"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 24) ? "selected" : ""%>>
                                                            24

                                                        <option value="25"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 25) ? "selected" : ""%>>
                                                            25

                                                        <option value="26"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 26) ? "selected" : ""%>>
                                                            26

                                                        <option value="27"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 27) ? "selected" : ""%>>
                                                            27

                                                        <option value="28"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 28) ? "selected" : ""%>>
                                                            28

                                                        <option value="29"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 29) ? "selected" : ""%>>
                                                            29

                                                        <option value="30"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 30) ? "selected" : ""%>>
                                                            30

                                                        <option value="31"
                                                                <%= (visitData.getLDL_LabresultsDate() != null && visitData.getLDL_LabresultsDate().getDate() == 31) ? "selected" : ""%>>
                                                            31

                                                    </select> </font></td>
                                                </tr>
                                                <tr>
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif">HDL</font>
                                                    </td>
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif">
                                                ...
                                                <tr class="dash">
                                                    <td>
                                                        <div align="right"><em><font size="2"
                                                                                     face="Arial, Helvetica, sans-serif">Date</font></em>
                                                        </div>
                                                    </td>
                                                    <td><em><font size="2"
                                                                  face="Arial, Helvetica, sans-serif"> </font></em><font
                                                            size="2"
                                                            face="Arial, Helvetica, sans-serif"> <input
                                                        ...
                                                        - <select name="HDL_LabresultsDate_month">
                                                            <option value="1"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 1) ? "selected" : ""%>>
                                                                Jan

                                                            <option value="2"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 2) ? "selected" : ""%>>
                                                                Feb

                                                            <option value="3"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 3) ? "selected" : ""%>>
                                                                Mar

                                                            <option value="4"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 4) ? "selected" : ""%>>
                                                                Apr

                                                            <option value="5"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 5) ? "selected" : ""%>>
                                                                May

                                                            <option value="6"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 6) ? "selected" : ""%>>
                                                                Jun

                                                            <option value="7"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 7) ? "selected" : ""%>>
                                                                Jul

                                                            <option value="8"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 8) ? "selected" : ""%>>
                                                                Aug

                                                            <option value="9"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 9) ? "selected" : ""%>>
                                                                Sep

                                                            <option value="10"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 10) ? "selected" : ""%>>
                                                                Oct

                                                            <option value="11"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 11) ? "selected" : ""%>>
                                                                Nov

                                                            <option value="12"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getMonth()+1 == 12) ? "selected" : ""%>>
                                                                Dec

                                                        </select> - <select name="HDL_LabresultsDate_day">
                                                            <option value="1"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 1) ? "selected" : ""%>>
                                                                1

                                                            <option value="2"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 2) ? "selected" : ""%>>
                                                                2

                                                            <option value="3"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 3) ? "selected" : ""%>>
                                                                3

                                                            <option value="4"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 4) ? "selected" : ""%>>
                                                                4

                                                            <option value="5"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 5) ? "selected" : ""%>>
                                                                5

                                                            <option value="6"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 6) ? "selected" : ""%>>
                                                                6

                                                            <option value="7"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 7) ? "selected" : ""%>>
                                                                7

                                                            <option value="8"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 8) ? "selected" : ""%>>
                                                                8

                                                            <option value="9"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 9) ? "selected" : ""%>>
                                                                9

                                                            <option value="10"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 10) ? "selected" : ""%>>
                                                                10

                                                            <option value="11"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 11) ? "selected" : ""%>>
                                                                11

                                                            <option value="12"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 12) ? "selected" : ""%>>
                                                                12

                                                            <option value="13"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 13) ? "selected" : ""%>>
                                                                13

                                                            <option value="14"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 14) ? "selected" : ""%>>
                                                                14

                                                            <option value="15"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 15) ? "selected" : ""%>>
                                                                15

                                                            <option value="16"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 16) ? "selected" : ""%>>
                                                                16

                                                            <option value="17"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 17) ? "selected" : ""%>>
                                                                17

                                                            <option value="18"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 18) ? "selected" : ""%>>
                                                                18

                                                            <option value="19"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 19) ? "selected" : ""%>>
                                                                19

                                                            <option value="20"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 20) ? "selected" : ""%>>
                                                                20

                                                            <option value="21"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 21) ? "selected" : ""%>>
                                                                21

                                                            <option value="22"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 22) ? "selected" : ""%>>
                                                                22

                                                            <option value="23"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 23) ? "selected" : ""%>>
                                                                23

                                                            <option value="24"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 24) ? "selected" : ""%>>
                                                                24

                                                            <option value="25"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 25) ? "selected" : ""%>>
                                                                25

                                                            <option value="26"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 26) ? "selected" : ""%>>
                                                                26

                                                            <option value="27"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 27) ? "selected" : ""%>>
                                                                27

                                                            <option value="28"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 28) ? "selected" : ""%>>
                                                                28

                                                            <option value="29"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 29) ? "selected" : ""%>>
                                                                29

                                                            <option value="30"
                                                                    <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 30) ? "selected" : ""%>>
                                                                30

                                                            <option
                                                                    value="31 <%= (visitData.getHDL_LabresultsDate() != null && visitData.getHDL_LabresultsDate().getDate() == 31) ? "selected" : ""%>">
                                                                31

                                                        </select> </font></td>
                                                </tr>
                                                <tr>
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif">A1C</font>
                                                    </td>
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font size="2" face="Arial, Helvetica, sans-serif"><em>
                                                        ...
                                                        <option value="1"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 1) ? "selected" : ""%>>
                                                            Jan

                                                        <option value="2"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 2) ? "selected" : ""%>>
                                                            Feb

                                                        <option value="3"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 3) ? "selected" : ""%>>
                                                            Mar

                                                        <option value="4"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 4) ? "selected" : ""%>>
                                                            Apr

                                                        <option value="5"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 5) ? "selected" : ""%>>
                                                            May

                                                        <option value="6"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 6) ? "selected" : ""%>>
                                                            Jun

                                                        <option value="7"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 7) ? "selected" : ""%>>
                                                            Jul

                                                        <option value="8"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 8) ? "selected" : ""%>>
                                                            Aug

                                                        <option value="9"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 9) ? "selected" : ""%>>
                                                            Sep

                                                        <option value="10"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 10) ? "selected" : ""%>>
                                                            Oct

                                                        <option value="11"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 11) ? "selected" : ""%>>
                                                            Nov

                                                        <option value="12"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getMonth()+1 == 12) ? "selected" : ""%>>
                                                            Dec

                                                    </select> - <select name="A1C_LabresultsDate_day">
                                                        <option value="1"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 1) ? "selected" : ""%>>
                                                            1

                                                        <option value="2"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 2) ? "selected" : ""%>>
                                                            2

                                                        <option value="3"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 3) ? "selected" : ""%>>
                                                            3

                                                        <option value="4"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 4) ? "selected" : ""%>>
                                                            4

                                                        <option value="5"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 5) ? "selected" : ""%>>
                                                            5

                                                        <option value="6"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 6) ? "selected" : ""%>>
                                                            6

                                                        <option value="7"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 7) ? "selected" : ""%>>
                                                            7

                                                        <option value="8"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 8) ? "selected" : ""%>>
                                                            8

                                                        <option value="9"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 9) ? "selected" : ""%>>
                                                            9

                                                        <option value="10"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 10) ? "selected" : ""%>>
                                                            10

                                                        <option value="11"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 11) ? "selected" : ""%>>
                                                            11

                                                        <option value="12"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 12) ? "selected" : ""%>>
                                                            12

                                                        <option value="13"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 13) ? "selected" : ""%>>
                                                            13

                                                        <option value="14"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 14) ? "selected" : ""%>>
                                                            14

                                                        <option value="15"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 15) ? "selected" : ""%>>
                                                            15

                                                        <option value="16"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 16) ? "selected" : ""%>>
                                                            16

                                                        <option value="17"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 17) ? "selected" : ""%>>
                                                            17

                                                        <option value="18"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 18) ? "selected" : ""%>>
                                                            18

                                                        <option value="19"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 19) ? "selected" : ""%>>
                                                            19

                                                        <option value="20"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 20) ? "selected" : ""%>>
                                                            20

                                                        <option value="21"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 21) ? "selected" : ""%>>
                                                            21

                                                        <option value="22"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 22) ? "selected" : ""%>>
                                                            22

                                                        <option value="23"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 23) ? "selected" : ""%>>
                                                            23

                                                        <option value="24"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 24) ? "selected" : ""%>>
                                                            24

                                                        <option value="25"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 25) ? "selected" : ""%>>
                                                            25

                                                        <option value="26"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 26) ? "selected" : ""%>>
                                                            26

                                                        <option value="27"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 27) ? "selected" : ""%>>
                                                            27

                                                        <option value="28"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 28) ? "selected" : ""%>>
                                                            28

                                                        <option value="30"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 29) ? "selected" : ""%>>
                                                            29

                                                        <option value="30"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 30) ? "selected" : ""%>>
                                                            30

                                                        <option value="31"
                                                                <%= (visitData.getA1C_LabresultsDate() != null && visitData.getA1C_LabresultsDate().getDate() == 31) ? "selected" : ""%>>
                                                            31
                ...
                <td height="374" valign="top"><font size="2"
                                ...
                                <table width="100%" height="100%" border="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td width="307" height="32" valign="top"><font size="2"
                                                                                       face="Arial, Helvetica, sans-serif">How
                                            confident is pt
                    ...
                    <table width="100%" border="0" cellpadding="1" cellspacing="3"
                        ...
                        <tr>
                            <td width="169" height="17"><font size="2"
                                                              face="Arial, Helvetica, sans-serif">Overwhelmed or
                                stressed
                            </font></td>
                    ...
                    <table width="100%" cellpadding="1" cellspacing="1" class="formtable">
                        <tr>
                            ...
                            <td colspan="5" class="colsolid">
                                <div align="center"><font size="2"
                                                          face="Arial, Helvetica, sans-serif">Rx decision today </font>
                                </div>
                            </td>
                        ...
                        <tr class="dash">
                            ...
                            <td width="60" class="coldash"><font size="2"
                                                                 face="Arial, Helvetica, sans-serif">Side
                                effects </font></td>
                            ...
                            <td width="83" valign="bottom"><font size="2"
                                                                 face="Arial, Helvetica, sans-serif">In-class
                                switch </font></td>
                        </tr>
                        <tr class="dash">
                            ...
                            <td class="coldash"><font size="2"
                                                      face="Arial, Helvetica, sans-serif"> <input type="checkbox"
                                                                                                  name="Diuret_SideEffects"
                                                                                                  value="Diuret_SideEffects"
                        ...
                        <tr class="dash">
                            ...
                            <td class="coldash"><font size="2"
                                                      face="Arial, Helvetica, sans-serif"> <input type="checkbox"
                                                                                                  name="Arecept_SideEffects"
                                                                                                  value="Arecept_SideEffects"
                        ...
                        <tr class="dash">
                            ...
                            <td class="coldash"><font size="2"
                                                      face="Arial, Helvetica, sans-serif"> <input type="checkbox"
                                                                                                  name="Anti_SideEffects"
                                                                                                  value="Anti_SideEffects"
                        ...
                        <tr>
                            ...
                            <td class="coldash"><font size="2"
                                                      face="Arial, Helvetica, sans-serif"> <input type="checkbox"
                                                                                                  name="Hypo_SideEffects"
                                                                                                  value="Hypo_SideEffects"
                    ...
                    <table width="100%" cellpadding="1" cellspacing="3" class="formtable">
                        ...
                        <tr>
                            ...
                            <td class="coldash"><font size="2"
                                                      face="Arial, Helvetica, sans-serif"><u>BP monitoring </u> </font>
                            </td>
                ...
                <td height="115" valign="bottom">
                    <p align="right"><input type="submit" name="Save" value="Save">
                        ...
                        <input type="button" name="Close" value="Exit"
                               onClick="confirmExit(document.FrmForm)"> <%
