        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr align="center">
                ...
                <td colspan="3"><textarea name="p2_pConcern4m"
                                          ...
                                          rows="2"><%= props.getProperty("p2_pConcern4m", "") %></textarea>
                </td>
                <td colspan="3"><textarea name="p2_pConcern6m"
                                          style="width: 100%" cols="10"
                                          rows="2"><%= props.getProperty("p2_pConcern6m", "") %></textarea>
                </td>
                <td colspan="3"><textarea name="p2_pConcern9m"
                                          style="width: 100%" cols="10"
                                          rows="2"><%= props.getProperty("p2_pConcern9m", "") %></textarea>
                </td>
                <td colspan="3"><textarea name="p2_pConcern12m"
                                          style="width: 100%" cols="10"
                                          rows="2"><%= props.getProperty("p2_pConcern12m", "") %></textarea>
                </td>
            </tr>
            <tr>
