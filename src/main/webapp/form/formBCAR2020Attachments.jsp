            ...
            <div id="content_bar" class="innertube">
                <html:form action="/form/BCAR2020">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                        <tr>
                            <th align="left">British Columbia Antenatal Record Attachments <font size="-2">PSBC 1905 - January 2020</font></th>
                        </tr>
                    </table>
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="1" class="small9">
                        <tr>
                            <td width="60%" valign="top">
                                <p>
                                    This page is not part of the standard BC Antenatal Record 2020 form. Any additional information that does not fit onto the standard form can be added to the sections below.
                                </p>
                                <p>
                                    The buttons above each section will pull information from the patients E-Chart into the section below. 
                                    
                                    If a section is checked (enabled), it will print as part of the attachments. If the section is unchecked (disabled), it will not print.
                                </p>
                                <p>
                                    The Privacy Statement is a requirement by PHSA, it cannot be modified or removed, and must be printed as part of the BCAR2020.
                                </p>
                            </td>
                            ...
                            <td colspan="2">
                                <table width="100%" border="1" cellspacing="0" cellpadding="4">
                                    <tr>
                                        <td valign="top">
                                            <!-- Medications -->
                                            <input type="checkbox" name="c_attMedications" <%=Encode.forHtmlAttribute(props.getProperty("c_attMedications", "").equals("X") ? "checked" : "") %> />

                                            <span class="title">Medications</span>
                                            <p>You can either click any of the buttons below to pull in any medications from the E-Chart, or enter your own in the box below.</p>
                                            <input id="fetchMedications|mt_attMedications" type="button" class="btn-small clinicalData" value="Medications" />&nbsp;
                                            <input id="fetchLongTermMedications|mt_attMedications" type="button" class="btn-small clinicalData" value="Long Term Medications" />&nbsp;
                                            <input id="fetchOtherMeds" type="button" class="btn-small" value="<bean:message key="oscarEncounter.oscarConsultationRequest.ConsultationFormRequest.btnImportOtherMeds"/>" onclick="importFromEnct('OtherMeds',document.forms[0].mt_attMedications);" />
                                            <br />
                                            <textarea name="mt_attMedications" id="mt_attMedications" style="width: 100%; height:180px;" size="30" title="Medications"><%= UtilMisc.htmlEscape(props.getProperty("mt_attMedications", "")) %></textarea>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="1" cellspacing="0" cellpadding="4">
                                    <tr>
                                        <td valign="top">
                                            <!-- Allergies -->
                                            <input type="checkbox" name="c_attAllergies" <%=Encode.forHtmlAttribute(props.getProperty("c_attAllergies", "").equals("X") ? "checked" : "") %> />

                                            <span class="title">Allergies</span>
                                            <p>You can either click the button below to pull in any allergies from the E-Chart, or enter your own in the box below.</p>
                                            <input id="fetchAllergies|mt_attAllergies" type="button" class="btn-small clinicalData" value="Allergies" />
                                            <br />
                                                <textarea name="mt_attAllergies" id="mt_attAllergies" style="width: 100%; height:180px;" size="30" title="Allergies"><%= UtilMisc.htmlEscape(props.getProperty("mt_attAllergies", "")) %></textarea>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="1" cellspacing="0" cellpadding="4">
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <input type="checkbox" name="c_attAdditionalInfo" <%=Encode.forHtmlAttribute(props.getProperty("c_attAdditionalInfo", "").equals("X") ? "checked" : "") %> />

                                            <span class="title">Additional Information</span>
                                            <p>The buttons below will pull information in from the E-Chart.</p>
                                            <input id="fetchAddInfoSocHistory" type="button" class="btn-small" value="<bean:message key="oscarEncounter.oscarConsultationRequest.ConsultationFormRequest.btnImportSocHistory"/>" onclick="importFromEnct('SocialHistory',document.forms[0].mt_attAdditionalInfo);" />&nbsp;
                                            <input id="fetchAddInfoFamHistory" type="button" class="btn-small" value="<bean:message key="oscarEncounter.oscarConsultationRequest.ConsultationFormRequest.btnImportFamHistory"/>" onclick="importFromEnct('FamilyHistory',document.forms[0].mt_attAdditionalInfo);" />&nbsp;
                                            <input id="fetchAddInfoMedHistory" type="button" class="btn-small" value="<bean:message key="oscarEncounter.oscarConsultationRequest.ConsultationFormRequest.btnImportMedHistory"/>" onclick="importFromEnct('MedicalHistory',document.forms[0].mt_attAdditionalInfo);" />&nbsp;
                                            <input id="fetchAddInfoConcerns" type="button" class="btn-small" value="<bean:message key="oscarEncounter.oscarConsultationRequest.ConsultationFormRequest.btnImportConcerns"/>" onclick="importFromEnct('ongoingConcerns',document.forms[0].mt_attAdditionalInfo);" />&nbsp;
                                            <input id="fetchAddInfoReminders" type="button" class="btn-small" value="<bean:message key="oscarEncounter.oscarConsultationRequest.ConsultationFormRequest.btnImportReminders"/>" onclick="importFromEnct('Reminders',document.forms[0].mt_attAdditionalInfo);" />&nbsp;
                                            <input id="fetchRiskFactors|mt_attAdditionalInfo" type="button" class="btn-small clinicalData" value="Risk Factors" />&nbsp;
                                            <br />
                                            <textarea name="mt_attAdditionalInfo" id="mt_attAdditionalInfo" style="width: 100%; height:180px;" size="30" title="Additional Information"><%= UtilMisc.htmlEscape(props.getProperty("mt_attAdditionalInfo", "")) %></textarea>
                                        </td>
                                    </tr>
                                </table>
                                <!-- Documents -->
                                ...
                                <table width="100%" border="1" cellspacing="0" cellpadding="4">
                                    <tr>
                                        <td valign="top">
                                            <!-- Privacy Statement -->
                                            <span class="title">Privacy Statement </span><span class="sub-text">Mandatory</span>
                                            <p>Printing the privacy statement as part of the BCAR2020 is a requirement by PHSA. It cannot be modified or removed.</p>
