            ...
            <table>
                <tr>
                    <td class="mhSelect">Psychiatric Symptoms:<br>
                        ...
                        1.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rps1", "---").equals("") ? "" : rps[Integer.parseInt(props.getProperty("r_rps1", "---")) - 1]))%>
                        </b><br>
                        2.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rps2", "---").equals("") ? "" : rps[Integer.parseInt(props.getProperty("r_rps2", "---")) - 1]))%>
                        </b><br>
                        3.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rps3", "---").equals("") ? "" : rps[Integer.parseInt(props.getProperty("r_rps3", "---")) - 1]))%>
                        </b>
                    </td>
                </tr>
                <tr>
                    <td class="mhSelect">Psychosocial Issues:<br>
                        ...
                        1.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rpi1", "---").equals("") ? "" : rpi[Integer.parseInt(props.getProperty("r_rpi1", "---")) - 1]))%>
                        </b><br>
                        2.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rpi2", "---").equals("") ? "" : rpi[Integer.parseInt(props.getProperty("r_rpi2", "---")) - 1]))%>
                        </b><br>
                        3.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rpi3", "---").equals("") ? "" : rpi[Integer.parseInt(props.getProperty("r_rpi3", "---")) - 1]))%>
                        </b>
                    </td>
                </tr>
                <tr>
                    <td class="mhSelect">Med/Phy Issues:<br>
                        ...
                        1.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rmpi1", "---").equals("") ? "" : rmpi[Integer.parseInt(props.getProperty("r_rmpi1", "---")) - 1]))%>
                        </b><br>
                        2.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rmpi2", "---").equals("") ? "" : rmpi[Integer.parseInt(props.getProperty("r_rmpi2", "---")) - 1]))%>
                        </b><br>
                        3.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_rmpi3", "---").equals("") ? "" : rmpi[Integer.parseInt(props.getProperty("r_rmpi3", "---")) - 1]))%>
                        </b>
                    </td>
                </tr>
                <tr>
                    <td class="mhSelect">Interventions Requested:<br>
                        ...
                        1.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_ir1", "---").equals("") ? "" : ir[Integer.parseInt(props.getProperty("r_ir1", "---")) - 1]))%>
                        </b><br>
                        2.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_ir2", "---").equals("") ? "" : ir[Integer.parseInt(props.getProperty("r_ir2", "---")) - 1]))%>
                        </b><br>
                        3.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_ir3", "---").equals("") ? "" : ir[Integer.parseInt(props.getProperty("r_ir3", "---")) - 1]))%>
                        </b>
                    </td>
                </tr>
                <tr>
                    <td class="mhSelect">Advice Regarding Management:<br>
                        ...
                        1.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_arm1", "---").equals("") ? "" : arm[Integer.parseInt(props.getProperty("r_arm1", "---")) - 1]))%>
                        </b><br>
                        2.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_arm2", "---").equals("") ? "" : arm[Integer.parseInt(props.getProperty("r_arm2", "---")) - 1]))%>
                        </b><br>
                        3.
                        <b><%=Encode.forHtml(String.valueOf(props.getProperty("r_arm3", "---").equals("") ? "" : arm[Integer.parseInt(props.getProperty("r_arm3", "---")) - 1]))%>
                        </b>
                    </td>
                </tr>
                <tr>
                    <td class="mhSelect">Comments:<br>
                        <%=Encode.forHtml(String.valueOf(props.getProperty("r_refComments", "")))%>
                    </td>
                </tr>
            </table>
        </td>
