    ...
    if (!fedb.equals("") && !cppw.equals("")) {
        ...
        for (int i = 1; i < 18; i++) {
            if (!props.getProperty(("pg2_date" + i), "").equals("")) {
                ...
                if (arG.getWeekInt() < 8 || arG.getWeekInt() > 40 || arG.getHt(props.getProperty(("pg2_wt" + i), "")).equals(""))
                    continue;
        ...
        for (int i = 18; i < 35; i++) {
            if (!props.getProperty(("pg3_date" + i), "").equals("")) {
                ...
                if (arG.getWeekInt() < 19 || arG.getWeekInt() > 40 || arG.getHt(props.getProperty(("pg3_wt" + i), "")).equals(""))
                    continue;
