        ...
        <table class="Head" class="hidePrint">
            ...
            &nbsp;</font> --></td>
                <td align="right"><b>Edit:</b>AR1 | <a
                        href="form/formbcarpg2.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>">AR2
                    <font size=-2>(pg.1)</font></a> | <a
                        href="form/formbcarpg3.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>">AR2
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td colspan='2'>MOTHER'S NAME <input type="text"
                                                                 name="pg1_moName" style="width: 100%" size="60"
                                                                 maxlength="60"
                            ...
                            <td>AGE AT EDD<br>
                                <input type="text" name="pg1_ageAtEDD" style="width: 100%" size="2"
                                       maxlength="2" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_ageAtEDD", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>DATE<br>
                                <input type="text" name="pg1_formDate" style="width: 100%"
                                       ...
                                       dbType="date"/></td>
                            <td align="right"><%=bSync ? ("<b><a href=\"javascript: function myFunction() {return false; }\" onClick='syncDemo(); return false;'><font size='+1' color='red'>Synchronize</font></a></b>") : "" %>
                            </td>
                        </tr>
                        <tr>
        ...
        <table class="shrinkMe" width="100%" border="0" cellspacing="0"
            ...
            <tr>
                <td width="45%"><i>Mother's Signature:</i> <input type="text"
                                                                  ...
                                                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_moSign", "")))%>"
                                                                  @oscar.formDB/>
                </td>
                <td width="40%"><i>Witness:</i> <input type="text"
                                                       name="pg1_witness" size="40" maxlength="60"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_witness", "")))%>"
                                                       @oscar.formDB/>
                </td>
                <td><i>Date:</i> <input type="text" name="pg1_signDate"
                                        size="10" maxlength="10"
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_signDate", "")))%>" @oscar.formDB
                                        dbType="date"/></td>
            </tr>
        </table>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="6"><b>3. OBSTETRICAL HISTORY INCLUDING
                    ABORTIONS G</b><span class="small8">ravida</span> <input type="text"
                                                                             name="pg1_gravida" style="width: 30px;"
                                                                             size="2" maxlength="4"
                    ...
                    <b>L</b><span class="small8">iving</span> <input type="text"
                                                                     name="pg1_living" style="width: 30px;" size="2"
                                                                     maxlength="3"
                                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_living", "")))%>"
                                                                     @oscar.formDB/>
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="pg1_birthWeit2" style="width: 100%"
                           size="6" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_birthWeit2", "")))%>" @oscar.formDB/>
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="pg1_birthWeit3" style="width: 100%"
                           size="6" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_birthWeit3", "")))%>" @oscar.formDB/>
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="pg1_birthWeit4" style="width: 100%"
                           size="6" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_birthWeit4", "")))%>" @oscar.formDB/>
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="pg1_birthWeit5" style="width: 100%"
                           size="6" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_birthWeit5", "")))%>" @oscar.formDB/>
                </td>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            <tr>
                <td width="33%">
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="30%"><b>4.</b> LMP <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                               id="pg1_lmp_cal"><br>
                                dd/mm/yyyy<br>
                            ...
                            <td width="30%">MENSES CYCLE<br>
                                <input type="text" name="pg1_mensCycle" style="width: 100%"
                                       size="8" maxlength="8"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_mensCycle", "")))%>"
                                       @oscar.formDB/></td>
                            <td>EDD BY DATES<br>
                                dd/mm/yyyy<br>
                        ...
                        <tr>
							...
							<select name="pg1_contrMethod">
                                ...
                                %>
								<option value="<%=Encode.forHtmlAttribute(String.valueOf(opt[i]))%>"
                                        <%=props.getProperty("pg1_contrMethod", "").equals(opt[i]) ? "selected" : ""%>><%=Encode.forHtml(String.valueOf(opt[i]))%></option>
								<%}%>
							</select></td>
							...
							<input type="text" name="pg1_stopDate" id="pg1_stopDate"
                                   style="width: 100%" size="10" maxlength="10"
                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_stopDate", "")))%>"
                                   @oscar.formDB/></td>
                                    </tr>
                                </table>
                            </td>
                            <td>EDD BY US <img src="<%= request.getContextPath() %>/images/cal.gif"
                                               id="pg1_eddByUs_cal"><br>
                                dd/mm/yyyy<br>
                                <input type="text" name="pg1_eddByUs" id="pg1_eddByUs"
                                       style="width: 100%" size="10" maxlength="10"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_eddByUs", "")))%>" @oscar.formDB
                                       dbType="date"/></td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><b>CURRENT MEDICATIONS</b> <textarea name="pg1_curMedic"
                                                                     ...
                                                                     @oscar.formDB
                                                                     dbType="varchar(255)"> <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_curMedic", "")))%> </textarea>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>COMPLEMENTARY Rx's <br>
                                <input type="text" name="pg1_compRx" style="width: 100%" size="60"
                                       maxlength="60" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_compRx", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                    </table>
							...
							OR FEVER</span></td>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="pg1_depres"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_depres", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><span class="small9">DEPRESSION</span></td>
                                        <td><input type="text" name="pg1_depresSpec"
                                                   style="width: 100%" size="30" maxlength="30"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_depresSpec", "")))%>"
                                                   @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                ...
                <td width="33%" valign="top">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td><textarea name="pg1_operationSpec" style="width: 100%"
                                          cols="60" rows="3" @oscar.formDB
                                          dbType="varchar(255)"><%=Encode.forHtml(String.valueOf(props.getProperty("pg1_operationSpec", "")))%>
    </textarea></td>
                        </tr>
                        <tr>
					...
					RESPIRATORY</span></td>
                            <td><textarea name="pg1_cvOrRespSpec" style="width: 100%"
                                          cols="60" rows="2" @oscar.formDB
                                          dbType="varchar(255)"><%=Encode.forHtml(String.valueOf(props.getProperty("pg1_cvOrRespSpec", "")))%>
    </textarea></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top"><input type="checkbox" name="pg1_rxBlood"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_rxBlood", "")))%> @oscar.formDB
                                                    dbType="tinyint(1)"/></td>
                            <td><span class="small8">Rx BLOOD PRODUCTS</span></td>
                            <td><input type="text" name="pg1_rxBloodSpec"
                                       style="width: 100%" size="40" maxlength="40"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_rxBloodSpec", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                        <tr>
					...
					PSYCHIATRIC</span></td>
                            <td><input type="text" name="pg1_deprPsySpec"
                                       style="width: 100%" size="40" maxlength="40"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_deprPsySpec", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                        <tr>
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
							...
							discussed &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;concerns (specify)</span></i></td>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="pg1_speDiet"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_speDiet", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><span class="small9">SPECIAL DIET</span> <input
                                                type="text" name="pg1_speDietSpec" size="30" maxlength="40"
                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_speDietSpec", "")))%>"
                                                @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><span class="small8">FOLIC ACID</span> <input
                                                ...
                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_foliAcidDate", "")))%>"
                                                @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><span class="small8">ALCOHOL</span> <input type="text"
                                                                                       name="pg1_alcoSpec" size="10"
                                                                                       maxlength="10"
                                                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_alcoSpec", "")))%>"
                                                                                       @oscar.formDB/> <span
                                                class="small7" title="(see reverse)">T-ACE
							SCORE:</span> <input type="text" name="pg1_alcoTA" size="5"
                                                 maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_alcoTA", "")))%>"
                                                 @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="pg1_ipv"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_ipv", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><span class="small9">IPV</span> <input type="text"
                                                                                   name="pg1_ipvSpec" size="40"
                                                                                   maxlength="40"
                                                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_ipvSpec", "")))%>"
                                                                                   @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="pg1_smokeBef"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_smokeBef", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><span class="small8">SMOKING (before pregnancy)
							Cigs./day</span> <input type="text" name="pg1_smokeBefSpec" size="5"
                                                    maxlength="5"
                                                    value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_smokeBefSpec", "")))%>"
                                                    @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="pg1_smokeCur"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_smokeCur", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
							...
							Cigs./day</span> <input type="text" name="pg1_smokeCurSpec" size="5"
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="pg1_secSmoke"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_secSmoke", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><span class="small8">SECOND HAND SMOKE</span> <input
                                                type="text" name="pg1_secSmokeSpec" size="24" maxlength="30"
                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_secSmokeSpec", "")))%>"
                                                @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="pg1_finaHouse"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_finaHouse", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><span class="small8">FINANCIAL/HOUSING</span> <input
                                                type="text" name="pg1_finaHouseSpec" size="26" maxlength="30"
                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_finaHouseSpec", "")))%>"
                                                @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="pg1_supSys"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_supSys", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><span class="small8">SUPPORT SYSTEMS</span> <input
                                                type="text" name="pg1_supSysSpec" size="26" maxlength="30"
                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_supSysSpec", "")))%>"
                                                @oscar.formDB/></td>
                                    </tr>
                                </table>
                        ...
                        <tr>
							...
							YEARS COMPLETED:</span> <input type="text" name="pg1_schYear" size="3"
                                                           maxlength="3"
                                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_schYear", "")))%>"
                                                           @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"><span class="small8">WORK (specify
							type):</span> <input type="text" name="pg1_work" size="20"
                                                 maxlength="25" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_work", "")))%>"
                                                 @oscar.formDB/></td>
                                    </tr>
                                    <tr>
							...
							day:</span> <input type="text" name="pg1_workHourDay" size="3"
                                               ...
                                               @oscar.formDB/> <span class="small8">quitting date:</span> <input
                                                ...
                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_quitDate", "")))%>"
                                                @oscar.formDB dbType="date"/></td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="1%" valign="top"><input type="checkbox"
                                                                           name="pg1_earComm"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_earComm", "")))%> @oscar.formDB
                                                                           dbType="tinyint(1)"/></td>
							...
							SERVICES REFERRAL</span></td>
                                        <td valign="top"><input type="text" name="pg1_earCommSpec"
                                                                ...
                                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_earCommSpec", "")))%>"
                                                                @oscar.formDB/></td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" name="pg1_otherRef"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_otherRef", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                        <td><span class="small8">OTHER REFERRAL</span></td>
                                        <td valign="top"><input type="text" name="pg1_otherRefSpec"
                                                                size="26" maxlength="35"
                                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_otherRefSpec", "")))%>"
                                                                @oscar.formDB/></td>
                                    </tr>
                                </table>
                ...
                <td width="60%" valign="top">
                    ...
                    <table class="shrinkMe" width="100%" border="1" cellspacing="0"
                        ...
                        <tr>
                            <td colspan="2"><b>11. EXAMINATION</b> dd/mm/yyyy <img
                                    src="<%= request.getContextPath() %>/images/cal.gif" id="pg1_examination_cal"><br>
                                <input type="text" name="pg1_examination" id="pg1_examination"
                                       style="width: 100%" size="10" maxlength="10"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_examination", "")))%>"
                                       @oscar.formDB dbType="date"/></td>
                            <td colspan="2"><b>BP</b><br>
                                <input type="text" name="pg1_bp" style="width: 100%" size="10"
                                       maxlength="12" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_bp", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                        <tr>
					...
					&SPINE</span></td>
                            <td width="35%"><input type="text" name="pg1_muscSpine"
                                                   ...
                                                   maxlength="40"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_muscSpine", "")))%>"
                                                   @oscar.formDB/></td>
                        </tr>
                        <tr>
					...
					LUNGS</span></td>
                            <td><input type="text" name="pg1_heartLung" class="spe"
                                       onDblClick='showDef("NAD", this);' size="35" maxlength="40"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_heartLung", "")))%>"
                                       @oscar.formDB/></td>
					...
					CERVIX CYTOLOGY</span></td>
                            <td><input type="text" name="pg1_swabsCerv" class="spe"
                                       onDblClick='showDef("NAD", this);' size="30" maxlength="40"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_swabsCerv", "")))%>"
                                       @oscar.formDB/></td>
                        </tr>
                    </table>
					...
					Labour</font></td>
                        ...
                        <tr>
                            <td colspan="2"><span class="small7">plans to BF<input
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disBfY", "")))%> @oscar.formDB
                                    dbType="tinyint(1)"/>yes <input type="checkbox" name="pg1_disBfN"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disBfN", "")))%> @oscar.formDB
                                                                    dbType="tinyint(1)"/>no</font></td>
                            <td><input type="checkbox" name="pg1_disVBAC"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disVBAC", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">VBAC</font></td>
                            <td><input type="checkbox" name="pg1_disBabyCare"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disBabyCare", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">Baby Care</font></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="pg1_disBreNip"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disBreNip", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">Breast / Nipple Care </font></td>
                            <td><input type="checkbox" name="pg1_disHospAdm"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disHospAdm", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">Hospital Admission/</font></td>
                            <td><input type="checkbox" name="pg1_disSIDS"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disSIDS", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">SIDS Prevention</font></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="pg1_disExer"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disExer", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            ...
                            <td><input type="checkbox" name="pg1_disCircum"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disCircum", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">Circumcision</font></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="pg1_disGenCouns"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disGenCouns", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">Genetic Counselling</font></td>
                            <td><input type="checkbox" name="pg1_disBirthPlan"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disBirthPlan", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">Birth Plan</font></td>
                            <td><input type="checkbox" name="pg1_disOther"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disOther", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td rowspan="2"><span class="small8"> <textarea
                                    name="pg1_disOtherSpec" style="width: 100%" cols="10" rows="2"
                                    @oscar.formDB dbType="varchar(30)"><%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disOtherSpec", "")))%>
    </textarea> </font></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" name="pg1_disHIV"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disHIV", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
                            <td><span class="small8">HIV Testing</font></td>
                            <td><input type="checkbox" name="pg1_disPain"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_disPain", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="1%" valign="top"><input type="checkbox"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_sumBloodTran", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                <td width="50%" valign="top">I have discussed the benefits and
                    ...
                    blood products with the patient
                </td>
                <td width="1%" valign="top"><input type="checkbox"
                                                   name="pg1_sumSerumScr"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_sumSerumScr", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td>SIGNATURE: <input type="text" name="pg1_signature" size="35"
                                      maxlength="40" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg1_signature", "")))%>"
                                      @oscar.formDB/> MD/RM
                </td>
            </tr>
        </table>
        ...
        <table class="Head" class="hidePrint">
            <tr>
                ...
                <td align="right"><b>View:</b> <a
                        href="javascript: popupPage('form/formbcarpg2.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>&view=1');">AR2
                    <font size=-2>(pg.1)</font></a> | <a
                        href="javascript: popupPage('form/formbcarpg3.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>&view=1');">AR2
							...
							FACTORS</span></th>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="ar2_riskPriPretBirth33"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_riskPriPretBirth33", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="ar2_riskRhImmu"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_riskRhImmu", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
                                    ...
                                    <tr>
                                        <td valign="top"><input type="checkbox"
                                                ...
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_riskPriRhNB", "")))%> @oscar.formDB
                                                                dbType="tinyint(1)"/></td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="ar2_riskDietMacFetus"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_riskDietMacFetus", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
							...
							DISEASE</span></th>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="ar2_riskH157"
                                                <%=Encode.forHtml(String.valueOf(props.getProperty("ar2_riskH157", "")))%> @oscar.formDB
                                                   dbType="tinyint(1)"/></td>
