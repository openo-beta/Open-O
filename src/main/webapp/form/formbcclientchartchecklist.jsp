...
//int n0 = descCon.length;
        ...
        <table width="80%" border="1" cellspacing="0" cellpadding="2">
            ...
            <tr>
                <td width="20%"><select name="status3rd2a0">
                    ...
                    <option value="Discussed"
                            <%=props.getProperty("status3rd2a0", "").equalsIgnoreCase("Discussed") ? "selected" : ""%>>
                        Discussed
                    </option>
                    <option value="IM"
                            <%=props.getProperty("status3rd2a0", "").equalsIgnoreCase("IM") ? "selected" : ""%>>IM
                    </option>
                    <option value="PO"
                            <%=props.getProperty("status3rd2a0", "").equalsIgnoreCase("PO") ? "selected" : ""%>>PO
                    </option>
                    <option value="Declined"
                            <%=props.getProperty("status3rd2a0", "").equalsIgnoreCase("Declined") ? "selected" : ""%>>
                        Declined
                    </option>
                </select></td>
            ...
            <tr>
                <td width="20%"><select name="status3rd2a1">
                    ...
                    <option value="Discussed"
                            <%=props.getProperty("status3rd2a1", "").equalsIgnoreCase("Discussed") ? "selected" : ""%>>
                        Discussed
                    </option>
                    <option value="Yes"
                            <%=props.getProperty("status3rd2a1", "").equalsIgnoreCase("Yes") ? "selected" : ""%>>Yes
                    </option>
                    <option value="Delayed"
                            <%=props.getProperty("status3rd2a1", "").equalsIgnoreCase("Delayed") ? "selected" : ""%>>
                        Delayed
                    </option>
                    <option value="Declined"
                            <%=props.getProperty("status3rd2a1", "").equalsIgnoreCase("Declined") ? "selected" : ""%>>
                        Declined
                    </option>
                </select></td>
            ...
            <tr>
                <td width="20%"><select name="status3rd2a2">
                    ...
                    <option value="Discussed"
                            <%=props.getProperty("status3rd2a2", "").equalsIgnoreCase("Discussed") ? "selected" : ""%>>
                        Discussed
                    </option>
                    <option value="Yes"
                            <%=props.getProperty("status3rd2a2", "").equalsIgnoreCase("Yes") ? "selected" : ""%>>Yes
                    </option>
                    <option value="Declined"
                            <%=props.getProperty("status3rd2a2", "").equalsIgnoreCase("Declined") ? "selected" : ""%>>
                        Declined
                    </option>
                </select></td>
            ...
            <tr>
                <td width="20%"><select name="status3rd2a3">
                    ...
                    <option value="Discussed"
                            <%=props.getProperty("status3rd2a3", "").equalsIgnoreCase("Discussed") ? "selected" : ""%>>
                        Discussed
                    </option>
                    <option value="Yes"
                            <%=props.getProperty("status3rd2a3", "").equalsIgnoreCase("Yes") ? "selected" : ""%>>Yes
                    </option>
                    <option value="Declined"
                            <%=props.getProperty("status3rd2a3", "").equalsIgnoreCase("Declined") ? "selected" : ""%>>
                        Declined
                    </option>
                </select></td>
        ...
        <table width="80%" border="1" cellspacing="0" cellpadding="2">
            ...
            <tr>
                <td width="20%"><select name="status3rd3<%=i %>">
                    ...
                    <option value="Discussed"
                            <%=props.getProperty("status3rd30", "").equalsIgnoreCase("Discussed") ? "selected" : ""%>>
                        Discussed
                    </option>
                    <option value="Yes"
                            <%=props.getProperty("status3rd30", "").equalsIgnoreCase("Yes") ? "selected" : ""%>>Yes
                    </option>
                    <option value="Declined"
                            <%=props.getProperty("status3rd30", "").equalsIgnoreCase("Declined") ? "selected" : ""%>>
                        Declined
                    </option>
                    <% } else { %>
                    <option value=""></option>
    ...
    <script type="text/javascript">
        <% for(int i=0; i<14; i++) { %>
        Calendar.setup({
            inputField: "dateCon<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "dateCon<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<11; i++) { %>
        Calendar.setup({
            inputField: "dateConA<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "dateConA<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<14; i++) { %>
        Calendar.setup({
            inputField: "date1st<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "date1st<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<13; i++) { %>
        Calendar.setup({
            inputField: "date2nd<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "date2nd<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<14; i++) { %>
        Calendar.setup({
            inputField: "date3rd1<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "date3rd1<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<10; i++) { %>
        Calendar.setup({
            inputField: "date3rd2<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "date3rd2<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<4; i++) { %>
        Calendar.setup({
            inputField: "date3rd2a<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "date3rd2a<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<10; i++) { %>
        Calendar.setup({
            inputField: "date3rd3<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "date3rd3<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<3; i++) { %>
        Calendar.setup({
            inputField: "date3rd4<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "date3rd4<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<7; i++) { %>
        Calendar.setup({
            inputField: "date3rd5<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "date3rd5<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
        <% for(int i=0; i<7; i++) { %>
        Calendar.setup({
            inputField: "dateOther<%=i %>",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "dateOther<%=i%>_cal",
            singleClick: true,
            step: 1
        });
        <% } %>
