...
<html>
<head>
	<title><%= "Rourke2017 Record for " + Encode.forHtmlAttribute(props.getProperty("c_pName", "")) + " DOB: " + props.getProperty("c_birthDate", "")%></title>
...
function showNotes() {
    popPage('./Rourke2017_Ontario_English_Notes.pdf', 'Rourke2017_Ontario_English_Notes.pdf');
}
...
<div id="rourke2017-tabs">
	...
	<div class="panel-page" id="panel-page">
		<div class="tab-page" id="tab-cp1"><jsp:include page="formrourke2017p1.jsp" /></div>
		<div class="tab-page" id="tab-cp2"><jsp:include page="formrourke2017p2.jsp" /></div>
		<div class="tab-page" id="tab-cp3"><jsp:include page="formrourke2017p3.jsp" /></div>
		<div class="tab-page" id="tab-cp4"><jsp:include page="formrourke2017p4.jsp" /></div>
		<div id="tab-all"></div>
	</div>
</div>
</html:form>
