...
<%
    ...
    if (props.getProperty("ar2_lmpDate", "").equals(""))
        props.setProperty("ar2_lmpDate", props.getProperty("pg1_lmp", ""));
...
// Declaring valid date character, minimum year and maximum year
        ...
        function checkAllDates() {
            ...
            if (valDate(document.forms[0].c_EDD) == false) {
                ...
                b = false;
            } else if (valDate(document.forms[0].pg2_date17) == false) {
                b = false;
            }
            return b;
        }
...
%>
    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        -->
                <td align="right"><b>Edit:</b>
                    ...
                    <a href="form/formbcarpg3.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>">AR2 <font
                            size=-2>(pg.2)</font></a> |
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td>1st:<br>
                                            <input type="text" name="ar2_labHem1st" style="width:100%" size="10"
                                                   maxlength="12" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labHem1st", "")))%>"
                                                   @oscar.formDB/>
                                        </td>
                                        <td>3rd:<br>
                                            <input type="text" name="ar2_labHem3rd" style="width:100%" size="10"
                                                   maxlength="12" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labHem3rd", "")))%>"
                                                   @oscar.formDB/>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td nowrap>
                                            <input type="text" name="ar2_labRATDate1" id="ar2_labRATDate1" size="8"
                                                   maxlength="10"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labRATDate1", "")))%>" @oscar.formDB
                                                   dbType="date"/>
                                        ...
                                        <td>
                                            <input type="text" name="ar2_labRATRes1" style="width:100%" size="10"
                                                   maxlength="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labRATRes1", "")))%>"
                                                   @oscar.formDB/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                            <input type="text" name="ar2_labRATDate2" id="ar2_labRATDate2" size="8"
                                                   maxlength="10"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labRATDate2", "")))%>" @oscar.formDB
                                                   dbType="date"/>
                                        ...
                                        <td>
                                            <input type="text" name="ar2_labRATRes2" style="width:100%" size="10"
                                                   maxlength="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labRATRes2", "")))%>"
                                                   @oscar.formDB/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                            <input type="text" name="ar2_labRATDate3" id="ar2_labRATDate3" size="8"
                                                   maxlength="10"
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labRATDate3", "")))%>" @oscar.formDB
                                                   dbType="date"/>
                                        ...
                                        <td>
                                            <input type="text" name="ar2_labRATRes3" style="width:100%" size="10"
                                                   maxlength="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labRATRes3", "")))%>"
                                                   @oscar.formDB/>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="ar2_labRhIgG" id="ar2_labRhIgG" style="width:100%"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labRhIgG", "")))%>" @oscar.formDB
                                                   dbType="date"/>
                                        ...
                                        <td>
                                            <input type="text" name="ar2_labRhIgG2" id="ar2_labRhIgG2"
                                                   ...
                                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labRhIgG2", "")))%>" @oscar.formDB
                                                   dbType="date"/>
          ...
          <input type="checkbox" name="ar2_labHivTestN" <%= props.getProperty("ar2_labHivTestN", "")%> @oscar.formDB
                 dbType="tinyint(1)"/>
		  No
          <input type="checkbox" name="ar2_labHivTestY" <%= props.getProperty("ar2_labHivTestY", "")%> @oscar.formDB
                 dbType="tinyint(1)"/>
		  Yes</span>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="2">DATE<br>
                        <input type="text" name="pg2_formDate" style="width:100%" size="10" maxlength="10"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_formDate", "")))%>" @oscar.formDB dbType="date"/>
                    </td>
                </tr>
                <tr>
                        ...
                        <tr>
                            <td>
                                <input type="text" name="ar2_labGWeek" style="width:100%" size="3" maxlength="5"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labGWeek", "")))%>" @oscar.formDB/>
                            </td>
                            <td nowrap>
                                <input type="text" name="ar2_labDiabDate" id="ar2_labDiabDate" size="8" maxlength="10"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labDiabDate", "")))%>" @oscar.formDB
                                       dbType="date"/>
                            ...
                            <td>
                                <input type="text" name="ar2_labDiabRes" style="width:100%" size="10" maxlength="10"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labDiabRes", "")))%>" @oscar.formDB/>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="ar2_labGBSRes" class="spe"
                                       ...
                                       style="width:100%" size="10" maxlength="10"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_labGBSRes", "")))%>" @oscar.formDB/>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="12%" nowrap><span class="small8">PREPREGNANT WEIGHT</span><br>
                                <input type="text" name="c_ppWt" style="width:100%;" class="spe"
                            ...
                            <td width="10%">HEIGHT<br>
                                <input type="text" name="c_ppHt" class="spe" style="width:100%;"
                            ...
                            <td width="12%">
                                ...
                                <input type="text" name="c_ppBMI" class="spe" style="width:100%;"
                                       onDblClick="calcBMIMetric();" size="5" maxlength="5"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_ppBMI", "")))%>" @oscar.formDB/>
                            </td>
                            <td width="25%">LMP <span class="small8">DD/MM/YYYY</span><br>
                                <input type="text" name="ar2_lmpDate" style="width:100%" size="10" maxlength="10"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_lmpDate", "")))%>" @oscar.formDB dbType="date"/>
                            </td>
  ...
  GIVEN TO PATIENT</span>
            ...
            <tr>
                <td>
                    <input type="text" name="pg2_date17" class="spe" style="width:100%;" size="10" maxlength="10"
                           onDblClick="calToday(this)" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date17", "")))%>" @oscar.formDB
                           dbType="date"/>
                </td>
                <td>
                    <input type="text" name="pg2_wt17" class="spe" onDblClick="wtEnglish2Metric(this);"
                           style="width:100%" size="5" maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_wt17", "")))%>"
                           @oscar.formDB/>
                </td>
                <td>
                    <input type="text" name="pg2_bp17" style="width:100%" size="8" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_bp17", "")))%>" @oscar.formDB/>
                </td>
                <td nowrap>
                    <input type="text" name="pg2_urine17" class="spe"
                           onDblClick="showPGBox('UrineDiv',1, this, event, 'pg2_urine', 200, 481, 26);" size="2"
                           maxlength="8" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_urine17", "")))%>" @oscar.formDB/>
                    <input type="text" name="pg2_urineG17" class="spe"
                           onDblClick="showPGBox('UrineDiv',1, this, event, 'pg2_urineG', 200, 481, 26);" size="2"
                           maxlength="8" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_urineG17", "")))%>" @oscar.formDB/>
                </td>
                <td>
                    <input type="text" name="pg2_gest17" class="spe" style="width:100%;" size="8" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_gest17", "")))%>" onDblClick="calcWeek(this)"
                           @oscar.formDB/>
                </td>
                <td>
                    <input type="text" name="pg2_ht17" style="width:100%" size="8" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_ht17", "")))%>" @oscar.formDB/>
                </td>
                <td>
                    <input type="text" name="pg2_fhrAct17" style="width:100%" size="8" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_fhrAct17", "")))%>" @oscar.formDB/>
                </td>
                <td>
                    <input type="text" name="pg2_pos17" onDblClick="showBox('Langdiv',1, this, event);" class="spe"
                           style="width:100%;" size="8" maxlength="8" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_pos17", "")))%>"
                           @oscar.formDB/>
                </td>
                <td><span class="small8"><font color="red">NOTE: SEND HOSPITAL COPY AT 36 WEEKS</font></span><br>
                    <input type="text" name="pg2_comment17" style="width:100%" size="50" maxlength="80"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_comment17", "")))%>" @oscar.formDB/>
                </td>
                <td>
                    <input type="text" name="pg2_retIn17" style="width:100%" size="8" maxlength="8"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_retIn17", "")))%>" @oscar.formDB/>
                </td>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            <tr>
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td><span class="small9">COMMENTS</span><br>
                                <textarea name="ar2_probComment" style="width:100%" cols="40" rows="1" @oscar.formDB
                                          dbType="varchar(255)"><%=Encode.forHtml(String.valueOf(props.getProperty("ar2_probComment", "")))%></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3"><textarea name="ar2_investigation" style="width:100%" cols="50" rows="5"
                                                      @oscar.formDB
                                                      dbType="text"><%=Encode.forHtml(String.valueOf(props.getProperty("ar2_investigation", "")))%></textarea>
                            </td>
                        </tr>
                    </table>
                ...
                <td><input type="text" name="ar2_doulaNo" style="width:100%" size="10" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ar2_doulaNo", "")))%>" @oscar.formDB/></td>
                </td>
            </tr>
        </table>
        <br>
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
            ...
            <tr>
                ...
                <td width="45%"><input type="text" name="pg2_consultName" style="width:100%" size="50" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_consultName", "")))%>" @oscar.formDB/></td>
                </td>
                <td width="45%"><input type="text" name="pg2_signature" style="width:100%" size="50" maxlength="60"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_signature", "")))%>" @oscar.formDB/></td>
