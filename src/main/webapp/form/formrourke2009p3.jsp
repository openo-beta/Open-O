...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr class="titleBar">
        <th><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.msgRourkeBabyRecord"/></th>
    </tr>
</table>
...
<table cellpadding="0" cellspacing="0" width="100%" border="1">
    <tr align="center">
        ...
        <td colspan="3" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.msg9mos"/></a></td>
        <td colspan="3" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.msg12mos"/></a></td>
        <td colspan="3" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.msg15mos"/></a></td>
    </tr>
    <tr align="center">
    ...
    <tr id="growthAp3" align="center">
        ...
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHt"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formWt12m"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHdCirc"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHt"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formWt"/></td>
        <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHdCirc"/></td>
    ...
    <tr id="growthBp3" align="center">
        <td><input type="text" class="wide"
                   ...
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_ht9m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p3_wt9m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_wt9m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p3_hc9m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_hc9m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p3_ht12m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_ht12m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p3_wt12m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_wt12m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p3_hc12m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_hc12m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p3_ht15m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_ht15m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="wtEnglish2Metric(this);" name="p3_wt15m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_wt15m", "")))%>"></td>
        <td><input type="text" class="wide"
                   ondblclick="htEnglish2Metric(this);" name="p3_hc15m" size="4"
                   maxlength="5" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_hc15m", "")))%>"></td>
    </tr>
    <tr align="center">
        ...
        <td colspan="3"><textarea id="p3_pConcern9m"
                                  name="p3_pConcern9m" class="wide" cols="10"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_pConcern9m", "")))%></textarea>
        </td>
        <td colspan="3"><textarea id="p3_pConcern12m"
                                  name="p3_pConcern12m" class="wide" cols="10"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_pConcern12m", "")))%></textarea>
        </td>
        <td colspan="3"><textarea id="p3_pConcern15m"
                                  name="p3_pConcern15m" class="wide" cols="10"
                                  rows="5"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_pConcern15m", "")))%></textarea>
        </td>
    </tr>
            ...
            <table id="ntp31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_breastFeeding9mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding9mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding9mOkConcerns"
                                            name="p3_breastFeeding9mOkConcerns"
                                            onclick="onCheck(this,'p3_breastFeeding9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding9mNo"
                                            name="p3_breastFeeding9mNo" onclick="onCheck(this,'p3_breastFeeding9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding9mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding9mNotDiscussed"
                                            name="p3_breastFeeding9mNotDiscussed"
                                            onclick="onCheck(this,'p3_breastFeeding9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding9mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              ...
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.btnBreastFeeding"/><br/>
                    </a><span
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.msgBreastFeedingDescr"/></span></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_formulaFeeding9mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_formulaFeeding9mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_formulaFeeding9mOkConcerns"
                                            name="p3_formulaFeeding9mOkConcerns"
                                            onclick="onCheck(this,'p3_formulaFeeding9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_formulaFeeding9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_formulaFeeding9mNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_formulaFeeding9mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_formulaFeeding9mNotDiscussed"
                                            name="p3_formulaFeeding9mNotDiscussed"
                                            onclick="onCheck(this,'p3_formulaFeeding9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_formulaFeeding9mNotDiscussed", "")))%>></td>
                    <td><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.msgFormulaFeeding"/></i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_bottle9mOk"
                                            name="p3_bottle9mOk" onclick="onCheck(this,'p3_bottle9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_bottle9mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_bottle9mOkConcerns"
                                            name="p3_bottle9mOkConcerns" onclick="onCheck(this,'p3_bottle9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_bottle9mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_bottle9mNotDiscussed"
                                            name="p3_bottle9mNotDiscussed" onclick="onCheck(this,'p3_bottle9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_bottle9mNotDiscussed", "")))%>></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_liquids9mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_liquids9mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_liquids9mOkConcerns"
                                            name="p3_liquids9mOkConcerns" onclick="onCheck(this,'p3_liquids9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_liquids9mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_liquids9mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_liquids9mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_2.msgLiquids"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_cereal9mOk"
                                            name="p3_cereal9mOk" onclick="onCheck(this,'p3_cereal9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cereal9mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_cereal9mOkConcerns"
                                            name="p3_cereal9mOkConcerns" onclick="onCheck(this,'p3_cereal9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cereal9mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_cereal9mNotDiscussed"
                                            name="p3_cereal9mNotDiscussed" onclick="onCheck(this,'p3_cereal9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cereal9mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.msgCereal"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><input type="radio" id="p3_introCowMilk9mOkConcerns"
                                            name="p3_introCowMilk9mOkConcerns"
                                            onclick="onCheck(this,'p3_introCowMilk9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cereal9mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_introCowMilk9mNotDiscussed"
                                            name="p3_introCowMilk9mNotDiscussed"
                                            onclick="onCheck(this,'p3_introCowMilk9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_introCowMilk9mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.msgIntroCowMilk"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_egg9mOk"
                                            name="p3_egg9mOk" onclick="onCheck(this,'p3_egg9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_egg9mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_egg9mOkConcerns"
                                            name="p3_egg9mOkConcerns" onclick="onCheck(this,'p3_egg9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_egg9mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_egg9mNotDiscussed"
                                            name="p3_egg9mNotDiscussed" onclick="onCheck(this,'p3_egg9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_egg9mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgEggWhites"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_choking9mOk"
                                            name="p3_choking9mOk" onclick="onCheck(this,'p3_choking9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking9mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_choking9mOkConcerns"
                                            name="p3_choking9mOkConcerns" onclick="onCheck(this,'p3_choking9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking9mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_choking9mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking9mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgChoking"/>*</a></td>
                </tr>

                <tr align="center" style="vertical-align:bottom;">
                    <td colspan="5"><textarea id="p3_nutrition9m"
                                              name="p3_nutrition9m" class="wide" rows="5"
                                              cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_nutrition9m", "")))%></textarea></td>
                </tr>
            </table>
            ...
            <table id="ntp32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_breastFeeding12mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding12mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding12mOkConcerns"
                                            name="p3_breastFeeding12mOkConcerns"
                                            onclick="onCheck(this,'p3_breastFeeding12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding12mNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding12mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding12mNotDiscussed"
                                            name="p3_breastFeeding12mNotDiscussed"
                                            onclick="onCheck(this,'p3_breastFeeding12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding12mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnBreastFeeding"/>*</a></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_homoMilk12mOk"
                                            name="p3_homoMilk12mOk" onclick="onCheck(this,'p3_homoMilk12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk12mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_homoMilk12mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_homoMilk12mNo"
                                            name="p3_homoMilk12mNo" onclick="onCheck(this,'p3_homoMilk12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk12mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_homoMilk12mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk12mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2.formHomogenizedMilk"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_cup12mOk"
                                            name="p3_cup12mOk" onclick="onCheck(this,'p3_cup12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cup12mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_cup12mOkConcerns"
                                            name="p3_cup12mOkConcerns" onclick="onCheck(this,'p3_cup12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cup12mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_cup12mNotDiscussed"
                                            name="p3_cup12mNotDiscussed" onclick="onCheck(this,'p3_cup12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cup12mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formEncourageCup"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_appetite12mOk"
                                            name="p3_appetite12mOk" onclick="onCheck(this,'p3_appetite12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_appetite12mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_appetite12mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_appetite12mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_appetite12mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_appetite12mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2.formAppetiteReduced"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_choking12mOk"
                                            name="p3_choking12mOk" onclick="onCheck(this,'p3_choking12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking12mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_choking12mOkConcerns"
                                            name="p3_choking12mOkConcerns" onclick="onCheck(this,'p3_choking12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking12mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_choking12mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking12mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgChoking"/>*</a></td>
                </tr>
                ...
                <tr align="center">
                    <td colspan="5" style="vertical-align:bottom;"><textarea id="p3_nutrition12m"
                                                                             name="p3_nutrition12m" class="wide"
                                                                             rows="5"
                                                                             cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_nutrition12m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="ntp33" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_breastFeeding15mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding15mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding15mOkConcerns"
                                            name="p3_breastFeeding15mOkConcerns"
                                            onclick="onCheck(this,'p3_breastFeeding15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding15mNo"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding15mNo", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_breastFeeding15mNotDiscussed"
                                            name="p3_breastFeeding15mNotDiscussed"
                                            onclick="onCheck(this,'p3_breastFeeding15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_breastFeeding15mNotDiscussed", "")))%>></td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnBreastFeeding"/>*</a></b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_homoMilk15mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk15mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_homoMilk15mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_homoMilk15mNo"
                                            name="p3_homoMilk15mNo" onclick="onCheck(this,'p3_homoMilk15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homoMilk15mNo", "")))%>></td>
                ...
                <tr>
                    ...
                    <td valign="top"><input type="radio" id="p3_choking15mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_choking15mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.msgChoking"/>*</a></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_cup15mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cup15mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_cup15mOkConcerns"
                                            name="p3_cup15mOkConcerns" onclick="onCheck(this,'p3_cup15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cup15mOkConcerns", "")))%>></td>
                    <td>&nbsp;</td>
                    <td valign="top"><input type="radio" id="p3_cup15mNotDiscussed"
                                            name="p3_cup15mNotDiscussed" onclick="onCheck(this,'p3_cup15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_cup15mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formEncourageCup"/></td>
                </tr>

                <tr align="center">
                    <td colspan="5" style="vertical-align:bottom;"><textarea id="p3_nutrition15m"
                                                                             name="p3_nutrition15m" class="wide"
                                                                             rows="5"
                                                                             cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_nutrition15m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="educationp3">
        ...
        <td colspan="9" valign="top">
            <table id="edt3" style="font-size: 8pt;" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td valign="top" colspan="20"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formInjuryPrev"/></td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15"
                                                                     width="20" src="graphics/Checkmark_L.gif"></td>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_smokeSafetyOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_smokeSafetyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_smokeSafetyOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_smokeSafetyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_smokeSafetyNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_smokeSafetyNotDiscussed", "")))%>></td>
                    ...
                    <td valign="top"><input type="radio" id="p3_hotWaterOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hotWaterOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_hotWaterOkConcerns"
                                            name="p3_hotWaterOkConcerns" onclick="onCheck(this,'p3_hotWater')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hotWaterOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_hotWaterNotDiscussed"
                                            name="p3_hotWaterNotDiscussed" onclick="onCheck(this,'p3_hotWater')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hotWaterNotDiscussed", "")))%>></td>
                    <td valign="top"><i><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHotWater"/>*</a></i></td>
                    <td colspan="8">&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="4" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formChildProof"/>
                    <td valign="top"><input type="radio" id="p3_electricOk"
                                            name="p3_electricOk" onclick="onCheck(this,'p3_electric')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_electricOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_electricOkConcerns"
                                            name="p3_electricOkConcerns" onclick="onCheck(this,'p3_electric')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_electricOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_electricNotDiscussed"
                                            name="p3_electricNotDiscussed" onclick="onCheck(this,'p3_electric')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_electricNotDiscussed", "")))%>></td>
                    <td valign="top"><i><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formElectric"/></i></td>
                    <td valign="top"><input type="radio" id="p3_fallsOk"
                                            name="p3_fallsOk" onclick="onCheck(this,'p3_falls')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fallsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_fallsOkConcerns"
                                            name="p3_fallsOkConcerns" onclick="onCheck(this,'p3_falls')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fallsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_fallsNotDiscussed"
                                            name="p3_fallsNotDiscussed" onclick="onCheck(this,'p3_falls')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fallsNotDiscussed", "")))%>></td>
                    <td valign="top"><i><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formFalls"/>*</a></i></td>
                    <td valign="top"><input type="radio" id="p3_safeToysOk"
                                            name="p3_safeToysOk" onclick="onCheck(this,'p3_safeToys')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_safeToysOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_safeToysOkConcerns"
                                            name="p3_safeToysOkConcerns" onclick="onCheck(this,'p3_safeToys')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_safeToysOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_safeToysNotDiscussed"
                                            name="p3_safeToysNotDiscussed" onclick="onCheck(this,'p3_safeToys')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_safeToysNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    ...
                    <td valign="top"><input type="radio" id="p3_soothabilityOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_soothabilityOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_soothabilityNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_soothabilityNotDiscussed", "")))%>></td>
                    ...
                    <td valign="top"><input type="radio" id="p3_homeVisitOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homeVisitOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_homeVisitOkConcerns"
                                            name="p3_homeVisitOkConcerns" onclick="onCheck(this,'p3_homeVisit')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homeVisitOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_homeVisitNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_homeVisitNotDiscussed", "")))%>></td>
                    <td valign="top"><b><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formHomeVisit"/>**</a></b></td>
                    <td colspan="4">&nbsp;</td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_parentingOk"
                                            name="p3_parentingOk" onclick="onCheck(this,'p3_parenting')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_parentingOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_parentingOkConcerns"
                                            name="p3_parentingOkConcerns" onclick="onCheck(this,'p3_parenting')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_parentingOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_parentingNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_parentingNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formParenting"/></td>
                    <td valign="top"><input type="radio" id="p3_pFatigueOk"
                                            name="p3_pFatigueOk" onclick="onCheck(this,'p3_pFatigue')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pFatigueOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_pFatigueOkConcerns"
                                            name="p3_pFatigueOkConcerns" onclick="onCheck(this,'p3_pFatigue')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pFatigueOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_pFatigueNotDiscussed"
                                            name="p3_pFatigueNotDiscussed" onclick="onCheck(this,'p3_pFatigue')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pFatigueNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                    ...
                    <td valign="top"><input type="radio" id="p3_famConflictOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_famConflictOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_famConflictOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_famConflictOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_famConflictNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_famConflictNotDiscussed", "")))%>></td>
                    ...
                    <td valign="top"><input type="radio" id="p3_childCareOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_childCareOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_childCareOkConcerns"
                                            name="p3_childCareOkConcerns" onclick="onCheck(this,'p3_childCare')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_childCareOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_childCareNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_childCareNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formChildCare"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top" colspan="20"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formOtherIssues"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_2ndSmokeOk"
                                            name="p3_2ndSmokeOk" onclick="onCheck(this,'p3_2ndSmoke')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_2ndSmokeOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_2ndSmokeOkConcerns"
                                            name="p3_2ndSmokeOkConcerns" onclick="onCheck(this,'p3_2ndSmoke')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_2ndSmokeOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_2ndSmokeNotDiscussed"
                                            name="p3_2ndSmokeNotDiscussed" onclick="onCheck(this,'p3_2ndSmoke')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_2ndSmokeNotDiscussed", "")))%>></td>
                    <td valign="top"><b><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                    ...
                    <td valign="top"><input type="radio" id="p3_teethingOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_teethingOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_teethingOkConcerns"
                                            name="p3_teethingOkConcerns" onclick="onCheck(this,'p3_teething')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_teethingOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_teethingNotDiscussed"
                                            name="p3_teethingNotDiscussed" onclick="onCheck(this,'p3_teething')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_teethingNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formTeething"/>*</a></td>
                    <td valign="top"><input type="radio" id="p3_altMedOk"
                                            name="p3_altMedOk" onclick="onCheck(this,'p3_altMed')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_altMedOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_altMedOkConcerns"
                                            name="p3_altMedOkConcerns" onclick="onCheck(this,'p3_altMed')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_altMedOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_altMedNotDiscussed"
                                            name="p3_altMedNotDiscussed" onclick="onCheck(this,'p3_altMed')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_altMedNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formAltMed"/>*</a></td>
                    <td valign="top"><input type="radio" id="p3_pacifierOk"
                                            name="p3_pacifierOk" onclick="onCheck(this,'p3_pacifier')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pacifierOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_pacifierOkConcerns"
                                            name="p3_pacifierOkConcerns" onclick="onCheck(this,'p3_pacifier')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pacifierOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_pacifierNotDiscussed"
                                            name="p3_pacifierNotDiscussed" onclick="onCheck(this,'p3_pacifier')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pacifierNotDiscussed", "")))%>></td>
                    <td colspan="5" valign="top"><i><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                            onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formPacifierUse"/>*</a></i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_feverOk"
                                            name="p3_feverOk" onclick="onCheck(this,'p3_fever')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_feverOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_feverOkConcerns"
                                            name="p3_feverOkConcerns" onclick="onCheck(this,'p3_fever')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_feverOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_feverNotDiscussed"
                                            name="p3_feverNotDiscussed" onclick="onCheck(this,'p3_fever')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_feverNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                        onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formFever"/>*</a></td>
                    <td valign="top"><input type="radio" id="p3_activeOk"
                                            name="p3_activeOk" onclick="onCheck(this,'p3_active')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_activeOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_activeOkConcerns"
                                            name="p3_activeOkConcerns" onclick="onCheck(this,'p3_active')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_activeOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_activeNotDiscussed"
                                            name="p3_activeNotDiscussed" onclick="onCheck(this,'p3_active')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_activeNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td colspan="4" valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formEnvHealth"/></td>
                    <td valign="top"><input type="radio" id="p3_sunExposureOk"
                                            name="p3_sunExposureOk" onclick="onCheck(this,'p3_sunExposure')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sunExposureOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_sunExposureOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sunExposureOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_sunExposureNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sunExposureNotDiscussed", "")))%>></td>
                    <td valign="top"><a href="javascript:showNotes()"
                                        onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                    ...
                    <td valign="top"><input type="radio" id="p3_checkSerumOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_checkSerumOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_checkSerumOkConcerns"
                                            name="p3_checkSerumOkConcerns" onclick="onCheck(this,'p3_checkSerum')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_checkSerumOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_checkSerumNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_checkSerumNotDiscussed", "")))%>></td>
                    <td valign="top"><i><a href="javascript:showNotes()"
                                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formCheckSerum"/>*</a></i></td>
                    <td valign="top"><input type="radio" id="p3_pesticidesOk"
                                            name="p3_pesticidesOk" onclick="onCheck(this,'p3_pesticides')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pesticidesOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_pesticidesOkConcerns"
                                            name="p3_pesticidesOkConcerns" onclick="onCheck(this,'p3_pesticides')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pesticidesOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_pesticidesNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pesticidesNotDiscussed", "")))%>></td>
                    <td valign="top"><i><a
                            href="javascript:showNotes()"
                            onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                ...
                <tr>
                    <td style="vertical-align:bottom;" colspan="20">
						<textarea id="p3_education"
                                  name="p3_education" class="wide" rows="5"
                                  cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_education", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="developmentp3">
        <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgDevelopment"/>**</a><br>
            <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_1.msgDevelopmentDesc"/><br>
            ...
            <table id="dt31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_hiddenToyOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hiddenToyOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_hiddenToyOkConcerns"
                                            name="p3_hiddenToyOkConcerns" onclick="onCheck(this,'p3_hiddenToy')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hiddenToyOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_hiddenToyNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hiddenToyNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formhiddenToy"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_soundsOk"
                                            name="p3_soundsOk" onclick="onCheck(this,'p3_sounds')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_soundsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_soundsOkConcerns"
                                            name="p3_soundsOkConcerns" onclick="onCheck(this,'p3_sounds')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_soundsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_soundsNotDiscussed"
                                            name="p3_soundsNotDiscussed" onclick="onCheck(this,'p3_sounds')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_soundsNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formSounds"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_responds2peopleOk"
                                            name="p3_responds2peopleOk" onclick="onCheck(this,'p3_responds2people')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_responds2peopleOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_responds2peopleOkConcerns"
                                            name="p3_responds2peopleOkConcerns"
                                            onclick="onCheck(this,'p3_responds2people')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_responds2peopleOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_responds2peopleNotDiscussed"
                                            name="p3_responds2peopleNotDiscussed"
                                            onclick="onCheck(this,'p3_responds2people')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_responds2peopleNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formResponds2people"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_makeSoundsOk"
                                            name="p3_makeSoundsOk" onclick="onCheck(this,'p3_makeSounds')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_makeSoundsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_makeSoundsOkConcerns"
                                            name="p3_makeSoundsOkConcerns" onclick="onCheck(this,'p3_makeSounds')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_makeSoundsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_makeSoundsNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_makeSoundsNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formMakeSounds"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_sitsOk"
                                            name="p3_sitsOk" onclick="onCheck(this,'p3_sits')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sitsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_sitsOkConcerns"
                                            name="p3_sitsOkConcerns" onclick="onCheck(this,'p3_sits')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sitsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_sitsNotDiscussed"
                                            name="p3_sitsNotDiscussed" onclick="onCheck(this,'p3_sits')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_sitsNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formSits"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_standsOk"
                                            name="p3_standsOk" onclick="onCheck(this,'p3_stands')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_standsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_standsOkConcerns"
                                            name="p3_standsOkConcerns" onclick="onCheck(this,'p3_stands')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_standsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_standsNotDiscussed"
                                            name="p3_standsNotDiscussed" onclick="onCheck(this,'p3_stands')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_standsNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formStands"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_thumbOk"
                                            name="p3_thumbOk" onclick="onCheck(this,'p3_thumb')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_thumbOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_thumbOkConcerns"
                                            name="p3_thumbOkConcerns" onclick="onCheck(this,'p3_thumb')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_thumbOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_thumbNotDiscussed"
                                            name="p3_thumbNotDiscussed" onclick="onCheck(this,'p3_thumb')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_thumbNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formThumb&Index"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_playGamesOk"
                                            name="p3_playGamesOk" onclick="onCheck(this,'p3_playGames')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_playGamesOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_playGamesOkConcerns"
                                            name="p3_playGamesOkConcerns" onclick="onCheck(this,'p3_playGames')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_playGamesOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_playGamesNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_playGamesNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formplayGames"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_attention9mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_attention9mOkConcerns" name="p3_attention9mOkConcerns"
                                            onclick="onCheck(this,'p3_attention9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_attention9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_attention9mNotDiscussed" name="p3_attention9mNotDiscussed"
                                            onclick="onCheck(this,'p3_attention9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_attention9mNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formAttention"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns9mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_noParentsConcerns9mOkConcerns"
                                            name="p3_noParentsConcerns9mOkConcerns"
                                            onclick="onCheck(this,'p3_noParentsConcerns9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_noParentsConcerns9mNotDiscussed"
                                            name="p3_noParentsConcerns9mNotDiscussed"
                                            onclick="onCheck(this,'p3_noParentsConcerns9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns9mNotDiscussed", "")))%>></td>
                ...
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p3_development9m"
                                                                             name="p3_development9m" rows="5" cols="25"
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_development9m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="dt32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_responds2nameOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_respondsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_responds2nameOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_respondsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_responds2nameNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_respondsNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formResponds"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_simpleRequestsOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_simpleRequestsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_simpleRequestsOkConcerns"
                                            name="p3_simpleRequestsOkConcerns"
                                            onclick="onCheck(this,'p3_simpleRequests')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_simpleRequestsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_simpleRequestsNotDiscussed"
                                            name="p3_simpleRequestsNotDiscussed"
                                            onclick="onCheck(this,'p3_simpleRequests')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_simpleRequestsNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formSimpleReq"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_consonantOk"
                                            name="p3_consonantOk" onclick="onCheck(this,'p3_consonant')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_consonantOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_consonantOkConcerns"
                                            name="p3_consonantOkConcerns" onclick="onCheck(this,'p3_consonant')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_consonantOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_consonantNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_consonantNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formConsonant"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_says3wordsOk"
                                            name="p3_says3wordsOk" onclick="onCheck(this,'p3_says3words')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_says3wordsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_says3wordsOkConcerns"
                                            name="p3_says3wordsOkConcerns" onclick="onCheck(this,'p3_says3words')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_says3wordsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_says3wordsNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_says3wordsNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formsays3words"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_shufflesOk"
                                            name="p3_shufflesOk" onclick="onCheck(this,'p3_shuffles')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_shufflesOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_shufflesOkConcerns"
                                            name="p3_shufflesOkConcerns" onclick="onCheck(this,'p3_shuffles')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_shufflesOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_shufflesNotDiscussed"
                                            name="p3_shufflesNotDiscussed" onclick="onCheck(this,'p3_shuffles')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_shufflesNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formCrawls"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_pull2standOk"
                                            name="p3_pull2standOk" onclick="onCheck(this,'p3_pull2stand')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pull2standOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_pull2standOkConcerns"
                                            name="p3_pull2standOkConcerns" onclick="onCheck(this,'p3_pull2stand')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pull2standOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_pull2standNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_pull2standNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formPulltoStand"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_showDistressOk"
                                            name="p3_showDistressOk" onclick="onCheck(this,'p3_showDistress')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_showDistressOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_showDistressOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_showDistressOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_showDistressNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_showDistressNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formShowDistress"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_followGazeOk"
                                            name="p3_followGazeOk" onclick="onCheck(this,'p3_followGaze')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_followGazeOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_followGazeOkConcerns"
                                            name="p3_followGazeOkConcerns" onclick="onCheck(this,'p3_followGaze')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_followGazeOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_followGazeNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_followGazeNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formfollowGaze"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns12mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_noParentsConcerns12mOkConcerns"
                                            name="p3_noParentsConcerns12mOkConcerns"
                                            onclick="onCheck(this,'p3_noParentsConcerns12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_noParentsConcerns12mNotDiscussed"
                                            name="p3_noParentsConcerns12mNotDiscussed"
                                            onclick="onCheck(this,'p3_noParentsConcerns12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns12mNotDiscussed", "")))%>></td>
                    <td valign="top"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formNoparentConcerns"/></td>
                </tr>

                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p3_development12m"
                                                                             name="p3_development12m" rows="5" cols="25"
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_development12m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="dt33" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_says5wordsOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_says5wordsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_says5wordsOkConcerns"
                                            name="p3_says5wordsOkConcerns" onclick="onCheck(this,'p3_says5words')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_says5wordsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_says5wordsNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_says5wordsNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formSays5words"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_fingerFoodsOk"
                                            name="p3_fingerFoodsOk" onclick="onCheck(this,'p3_fingerFoods')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fingerFoodsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_fingerFoodsOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fingerFoodsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_fingerFoodsNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fingerFoodsNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formFingerFoods"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_walksSidewaysOk"
                                            name="p3_walksSidewaysOk" onclick="onCheck(this,'p3_walksSideways')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_walksSidewaysOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_walksSidewaysOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_walksSidewaysOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_walksSidewaysNotDiscussed"
                                            name="p3_walksSidewaysNotDiscussed"
                                            onclick="onCheck(this,'p3_walksSideways')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_walksSidewaysNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formwalksSideways"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_showsFearStrangersOk"
                                            name="p3_showsFearStrangersOk"
                                            onclick="onCheck(this,'p3_showsFearStrangers')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_showsFearStrangersOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_showsFearStrangersOkConcerns"
                                            name="p3_showsFearStrangersOkConcerns"
                                            onclick="onCheck(this,'p3_showsFearStrangers')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_showsFearStrangersOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_showsFearStrangersNotDiscussed"
                                            name="p3_showsFearStrangersNotDiscussed"
                                            onclick="onCheck(this,'p3_showsFearStrangers')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_showsFearStrangersNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009_3.formshowsFearStrangers"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_crawlsStairsOk"
                                            name="p3_crawlsStairsOk" onclick="onCheck(this,'p3_crawlsStairs')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_crawlsStairsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_crawlsStairsOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_crawlsStairsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_crawlsStairsNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_crawlsStairsNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formCrawlsStairs"/></td>
                </tr>

                <tr>
                    <td valign="top"><input type="radio" id="p3_squatsOk"
                                            name="p3_squatsOk" onclick="onCheck(this,'p3_squats')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_squatsOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_squatsOkConcerns"
                                            name="p3_squatsOkConcerns" onclick="onCheck(this,'p3_squats')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_squatsOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_squatsNotDiscussed"
                                            name="p3_squatsNotDiscussed" onclick="onCheck(this,'p3_squats')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_squatsNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formSquats"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns15mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_noParentsConcerns15mOkConcerns"
                                            name="p3_noParentsConcerns15mOkConcerns"
                                            onclick="onCheck(this,'p3_noParentsConcerns15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_noParentsConcerns15mNotDiscussed"
                                            name="p3_noParentsConcerns15mNotDiscussed"
                                            onclick="onCheck(this,'p3_noParentsConcerns15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_noParentsConcerns15mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formNoparentConcerns"/></td>
                </tr>

                <tr>
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p3_development15m"
                                                                             name="p3_development15m" rows="5" cols="25"
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_development15m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="pt31" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles9mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_fontanelles9mOkConcerns" name="p3_fontanelles9mOkConcerns"
                                            onclick="onCheck(this,'p3_fontanelles9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_fontanelles9mNotDiscussed" name="p3_fontanelles9mNotDiscussed"
                                            onclick="onCheck(this,'p3_fontanelles9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles9mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFontanelles"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes9mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_eyes9mOkConcerns" name="p3_eyes9mOkConcerns"
                                            onclick="onCheck(this,'p3_eyes9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_eyes9mNotDiscussed" name="p3_eyes9mNotDiscussed"
                                            onclick="onCheck(this,'p3_eyes9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes9mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a>
                    </td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal9mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_corneal9mOkConcerns" name="p3_corneal9mOkConcerns"
                                            onclick="onCheck(this,'p3_corneal9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_corneal9mNotDiscussed" name="p3_corneal9mNotDiscussed"
                                            onclick="onCheck(this,'p3_corneal9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal9mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formCornealReflex"/>*</a></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing9mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hearing9mOkConcerns" name="p3_hearing9mOkConcerns"
                                            onclick="onCheck(this,'p3_hearing9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hearing9mNotDiscussed" name="p3_hearing9mNotDiscussed"
                                            onclick="onCheck(this,'p3_hearing9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing9mNotDiscussed", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHearingInquiry"/>*</a></i></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips9mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hips9mOkConcerns" name="p3_hips9mOkConcerns"
                                            onclick="onCheck(this,'p3_hips9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hips9mNotDiscussed" name="p3_hips9mNotDiscussed"
                                            onclick="onCheck(this,'p3_hips9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips9mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHips"/>*</a>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom">
						<textarea id="p3_physical9m"
                                  name="p3_physical9m" class="wide" rows="5"
                                  cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_physical9m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="pt32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles12mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_fontanelles12mOkConcerns" name="p3_fontanelles12mOkConcerns"
                                            onclick="onCheck(this,'p3_fontanelles12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_fontanelles12mNotDiscussed" name="p3_fontanelles12mNotDiscussed"
                                            onclick="onCheck(this,'p3_fontanelles12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles12mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFontanelles"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes12mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_eyes12mOkConcerns" name="p3_eyes12mOkConcerns"
                                            onclick="onCheck(this,'p3_eyes12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_eyes12mNotDiscussed" name="p3_eyes12mNotDiscussed"
                                            onclick="onCheck(this,'p3_eyes12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes12mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a>
                    </td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal12mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_corneal12mOkConcerns" name="p3_corneal12mOkConcerns"
                                            onclick="onCheck(this,'p3_corneal12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_corneal12mNotDiscussed" name="p3_corneal12mNotDiscussed"
                                            onclick="onCheck(this,'p3_corneal12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal12mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formCornealReflex"/>*</a></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing12mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hearing12mOkConcerns" name="p3_hearing12mOkConcerns"
                                            onclick="onCheck(this,'p3_hearing12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hearing12mNotDiscussed" name="p3_hearing12mNotDiscussed"
                                            onclick="onCheck(this,'p3_hearing12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing12mNotDiscussed", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHearingInquiry"/>*</a></i></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tonsil12mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_tonsil12mOkConcerns" name="p3_tonsil12mOkConcerns"
                                            onclick="onCheck(this,'p3_tonsil12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tonsil12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_tonsil12mNotDiscussed" name="p3_tonsil12mNotDiscussed"
                                            onclick="onCheck(this,'p3_tonsil12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tonsil12mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formTonsilSize"/>*</a>
                    </td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips12mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hips12mOkConcerns" name="p3_hips12mOkConcerns"
                                            onclick="onCheck(this,'p3_hips12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hips12mNotDiscussed" name="p3_hips12mNotDiscussed"
                                            onclick="onCheck(this,'p3_hips12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips12mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHips"/>*</a>
                    </td>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p3_physical12m"
                                  name="p3_physical12m" class="wide" rows="5"
                                  cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_physical12m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="pt33" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles15mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_fontanelles15mOkConcerns" name="p3_fontanelles15mOkConcerns"
                                            onclick="onCheck(this,'p3_fontanelles15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_fontanelles15mNotDiscussed" name="p3_fontanelles15mNotDiscussed"
                                            onclick="onCheck(this,'p3_fontanelles15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_fontanelles15mNotDiscussed", "")))%>></td>
                    <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFontanelles"/></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes15mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_eyes15mOkConcerns" name="p3_eyes15mOkConcerns"
                                            onclick="onCheck(this,'p3_eyes15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_eyes15mNotDiscussed" name="p3_eyes15mNotDiscussed"
                                            onclick="onCheck(this,'p3_eyes15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_eyes15mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formRedReflex"/>*</a>
                    </td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal15mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_corneal15mOkConcerns" name="p3_corneal15mOkConcerns"
                                            onclick="onCheck(this,'p3_corneal15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_corneal15mNotDiscussed" name="p3_corneal15mNotDiscussed"
                                            onclick="onCheck(this,'p3_corneal15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_corneal15mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formCornealReflex"/>*</a></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing15mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hearing15mOkConcerns" name="p3_hearing15mOkConcerns"
                                            onclick="onCheck(this,'p3_hearing15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hearing15mNotDiscussed" name="p3_hearing15mNotDiscussed"
                                            onclick="onCheck(this,'p3_hearing15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hearing15mNotDiscussed", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_1.formHearingInquiry"/>*</a></i></td>
                </tr>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tonsil15mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_tonsil15mOkConcerns" name="p3_tonsil15mOkConcerns"
                                            onclick="onCheck(this,'p3_tonsil15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tonsil15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_tonsil15mNotDiscussed" name="p3_tonsil15mNotDiscussed"
                                            onclick="onCheck(this,'p3_tonsil15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_tonsil15mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formTonsilSize"/>*</a>
                    </td>
                ...
                <tr>
                    <td valign="top"><input type="radio"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips15mOk", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hips15mOkConcerns" name="p3_hips15mOkConcerns"
                                            onclick="onCheck(this,'p3_hips15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips15mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio"
                                            id="p3_hips15mNotDiscussed" name="p3_hips15mNotDiscussed"
                                            onclick="onCheck(this,'p3_hips15m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hips15mNotDiscussed", "")))%>></td>
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_2.formHips"/>*</a>
                    </td>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
						<textarea id="p3_physical15m"
                                  name="p3_physical15m" class="wide" rows="5"
                                  cols="25"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_physical15m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr id="problemsPlansp3">
        <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgProblemsAndPlans"/></a>
            <br>
            <img height="15" width="20" src="graphics/Checkmark_Lwhite.gif">
            <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.msgProblemsLegendp2"/>
        </td>
        <td colspan="3">
            <table id="prbt31" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15"
                                                                     width="20" src="graphics/Checkmark_L.gif"></td>
                    <td class="edcol" valign="top">X</td>
                    <td class="edcol" valign="top" colspan="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2009.formNotDone"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_antiHB9mOk"
                                            name="p3_antiHB9mOk"
                                            onclick="onCheck(this,'p3_antiHB9m')" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_antiHB9mOk", "")))%>>
                    </td>
                    <td valign="top"><input type="radio" id="p3_antiHB9mOkConcerns"
                                            name="p3_antiHB9mOkConcerns"
                                            onclick="onCheck(this,'p3_antiHB9m')" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_antiHB9mOkConcerns", "")))%>>
                    </td>
                    <td valign="top"><input type="radio" id="p3_antiHB9mNotDiscussed"
                                            name="p3_antiHB9mNotDiscussed"
                                            onclick="onCheck(this,'p3_antiHB9m')" <%=Encode.forHtml(String.valueOf(props.getProperty("p3_antiHB9mNotDiscussed", "")))%>>
                    </td>
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formAntiHB"/>*</a></b><br/>
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formAntiHBcond"/></td>
                </tr>
                <tr>
                    <td valign="top"><input type="radio" id="p3_hemoglobin9mOk"
                                            name="p3_hemoglobin9mOk" onclick="onCheck(this,'p3_hemoglobin9m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hemoglobin9mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_hemoglobin9mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hemoglobin9mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_hemoglobin9mNotDiscussed"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hemoglobin9mNotDiscussed", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHemoglobin"/>*</a></i></td>
                </tr>

                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p3_problems9m"
                                                                             name="p3_problems9m" rows="5" cols="25"
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_problems9m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table id="prbt32" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top"><input type="radio" id="p3_hemoglobin12mOk"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hemoglobin12mOk", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_hemoglobin12mOkConcerns"
                        ...
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hemoglobin12mOkConcerns", "")))%>></td>
                    <td valign="top"><input type="radio" id="p3_hemoglobin12mNotDiscussed"
                                            name="p3_hemoglobin12mNotDiscussed"
                                            onclick="onCheck(this,'p3_hemoglobin12m')"
                        <%=Encode.forHtml(String.valueOf(props.getProperty("p3_hemoglobin12mNotDiscussed", "")))%>></td>
                    <td><i><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke2006_3.formHemoglobin"/>*</a></i></td>
                </tr>
                ...
                <tr align="center">
                    <td colspan="4" style="vertical-align:bottom;"><textarea id="p3_problems12m"
                                                                             name="p3_problems12m" rows="5" cols="25"
                                                                             class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_problems12m", "")))%></textarea>
                    </td>
                </tr>
            </table>
        </td>
        <td colspan="3" height="100%" style="vertical-align:bottom;"><textarea id="p3_problems15m"
                                                                               name="p3_problems15m" rows="5" cols="25"
                                                                               class="wide"><%=Encode.forHtml(String.valueOf(props.getProperty("p3_problems15m", "")))%></textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3"><input type="text" class="wide"
                               ...
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_signature9m", "")))%>"/></td>
        <td colspan="3"><input type="text" class="wide" maxlength="42"
                               style="width: 100%" name="p3_signature12m"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_signature12m", "")))%>"/></td>
        <td colspan="3"><input type="text" class="wide"
                               style="width: 100%" name="p3_signature15m"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("p3_signature15m", "")))%>"/></td>
    </tr>
