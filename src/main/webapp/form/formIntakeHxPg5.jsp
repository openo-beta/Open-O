...
<html>
    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <!--Medical Conditions-->
        <h2><fmt:message key="oscarEncounter.formIntakeHx.medicalConditionsTitle"/></h2>
        <hr/>
        <table>
            <tr>
                <td class="title" colspan="4"><fmt:message key="oscarEncounter.formIntakeHx.hadConditions"/>:</td>
            </tr>

            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.brokenBones"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.migraine"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.neuroDisorder"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.asthma"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.pneumonia"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.lungDisease"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.heartDisease"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.ulcer"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.bowelDisease"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.hepatitis"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.hivPositive"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.thyroidProblem"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.bloodDisorder"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.diabetes"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.bloodTransfusion"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.cancer"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.sexualDisease"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.urinary"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.emotional"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.arthritis"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.eatingDisorder"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.osteoporosis"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.skinProblems"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.highBP"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.learningDisability"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.schizophrenia"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.alcoholDependency"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.multipleSclerosis"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.stroke"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.highCholesterol"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.depression"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.drugDependancy"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.otherDisease"/>:</td>
