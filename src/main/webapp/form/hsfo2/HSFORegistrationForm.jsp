    ...
    <TR><TD>
      ...
      <TABLE style="border-bottom: medium solid;">
        ...
        <TR><TD>
          <FONT class="ft11">
            Last name<br />
            <input name="LName" type="text" style="background-color: gray" size="24" value="<%=(patientData.getLName()!=null) ? patientData.getLName() :"" %>" />
          </FONT>
        </TD></TR>
        ...
        <TR><TD>
          <FONT class="ft11">
            First name<br />
            <input name="FName" type="text" style="background-color: gray" size="24" value="<%=(patientData.getFName()!=null) ? patientData.getFName() :"" %>" />
          </FONT>
        </TD></TR>
      ...
      <TABLE style="border-bottom: medium solid">
        <TR><TD>
          <P>
            ...
            <input name="EmrHCPId1" type="text"  size="5" value="<%=(String)request.getAttribute("EmrHCPId1") %>" />
            <input name="EmrHCPId2" type="text"  size="20" value="<%=(String)request.getAttribute("EmrHCPId2") %>" /><br />
          ...
          <p>
            ...
            - <SELECT name="BirthDate_month">
              ...
              <option value="1" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==0 ) ? "SELECTED" :""%>>Jan</option>
              <option value="2" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==1 ) ? "SELECTED" :""%>>Feb</option>
              <option value="3" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==2 ) ? "SELECTED" :""%>>Mar</option>
              <option value="4" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==3 ) ? "SELECTED" :""%>>Apr</option>
              <option value="5" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==4 ) ? "SELECTED" :""%>>May</option>
              <option value="6" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==5 ) ? "SELECTED" :""%>>Jun</option>
              <option value="7" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==6 ) ? "SELECTED" :""%>>Jul</option>
              <option value="8" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==7 ) ? "SELECTED" :""%>>Aug</option>
              <option value="9" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==8 ) ? "SELECTED" :""%>>Sep</option>
              <option value="10" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==9 ) ? "SELECTED" :""%>>Oct</option>
              <option value="11" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==10 ) ? "SELECTED" :""%>>Nov</option>
              <option value="12" <%=(patientData.getBirthDate()!= null && patientData.getBirthDate().getMonth()==11 ) ? "SELECTED" :""%>>Dec</option>
            </SELECT> - <SELECT name="BirthDate_day">
              <option value="" <%=patientData.getBirthDate()==null ? "SELECTED" :""%>></option>
              <option value="1" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==1 ) ? "SELECTED" :""%>>1</option>
              <option value="2" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==2 ) ? "SELECTED" :""%>>2</option>
              <option value="3" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==3 ) ? "SELECTED" :""%>>3</option>
              <option value="4" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==4 ) ? "SELECTED" :""%>>4</option>
              <option value="5" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==5 ) ? "SELECTED" :""%>>5</option>
              <option value="6" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==6 ) ? "SELECTED" :""%>>6</option>
              <option value="7" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==7 ) ? "SELECTED" :""%>>7</option>
              <option value="8" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==8 ) ? "SELECTED" :""%>>8</option>
              <option value="9" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==9 ) ? "SELECTED" :""%>>9</option>
              <option value="10" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==10 ) ? "SELECTED" :""%>>10</option>
              <option value="11" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==11 ) ? "SELECTED" :""%>>11</option>
              <option value="12" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==12 ) ? "SELECTED" :""%>>12</option>
              <option value="13" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==13 ) ? "SELECTED" :""%>>13</option>
              <option value="14" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==14 ) ? "SELECTED" :""%>>14</option>
              <option value="15" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==15 ) ? "SELECTED" :""%>>15</option>
              <option value="16" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==16 ) ? "SELECTED" :""%>>16</option>
              <option value="17" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==17 ) ? "SELECTED" :""%>>17</option>
              <option value="18" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==18 ) ? "SELECTED" :""%>>18</option>
              <option value="19" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==19 ) ? "SELECTED" :""%>>19</option>
              <option value="20" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==20 ) ? "SELECTED" :""%>>20</option>
              <option value="21" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==21 ) ? "SELECTED" :""%>>21</option>
              <option value="22" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==22 ) ? "SELECTED" :""%>>22</option>
              <option value="23" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==23 ) ? "SELECTED" :""%>>23</option>
              <option value="24" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==24 ) ? "SELECTED" :""%>>24</option>
              <option value="25" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==25 ) ? "SELECTED" :""%>>25</option>
              <option value="26" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==26 ) ? "SELECTED" :""%>>26</option>
              <option value="27" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==27 ) ? "SELECTED" :""%>>27</option>
              <option value="28" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==28 ) ? "SELECTED" :""%>>28</option>
              <option value="29" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==29 ) ? "SELECTED" :""%>>29</option>
              <option value="30" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==30 ) ? "SELECTED" :""%>>30</option>
              <option value="31" <%=(patientData.getBirthDate()!=null && patientData.getBirthDate().getDate()==31 ) ? "SELECTED" :""%>>31</option>
          ...
          <p>
              ...
              <tr><font class="ft-postcode">
                <td>Sex</td>
                <td>Postal code</td> </font>
              </tr>
              <tr>
                <td>
                  <input type="radio" name="Sex" value="m" <%=(patientData.getSex()!=null && patientData.getSex().equalsIgnoreCase("m")) ? "checked" :"" %> >
                    M</input><br />
                  <input type="radio" name="Sex" value="f" <%=(patientData.getSex()!=null)  && patientData.getSex().equalsIgnoreCase("f")? "checked" :"" %>>
                    F</input>
                </td>
                <td>
                  <input name="PostalCode" type="text" size="7" maxlength=7 value="<%=(patientData.getPostalCode()!=null) ? patientData.getPostalCode() :"" %>" />
                </td>
              </tr>
            </table>
          </p>
          ...
          <table class="t-ethnicity" cellpadding=0 cellspacing="0">
						<tr><td colspan="2"><strong>Ethnicity(self reported)</strong>(fill ALL that apply)</td></tr>
						<tr class="tr-selection">
              <td width="80">
                <input type="checkbox" name="Ethnic_White" value="Ethnic_White"	<%=patientData.isEthnic_White()? "checked" :"" %>>White</input>
              </td>
              <td>
                <input type="checkbox" name="Ethnic_Japanese" value="Ethnic_Japanese" <%=patientData.isEthnic_Japanese()? "checked" :"" %>>Japanese</input>
              </td>
            </tr>
            <tr class="tr-selection">
              <td>
                <input type="checkbox" name="Ethnic_Black" value="Ethnic_Black"<%=patientData.isEthnic_Black()? "checked" :"" %>>Black</input>
              </td>
              <td>
                <input type="checkbox" name="Ethnic_Korean" value="Ethnic_Korean" <%=patientData.isEthnic_Korean()? "checked" :"" %>>Korean</input>
              </td>
            </tr>
            <tr class="tr-selection">
              <td>
                <input type="checkbox" name="Ethnic_EIndian" value="Ethnic_EIndian" <%=patientData.isEthnic_EIndian()? "checked" :"" %>>E. Indian</input>
              </td>
              <td>
                <input type="checkbox" name="Ethnic_Hispanic" value="Ethnic_Hispanic" <%=patientData.isEthnic_Hispanic()? "checked" :"" %>>Hispanic</input>
              </td>
            </tr>
            <tr class="tr-selection">
              <td>
                <input type="checkbox" name="Ethnic_Pakistani" value="Ethnic_Pakistani" <%=patientData.isEthnic_Pakistani()? "checked" :"" %>>Pakistani</input>
              </td>
              <td>
                <input type="checkbox" name="Ethnic_FirstNation" value="Ethnic_FirstNation" <%=patientData.isEthnic_FirstNation()? "checked" :"" %>>N. American First Nations</input>
              </td>
            </tr>
            <tr class="tr-selection">
              <td>
                <input type="checkbox" name="Ethnic_SriLankan" value="Ethnic_SriLankan" <%=patientData.isEthnic_SriLankan()? "checked" :"" %>>Sri Lankan</input>
              </td>
              <td>
                <input type="checkbox" name="Ethnic_Other" value="Ethnic_Other" <%=patientData.isEthnic_Other()? "checked" :"" %>>Other</input>
              </td>
            </tr>
            <tr class="tr-selection">
              <td>
                <input type="checkbox" name="Ethnic_Bangladeshi" value="Ethnic_Bangladeshi" <%=patientData.isEthnic_Bangladeshi()? "checked" :"" %>>Bangladeshi</input>
              </td>
              <td>
                <input type="checkbox" name="Ethnic_Refused" value="Ethnic_Refused" <%=patientData.isEthnic_Refused()? "checked" :"" %>>Refused</input>
              </td>
            </tr>
            <tr class="tr-selection">
              <td>
                <input type="checkbox" name="Ethnic_Chinese" value="Ethnic_Chinese" <%=patientData.isEthnic_Chinese()? "checked" :"" %>>Chinese</input>
              </td>
              <td>
                <input type="checkbox" name="Ethnic_Unknown" value="Ethnic_Unknown" <%=patientData.isEthnic_Unknown()? "checked" :"" %>>Unknown</input>
              </td>
            </tr>
					</table>
          </p>
          ...
          <p>
            <FONT class="ft8"><strong>1&deg; hypertension was diagnosed</strong>(fill ONE)</FONT><br />
            <input type="radio" style="margin-left: 2px; margin-right: 1px;" name="sel_TimeAgoDx" value="Under1YrAgo"
            ...
            <input type="radio" style="margin-left: 2px; margin-right: 1px;" name="sel_TimeAgoDx" value="AtLeast1YrAgo"
              <%=(patientData.getSel_TimeAgoDx()!=null)  && patientData.getSel_TimeAgoDx().equals("AtLeast1YrAgo")? "checked" :"" %>>
              <FONT class="ft6">&lt; 1 yr ago</FONT></input> 
            <br/>
            <input type="radio" style="margin-left: 2px; margin-right: 1px;" name="sel_TimeAgoDx" value="NA"
...
<!-- CV risk Factors -->
  ...
  <table>
    ...
    <tr><td><table style="border-bottom: thin solid;" >
      ...
      <tr>
        <td><input type="radio" name="Risk_alcohol" value="Yes" <%=(visitData.isRisk_alcohol()!=null && visitData.isRisk_alcohol()) ? "checked" :"" %> /></td>
        <td><input type="radio" name="Risk_alcohol" value="No" <%=(visitData.isRisk_alcohol()!=null && !visitData.isRisk_alcohol()) ? "checked" :"" %> > Alcohol intake</input></td>
  ...
  <tr><td>
    <table style="border-bottom: thin solid;">
      ...
      <tr>
        <td>Smoking</td>
        <td><input name="assessSmoking" type="text" size="3" maxlength="2"	value="<%=visitData.getAssessSmoking()==null ? "" : visitData.getAssessSmoking().intValue()%>" /></td>
        <td>cigs/day<br />(0 or more)</td>
      </tr>
      <tr>
        <td>Alcohol</td>
        <td><input name="assessAlcohol" type="text" size="3" maxlength="2"	value="<%=visitData.getAssessAlcohol()==null ? "" : visitData.getAssessAlcohol().intValue()%>" /></td>
...
<table class="t-12px" cellpadding=0 style="border-bottom: thin solid">
  ...
  <tr>
    ...
    <td align="right"><input type="text" style="width:30px" maxlength=2 name="A1CP1" value="<%=visitData.getA1CP1() != 0? ""+ visitData.getA1CP1(): ""%>" />
        .<input type="text" style="width:16px" maxlength=2 name="A1CP2" value="<%=visitData.getA1CP2() != 0 ? ""+ visitData.getA1CP2(): ""%>"/>%</td>
    <td>(goal &lt; 7.0%)</td>
  </tr>
  <tr>
    <td>FBS</td>
  ...
  <tr>
    <td height="20" valign="top">
      ...
      <p align="right">
        ...
        <input type="hidden" name="isFirstRecord" value="<%=(String)request.getAttribute("isFirstRecord")%>" /> 
