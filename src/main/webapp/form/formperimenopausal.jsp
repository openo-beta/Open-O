                    ...
                    <table class="TableWithBorder" width="100%">
                        <tr>
                            ...
                            <td width="25%">Age at Menopause: <input type="text"
                                                                     ...
                                                                     value="<%=props.getProperty("ageMenopause", "")%>"/>
                            </td>
                    ...
                    <table class="history" width="100%" cellspacing="0" border="1">
                        ...
                        <tr>
                            <td colspan="3"><textarea
                                    name="crf_comments"><%=props.getProperty("crf_comments", "")%></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Hysterectomy &nbsp;&nbsp;&nbsp;Age: <input type="text"
                                                                           ...
                                                                           value="<%=props.getProperty("ageHysterectomy", "")%>"/>
                            </td>
                        ...
                        <tr>
                            <td colspan="3"><textarea
                                    name="rh_comments"><%=props.getProperty("rh_comments", "")%></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3"><textarea
                                    name="cm_comments"><%=props.getProperty("cm_comments", "")%></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="2">
                    <table class="flowchart" width="100%" cellspacing="0" border="1"
                        ...
                        <tr>
                            ...
                            <td><textarea
                                    name="smokingCessation1"><%=props.getProperty("smokingCessation1", "")%></textarea>
                            </td>
                            <td><textarea
                                    name="smokingCessation2"><%=props.getProperty("smokingCessation2", "")%></textarea>
                            </td>
                            <td><textarea
                                    name="smokingCessation3"><%=props.getProperty("smokingCessation3", "")%></textarea>
                            </td>
                            <td><textarea
                                    name="smokingCessation4"><%=props.getProperty("smokingCessation4", "")%></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="bloodPressure1"><%=props.getProperty("bloodPressure1", "")%></textarea>
                            </td>
                            <td><textarea name="bloodPressure2"><%=props.getProperty("bloodPressure2", "")%></textarea>
                            </td>
                            <td><textarea name="bloodPressure3"><%=props.getProperty("bloodPressure3", "")%></textarea>
                            </td>
                            <td><textarea name="bloodPressure4"><%=props.getProperty("bloodPressure4", "")%></textarea>
                            </td>
                            <td>Weight</td>
