	...
	<table cellpadding="0" cellspacing="0" width="100%" border="1">
		...
		<tr align="center" id="nutritionp2">
			<td colspan="4">
				<table id="ntp21" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						<rourke:discussionRadioSelect sectionName="p2_supplementationSolids2m" formProperties="<%=props%>" showNoOption="<%=true%>" showNotDiscussedOption="<%=true%>"/>
			...
			<td colspan="4">
				<table id="ntp22" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td>
							<a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()" href="javascript:showNotes()">
								<bean:message key="oscarEncounter.formRourke2017.formFutureIntroductionSolids"/>*</a>
						</td>
					</tr>
					<tr>
						<rourke:discussionRadioSelect sectionName="p2_supplementationSolids4m" formProperties="<%=props%>" showNoOption="<%=true%>" showNotDiscussedOption="<%=true%>"/>
						<td><bean:message key="oscarEncounter.formRourke1.formSupplementationSolids" /></td>
					</tr>
					<tr>
			...
			<td colspan="4">
				<table id="ntp23" cellpadding="0" cellspacing="0" width="100%">				
					...
					<tr>
						...
						<td><b><bean:message key="oscarEncounter.formRourke2017.formIronContainingFoods"/></b></td>
					</tr>
					<tr>
						<rourke:discussionRadioSelect sectionName="p2_vegFruit6m" formProperties="<%=props%>" showNotDiscussedOption="<%=true%>"/>
						<td><bean:message key="oscarEncounter.formRourke2017.formFruitsVegetablesAndMilk"/></td>
					</tr>
					<tr>
						...
						<td><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()" href="javascript:showNotes()">
								<bean:message key="oscarEncounter.formRourke2017.formNoHoney"/>*</a>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<rourke:discussionRadioSelect sectionName="p2_liquids6m" formProperties="<%=props%>" showNotDiscussedOption="<%=true%>"/>
						<td>
							<b><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()" href="javascript:showNotes()">
			...
			<td colspan="12">
				<table id="edt2" style="font-size: 9pt;" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td valign="top">
							<a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote2" />')" onMouseOut="hideLayer()">
								<bean:message key="oscarEncounter.formRourke2017.formChildCare"/></a>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="5" valign="top">
							<a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
								<bean:message key="oscarEncounter.formRourke2006_2.formTeething"/>*
							</a>
						</td>
		...
		<tr id="physicalExamp2">
			...
			<table id="pt21" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
					<rourke:discussionRadioSelect sectionName="p2_corneal2m" formProperties="<%=props%>" showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
					<td valign="top">
						<b><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
							<bean:message key="oscarEncounter.formRourke2006_1.formCornealReflex"/>**
						</a></b>
					</td>
				</tr>
                <tr>
				...
				<tr>
					...
					<td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
							<bean:message key="oscarEncounter.formRourke2017.formNeckTorticollis"/>**
					</a></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
						<bean:message key="oscarEncounter.formRourke2017.formDrySkin"/>
					</a></td>
				</tr>
			...
			<table id="pt22" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<rourke:discussionRadioSelect sectionName="p2_corneal4m" formProperties="<%=props%>" showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
					<td valign="top">
						<b><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
							<bean:message key="oscarEncounter.formRourke2006_1.formCornealReflex"/>**
						</a></b>
				...
				<tr>
					...
					<td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
						<bean:message key="oscarEncounter.formRourke2017.formBruising"/>**
					</a></td>
				</tr>
				<tr>
					<td colspan="4" style="vertical-align:bottom;">
			...
			<table id="pt23" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<rourke:discussionRadioSelect sectionName="p2_teeth6m" formProperties="<%=props%>" showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
					<td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
		...
		<tr id="immunizationp2">
			...
			<table id="immt23" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<rourke:discussionRadioSelect sectionName="p2_hemoglobin6m" formProperties="<%=props%>" showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
					<td valign="top"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
						<bean:message key="oscarEncounter.formRourke2006_3.formHemoglobin"/>**
					</a></i></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><b><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')" onMouseOut="hideLayer()">
						<bean:message key="oscarEncounter.formRourke2017.formImmunizationHepatitisVaccine3"/>***</a></b>
					</td>
				</tr>
				<tr>
					<td colspan="4" style="vertical-align:bottom;">
