...
<div style="width:100%;"><img alt="copyright" src="graphics/rourke2017Banner.png" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2009.formCopyRight"/>')"
            ...
            <table id="ntp21" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="oscarEncounter.formRourke2017.formVitaminD200"/>*
                        </a>
                    </b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_supplementationSolids2m" formProperties="<%=props%>"
                                                  showNoOption="<%=true%>" showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="oscarEncounter.formRourke1.formSupplementationSolids"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="oscarEncounter.formRourke2017.formFutureIntroductionSolids"/>*</a>
                    </td>
                </tr>
                <tr>
            ...
            <table id="ntp23" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_iron6m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><b><fmt:message key="oscarEncounter.formRourke2017.formIronContainingFoods"/></b></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_vegFruit6m" formProperties="<%=props%>"
                                                  showNotDiscussedOption="<%=true%>"/>
                    <td><fmt:message key="oscarEncounter.formRourke2017.formFruitsVegetablesAndMilk"/></td>
                </tr>
                <tr>
                    ...
                    <td><a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()" href="javascript:showNotes()">
                        <fmt:message key="oscarEncounter.formRourke2017.formNoHoney"/>*</a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="oscarEncounter.formRourke2017.formSweetenedLiquids"/>*</a></b>
                    </td>
                </tr>
                <tr>
            ...
            <table id="edt2" style="font-size: 9pt;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <b><a onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()" href="javascript:showNotes()">
                            <fmt:message key="oscarEncounter.formRourke1.formMotorizedvehicles"/>/<fmt:message key="oscarEncounter.formRourke1.formCarSeat"/>
                        </a>*</b>
                    </td>
                ...
                <tr>
                    ...
                    <rourke:discussionRadioSelect sectionName="p2_electric" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top">
                        <i><fmt:message key="oscarEncounter.formRourke2017.formElectricPlugs"/></i>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           ...
                           onMouseOut="hideLayer()">
                            <fmt:message key="oscarEncounter.formRourke2017.formBehaviourCrying"/>**</a>
                    </td>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="oscarEncounter.formRourke2017.formNightWaking"/>**</a></b>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="oscarEncounter.formRourke2017.formChildCare"/></a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="5" valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote2"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="oscarEncounter.formRourke2017.formHighRiskOrHomeVisit"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="5" valign="top">
                        <a href="javascript:showNotes()"
                           onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                           onMouseOut="hideLayer()">
                            <fmt:message key="oscarEncounter.formRourke2006_2.formTeething"/>*
                        </a>
                    </td>
                    ...
                    <td colspan="5" valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="oscarEncounter.formRourke2017.formTummyTime"/>*
                        </a></b>
                    </td>
                </tr>
                <tr>
            ...
            <table id="pt21" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td valign="top"><b><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2017.formRedReflex"/>**
                    </a></b></td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                            <fmt:message key="oscarEncounter.formRourke2006_1.formCornealReflex"/>**
                        </a></b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_heart2m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><fmt:message key="oscarEncounter.formRourke2017.formHeartAbdomen"/></td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2017.formNeckTorticollis"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_hips2m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2017.formHips"/>**
                    </a></td>
                </tr>
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_skin2m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2017.formDrySkin"/>
                    </a></td>
                </tr>
            ...
            <table id="pt22" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_fontanelles4m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2017.formAnteriorFontanelle"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_hips4m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2017.formHipsLimitedHipAdbn"/>**
                    </a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_bruising4m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2017.formBruising"/>**
                    </a></td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
            ...
            <table id="immt23" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="text-align: center" colspan="4">
                        <b><fmt:message key="oscarEncounter.formRourke2006_1.msgImmunizationColTitle"/></b>
                    </td>
                </tr>
                <tr>
                    <td style="padding-right: 5pt" valign="top"><img height="15" width="20"
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p2_hemoglobin6m" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><i><a href="javascript:showNotes()" onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2006_3.formHemoglobin"/>**
                    </a></i></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" style="padding-left: 4px;"><fmt:message key="oscarEncounter.formRourke2017.formImmunizationIfHepatitis"/>:
                    </td>
                </tr>
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              onMouseOver="popLayer('<fmt:message key="oscarEncounter.formRourke2006.footnote1"/>')"
                              onMouseOut="hideLayer()">
                        <fmt:message key="oscarEncounter.formRourke2017.formImmunizationHepatitisVaccine3"/>***</a></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="vertical-align:bottom;">
