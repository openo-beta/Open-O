...
<html>
    ...
    <script type="text/javascript" language="Javascript">
        ...
        function syncDemo() {
            ...
            document.forms[0].c_phone1.value = "<%=Encode.forJavaScript(String.valueOf(props.getProperty("c_phone1_cur", "")))%>";
            document.forms[0].c_phone2.value = "<%=Encode.forJavaScript(String.valueOf(props.getProperty("c_phone2_cur", "")))%>";
        }
                        ...
                        <tr>
                            <td>Given Name: <input type="text" name="c_givenName"
                                ...
                                Phone #1: <input type="text" name="c_phone1" size="20"
                                                 maxlength="30" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_phone1", "")))%>"
                                                 @oscar.formDB/> <br/>
                                Phone #2: <input type="text" name="c_phone2" size="20"
                                                 maxlength="30" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_phone2", "")))%>"
                                                 @oscar.formDB/> <br/>
                                Phone #3: <input type="text" name="c_phone3" size="20"
                                                 maxlength="30" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_phone3", "")))%>"
                                                 @oscar.formDB/> <br/>
                                <b><font size="+1">Indication:</font></b> <input type="text"
                                                                                 name="indication" size="20"
                                                                                 maxlength="30"
                                                                                 value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("indication", "")))%>"
                                                                                 @oscar.formDB/>
                                <br/>
                                Target INR Range:<br>
                                <input type="checkbox" name="targetINR1"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("targetINR1", "")))%> @oscar.formDB
                                       dbType="tinyint(1)"/> 2.0-3.0 &nbsp;&nbsp; <input type="checkbox"
                                                                                         name="targetINR2"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("targetINR2", "")))%> @oscar.formDB
                                                                                         dbType="tinyint(1)"/> 2.5-3.5
                                &nbsp;&nbsp; <input type="checkbox"
                                                    name="targetINR3"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("targetINR3", "")))%> @oscar.formDB
                                                    dbType="tinyint(1)"/> Other <input type="text"
                                                                                       name="targetINROther" size="6"
                                                                                       maxlength="30"
                                                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("targetINROther", "")))%>"
                                                                                       @oscar.formDB/> <br/>
                                Duration: <input type="checkbox" name="duration1"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("duration1", "")))%> @oscar.formDB
                                                 dbType="tinyint(1)"/> 3 mos &nbsp;&nbsp; <input type="checkbox"
                                                                                                 name="duration2"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("duration2", "")))%> @oscar.formDB
                                                                                                 dbType="tinyint(1)"/>
                                lifelong &nbsp;&nbsp; <input
                                        type="checkbox" name="duration3"
                                        <%=Encode.forHtml(String.valueOf(props.getProperty("duration3", "")))%> @oscar.formDB
                                        dbType="tinyint(1)"/> Other <input type="text"
                                                                           name="durationOther" size="10" maxlength="30"
                                                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("durationOther", "")))%>"
                                                                           @oscar.formDB/> <br/>
                                Date Started: <input type="text" name="dateStart" id="dateStart"
                                                     size="10" maxlength="10"
                                                     value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("dateStart", "")))%>" @oscar.formDB
                                ...
                                Coumadin Strength on Hand: <input type="text" name="coumadin"
                                                                  ...
                                                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("coumadin", "")))%>"
                                                                  @oscar.formDB/>
                                <br/>
                                Other Anticoagulant: <input type="text" name="anticoagulant"
                                                            size="20" maxlength="20"
                                                            value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("anticoagulant", "")))%>"
                                                            @oscar.formDB/> <br/>
                                Tablet Strengths: <br/>
            ...
            <table width="80%" border="1" cellspacing="0" cellpadding="1">
                ...
                <tr align="center" <%=bgcolor %>>
                    <td><input type="text" name="date<%=i %>" id="date<%=i %>"
                               ...
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("date"+i, "")))%>"
                    ...
                    <td><input type="text" name="inr<%=i %>" style="width: 100%"
                               size="6" maxlength="6" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("inr"+i, "")))%>"
                               @oscar.formDB/></td>
                    <td><input type="text" name="wason<%=i %>" style="width: 100%"
                               size="10" maxlength="20"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("wason"+i, "")))%>" @oscar.formDB/></td>
                    <td><input type="text" name="changeto<%=i %>"
                               style="width: 100%" size="10" maxlength="20"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("changeto"+i, "")))%>" @oscar.formDB/>
                    </td>
                    <td><input type="text" name="repeat<%=i %>" id="repeat<%=i %>"
                               size="10" maxlength="10"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("repeat"+i, "")))%>" @oscar.formDB
                               dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="repeat<%=i %>_cal">
                    </td>
                    <td><input type="checkbox" name="notified<%=i %>"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("notified" + i, "")))%> @oscar.formDB
                               dbType="tinyint(1)"/></td>
                    <td><input type="text" name="bill<%=i %>" style="width: 100%"
                               size="10" maxlength="20"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("bill"+i, "")))%>" @oscar.formDB/></td>
                </tr>
                <% } %>
