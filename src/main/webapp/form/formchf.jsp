...
// Declaring valid date character, minimum year and maximum year
            ...
            function checkAllDates() {
                ...
                if (valDate(document.forms[0].dateFlu) == false) {
                    b = false;
                } else if (valDate(document.forms[0].datePneumo) == false) {
                    b = false;
                } else if (valDate(document.forms[0].dateEcho) == false) {
                    b = false;
                } else if (valDate(document.forms[0].dateCXR) == false) {
                    b = false;
                } else if (valDate(document.forms[0].dateEKG) == false) {
                    b = false;
...
// Ontario clinical chemists use 186 as the mulitplier, others use 175
    ...
    <input type="hidden" name="demographic_no"
        ...
        <input type="hidden" name="sex"
               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("sex", "0")))%>"/>
        ...
        <table class="hideprint" bgcolor="#778899" width=100%>
            ...
            <tr>
                ...
                <td><a href="javascript: popupFixedPage(700,960,'form/chf.html');">Tips</a>&nbsp;&nbsp;
                    ...
                    <a
                            href="javascript: popPage('form/formlabreq07.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=0&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>&labType=CHF','LabReq');">LAB</a>
        ...
        <div align="left">
                ...
                <tr valign="top">
                    <td width="100%" colspan="6">
                            ...
                            <tr valign="top">
                                <td width="33%">Patient Name: <input type="hidden"
                                    ...
                                    DOB: <input type="hidden" name="birthDate"
                                                value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("birthDate", "0")))%>"/><%=Encode.forHtml(String.valueOf(props.getProperty("birthDate", "0")))%>
                                </td>
                                <td width="33%">Diagnosis: <input tabindex="1" type="checkbox"
                                                                  name="SHFDx"
                                                                  id="SHFDx" <%=Encode.forHtml(String.valueOf(props.getProperty("SHFDx", "")))%>><label
                                        for="SHFDx"> Systolic Heart Failure</label><BR>
                                    (LVEF&lt;40% - consider ICD if &lt;30%)
                                </td>
                                <td width="33%"><input tabindex="2" type="checkbox"
                                                       name="PSFDx"
                                                       id="PSFDx" <%=Encode.forHtml(String.valueOf(props.getProperty("PSFDx", "")))%>><label
                        ...
                        Annual Influenza Vaccine: <input tabindex="3" type="text"
                                                         ...
                                                         size="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("dateFlu", "")))%>"/>
                        <img
                        ...
                        Pneumococcal Vaccine: <input tabindex="4" type="text"
                                                     ...
                                                     size="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("datePneumo", "")))%>"/> <img
			...
			after 5 years.)</span></td>
                ...
                <tr valign="top">
                            ...
                            <tr valign="top">
                                <td width="47%"><u>Laboratory Testing to Assist Diagnosis:</u>
                                    ...
                                    Echocardiography: <input tabindex="5" type="text" class="CHFInput"
                                                             ...
                                                             size="10"
                                                             value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("dateEcho", "")))%>"/> <img
					...
					diagnosis</span> <br>
                                    Chest radiograph: <input tabindex="6" type="text" class="CHFInput"
                                                             ...
                                                             size="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("dateCXR", "")))%>"/>
                                    <img
                                    ...
                                    <input tabindex="7" type="checkbox" name="CXRedema" id="CXRedema"
                                            <%=Encode.forHtml(String.valueOf(props.getProperty("CXRedema", "")))%>> <label
                                            for="CXRedema"> interstitial edema </label> <input tabindex="8"
                                                                                               type="checkbox"
                                                                                               name="CXRcardiomegaly"
                                                                                               id="CXRcardiomegaly"
                                            <%=Encode.forHtml(String.valueOf(props.getProperty("CXRcardiomegaly", "")))%>> <label
                                            for="CXRcardiomegaly"> cardiomegaly </label> <input tabindex="9"
                                                                                                type="checkbox"
                                                                                                name="CXReffusion"
                                                                                                id="CXReffusion"
                                            <%=Encode.forHtml(String.valueOf(props.getProperty("CXReffusion", "")))%>> <label
                                            ...
                                            size="10" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("dateEKG", "")))%>"/> <img
                                ...
                                <td width="47%"><u>Laboratory Testing to Identify Systemic
                                    ...
                                    <input tabindex="11" type="checkbox" name="CBC" id="CBC"
                                            <%=Encode.forHtml(String.valueOf(props.getProperty("CBC", "")))%>><label for="CBC">
                                        CBC </label> <input tabindex="12" type="checkbox" name="lytes" id="lytes"
                                            <%=Encode.forHtml(String.valueOf(props.getProperty("lytes", "")))%>><label for="lytes">
                                        electrolytes </label> <input tabindex="13" type="checkbox" name="creat"
                                                                     id="creat" <%=Encode.forHtml(String.valueOf(props.getProperty("creat", "")))%>><label
                                            for="creat"> renal function </label> <input tabindex="14"
                                                                                        type="checkbox" name="ua"
                                                                                        id="ua"
                                            <%=Encode.forHtml(String.valueOf(props.getProperty("ua", "")))%>><label for="ua">
                                        urinalysis </label> <br>
                                    <input tabindex="15" type="checkbox" name="RBS" id="RBS"
                                            <%=Encode.forHtml(String.valueOf(props.getProperty("RBS", "")))%>><label for="RBS">
                                        glucose </label> <input tabindex="16" type="checkbox" name="lipids"
                                                                id="lipids" <%=Encode.forHtml(String.valueOf(props.getProperty("lipids", "")))%>><label
                                            for="lipids"> lipids </label> <input tabindex="17" type="checkbox"
                                                                                 name="LFT"
                                                                                 id="LFT" <%=Encode.forHtml(String.valueOf(props.getProperty("LFT", "")))%>><label
                                            for="LFT"> liver enzymes </label> <input tabindex="18"
                                                                                     type="checkbox" name="TSH" id="TSH"
                                            <%=Encode.forHtml(String.valueOf(props.getProperty("TSH", "")))%>><label for="TSH">
                                        thyroid </label></td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr valign="top">
                    ...
                    <td width="23%" bgcolor="#D9D9D9">Date:<input tabindex="19"
                                                                  ...
                                                                  size="10"
                                                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("date1", "")))%>"/> <img
                    ...
                    <td width="24%" bgcolor="#D9D9D9">Date:<input tabindex="119"
                                                                  ...
                                                                  size="10"
                                                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("date2", "")))%>"/> <img
                    ...
                    <td width="25%" bgcolor="#D9D9D9">Date:<input tabindex="219"
                                                                  ...
                                                                  size="10"
                                                                  value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("date3", "")))%>"/> <img
			...
			&rarr; &nbsp;</span> <input tabindex="21" type="text" class="CHFTextarea"
                                        ...
                                        size="3" maxlength="5"
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("weight1", "")))%>"/>kg
                    </td>
			...
			&rarr; &nbsp;</span> <input tabindex="121" type="text" class="CHFTextarea"
                                        ...
                                        onchange="checkIt(this,'^\\d{2,3}(\\.\\d)?$','Adult weight in kilograms is usually between 40 and 150 (enter just the number)');"
                                        size="3" maxlength="5"
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("weight2", "")))%>"/>kg
                    </td>
			...
			&rarr; &nbsp;</span> <input tabindex="221" type="text" class="CHFTextarea"
                                        ...
                                        onchange="checkIt(this,'^\\d{2,3}(\\.\\d)?$','Adult weight in kilograms is usually between 40 and 150 (enter just the number)');"
                                        size="3" maxlength="5"
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("weight3", "")))%>"/>kg
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="28" type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAI1", "")))%>><label for="NYHAI1">
                        Class I </label> <input tabindex="29" type="checkbox" name="NYHAII1"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAII1", "")))%>><label for="NYHAII1">
                        Class II </label> <br>
                        <input tabindex="30" type="checkbox" name="NYHAIII1" id="NYHAIII1"
                               onclick="NYHAI1.checked=false;NYHAII1.checked=false;NYHAIV1.checked=false;"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAIII1", "")))%>><label
                                ...
                                <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAIV1", "")))%>><label for="NYHAIV1">
                            Class IV </label></td>
                    <td width="24%"><input tabindex="128" type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAI2", "")))%>><label for="NYHAI2">
                        Class I </label> <input tabindex="129" type="checkbox" name="NYHAII2"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAII2", "")))%>><label for="NYHAII2">
                        Class II </label> <br>
                        <input tabindex="130" type="checkbox" name="NYHAIII2" id="NYHAIII2"
                               onclick="NYHAI2.checked=false;NYHAII2.checked=false;NYHAIV2.checked=false;"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAIII2", "")))%>><label
                                ...
                                <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAIV2", "")))%>><label for="NYHAIV2">
                            Class IV </label></td>
                    ...
                    <td width="25%"><input tabindex="228" type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAI3", "")))%>><label for="NYHAI3">
                        Class I </label> <input tabindex="229" type="checkbox" name="NYHAII3"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAII3", "")))%>><label for="NYHAII3">
                        Class II </label> <br>
                        <input tabindex="230" type="checkbox" name="NYHAIII3" id="NYHAIII3"
                               onclick="NYHAI3.checked=false;NYHAII3.checked=false;NYHAIV3.checked=false;"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAIII3", "")))%>><label
                                ...
                                <%=Encode.forHtml(String.valueOf(props.getProperty("NYHAIV3", "")))%>><label for="NYHAIV3">
                            Class IV </label></td>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="41" type="text"
                                           ...
                                           maxlength="7" size="6" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("BP1", "")))%>"/>
                        mmHg
                    </td>
                    <td width="24%"><input tabindex="141" type="text"
                                           class="CHFTextarea" name="BP2"
                                           onchange="checkIt(this,'^\\d{2,3}\/\\d{2,3}$','BPs should be numbers in the format NNN/NN');"
                                           maxlength="7" size="6" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("BP2", "")))%>"/>
                        mmHg
                    </td>
                    <td width="25%"><input tabindex="241" type="text"
                                           class="CHFTextarea" name="BP3"
                                           onchange="checkIt(this,'^\\d{2,3}\/\\d{2,3}$','BPs should be numbers in the format NNN/NN');"
                                           maxlength="7" size="6" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("BP3", "")))%>"/>
                        mmHg
                    </td>
                </tr>
	...
	// perhaps better code is onClick="JVPno1.checked=false;"  --> <input
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="44" type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("edemayes1", "")))%>><label
                    ...
                    <td width="24%"><input tabindex="144" type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("edemano2", "")))%>><label
                            for="edemano2"> no</label> <br>
                        <input tabindex="146" type="text" class="CHFTextarea" name="edema2"
                               maxlength="30" size="30"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("edema2", "")))%>"/></td>
                    <td width="25%"><input tabindex="244" type="checkbox"
                                           name="edemayes3" id="edemayes3"
                                           onClick="edemano3.checked=!edemayes3.checked;"
                            <%=Encode.forHtml(String.valueOf(props.getProperty("edemayes3", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("edemano3", "")))%>><label
                            for="edemano3"> no</label> <br>
                        <input tabindex="246" type="text" class="CHFTextarea" name="edema3"
                               maxlength="30" size="30"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("edema3", "")))%>"/></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="51" type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("cracklesyes1", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("cracklesno1", "")))%>><label
                            for="cracklesno1"> no</label> <br>
                        <input tabindex="53" type="text" class="CHFTextarea" name="crackles1"
                               maxlength="30" size="30"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("crackles1", "")))%>"/></td>
                    <td width="24%"><input tabindex="151" type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("cracklesyes2", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("cracklesno2", "")))%>><label
                            for="cracklesno2"> no</label> <br>
                        <input tabindex="153" type="text" class="CHFTextarea"
                               name="crackles2" maxlength="30" size="30"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("crackles2", "")))%>"/></td>
                    <td width="25%"><input tabindex="251" type="checkbox"
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("cracklesyes3", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("cracklesno3", "")))%>><label
                            for="cracklesno3"> no</label> <br>
                        <input tabindex="253" type="text" class="CHFTextarea"
                               name="crackles3" maxlength="30" size="30"
                               value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("crackles3", "")))%>"/></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="61" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("PI1", "")))%>"/></td>
                    <td width="24%"><input tabindex="161" type="text"
                                           class="CHFTextarea" name="PI2" maxlength="60" size="30"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("PI2", "")))%>"/></td>
                    <td width="25%"><input tabindex="261" type="text"
                                           class="CHFTextarea" name="PI3" maxlength="60" size="30"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("PI3", "")))%>"/></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="62" type="text"
                                           ...
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("Na1", "")))%>"/>
                        mmol/L
                    </td>
                    <td width="24%"><input tabindex="162" type="text"
                                           class="CHFTextarea" name="Na2"
                                           onchange="checkIt(this,'^\\d{2,3}(\\.\\d)?$','Sodium normal range is 137-145!\nPlease use just numbers in the format NNN');"
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("Na2", "")))%>"/>
                        mmol/L
                    </td>
                    <td width="25%"><input tabindex="262" type="text"
                                           class="CHFTextarea" name="Na3"
                                           onchange="checkIt(this,'^\\d{2,3}(\\.\\d)?$','Sodium normal range is 137-145!\nPlease use just numbers in the format NNN');"
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("Na3", "")))%>"/>
                        mmol/L
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="63" type="text"
                                           ...
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("K1", "")))%>"/>
                        mmol/L
                    </td>
                    <td width="24%"><input tabindex="163" type="text"
                                           class="CHFTextarea" name="K2"
                                           onchange="checkIt(this,'^\\d(\\.\\d)?$','Potassium is usually between 3.5-5.1!\nPlease use just numbers in the format N or N.N');"
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("K2", "")))%>"/>
                        mmol/L
                    </td>
                    <td width="25%"><input tabindex="263" type="text"
                                           class="CHFTextarea" name="K3"
                                           onchange="checkIt(this,'^\\d(\\.\\d)?$','Potassium is usually between 3.5-5.1!\nPlease use just numbers in the format N or N.N');"
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("K3", "")))%>"/>
                        mmol/L
                    </td>
                </tr>
			...
			male &lt;114 female &lt;90 umol/L</span></td>
                    ...
                    <td width="23%"><input tabindex="64" type="text"
                                           ...
                                           maxlength="3" size="4"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("creat1", "")))%>"/> mmol/L
                    </td>
                    <td width="24%"><input tabindex="164" type="text"
                                           ...
                                           maxlength="3" size="4"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("creat2", "")))%>"/> mmol/L
                    </td>
                    <td width="25%"><input tabindex="264" type="text"
                                           ...
                                           maxlength="3" size="4"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("creat3", "")))%>"/> mmol/L
                    </td>
                </tr>
                </tr>
                <tr valign="top">
			...
			refer if &lt; 60mL/min)</span></td>
                    <td width="23%"><input tabindex="65" type="text"
                                           ...
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("eGFR1", "")))%>"/>
                        mL/min
                    </td>
                    <td width="24%"><input tabindex="165" type="text"
                                           class="CHFTextarea" name="eGFR2"
                                           onchange="checkIt(this,'^\\d{2,3}$','The glomerular filtration rate is usually between 30-100!\nPlease type just numbers');"
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("eGFR2", "")))%>"/>
                        mL/min
                    </td>
                    <td width="25%"><input tabindex="265" type="text"
                                           class="CHFTextarea" name="eGFR3"
                                           onchange="checkIt(this,'^\\d{2,3}$','The glomerular filtration rate is usually between 30-100!\nPlease type just numbers');"
                                           maxlength="3" size="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("eGFR3", "")))%>"/>
                        mL/min
                    </td>
                </tr>
			...
			since last assessment</span></td>
                    <td width="23%"><input tabindex="66" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ervisits1", "")))%>"/> visits
                    </td>
                    <td width="24%"><input tabindex="166" type="text"
                                           class="CHFTextarea" name="ervisits12" maxlength="20" size="4"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ervisits2", "")))%>"/> visits
                    </td>
                    <td width="25%"><input tabindex="266" type="text"
                                           class="CHFTextarea" name="ervisits13" maxlength="20" size="4"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ervisits3", "")))%>"/> visits
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="71" type="checkbox"
                                           name="compliance1" <%=Encode.forHtml(String.valueOf(props.getProperty("compliance1", "")))%>>
                        Patient medication use <br>
                        <input tabindex="72" type="checkbox" name="fluids1"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("fluids1", "")))%>> Salt / fluid
                        vigilance &and; <br>
                        <input tabindex="73" type="checkbox" name="weights1"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("weights1", "")))%>> Daily weight
                        monitoring &and; <br>
                        <input tabindex="74" type="checkbox" name="exercise1"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("exercise1", "")))%>> Exercise /
                        activity
                    </td>

                    <td width="23%"><input tabindex="171" type="checkbox"
                                           name="compliance2" <%=Encode.forHtml(String.valueOf(props.getProperty("compliance2", "")))%>>
                        Patient medication use <br>
                        <input tabindex="172" type="checkbox" name="fluids2"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("fluids2", "")))%>> Salt / fluid
                        vigilance &and; <br>
                        <input tabindex="173" type="checkbox" name="weights2"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("weights2", "")))%>> Daily weight
                        monitoring &and; <br>
                        <input tabindex="174" type="checkbox" name="exercise2"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("exercise2", "")))%>> Exercise /
                        activity
                    </td>

                    <td width="23%"><input tabindex="271" type="checkbox"
                                           name="compliance3" <%=Encode.forHtml(String.valueOf(props.getProperty("compliance3", "")))%>>
                        Patient medication use <br>
                        <input tabindex="272" type="checkbox" name="fluids3"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("fluids3", "")))%>> Salt / fluid
                        vigilance &and; <br>
                        <input tabindex="273" type="checkbox" name="weights3"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("weights3", "")))%>> Daily weight
                        monitoring &and; <br>
                        <input tabindex="274" type="checkbox" name="exercise3"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("exercise3", "")))%>> Exercise /
                        activity
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="76" type="checkbox"
                                           name="discussbp1" <%=Encode.forHtml(String.valueOf(props.getProperty("discussbp1", "")))%>>
                        Hypertension <br>
                        <input tabindex="77" type="checkbox" name="discussdm1"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discussdm1", "")))%>> Diabetes <br>
                        <input tabindex="78" type="checkbox" name="discusslipids1"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discusslipids1", "")))%>>
                        Hyperlipidemia <br>
                        <input tabindex="79" type="checkbox" name="discusssmoking1"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discusssmoking1", "")))%>> Smoking <br>
                        <input tabindex="80" type="checkbox" name="discussweight1"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discussweight1", "")))%>> Overweight /
                        Obesity
                    </td>

                    <td width="24%"><input tabindex="176" type="checkbox"
                                           name="discussbp2" <%=Encode.forHtml(String.valueOf(props.getProperty("discussbp2", "")))%>>
                        Hypertension <br>
                        <input tabindex="177" type="checkbox" name="discussdm2"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discussdm2", "")))%>> Diabetes <br>
                        <input tabindex="178" type="checkbox" name="discusslipids2"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discusslipids2", "")))%>>
                        Hyperlipidemia <br>
                        <input tabindex="179" type="checkbox" name="discusssmoking2"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discusssmoking2", "")))%>> Smoking <br>
                        <input tabindex="180" type="checkbox" name="discussweight2"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discussweight2", "")))%>> Overweight /
                        Obesity
                    </td>

                    <td width="25%"><input tabindex="276" type="checkbox"
                                           name="discussbp3" <%=Encode.forHtml(String.valueOf(props.getProperty("discussbp3", "")))%>>
                        Hypertension <br>
                        <input tabindex="277" type="checkbox" name="discussdm3"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discussdm3", "")))%>> Diabetes <br>
                        <input tabindex="278" type="checkbox" name="discusslipids3"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discusslipids3", "")))%>>
                        Hyperlipidemia <br>
                        <input tabindex="279" type="checkbox" name="discusssmoking3"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discusssmoking3", "")))%>> Smoking <br>
                        <input tabindex="280" type="checkbox" name="discussweight3"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("discussweight3", "")))%>> Overweight /
                        Obesity
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="81" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("goal1", "")))%>"/></td>
                    <td width="24%"><input tabindex="181" type="text"
                                           class="CHFTextarea" name="goal2" size="30" maxlength="60"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("goal2", "")))%>"/></td>
                    <td width="25%"><input tabindex="281" type="text"
                                           class="CHFTextarea" name="goal3" size="30" maxlength="60"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("goal3", "")))%>"/></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="82" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("challenge1", "")))%>"/></td>
                    <td width="24%"><input tabindex="182" type="text"
                                           class="CHFTextarea" name="challenge2" size="30" maxlength="60"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("challenge2", "")))%>"/></td>
                    <td width="25%"><input tabindex="282" type="text"
                                           class="CHFTextarea" name="challenge3" size="30" maxlength="60"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("challenge3", "")))%>"/></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td width="17%">ACEI<span class="fine">ACE inhibitor</span> <br>
                        <input tabindex="83" type="checkbox" name="ACEintolerant"
                               id="antiACE" <%=Encode.forHtml(String.valueOf(props.getProperty("ACEintolerant", "")))%>><label
                                for="antiACE" class="fine">Intolerant</label> <br>
                        <input tabindex="84" type="checkbox" name="ACEcontraindicated"
                               id="noACE" <%=Encode.forHtml(String.valueOf(props.getProperty("ACEcontraindicated", "")))%>><label
                    ...
                    <td width="23%"><input tabindex="85" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ACE1", "")))%>"/> <select
                        ...
                        <option value="Target">Lisinopril 20mg od</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ACEtargetY1", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ACEtargetN1", "")))%>><label
                            for="ACEtargetN1"> no</label></td>
                    <td width="24%"><input tabindex="185" type="text"
                                           class="CHFTextarea" name="ACE2" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ACE2", "")))%>"/> <select
                        ...
                        <option value="Target">Lisinopril 20mg od</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ACEtargetY2", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ACEtargetN2", "")))%>><label
                            for="ACEtargetN2"> no</label></td>
                    <td width="25%"><input tabindex="285" type="text"
                                           class="CHFTextarea" name="ACE3" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ACE3", "")))%>"/> <select
                        ...
                        <option value="Target">Lisinopril 20mg od</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ACEtargetY3", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ACEtargetN3", "")))%>><label
                ...
                <tr valign="top">
                    <td width="17%">&beta; Blocker <br>
                        <input tabindex="88" type="checkbox" name="bbintolerant" id="antibb"
                                <%=Encode.forHtml(String.valueOf(props.getProperty("bbintolerant", "")))%>><label
                                for="antibb" class="fine">Intolerant</label> <br>
                        <input tabindex="89" type="checkbox" name="bbcontraindicated"
                               id="nobb" <%=Encode.forHtml(String.valueOf(props.getProperty("bbcontraindicated", "")))%>><label
                    ...
                    <td width="23%"><input tabindex="90" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("bb1", "")))%>"/> <select
                            name="bbsel1" size="1" class="hideprint"
                            onchange="setTarget('bb',1);">
                        <option value="" selected="selected">pick
                            &beta;blocker/dose/frequency
                        </option>
                        ...
                        <option value="Target">Carvedilol 25mg bid</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("bbtargetY1", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("bbtargetN1", "")))%>><label
                            for="bbtargetN1"> no</label></td>
                    <td width="24%"><input tabindex="190" type="text"
                                           class="CHFTextarea" name="bb2" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("bb2", "")))%>"/> <select
                        ...
                        <option value="Target">Carvedilol 25mg bid</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("bbtargetY2", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("bbtargetN2", "")))%>><label
                            for="bbtargetN2"> no</label></td>
                    <td width="25%"><input tabindex="290" type="text"
                                           class="CHFTextarea" name="bb3" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("bb3", "")))%>"/> <select
                        ...
                        <option value="Target">Carvedilol 25mg bid</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("bbtargetY3", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("bbtargetN3", "")))%>><label
			...
			Receptor Blocker if ACEI intolerant</span></td>
                    <td width="23%"><input tabindex="93" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ARB1", "")))%>"/> <select
                        ...
                        <option value="Target">Valsartan 160mg bid</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ARBtargetY1", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ARBtargetN1", "")))%>><label
                            for="ARBtargetN1"> no</label></td>
                    <td width="24%"><input tabindex="193" type="text"
                                           class="CHFTextarea" name="ARB2" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ARB2", "")))%>"/> <select
                        ...
                        <option value="Target">Valsartan 160mg bid</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ARBtargetY2", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ARBtargetN2", "")))%>><label
                            for="ARBtargetN2"> no</label></td>
                    <td width="25%"><input tabindex="293" type="text"
                                           class="CHFTextarea" name="ARB3" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ARB3", "")))%>"/> <select
                        ...
                        <option value="Target">Valsartan 160mg bid</option>
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ARBtargetY3", "")))%>><label
                            ...
                            <%=Encode.forHtml(String.valueOf(props.getProperty("ARBtargetN3", "")))%>><label
			...
			effective dose</span></td>
                    <td width="23%"><input tabindex="96" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("loop1", "")))%>"/><BR>
                        Agent / dose
                    </td>
                    <td width="24%"><input tabindex="196" type="text"
                                           class="CHFTextarea" name="loop2" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("loop2", "")))%>"/><BR>
                        Agent / dose
                    </td>
                    <td width="25%"><input tabindex="296" type="text"
                                           class="CHFTextarea" name="loop3" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("loop3", "")))%>"/><BR>
                        Agent / dose
                    </td>
                </tr>
			...
			Class III - IV Heart Failure</span></td>
                    <td width="23%"><input tabindex="97" type="text"
                                           ...
                                           size="30" maxlength="4"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("spironolactone1", "")))%>"/><br>
                        mg/d dose
                    </td>
                    <td width="24%"><input tabindex="197" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("spironolactone2", "")))%>"/><br>
                        mg/d dose
                    </td>
                    <td width="25%"><input tabindex="297" type="text"
                                           ...
                                           onchange="checkIt(this,'^\\d{2,3}(\\.\\d)?$','The daily Spironolactone dose usually is between 12.5 and 200\n(enter just the number)');"
                                           size="30" maxlength="20"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("spironolactone3", "")))%>"/><br>
                        mg/d dose
                    </td>
                </tr>
			...
			advanced HF</span></td>
                    <td width="23%"><input tabindex="98" type="text"
                                           ...
                                           size="30" maxlength="6"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("digoxin1", "")))%>"/><br>
                        mg/d dose
                    </td>
                    <td width="24%"><input tabindex="198" type="text"
                                           ...
                                           onchange="checkIt(this,'^0\\.\\d{3,4}$','The daily Digoxin dose usually is between 0.0625 and 0.250\n(enter just the number)');"
                                           size="30" maxlength="6"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("digoxin2", "")))%>"/><br>
                        mg/d dose
                    </td>
                    <td width="25%"><input tabindex="298" type="text"
                                           ...
                                           onchange="checkIt(this,'^0\\.\\d{3,4}$','The daily Digoxin dose usually is between 0.0625 and 0.250\n(enter just the number)');"
                                           size="30" maxlength="6"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("digoxin3", "")))%>"/><br>
                        mg/d dose
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="99" type="text"
                                           ...
                                           size="30" maxlength="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ASA1", "")))%>"/><br>
                        mg/d dose
                    </td>
                    <td width="24%"><input tabindex="199" type="text"
                                           class="CHFTextarea" name="ASA2"
                                           onchange="checkIt(this,'^\\d{2,4}$','The daily aspirin dose usually is between 80 and 325\n(enter just the number)');"
                                           size="30" maxlength="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ASA2", "")))%>"/><br>
                        mg/d dose
                    </td>
                    <td width="25%"><input tabindex="299" type="text"
                                           class="CHFTextarea" name="ASA3"
                                           onchange="checkIt(this,'^\\d{2,4}$','The daily aspirin dose usually is between 80 and 325\n(enter just the number)');"
                                           size="30" maxlength="4" value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("ASA3", "")))%>"/><br>
                        mg/d dose
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td width="23%"><input tabindex="100" type="text"
                                           ...
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("anticoagulant1", "")))%>"/> Agent /
                        dose
                    </td>
                    <td width="24%"><input tabindex="200" type="text"
                                           class="CHFTextarea" name="anticoagulant2" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("anticoagulant2", "")))%>"/> Agent /
                        dose
                    </td>
                    <td width="25%"><input tabindex="300" type="text"
                                           class="CHFTextarea" name="anticoagulant3" size="30" maxlength="40"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("anticoagulant3", "")))%>"/> Agent /
                        dose
                    </td>
                </tr>
                ...
                <td width="23%"><input type="text" class="CHFTextarea"
                                       ...
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("sig1", "")))%>"/></td>
                <td width="24%"><input type="text" class="CHFTextarea"
                                       name="sig2" size="30" maxlength="20"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("sig2", "")))%>"/></td>
                <td width="25%"><input type="text" class="CHFTextarea"
                                       name="sig3" size="30" maxlength="20"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("sig3", "")))%>"/></td>
                </tr>
    ...
    <script type="text/javascript">
        ...
        Calendar.setup({
            inputField: "datePneumo",
            ifFormat: "%Y/%m/%d",
            date: dflu,
            showsTime: false,
            button: "datePneumo_cal",
            singleClick: true,
            step: 1
        });
