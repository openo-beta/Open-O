                                ...
                                <table width="740px" height="620px" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td colspan="5"><font style="font-weight: bold">During
                                            the past week</font> (even if it was <font
                                                style="font-weight: bold">not</font>
                                    ...
                                    <tr bgcolor="white">
                                        <td colspan="4">5. Other aerobic exercise equipment
                                            (stairmaster, rowing or skiing machine)
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="5" class="score">Scoring: Each category is
                                            converted to the following number of minutes spent:
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">&nbsp;</td>
                                    ...
                                    <tr bgcolor="white">
                                        <td colspan="4">Time spent in stretching or strengthening
                                            exercise is the value for Item 1.
                                        </td>
                                    ...
                                    <tr bgcolor="white">
                                        <td colspan="4">Time spent in aerobic exercise is the sum of
                                            the values for Items 2 through 6.
                                        </td>
                                ...
                                <table width="740px" height="620px" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td colspan="6">When you are feeling down in the dumps,
                                            ...
                                            you... (please enter score in box for <font
                                                    style="font-weight: bold">each</font> question).
                                        </td>
                                    </tr>
                                    <tr class="scoreLight">
                                        <td colspan="6">&nbsp;</td>
                                    ...
                                    <tr bgcolor="white">
                                        <td colspan="5">5. Practice visualization or guided imagery,
                                            such as picturing yourself somewhere else?
                                        </td>
                                ...
                                <table width="740px" height="620px" border="0" cellspacing="0"
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td width="65%"><input type="text" name="mentalStressTimes"
                                                               onchange="calMentalStressScore()" size="5"
                                    ...
                                    <tr>
                                        <td colspan="2" class="score">Scoring: Single item only. If
                                            ...
                                            into an ordinal scale with the following categories:
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td colspan="2" class="score">This item can also be left as
                                            a continuous measure: that is, the actual times per week coded.
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table width="740px" height="620px" border="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td colspan="4"><font style="font-weight: bold">Outside
                                            ...
                                            support groups about your health problem in the <font
                                                    style="font-weight: bold">past 9 month</font>?
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">&nbsp;</td>
                                    ...
                                    <tr bgcolor="white">
                                        ...
                                        <td width="65%">If Yes, how many <font
                                                ...
                                                onchange="healthEdScore()" size="10"
                                    ...
                                    <tr>
                                        <td colspan="4">In the <font style="font-weight: bold">past
                                            ...
                                            as walking clubs, aerobic classes or water exercise programs)?.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">&nbsp;</td>
                                    ...
                                    <tr bgcolor="white">
                                        <td width="5%">&nbsp;</td>
                                        <td width="15%"><input type="checkbox" class="checkbox"
                                                               onchange="exPrgmScore()" name="exercisePrgmN"
                                                <%= props.getProperty("exercisePrgmN", "") %> /> No
                                        </td>
                                        <td width="15%"><input type="checkbox" class="checkbox"
                                                               onchange="exPrgmScore()" name="exercisePrgmY"
