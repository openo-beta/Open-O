...
<html>
    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <!--Immunizations-->
        <h2><fmt:message key="oscarEncounter.formIntakeHx.immunizationsTitle"/></h2>
        <hr/>
        <table>
            <tr>
                <td class="title" colspan="4"><fmt:message key="oscarEncounter.formIntakeHx.whenImmunized"/>:</td>
            </tr>
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.hepatitisBSerum"/>:</td>
                ...
                <td><fmt:message key="oscarEncounter.formIntakeHx.year"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.tetanusLockjaw"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.polio"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.mmr"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.lastTBTest"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.rubella"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.varicella"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.meningitis"/>:</td>
            ...
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.pneumococcus"/>:</td>
            ...
            <tr>
                <td class="title" colspan="4"><fmt:message key="oscarEncounter.formIntakeHx.hadDisease"/>:</td>
            </tr>
            <tr>
                <td><fmt:message key="oscarEncounter.formIntakeHx.hepatitisBSerum"/>:</td>
            ...
            <tr>
                <td class="title" colspan="3"><fmt:message key="oscarEncounter.formIntakeHx.immunizationCardOnPerson"/>:</td>
