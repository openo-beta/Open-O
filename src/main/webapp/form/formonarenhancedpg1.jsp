...
<html>
    <head>
        ...
        <script src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/js/jquery-1.7.1.min.js" type="text/javascript"></script>
...
%>
	...
	%>
		...
		*/
                ...
                if (!validateYesNo('pg1_cp1')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo('pg1_cp2')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo('pg1_cp3')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo('pg1_cp4')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo('pg1_cp8')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo('pg1_naDiet')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo('pg1_naMilk')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo('pg1_naFolic')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                ...
                if (!validateYesNo2('10')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('12')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('13')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('14')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('17')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }

                if (!validateYesNo2('22')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('20')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('21')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('24')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('15')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('25')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('27')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('31')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('32')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo2('34')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo3('35')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo3('40')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo3('38')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }

                if (!validateYesNo3('42')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo4('43')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo4('44')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo4('45')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo4('46')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo4('47')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo4('48')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }

                if (!validateYesNo5('pg1_bloodTran')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo5('pg1_infectDisOther')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo5('pg1_reliCult')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }
                if (!validateYesNo5('pg1_fhRisk')) {
                    alert("Cannot choose yes and no together for an item in Medical History");
                    return false;
                }

                if (!validateYesNo5('pg1_thyroid')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_chest')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_breasts')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_cardio')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_abdomen')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_vari')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_extGen')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_cervix')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_uterus')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_adnexa')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
                if (!validateYesNo5('pg1_pExOther')) {
                    alert("Cannot choose normal and abnormal together for an item in Physical Exam");
                    return false;
                }
            ...
            function addObxHx() {
                ...
                jQuery.ajax({
                    url: 'onarenhanced_obxhx.jsp?n=' + total, async: false, success: function (data) {
		...
		%>
                jQuery.ajax({
                    url: 'onarenhanced_obxhx.jsp?n=' +<%=x%>, async: false, success: function (data) {
                        jQuery("#obxhx_container tbody").append(data);
                        setInput(<%=x%>, "pg1_year", '<%= Encode.forJavaScript(props.getProperty("pg1_year"+x, "")) %>');
                        setInput(<%=x%>, "pg1_sex", '<%= Encode.forJavaScript(props.getProperty("pg1_sex"+x, "")) %>');
                        setInput(<%=x%>, "pg1_oh_gest", '<%= Encode.forJavaScript(props.getProperty("pg1_oh_gest"+x, "")) %>');
                        setInput(<%=x%>, "pg1_weight", '<%= Encode.forJavaScript(props.getProperty("pg1_weight"+x, "")) %>');
                        setInput(<%=x%>, "pg1_length", '<%= Encode.forJavaScript(props.getProperty("pg1_length"+x, "")) %>');
                        setInput(<%=x%>, "pg1_place", '<%= Encode.forJavaScript(props.getProperty("pg1_place"+x, "")) %>');
                        ...
                        setInput(<%=x%>, "pg1_oh_comments", '<%= Encode.forJavaScript(props.getProperty("pg1_oh_comments"+x, "")) %>');
                    }
                });
                <%
		}
	...
	%>
            ...
            function watchFormVersion() {
                $.ajax({
                    type: "POST",
                    url: "<%=Encode.forJavaScript(String.valueOf(context))%>/Pregnancy.do",
                    data: {
                        method: "getLatestFormIdByPregnancy",
                        episodeId: '<%=Encode.forJavaScript(props.getProperty("episodeId","0"))%>'
                    },
                    dataType: 'json',
                    success: function (data, textStatus) {
                        if (data.value != '<%=Encode.forJavaScript(String.valueOf(formId))%>') {
                            $("#outdated_warn").show();
                        } else {
                            $("#outdated_warn").hide();
                        }
            ...
            function onPrint() {
				...
				%>
                    if ($("textarea[name='pg1_comments2AR1']").val().length > 0)
                        ...
                        document.forms[0].action = "<%=Encode.forJavaScript(String.valueOf(context))%>/form/createpdf?__title=Antenatal+Record+Part+1&__cfgfile=onar1enhancedPrintCfgPg1&__template=onar1&__numPages=1&postProcessor=ONAR1EnhancedPostProcessor";
                    <%
			} %>
            ...
            function onPageChange(url) {
                ...
                if (ret == true && ret1 == true) {
                    ...
                    if (ret) {
                        ...
                        adjustDynamicListTotals();
                        jQuery.ajax({
                            url: '<%=Encode.forJavaScript(String.valueOf(context))%>/Pregnancy.do?method=saveFormAjax',
                            data: $("form").serialize(),
                            async: false,
                            dataType: 'json',
                            success: function (data) {
 ...
 */
                ...
                $("#mcv-req-form").dialog({
                    ...
                    buttons: {
                        "Generate Requisition": function () {
                            ...
                            var demographic = '<%=Encode.forJavaScript(props.getProperty("demographic_no", "0"))%>';
                            ...
                            jQuery.ajax({
                                url: '<%=Encode.forJavaScript(String.valueOf(context))%>/Pregnancy.do?method=createMCVLabReq&demographicNo=' + demographic + '&ferritin=' + ferritin + '&hb_electrophoresis=' + hbElectrophoresis,
                                async: false,
                                success: function (data) {
                                    popPage(url, 'LabReq');
                                }
                ...
                $("#print-dialog").dialog({
                    ...
                    buttons: {
                        "Print": function () {
                            ...
                            var rfNum = '<%=Encode.forJavaScript(String.valueOf(props.getProperty("rf_num", "0")))%>';
                            var svNum = '<%=Encode.forJavaScript(String.valueOf(props.getProperty("sv_num", "0")))%>';
                            var usNum = '<%=Encode.forJavaScript(String.valueOf(props.getProperty("us_num", "0")))%>';
    ...
    <div id="framecontent">
        <div class="innertube">
            ...
            <div id="lock_req">
                ...
                <input style="display:none" id="lock_rel_btn" type="button" value="Release Lock"
                       onclick="releaseLock();"/>
            </div>
    ...
    <div id="maincontent">
        <div id="content_bar" class="innertube">
            <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
                    ...
                    <tr>
                        <td valign="top" width="50%">Patient's Last Name<br>
                            <input type="text" name="c_lastName" style="width: 100%" size="30"
                                   maxlength="60"
                                   value="<%= UtilMisc.htmlEscape(props.getProperty("c_lastName", "")) %>"/>
                        </td>
                        <td valign="top" colspan='2'>Patient's First Name<br>
                            <input type="text" name="c_firstName" style="width: 100%" size="30"
                                   maxlength="60"
                                   value="<%= UtilMisc.htmlEscape(props.getProperty("c_firstName", "")) %>"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" width="25%">Partner's First Name<br>
                            <input type="text" name="c_partnerFirstName" style="width: 100%"
                                   size="30" maxlength="60"
                                   value="<%= UtilMisc.htmlEscape(props.getProperty("c_partnerFirstName", "")) %>"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="15%" valign="top">Telephone - Work<br>
                            <input type="text" name="pg1_workPhone" size="15" style="width: 100%"
                                   maxlength="20"
                                   value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_workPhone", "")) %>"/>
                        </td>
                        ...
                        <td width="8%" valign="top">Age<br>
                            <input type="text" name="pg1_partnerAge" style="width: 100%" size="5"
                                   maxlength="5"
                                   value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_partnerAge", "")) %>"/>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td width="8%" valign="top">Age<br>
                            <input type="text" name="pg1_age" style="width: 100%" size="10"
                                   maxlength="10" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_age", "")) %>"/>
                        </td>
                        ...
                        <td width="17%"><font size="-1">Newborn care<br>
                            <input type="checkbox" name="pg1_ncPed"
                                    ...
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_ncFP", "")))%> />FP <input type="checkbox"
                                       ...
                                       maxlength="25"
                                       value="<%= UtilMisc.htmlEscape(props.getProperty("c_nc", "")) %>"/></td>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="50%">Allergies or Sensitivities &nbsp;<a id="update_allergies_link"
                                                                            href="javascript:void(0)"
                                                                            class="edit-feature"
                                                                            onclick="updateAllergies();">Update from
                            Chart</a><br>
                            <div align="center"><textarea name="c_allergies" class="limit-text"
                                                          style="width: 100%" cols="30" rows="4" maxlength="150"
                                                          data-msg="allergies_size"
                                                          data-new-line="true"><%= UtilMisc.htmlEscape(props.getProperty("c_allergies", "")) %></textarea>
                            </div>
                            <%if (!bView) {%>
                        ...
                        <td width="50%">Medications/Herbals&nbsp;<a id="update_meds_link" href="javascript:void(0)"
                                                                    class="edit-feature" onclick="updateMeds();">Update
                            from Chart</a><br>
                            <div align="center"><textarea name="c_meds" class="limit-text" style="width: 100%"
                                                          cols="30" rows="4" maxlength="146" data-msg="meds_size"
                                                          data-new-line="true"><%= UtilMisc.htmlEscape(props.getProperty("c_meds", "")) %></textarea>
                            </div>
                            <%if (!bView) {%>
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td valign="top" nowrap>LMP <input type="text"
                                        ...
                                        <img src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/cal.gif" id="pg1_menLMP_cal"></td>
                                    <td>Certain</td>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap"><input type="text" name="pg1_lastUsed" id="pg1_lastUsed"
                                        ...
                                        <img src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/cal.gif" id="pg1_lastUsed_cal"></td>
                                </tr>
                            </table>
                        ...
                        <td valign="top" nowrap>EDB (by dates)</br>
                            <input type="text" name="pg1_menEDB" id="pg1_menEDB" class="spe"
                                   ...
                                   value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_menEDB", "")) %>"/> <img
                                    src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/cal.gif" id="pg1_menEDB_cal"></td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td valign="top" align="center"><font size="+1"><b>Final
                                        ...
                                        <img src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/cal.gif" id="c_finalEDB_cal"></td>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td valign="top">
                            ...
                            <input type="hidden" id="obxhx_num" name="obxhx_num"
                                   value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("obxhx_num", "0")))%>"/>
                            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td colspan="9"><input id="obxhx_add_btn" type="button" value="Add New"
                                                           onclick="addObxHx();"/></td>
                                </tr>
                            </table>
                        </td>
                ...
                <table class="shrinkMe" width="100%" border="0" cellspacing="0"
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" name="pg1_cp8N"
                                                        <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_cp8N", "")))%> /></td>
                                            </tr>
                                            <tr>
                                                <td valign="top">6.</td>
                                                <td>Dietary restrictions</td>
                                                <td><input type="checkbox" name="pg1_naDiet"
                                                        <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_naDiet", "")))%>></td>
                                                <td><input type="checkbox" name="pg1_naDietN"
                                                        <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_naDietN", "")))%>></td>
                                            </tr>
                                            <tr>
                                                <td valign="top">7.</td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td colspan="4">BMI<input type="text" id="c_bmi" name="c_bmi"
                                                                          class="spe" onDblClick="calcBMIMetric(this);"
                                                                          size="6"
                                                                          maxlength="6"
                                            ...
                                            <tr>
                                                <td>48.</td>
                                                <td nowrap="nowrap">Size: <input type="text" name="pg1_uterusBox"
                                                                                 size="3"
                                                                                 maxlength="3"
                                            ...
                                            <tr>
                                                ...
                                                <td>Other <input type="text" name="pg1_pExOtherDesc" size="6"
                                                                 maxlength="20"
                                                                 value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_pExOtherDesc", "")) %>">
                                                </td>
                                                <td><input type="checkbox" name="pg1_pExOther"
                                                        <%=Encode.forHtml(String.valueOf(props.getProperty("pg1_pExOther", "")))%>></td>
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td valign="top" rowspan="2" nowrap="nowrap">Last Pap <br/>
                                        ...
                                        <img
                                                src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/cal.gif" id="pg1_labLastPapDate_cal">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" size="10" name="pg1_labCustom1Result"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labCustom1Result", "")) %>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Sickle Cell</td>
                                    ...
                                    <td><input type="text" size="10" name="pg1_labCustom2Label"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labCustom2Label", "")) %>"/>
                                    </td>
                                    <td><input type="text" size="10" name="pg1_labCustom2Result"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labCustom2Result", "")) %>"/>
                                    </td>
                                </tr>
                            </table>
                            <br/>
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="pg1_geneticA" size="10"
                                               maxlength="20"
                                               value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_geneticA", "")) %>">
                                    </td>
                        </td>
                    ...
                    <tr>
                        <td><input type="text" size="10" name="pg1_labCustom3Label"
                                   value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labCustom3Label", "")) %>"/>
                        </td>
                        <td><input type="text" size="10" name="pg1_labCustom3Result"
                    ...
                    <tr>
                        <td>d) Counseled</td>
                        <td align="center">
                            <input type="hidden" name="pg1_geneticD"
                                   value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_geneticD", "")) %>"/>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td colspan="4"><textarea name="pg1_commentsAR1" class="limit-text"
                                                  style="width: 100%" cols="80" rows="5" maxlength="885"
                                                  data-msg="comment_size"><%= UtilMisc.htmlEscape(props.getProperty("pg1_commentsAR1", "")) %></textarea>
                        </td>
                    </tr>
                    <%if (!bView) {%>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4"><textarea id="pg1_comments2AR1" name="pg1_comments2AR1" class="limit-text"
                                                  style="width: 100%" cols="80" rows="15" maxlength="4160"
                                                  data-msg="comment2_size"><%= UtilMisc.htmlEscape(props.getProperty("pg1_comments2AR1", "")) %></textarea>
                        </td>
                    </tr>
                    <%if (!bView) {%>
                    <tr>
        ...
        <form>
            <fieldset>
                ...
                <a href="javascript:void(0);" onclick="return false;" title="Consider to rule out iron deficiency"><img
                        border="0" src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/icon_help_sml.gif"/></a>
        ...
        <form>
            <fieldset>
                <table>
                    ...
                    <tr>
                        <td>
                            <button id="credit_valley_genetic_btn">Lab Requisition</button>
                        </td>
                        <td>Credit Valley Hospital</td>
                    </tr>
                    <tr>
                        <td>
                            <button id="north_york_genetic_btn">Lab Requisition</button>
                        </td>
    ...
    <div id="genetics_menu_div" class="hidden">
        <ul>
            ...
            <li><a href="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/pregnancy/genetics-provider-guide-e.pdf" target="sogc">Guide</a>
            </li>
            <li><a href="javascript:void(0)" onclick="loadCustomForms();"><%=Encode.forHtml(String.valueOf(customEformGroup))%> Forms</a></li>
        </ul>
    </div>
            ...
            <fieldset>
                <table>
                    ...
                    <tr>
                        ...
                        <td><input readonly="readonly" type="text" size="5" id="height_form" name="height_form"
                                   class="text ui-widget-content ui-corner-all"/></td>
                        <td>
                            <a id="moveToForm_height" href="javascript:void(0)" title="Copy from Chart to Form"><img
                                    src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/icons/132.png"/></a>
                            &nbsp;
                            <a id="moveToChart_height" href="javascript:void(0)" onClick="moveToChart('height','HT');"
                               title="Copy from Form to Chart"><img src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/icons/131.png"/></a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input readonly="readonly" type="text" size="5" id="weight_form" name="weight_form"
                                   class="text ui-widget-content ui-corner-all"/></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input readonly="readonly" type="text" size="5" id="bp_form" name="bp_form"
                                   class="text ui-widget-content ui-corner-all"/></td>
                        <td>
        ...
        <form>
            <fieldset>
                <table>
                    ...
                    <tr>
                        <td>
                            Order <%=Encode.forHtml(String.valueOf(prenatalScreenName))%> (<%=Encode.forHtml(String.valueOf(prenatalScreen))%>)
                            <a href="javascript:void(0);" onclick="return false;"
                               title="Click on 'Forms' menu item under Prompts, and choose <%=Encode.forHtmlAttribute(String.valueOf(customEformGroup))%>"><img
                                    border="0" src="<%=Encode.forHtmlAttribute(String.valueOf(context))%>/images/icon_help_sml.gif"/></a>
                        </td>
                    </tr>
                    <tr>
    ...
    <div id="print-dialog" title="Print Antenatal Record">
        ...
        <form>
            <fieldset>
                <input type="checkbox" name="print_ar1" id="print_ar1" checked="checked"
                       class="text ui-widget-content ui-corner-all"/>
                <label for="print_ar1">AR1</label>
                <br/>
                <input type="checkbox" name="print_ar2" id="print_ar2" checked="checked"
                       class="text ui-widget-content ui-corner-all"/>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <select name="print_location" id="print_location"
                                    class="text ui-widget-content ui-corner-all">
