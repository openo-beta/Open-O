...
// Declaring valid date character, minimum year and maximum year
        ...
        function checkAllDates() {
            ...
            if (valDate(document.forms[0].c_finalEDB) == false) {
                ...
                b = false;
            } else if (valDate(document.forms[0].pg3_date18) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date19) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date20) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date21) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date22) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date23) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date24) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date25) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date26) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date27) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date28) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date29) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date30) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date31) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date32) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date33) == false) {
                b = false;
            } else if (valDate(document.forms[0].pg3_date34) == false) {
                b = false;
            }
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr align="center">
                <td width="11%"><input type="text" name="pg3_date18" size="10"
                                       ...
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg3_date18", "")))%>"></td>
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments18"
                                              ...
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments18", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig18"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig18", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments19"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments19", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig19"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig19", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments20"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments20", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig20"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig20", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments21"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments21", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig21"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig21", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments22"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments22", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig22"
                                             size="22" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig22", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments23"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments23", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig23"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig23", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments24"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments24", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig24"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig24", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments25"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments25", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig25"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig25", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments26"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments26", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig26"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig26", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments27"
                                              size="20" maxlength="70" style="width: 100%;"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments27", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig27"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig27", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments28"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments28", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig28"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig28", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments29"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments29", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig29"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig29", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments30"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments30", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig30"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig30", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments31"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments31", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig31"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig31", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments32"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments32", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig32"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig32", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments33"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments33", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig33"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig33", "")) %>">
                </td>
            </tr>
            <tr align="center">
                ...
                <td nowrap width="33%"><input type="text" name="pg3_comments34"
                                              size="20" maxlength="70" style="width: 100%"
                                              value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_comments34", "")) %>">
                </td>
                <td nowrap width="4%"><input type="text" name="pg3_cig34"
                                             size="5" maxlength="3" style="width: 90%"
                                             value="<%= UtilMisc.htmlEscape(props.getProperty("pg3_cig34", "")) %>">
                </td>
            </tr>
        </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td align="right"><b>Edit:</b> <a
                    ...
                    &nbsp;|&nbsp; <a
                        ...
                        <font size=-2>(pg.1)</a> &nbsp;|&nbsp; <a
                            href="javascript: popupFixedPage(700,950,'<%=request.getContextPath()%>/decision/antenatal/antenatal/antenatalplanner.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>');">AR
                        Planner</a></td>
                <%
                    }
                %>
