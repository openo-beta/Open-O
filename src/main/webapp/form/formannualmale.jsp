...
o=<%=Encode.forHtml(String.valueOf(provNo))%>');"><fmt:message key="oscarEncounter.formMaleAnnual.btnRisk"/></a></td>
                                    </tr>
                                    <!--tr>
                    ...
                    <table width="100%" class="tableWithBorder">
                        ...
                        <tr>
                            ...
                            <td><fmt:message key="oscarEncounter.formMaleAnnual.formBP"/>:
                                <input type="text" name="bprTop" size="5" maxlength="3"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("bprTop", "")))%>"/>/ <input
                                        ...
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("bprBottom", "")))%>"/> <fmt:message key="oscarEncounter.formMaleAnnual.msgR"/></td>
                            <td align="right"><fmt:message key="oscarEncounter.formMaleAnnual.formPulse"/>:
                            </td>
                            <td><input type="text" name="pulse" size="10" maxlength="10"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pulse", "")))%>"/> /<fmt:message key="oscarEncounter.formMaleAnnual.msgMinute"/></td>
                            ...
                            <td><input type="text" name="height" size="10" maxlength="4"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("height", "")))%>"/> <fmt:message key="oscarEncounter.formMaleAnnual.msgHeightUnit"/>.
                            </td>
                            <td align="right"><fmt:message key="oscarEncounter.formMaleAnnual.formWeight"/>: <input
                                    type="text" name="weight" size="10" maxlength="4"
                                    value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("weight", "")))%>"/> <fmt:message key="oscarEncounter.formMaleAnnual.msgWeightUnit"/>.
                            </td>
                        <tr>
                            <td>&nbsp;</td>
                            <td><fmt:message key="oscarEncounter.formMaleAnnual.formBP"/>:
                                <input type="text" name="bplTop" size="5" maxlength="3"
                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("bplTop", "")))%>"/>/ <input
                                        ...
                                        value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("bplBottom", "")))%>"/> <fmt:message key="oscarEncounter.formMaleAnnual.msgL"/></td>
