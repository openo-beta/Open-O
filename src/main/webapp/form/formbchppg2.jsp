...
<html>
        ...
        <table class="Head" class="hidePrint">
            <tr>
                ...
                <td align="right"><b>Edit:</b><a
                        href="form/formbchppg1.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>">HP
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td><input type="text" name="pg2_date1" id="pg2_date1"
                           ...
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date1", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date1_cal">
                </td>
                <td><input type="text" name="pg2_medName1" id="pg2_medName1"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName1", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose1" id="pg2_dose1"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose1", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften1" id="pg2_howOften1"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften1", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason1" id="pg2_reason1"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason1", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date2" id="pg2_date2"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date2", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date2_cal">
                </td>
                <td><input type="text" name="pg2_medName2" id="pg2_medName2"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName2", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose2" id="pg2_dose2"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose2", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften2" id="pg2_howOften2"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften2", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason2" id="pg2_reason2"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason2", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date3" id="pg2_date3"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date3", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date3_cal">
                </td>
                <td><input type="text" name="pg2_medName3" id="pg2_medName3"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName3", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose3" id="pg2_dose3"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose3", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften3" id="pg2_howOften3"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften3", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason3" id="pg2_reason3"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason3", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date4" id="pg2_date4"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date4", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date4_cal">
                </td>
                <td><input type="text" name="pg2_medName4" id="pg2_medName4"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName4", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose4" id="pg2_dose4"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose4", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften4" id="pg2_howOften4"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften4", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason4" id="pg2_reason4"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason4", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date5" id="pg2_date5"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date5", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date5_cal">
                </td>
                <td><input type="text" name="pg2_medName5" id="pg2_medName5"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName5", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose5" id="pg2_dose5"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose5", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften5" id="pg2_howOften5"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften5", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason5" id="pg2_reason5"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason5", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date6" id="pg2_date6"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date6", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date6_cal">
                </td>
                <td><input type="text" name="pg2_medName6" id="pg2_medName6"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName6", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose6" id="pg2_dose6"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose6", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften6" id="pg2_howOften6"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften6", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason6" id="pg2_reason6"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason6", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date7" id="pg2_date7"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date7", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date7_cal">
                </td>
                <td><input type="text" name="pg2_medName7" id="pg2_medName7"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName7", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose7" id="pg2_dose7"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose7", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften7" id="pg2_howOften7"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften7", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason7" id="pg2_reason7"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason7", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date8" id="pg2_date8"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date8", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date8_cal">
                </td>
                <td><input type="text" name="pg2_medName8" id="pg2_medName8"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName8", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose8" id="pg2_dose8"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose8", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften8" id="pg2_howOften8"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften8", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason8" id="pg2_reason8"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason8", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date9" id="pg2_date9"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date9", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date9_cal">
                </td>
                <td><input type="text" name="pg2_medName9" id="pg2_medName9"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName9", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_dose9" id="pg2_dose9"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose9", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften9" id="pg2_howOften9"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften9", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason9" id="pg2_reason9"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason9", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date10" id="pg2_date10"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date10", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date10_cal">
                </td>
                <td><input type="text" name="pg2_medName10" id="pg2_medName10"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName10", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_dose10" id="pg2_dose10"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose10", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften10"
                           id="pg2_howOften10" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften10", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason10" id="pg2_reason10"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason10", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date11" id="pg2_date11"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date11", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date11_cal">
                </td>
                <td><input type="text" name="pg2_medName11" id="pg2_medName11"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName11", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_dose11" id="pg2_dose11"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose11", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften11"
                           id="pg2_howOften11" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften11", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason11" id="pg2_reason11"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason11", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date12" id="pg2_date12"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date12", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date12_cal">
                </td>
                <td><input type="text" name="pg2_medName12" id="pg2_medName12"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName12", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_dose12" id="pg2_dose12"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose12", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften12"
                           id="pg2_howOften12" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften12", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason12" id="pg2_reason12"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason12", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date13" id="pg2_date13"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date13", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date13_cal">
                </td>
                <td><input type="text" name="pg2_medName13" id="pg2_medName13"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName13", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_dose13" id="pg2_dose13"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose13", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften13"
                           id="pg2_howOften13" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften13", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason13" id="pg2_reason13"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason13", "")))%>" @oscar.formDB/>
                </td>
            </tr>
            <tr>
                <td><input type="text" name="pg2_date14" id="pg2_date14"
                           style="width: 80%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_date14", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif" id="pg2_date14_cal">
                </td>
                <td><input type="text" name="pg2_medName14" id="pg2_medName14"
                           style="width: 100%" size="30" maxlength="30"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_medName14", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_dose14" id="pg2_dose14"
                           style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_dose14", "")))%>" @oscar.formDB/>
                </td>
                <td><input type="text" name="pg2_howOften14"
                           id="pg2_howOften14" style="width: 100%" size="10" maxlength="10"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_howOften14", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_reason14" id="pg2_reason14"
                           style="width: 100%" size="20" maxlength="20"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_reason14", "")))%>" @oscar.formDB/>
                </td>
            </tr>
        </table>
        <table width="100%" border="0" cellpadding="0" cellspacing="10">
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><input type="text" name="pg2_fluDate1" id="pg2_fluDate1"
                           ...
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_fluDate1", "")))%>" @oscar.formDB
                ...
                <td><input type="text" name="pg2_fluDate2" id="pg2_fluDate2"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_fluDate2", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg2_fluDate2_cal"></td>
                <td><input type="text" name="pg2_fluDate3" id="pg2_fluDate3"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_fluDate3", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg2_fluDate3_cal"></td>
                <td><input type="text" name="pg2_fluDate4" id="pg2_fluDate4"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_fluDate4", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg2_fluDate4_cal"></td>
                <td><input type="text" name="pg2_fluDate5" id="pg2_fluDate5"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_fluDate5", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg2_fluDate5_cal"></td>
                <td><input type="text" name="pg2_fluDate6" id="pg2_fluDate6"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_fluDate6", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
                                                id="pg2_fluDate6_cal"></td>
                <td><input type="text" name="pg2_fluDate7" id="pg2_fluDate7"
                           style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_fluDate7", "")))%>" @oscar.formDB
                           dbType="date"/> <img src="<%= request.getContextPath() %>/images/cal.gif"
            ...
            <tr>
                <td><input type="text" name="pg2_otherVac1" id="pg2_otherVac1"
                           ...
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_otherVac1", "")))%>"
                           @oscar.formDB/></td>
                <td><input type="text" name="pg2_other1Date1"
                           id="pg2_other1Date1" style="width: 75%" size="10" maxlength="15"
                           value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("pg2_other1Date1", "")))%>"
    ...
    <script type="text/javascript">
        Calendar.setup({
            inputField: "pg2_date1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date8",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date8_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date9",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date9_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date10",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date10_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date11",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date11_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date12",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date12_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date13",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date13_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_date14",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_date14_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_fluDate1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_fluDate1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_fluDate2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_fluDate2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_fluDate3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_fluDate3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_fluDate4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_fluDate4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_fluDate5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_fluDate5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_fluDate6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_fluDate6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_fluDate7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_fluDate7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other1Date1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other1Date1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other1Date2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other1Date2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other1Date3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other1Date3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other1Date4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other1Date4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other1Date5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other1Date5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other1Date6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other1Date6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other1Date7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other1Date7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other2Date1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other2Date1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other2Date2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other2Date2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other2Date3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other2Date3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other2Date4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other2Date4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other2Date5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other2Date5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other2Date6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other2Date6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other2Date7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other2Date7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other3Date1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other3Date1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other3Date2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other3Date2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other3Date3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other3Date3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other3Date4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other3Date4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other3Date5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other3Date5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other3Date6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other3Date6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other3Date7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other3Date7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other4Date1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other4Date1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other4Date2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other4Date2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other4Date3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other4Date3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other4Date4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other4Date4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other4Date5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other4Date5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other4Date6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other4Date6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other4Date7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other4Date7_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other5Date1",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other5Date1_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other5Date2",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other5Date2_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other5Date3",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other5Date3_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other5Date4",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other5Date4_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other5Date5",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other5Date5_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other5Date6",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other5Date6_cal",
            singleClick: true,
            step: 1
        });
        Calendar.setup({
            inputField: "pg2_other5Date7",
            ifFormat: "%d/%m/%Y",
            showsTime: false,
            button: "pg2_other5Date7_cal",
            singleClick: true,
            step: 1
        });
    </script>
