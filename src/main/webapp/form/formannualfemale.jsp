    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <table class="Head" class="hidePrint">
            <tr>
                ...
                <td align='right'><a
                        href="javascript: popupPage(700,950,'<%= request.getContextPath() %>/decision/annualreview/annualreviewplanner.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>');"><fmt:message key="oscarEncounter.formFemaleAnnual.btnAnnualReview"/></a></td>
            </tr>
        </table>
                        ...
                        <tr>
                            <td align="center"><fmt:message key="oscarEncounter.formFemaleAnnual.msgSeeChart"/>
                                &nbsp;&nbsp;&nbsp; <input type="checkbox" name="currentConcernsNo"
                                        <%= props.getProperty("currentConcernsNo", "") %> /> &nbsp;<fmt:message key="oscarEncounter.formFemaleAnnual.brtNo"/>&nbsp;&nbsp;&nbsp; <input
                                        type="checkbox" name="currentConcernsYes"
                                        <%= props.getProperty("currentConcernsYes", "") %> /> &nbsp;<fmt:message key="oscarEncounter.formFemaleAnnual.btnYes"/></td>
                        </tr>
                    </table>
                </td>
                <td>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td nowrap="true"><fmt:message key="oscarEncounter.formFemaleAnnual.msgGTPALRevisions"/>&nbsp; <input
                                    ...
                                    <%= props.getProperty("noGtpalRevisions", "") %> /> <fmt:message key="oscarEncounter.formFemaleAnnual.brtNo"/> <input
                                    type="checkbox" name="yesGtpalRevisions"
                                    <%= props.getProperty("yesGtpalRevisions", "") %> /> <fmt:message key="oscarEncounter.formFemaleAnnual.btnYes"/> <input
                                    type="checkbox" name="frontSheet"
                                    <%= props.getProperty("frontSheet", "") %> /> <fmt:message key="oscarEncounter.formFemaleAnnual.formFrontSheeyUpdated"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td><fmt:message key="oscarEncounter.formFemaleAnnual.formLMP"/><small>(yyyy/mm/dd)</small>:
                                ...
                                &nbsp;&nbsp;&nbsp; <fmt:message key="oscarEncounter.formFemaleAnnual.formMenopause"/>: <input
                                        ...
                                        value="<%= props.getProperty("menopause", "") %>"/> /<fmt:message key="oscarEncounter.formFemaleAnnual.formMenopauseUnit"/></td>
                        </tr>
                        <tr>
...
o=<%=provNo%>');"><fmt:message key="oscarEncounter.formFemaleAnnual.btnRisk"/></a></td>
                        </tr>
                        <!--tr>
        ...
        <table width="100%" class="tableWithBorder">
            ...
            <tr>
                ...
                <td><fmt:message key="oscarEncounter.formFemaleAnnual.formBP"/>:
                    <input type="text" name="bprTop" size="5" maxlength="3"
                           value="<%= props.getProperty("bprTop", "") %>"/>/ <input
                            ...
                            value="<%= props.getProperty("bprBottom", "") %>"/> <fmt:message key="oscarEncounter.formFemaleAnnual.msgR"/></td>
                ...
                <td><input type="text" name="height" size="10" maxlength="4"
                           value="<%= props.getProperty("height", "") %>"/> <fmt:message key="oscarEncounter.formFemaleAnnual.HeightUnit"/></td>
                <td align="right"><fmt:message key="oscarEncounter.formFemaleAnnual.formWeight"/>: <input
                        type="text" name="weight" size="10" maxlength="4"
                        value="<%= props.getProperty("weight", "") %>"/> <fmt:message key="oscarEncounter.formFemaleAnnual.formWeightUnit"/></td>
            <tr>
                <td>&nbsp;</td>
                <td><fmt:message key="oscarEncounter.formFemaleAnnual.formBP"/>:
                    <input type="text" name="bplTop" size="5" maxlength="3"
                           value="<%= props.getProperty("bplTop", "") %>"/>/ <input
                            ...
                            value="<%= props.getProperty("bplBottom", "") %>"/> <fmt:message key="oscarEncounter.formFemaleAnnual.msgL"/></td>
