...
"")))%>"/></td>
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="checkbox" name="examGenitaliaN"
                                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("examGenitaliaN", "")))%> />
                                                            </td>
                                                            <td><input type="checkbox" name="examGenitaliaAbN"
                                                                    <%=Encode.forHtml(String.valueOf(props.getProperty("examGenitaliaAbN", "")))%> />
                                                            </td>
                                                            <td><input type="text" class="OnExam"
                                                                       name="examGenitalia"
                                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("examGenitalia", "")))%>"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan=4>&nbsp;</td>
			...
			<td class="bottomBorder"><textarea class="ToDos" rows=3 name="toDoPAPs"><%=Encode.forHtml(String.valueOf(props.getProperty("toDoPAPs", "")))%></textarea></td>
		</tr>-->
                    <!--<tr>
			...
			<td class="bottomBorder"><textarea class="ToDos" rows=3 name="toDoMammogram" ><%=Encode.forHtml(String.valueOf(props.getProperty("toDoMammogram", "")))%></textarea></td>
                    ...
                    <tr>
                        ...
                        <td class="bottomBorder"><textarea class="ToDos" rows=8
                                                           name="toDoProstateCancer"><%=Encode.forHtml(String.valueOf(props.getProperty("toDoProstateCancer", "")))%></textarea>
                        </td>
