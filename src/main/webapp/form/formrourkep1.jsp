        ...
        <table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
            <tr>
                ...
                <td nowrap="true"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgPage1"/></a>&nbsp;|&nbsp; <a
                        href="formrourkep2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnPage2"/></a>&nbsp;|&nbsp; <a
                        href="formrourkep3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnPage3"/></a></td>
            </tr>
        </table>
