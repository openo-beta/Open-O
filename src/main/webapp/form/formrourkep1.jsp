...
<html>
    <head>
        ...
        <title><fmt:message key="oscarEncounter.formRourke1.title"/></title>
...
//        if(ret==true)
//        {
//            ret = confirm("<fmt:message key="oscarEncounter.formRourke1.msgSavePrintPreview"/>");
//        }
//        return ret;
            window.print();
        }
        ...
        function onSave() {
            ...
            var ret = checkAllDates();
            if (ret == true) {
                ret = confirm("<fmt:message key="oscarEncounter.formRourke1.msgSave"/>");
            }
            return ret;
        }
        ...
        function onSaveExit() {
            ...
            var ret = checkAllDates();
            if (ret == true) {
                ret = confirm("<fmt:message key="oscarEncounter.formRourke1.msgSaveExit"/>");
            }
            return ret;
        }
...
// Declaring valid date character, minimum year and maximum year
        ...
        function checkTypeIn(obj) {
            if (!checkTypeNum(obj.value)) {
                alert("<fmt:message key="oscarEncounter.formRourke1.msgTypeNumbers"/>");
            }
        }
    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="1">
            <tr align="center">
                <td class="column"><a><fmt:message key="oscarEncounter.formRourke1.btnAge"/></a></td>
                ...
                <td colspan="3" class="row"><a><fmt:message key="oscarEncounter.formRourke1.btn2Months"/></a></td>
            </tr>
            <tr align="center">
            ...
            <tr align="center">
                <td class="column" rowspan="2"><a><fmt:message key="oscarEncounter.formRourke1.btnGrowth"/></a></td>
            ...
            <tr>
                <td class="column">
                    <table cellpadding="0" cellspacing="0" width="100%" class="column">
                        <tr>
                            <td nowrap="true"><a><fmt:message key="oscarEncounter.formRourke1.msgEducational"/></a></td>
                        </tr>
                        <tr>
                            <td align="right"><fmt:message key="oscarEncounter.formRourke1.msgSafety"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td align="right"><fmt:message key="oscarEncounter.formRourke1.msgBehaviour"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="right"><fmt:message key="oscarEncounter.formRourke1.msgFamily"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td align="right"><fmt:message key="oscarEncounter.formRourke1.msgOther"/></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
            ...
            <tr>
                <td class="column"><a><fmt:message key="oscarEncounter.formRourke1.msgDevelopment"/></a><br>
                    <fmt:message key="oscarEncounter.formRourke1.msgDevelopmentDesc"/>
                </td>
