...
<html>
    <head>
        ...
        <title><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.title"/></title>
...
//        if(ret==true)
//        {
//            ret = confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgSavePrintPreview"/>");
//        }
//        return ret;
            window.print();
        }
        ...
        function onSave() {
            ...
            var ret = checkAllDates();
            if (ret == true) {
                ret = confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgSave"/>");
            }
            return ret;
        }
        ...
        function onSaveExit() {
            ...
            var ret = checkAllDates();
            if (ret == true) {
                ret = confirm("<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgSaveExit"/>");
            }
            return ret;
        }
...
// Declaring valid date character, minimum year and maximum year
        ...
        function checkTypeIn(obj) {
            if (!checkTypeNum(obj.value)) {
                alert("<fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgTypeNumbers"/>");
            }
        }
    ...
    <form action="${pageContext.request.contextPath}/form/formname.do" method="post">
                ...
                <td align="center" width="100%"><a name="length"
                    ...
                    <a name="headCirc"
                       href="javascript:popup('form/graphHeadCirc.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>');">
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnGraphHead"/></a></td>
                <td nowrap="true"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgPage1"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourkep2.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnPage2"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourkep3.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(demoNo))%>&formId=<%=Encode.forUriComponent(String.valueOf(formId))%>&provNo=<%=Encode.forUriComponent(String.valueOf(provNo))%>"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnPage3"/></a></td>
            </tr>
        </table>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr valign="top">
                <td nowrap align="center"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formBirhtRemarks"/><br>
                ...
                <td width="65%" nowrap align="center">
                    <p><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgName"/>: <input
                        ...
                        &nbsp;&nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgBirthDate"/> (yyyy/mm/dd): <input
                    ...
                    <p><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgLenght"/>: <input
                        ...
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgHeadCircUnit"/> &nbsp;&nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgBirthWt"/>: <input type="text"
                                                                                      name="c_birthWeight" size="6"
                                                                                      maxlength="7"
                                                                                      value="<%=Encode.forHtmlAttribute(String.valueOf(props.getProperty("c_birthWeight", "")))%>"/>
                        <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgBirthWtUnit"/> &nbsp;&nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgDischargeWt"/>: <input
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="1">
            <tr align="center">
                <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnAge"/></a></td>
                ...
                <td colspan="3" class="row"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btn2Months"/></a></td>
            </tr>
            <tr align="center">
                <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgDate"/></a></td>
                <td colspan="3"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formDate"/> <input type="text"
            ...
            <tr align="center">
                <td class="column" rowspan="2"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnGrowth"/></a></td>
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>n_breastFeeding');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnBreastFeeding"/></a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgBreastFeedingDescr"/></b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_formulaFeeding1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_formulaFeeding1w", "")))%> /></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgFormulaFeeding"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
            ...
            <tr>
                <td class="column">
                    <table cellpadding="0" cellspacing="0" width="100%" class="column">
                        <tr>
                            <td nowrap="true"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgEducational"/></a></td>
                        </tr>
                        <tr>
                            <td align="right"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgSafety"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td align="right"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgBehaviour"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="right"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgFamily"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td align="right"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgOther"/></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>s_motorVehicleAccidents');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formCarSeat"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_cribSafety1w"
                                    <%=Encode.forHtml(String.valueOf(props.getProperty("p1_cribSafety1w", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formCribSafety"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSleeping"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_sooth1w" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sooth1w", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSoothability"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_bonding1w" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_bonding1w", "")))%>>
                            </td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formParenting"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_fatigue1w" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_fatigue1w", "")))%>>
                            </td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFatigue"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_family1w" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_family1w", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFamilyConflict"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_siblings1w" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_siblings1w", "")))%>>
                            </td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSiblings"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_homeVisit1w"
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>hri_homeVisits');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnHomeVisit"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>o_sleepPosition');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnSleepPosition"/></a>*</b>
                            <td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_temp1w" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_temp1w", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formTemperatureControl"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_smoke1w" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_smoke1w", "")))%>></td>
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>o_secondHandSmoke');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSecondHandSmoke"/></a>*</b></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>o_sleepPosition');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnSleepPosition"/>*</a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><i><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>s_burns');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSleepwear"/></a></i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                            ...
                            <td><i><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>s_burns');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnHotWater"/></a>*</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_toys1m" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_toys1m", "")))%>></td>
                            <td><a href="#"
                                   onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>s_choking');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnSafeToys"/></a>*
                            </td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                        ...
                        <tr>
                            ...
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formParentChildinteraction"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_supports1m" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_supports1m", "")))%>>
                            </td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formAssessSupports"/></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><i><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>s_falls');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnFalls"/></a>*</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                        ...
                        <tr>
                            ...
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formDepression"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFeverControl"/></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td class="column"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgDevelopment"/></a><br>
                    <fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgDevelopmentDesc"/>
                </td>
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFocusesGaze"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_startles1m" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_startles1m", "")))%>>
                            </td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSuddenNoise"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_sucks1m" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sucks1m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSucksWell"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formFollowsMovement"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_sounds2m" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_sounds2m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formVarietyOfSounds"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_headUp2m" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_headUp2m", "")))%>></td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHoldHeadsUp"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_cuddled2m" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_cuddled2m", "")))%>>
                            </td>
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.EnjoysBeingTouched"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formEarDrums"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                        ...
                        <tr>
                            ...
                            <td><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHips"/></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_testicles1w"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>pe_cover');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnCoverTest"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_hearing1m" <%=Encode.forHtml(String.valueOf(props.getProperty("p1_hearing1m", "")))%>>
                            </td>
                            <td><b><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHearingInquirity"/></b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=Encode.forJavaScript(String.valueOf(resource))%>pp_hemoglobinopathyScreening');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHemoglobinopathy"/></a> (if at
                                risk)*</b></td>
                        </tr>
                    </table>
                </td>
