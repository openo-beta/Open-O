        ...
        <table cellpadding="0" cellspacing="0" class="Header" class="hidePrint">
            <tr>
                ...
                <td nowrap="true"><a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgPage1"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourkep2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnPage2"/></a>&nbsp;|&nbsp; <a
                        href="form/formrourkep3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnPage3"/></a></td>
            </tr>
        </table>
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=resource%>n_breastFeeding');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnBreastFeeding"/></a><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.msgBreastFeedingDescr"/></b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=resource%>s_motorVehicleAccidents');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formCarSeat"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=resource%>hri_homeVisits');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnHomeVisit"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=resource%>o_sleepPosition');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnSleepPosition"/></a>*</b>
                            <td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=resource%>o_secondHandSmoke');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSecondHandSmoke"/></a>*</b></td>
                        </tr>
                    </table>
                </td>
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=resource%>o_sleepPosition');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnSleepPosition"/>*</a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><i><a href="#"
                                      onclick="popup('<%=resource%>s_burns');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formSleepwear"/></a></i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                            ...
                            <td><i><a href="#"
                                      onclick="popup('<%=resource%>s_burns');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnHotWater"/></a>*</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                                                    name="p1_toys1m" <%= props.getProperty("p1_toys1m", "") %>></td>
                            <td><a href="#"
                                   onclick="popup('<%=resource%>s_choking');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnSafeToys"/></a>*
                            </td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><i><a href="#"
                                      onclick="popup('<%=resource%>s_falls');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnFalls"/></a>*</i></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=resource%>pe_cover');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.btnCoverTest"/></a>*</b></td>
                        </tr>
                        <tr>
                            <td valign="top"><input type="checkbox" class="chk"
                ...
                <td colspan="3" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><b><a href="#"
                                      onclick="popup('<%=resource%>pp_hemoglobinopathyScreening');return false;"><fmt:setBundle basename="oscarResources"/><fmt:message key="oscarEncounter.formRourke1.formHemoglobinopathy"/></a> (if at
                                risk)*</b></td>
                        </tr>
                    </table>
                </td>
