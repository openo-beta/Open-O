                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><input type="radio" id="p1_focusGaze1mNo"
                                    ...
                                    <%= props.getProperty("p1_focusGaze1mNo", "") %>><fmt:message key="oscarEncounter.formRourke1.formFocusesGaze"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" id="p1_startles1mNo"
                                    ...
                                    <%= props.getProperty("p1_startles1mNo", "") %>><fmt:message key="oscarEncounter.formRourke1.formSuddenNoise"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td><input type="radio" id="p1_sucks1mNo" name="p1_sucks1mNo"
                                    ...
                                    <%= props.getProperty("p1_sucks1mNo", "") %>><fmt:message key="oscarEncounter.formRourke1.formSucksWell"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
                        ...
                        <tr>
                            ...
                            <td><input type="radio" id="p1_noParentsConcerns1mNo"
                                       ...
                                       onclick="onCheck(this,'p1_noParentsConcerns1m')"
                                    <%= props.getProperty("p1_noParentsConcerns1mNo", "") %>><fmt:message key="oscarEncounter.formRourke1.formNoparentConcerns"/></td>
                        </tr>
                        <tr>
                            <td valign="top" class="edcol" colspan="2"><input
                                    class="delete" type="button" value="Del"
