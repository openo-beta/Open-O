...
<head>
    ...
    <script>
        ...
        function onHistory() {
            ...
            //alert(dd);
            popupPage("800", "1000", "billingONHistorySpec.jsp?demographic_no=<%=Encode.forJavaScript(String.valueOf(demo_no))%>&demo_name=<%=Encode.forJavaScript(String.valueOf(URLEncoder.encode(demoname,"UTF-8")))%>&orderby=appointment_date&day=" + dd);
        }
