    ...
    <table width="600" border="0">
        <tr>
            ...
            <td width="297"><font size="2"
                                  face="Arial, Helvetica, sans-serif"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgLastUpdate"/>: <%=Encode.forHtml(String.valueOf(_p0_0))%>
            </b></font></td>
        </tr>
    </table>
    <br>
    <table width="600" border="0">
        ...
        <tr>
            ...
            <td width="46%"><b><font face="Arial, Helvetica, sans-serif"
                                     size="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgHealthNo"/> : <%=Encode.forHtml(String.valueOf(_p0_2))%>
            </font></b></td>
        </tr>
        <tr bgcolor="#EEEEFF">
            <td><font size="2" face="Arial, Helvetica, sans-serif"><b><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgSex"/>: <%=Encode.forHtml(String.valueOf(_p0_15))%>
            </b></font></td>
            <td><font size="2"><b><font
                    face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgDOB"/> : <%=Encode.forHtml(String.valueOf(_p0_6))%>
            </font></b></font></td>
        </tr>
        <tr>
            <td><b><font size="2" face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgAddress"/>: <%=Encode.forHtml(String.valueOf(_p0_11))%>
            </font></b></td>
            <td><b><font size="2" face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgCity"/>: <%=Encode.forHtml(String.valueOf(_p0_13))%>
            </font></b></td>
        </tr>
        <tr bgcolor="#EEEEFF">
            <td><b><font size="2" face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgProvince"/>: <%=Encode.forHtml(String.valueOf(_p0_12))%>
            </font></b></td>
            <td><b><font size="2" face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgPostalCode"/>: <%=Encode.forHtml(String.valueOf(_p0_14))%>
            </font></b></td>
        </tr>
        <tr>
            <td><b><font size="2" face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgReferal"/>: <%=Encode.forHtml(String.valueOf(SxmlMisc.getXmlContent(billingDataBean.getContent(), "<rd>", "</rd>")))%>
            </font></b></td>
            <td><b><font size="2" face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgReferealNo"/>: <%=Encode.forHtml(String.valueOf(SxmlMisc.getXmlContent(billingDataBean.getContent(), "<rdohip>", "</rdohip>")))%>
            </font></b></td>
        </tr>
    </table>
    <table width="600" border="0">
        ...
        <tr>
            <td width="320"><strong><font size="2"
                                          face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgHCType"/>: <%=Encode.forHtml(String.valueOf(SxmlMisc.getXmlContent(billingDataBean.getContent(), "<hctype>", "</hctype>")))%>
            </font></strong></td>
        ...
        <tr bgcolor="#EEEEFF">
            ...
            <td><strong><font size="2"
                              face="Arial, Helvetica, sans-serif"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgRosterStatus"/>: <%=Encode.forHtml(String.valueOf(SxmlMisc.getXmlContent(billingDataBean.getContent(), "<xml_roster>", "</xml_roster>")))%>
            </font></strong></td>
        </tr>
    </table>
    <table width="600" border="0">
        ...
        <tr>
            <td width="54%"><b><font face="Arial, Helvetica, sans-serif"
                                     size="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgBillingType"/>: <%=Encode.forHtml(String.valueOf(_p0_5))%>
            </font></b></td>
            <td width="46%"><b><font face="Arial, Helvetica, sans-serif"
                                     size="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgBillingDate"/>: <%=Encode.forHtml(String.valueOf(_p0_9))%>
            </font></b></td>
        </tr>
        <tr bgcolor="#EEEEFF">
            <td width="54%"><b><font face="Arial, Helvetica, sans-serif"
                                     size="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgVisitLocation"/>: <%=Encode.forHtml(String.valueOf(_p0_8))%>
            </font></b></td>
            <td width="46%"><b><font face="Arial, Helvetica, sans-serif"
                                     size="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgBillingPhysicianNo"/>: <%=Encode.forHtml(String.valueOf(_p0_7))%>
            </font></b></td>
        </tr>
        <tr>
            <td width="54%"><b><font face="Arial, Helvetica, sans-serif"
                                     size="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgVisitType"/>: <%=Encode.forHtml(String.valueOf(_p0_3))%>
            </font></b></td>
            <td width="46%"><b><font face="Arial, Helvetica, sans-serif"
                                     size="2"><fmt:setBundle basename="oscarResources"/><fmt:message key="billing.billingCorrection.msgVisitDate"/>: <%=Encode.forHtml(String.valueOf(_p0_4))%>
            </font></b></td>
        </tr>
    </table>
    <table width="600" border="0">
