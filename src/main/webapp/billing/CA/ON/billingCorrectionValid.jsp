...
<%
    try {
        ...
        for (Enumeration f = request.getParameterNames(); f.hasMoreElements(); ) {
            ...
            if (strAuth != null) { //login successfully
                ...
                if (value.compareTo(".00") == 0) {
                    ...
                    //	billingunit = new BigDecimal(0).setScale(2,
                    // BigDecimal.ROUND_HALF_UP);
                    //	billingunit = new
                    // BigDecimal(Double.parseDouble(billunit)).setScale(2,
                    // BigDecimal.ROUND_HALF_UP);
                    //        otherunit2 = billingunit.multiply(otherunit2).setScale(2,
                    // BigDecimal.ROUND_HALF_UP);
        ...
        if (eFlag.compareTo("1") == 0) {
            ...
            //	percentPremium =
            // billingunit.multiply(percentPremium).setScale(2,
            // BigDecimal.ROUND_HALF_UP);
        ...
        if (xFlag.compareTo("1") == 0) {
            //	billingunit = new BigDecimal(0).setScale(2,
            // BigDecimal.ROUND_HALF_UP);
            //	billingunit = new BigDecimal().setScale(2,
            // BigDecimal.ROUND_HALF_UP);
