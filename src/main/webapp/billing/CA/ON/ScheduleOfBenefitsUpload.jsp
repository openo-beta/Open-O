...
<div>
1. Download the text file from <a href="https://www.health.gov.on.ca/en/pro/programs/ohip/sob/schedule_master/ohipfee_schedulemaster.txt" target="_blank">OHIP Fee Schedule</a> and save it to your computer.
</div><!--#1-->
