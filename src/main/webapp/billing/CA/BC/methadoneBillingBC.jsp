...
<link rel="stylesheet" href="<c:out value="${ oscar_context_path }/css/methadoneBillingBC.css" />" type="text/css" media="screen" />
		...
		<div id="header" class="bgLilac" >
			<ul>
			  <li>
				...
				<li>
				<input type="button" id="submitSearch" name="submitSearch" value="Search" onclick="javascript:form.submit();" />
				</li>
			</ul>
		</div>
		</form>
		...
		<div id="saved" style="display:none;">
			...
			<div id="inputList">
				<table>
					...
					<tr class="bgLilac"><th>HIN</th><th>Pt.Name</th><th>Service</th><th>DX Code</th><th>Total</th><th></th><th></th></tr>
