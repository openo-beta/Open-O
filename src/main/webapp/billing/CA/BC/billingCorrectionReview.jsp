...
<table width="600" border="0">
    ...
    <tr>
        ...
        <td width="270"><strong><font size="2"
            ...
            Review: <%=SxmlMisc.getXmlContent(billingDataBean.getContent(), "<mreview>", "</mreview>").equals("checked") ? "Yes" : "N/A"%>
        </font></strong></td>
    </tr>
    <tr bgcolor="#EEEEFF">
        <td><strong><font size="2"
                          face="Arial, Helvetica, sans-serif">Referral
            Doctor: <%=SxmlMisc.getXmlContent(billingDataBean.getContent(), "<xml_referral>", "</xml_referral>").equals("checked") ? "Yes" : "N/A"%>
        </font></strong></td>
        <td><strong><font size="2"
