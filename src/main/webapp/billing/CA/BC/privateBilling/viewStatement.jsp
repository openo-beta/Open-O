  ...
  <div class="container-fluid well">
    ...
    <div class="btn-toolbar" role="toolbar" arial-label="Toolbar">
      <div class="btn-group mr-2" role="group">Filter By:
        <select name="providerList" id="providerList" class="selectpicker" style="height:38px;margin-top:-1px;" onchange="handleFilterByProvider()">
    ...
    <table class="table table-condensed">
      ...
      <tbody>
        ...
        <c:forEach var="invoice" items="${bills}">
          ...
          <tr class="${rowstyle}">
            <td><input type="checkbox" class="case" value="${invoice.demographicNumber}|${invoice.recipientId}" onclick="checkMasterCheckbox();"/></td>
            ...
            <td>
              <button class="btn btn-primary btn-xs" value="${invoice.demographicNumber}|${invoice.recipientId}" onclick="printItem(this.value)">
                <span class="glyphicon glyphicon-print" aria-hidden="true"></span>
                print
              </button>
            </td>
