    ...
    <form action="${pageContext.request.contextPath}/billing/CA/BC/billingTeleplanCorrectionWCB.do" method="post">
        ...
        <table width="100%">
            <tr>
                <td colspan="2" class="SectionHead"><a href=#
                                                       onClick="popup(700,900,'<%= request.getContextPath() %>/demographic/demographiccontrol.jsp?demographic_no=<%=Encode.forUriComponent(String.valueOf(form.getDemographicNumber()))%>&displaymode=edit&dboperation=search_detail','
                    ...
                    Information</a> <input type="hidden" name="id" id="id" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getId()))%>"/>
                    <input type="hidden"
                           name="demographicNumber" id="demographicNumber"
                        value="<%=Encode.forHtmlAttribute(String.valueOf(form.getDemographicNumber()))%>"/></td>
            </tr>
            <tr>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td><input type="text" name="firstName"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getFirstName()))%>"/></td>
                        </tr>
                        <tr>
                            <td class="FormLabel">Middle Name:</td>
                            <td><input type="text" name="w_mname"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_mname()))%>"/></td>
                        </tr>
                        <tr>
                            <td class="FormLabel">Last Name:</td>
                            <td><input type="text" name="lastName"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getLastName()))%>"/></td>
                        </tr>
                        <tr>
                            <td class="FormLabel">Date Of Birth:</td>
                            <td><input type="text" name="yearOfBirth"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getYearOfBirth()))%>" maxlength="4" size="4"/>
                                <input type="text" name="monthOfBirth" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getMonthOfBirth()))%>"
                                    maxlength="2" size="2"/> <input type="text" name="dayOfBirth"
                                                                        value="<%=Encode.forHtmlAttribute(String.valueOf(form.getDayOfBirth()))%>" maxlength="2"
                                                                        size="2"/> Age:(
                                <%=Encode.forHtml(String.valueOf(form.getAge()))%> )
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabel">HIN (PHN):</td>
                            <td><input type="checkbox" name="hin" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getHin()))%>" /></td>
                        </tr>
                        <tr>
                            <td class="FormLabel">Gender:</td>
                            <td><input type="text" readonly="true" name="w_gender"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_gender()))%>"/></td>
                        </tr>
                    </table>
                </td>
                <td width="50%" align="left" valign="top">
                    <table width="100%">
                        <tr>
                            ...
                            <td><input type="checkbox" name="w_area" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_area()))%>" />
                            </td>
                        </tr>
                        <tr>
                            <td width="100" class="FormLabel">Phone:</td>
                            <td><input type="text" name="w_phone"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_phone()))%>"/></td>
                        </tr>
                        <tr>
                            <td width="100" class="FormLabel">Address:</td>
                            <td><input type="text" name="address"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getAddress()))%>"/></td>
                        </tr>
                        <tr>
                            <td width="100" class="FormLabel">City:</td>
                            <td><input type="checkbox" name="city" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getCity()))%>" />
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabel">Province:</td>
                            <td><input type="text" name="province"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getProvince()))%>"/></td>
                        </tr>
                        <tr>
                            <td width="100" class="FormLabel">Postal:</td>
                            <td><input type="checkbox" name="postal" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getPostal()))%>" />
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td><input type="text" name="w_empname"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_empname()))%>"/></td>
                                    </tr>
                                    <tr>
                                        <td class="FormLabel">Area:</td>
                                        <td><input type="text" name="w_emparea"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_emparea()))%>"/></td>
                                    </tr>
                                    <tr>
                                        <td class="FormLabel">Phone:</td>
                                        <td><input type="text" name="w_empphone"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_empphone()))%>"/></td>
                                    </tr>
                                </table>
                            </td>
                            <td width="50%" align="left" valign="top">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td><input type="text" name="w_opaddress"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_opaddress()))%>"/></td>
                                    </tr>
                                    <tr>
                                        <td width="175" class="FormLabel">Operating City:</td>
                                        <td><input type="text" name="w_opcity"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_opcity()))%>"/></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td><select name="w_capability"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_capability()))%>" id="w_capability">
                                <option value="Y">Yes</option>
                                <option value="N">No</option>
                            </select></td>
                            <td>Rehab:</td>
                            <td><select name="w_rehab" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_rehab()))%>"
                                             id="w_rehab">
                                <option value="Y">Yes</option>
                                <option value="N">No</option>
                            </select></td>
                        ...
                        <tr>
                            ...
                            <td><select name="w_rehabtype"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_rehabtype()))%>" id="w_rehabtype">
                                <option value="C">Work Conditioning</option>
                                <option value="O">Other</option>
                            </select></td>
                            <td>To Follow:</td>
                            <td><select name="w_tofollow"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_tofollow()))%>" id="w_tofollow">
                                <option value="Y">Yes</option>
                                <option value="N">No</option>
                            </select></td>
                        </tr>
            ...
            <td><select name="w_wcbadvisor"
                             value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_wcbadvisor()))%>" id="w_wcbadvisor">
                <option value="Y">Yes</option>
                <option value="N">No</option>
            </select></td>
            </tr>
        ...
        <table width="100%">
            <tr>
                <td colspan="2" class="SectionHead">Claim Information ( <%=Encode.forHtml(String.valueOf(form.getDataSequenceNo()))%>
                    )
                </td>
            </tr>
            <tr>
                <td width="50%" align="left" valign="top">
                    <table width="100%">
                        <tr>
                            ...
                            <td><input type="text" name="w_wcbno"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_wcbno()))%>"/></td>
                        </tr>
                        <tr>
                            ...
                            <td><select style="font-size:80%;" name="providerNo"
                                ...
                                %>
                                <option value="<%=Encode.forHtmlAttribute(String.valueOf(proOHIP))%>"><%=Encode.forHtml(String.valueOf(proOHIP))%>                    |
                                    <%=Encode.forHtml(String.valueOf(proLast))%>                    ,
                        ...
                        <tr>
                            ...
                            <td><%=Encode.forHtml(String.valueOf(form.getW_pracno()))%>
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabel">Payee Num:</td>
                            <td><%=Encode.forHtml(String.valueOf(form.getW_payeeno()))%>
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabel">Regular Physician:</td>
                            <td><select name="w_rphysician"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_rphysician()))%>" id="w_rphysician">
                                <option value="Y">Yes</option>
                                <option value="N">No</option>
                            </select></td>
                        </tr>
                        <tr>
                            ...
                            <td><select name="w_duration"
                                             value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_duration()))%>" id="w_duration">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="billingUnit"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getBillingUnit()))%>"/></td>
                        </tr>
                        <!--<tr>

					<td class="FormLabel">Billing Code:</td>

					<td><input type="checkbox" name="billingCode" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getBillingCode()))%>" />
					...
					<a onClick="popup('400', '600', 'support/billingcodes.jsp?form=TeleplanCorrectionFormWCB&field=billingCode', 'Code');">Service</a>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="billingAmount"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getBillingAmount()))%>"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="w_icd9" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_icd9()))%>" />
                                <a onClick="popICD9List('TeleplanCorrectionFormWCB','w_icd9');">Codes</a>
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabel">Body Part:</td>
                            <td><input type="checkbox" name="w_bp" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_bp()))%>" />
                        ...
                        <tr>
                            ...
                            <td colspan="2"><select name="w_side"
                                                         value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_side()))%>" id="w_side">
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="w_noi" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_noi()))%>" />
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="w_feeitem"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_feeitem()))%>"/> <a
					...
					<td><input type="checkbox" name="w_extrafeeitem" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_extrafeeitem()))%>" />
					...
					<a onClick="popup('400', '600', 'support/billingfeeitem.jsp?info=all&form=TeleplanCorrectionFormWCB&field=w_extrafeeitem', 'eFeeItem');">Codes</a></td>
                        ...
                        <tr>
                            ...
                            <td><select name="serviceLocation"
                                             style="font-size:80%;" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getServiceLocation()))%>">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="w_reporttype"
                                           value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_reporttype()))%>"/></td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <jsp:include flush="false" page="billType_frag.jsp">
                                    <jsp:param name="BillType" value="<%=Encode.forHtmlAttribute(String.valueOf(status))%>"/>
                                </jsp:include>
                            </td>
                        </tr>
                    </table>
                            ...
                            <td>
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <select name="w_work" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_work()))%>" property="w_work">
                                                <option value="Y">Yes</option>
                                                <option value="N">No</option>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" readonly="readonly" name="w_doi" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_doi()))%>"
                                                       id="w_doi"/>
                                            <a id="hlIDate">Date</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" readonly="readonly" name="w_servicedate"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_servicedate()))%>" id="w_servicedate"/>
                                            <a id="hlSDate">Date</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" readonly="readonly" name="w_workdate"
                                                       value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_workdate()))%>" id="w_workdate"/>
                                            <a id="hlWDate">Date</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="w_estimate" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getW_estimate()))%>">
            ...
            <tr valign="top">
                ...
                <td>
                    <jsp:include flush="false" page="billTransactions.jsp">
                        <jsp:param name="billNo" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getBillingNo()))%>"/>
                    </jsp:include>
                </td>
            </tr>
        </table>
        ...
        <input type="hidden" name="billingNo" id="billingNo" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getBillingNo()))%>"/>
        <input type="hidden" name="id" id="id" value="<%=Encode.forHtmlAttribute(String.valueOf(form.getId()))%>"/>
        <table width="100%">
            <tr>
                <td colspan="2" align="center" class="SectionHead"><a
                        href="billingTeleplanCorrectionWCB.jsp?billing_no=<%=Encode.forUriComponent(String.valueOf(form.getId()))%>">Refresh</a>
