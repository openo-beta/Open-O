    ...
    <form>
      ...
      %>
        <tr>
            ...
            <td width="10%" height="16" align=right><%=Encode.forHtml(String.valueOf(moneyFormat(result.getPaidAmount())))%>
            </td>
        </tr>
