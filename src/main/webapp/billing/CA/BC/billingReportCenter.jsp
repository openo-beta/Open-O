...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" rightmargin="0"
      topmargin="10">
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="align-content: start;">
    <tr bgcolor="#FFFFFF">
...
<%--		<td width="25%" align="center"><font size="2" color="#333333"--%>
			...
			<input type="radio" name="reportAction" value="unbilled"> Unbilled
		...
		<td width="25%">
			<input type="text" name="xml_vdate" value="<%=Encode.forHtmlAttribute(String.valueOf(xml_vdate))%>">
				<font size="1" face="Arial, Helvetica, sans-serif">
					<a href="#" onClick="openBrWindow('billingCalendarPopup.jsp?type=&returnItem=xml_vdate&returnForm=serviceform&year=<%=Encode.forUriComponent(String.valueOf(curYear))%>&month=<%=Encode.forUriComponent(String.valueOf(curMonth))%>','','width=300,height=300')">Begin:</a>
				</font>
		</td>
		<td width="25%">
			<div >
                        <%--			<fontface="Verdana, Arial, Helvetica, sans-serif" size="2" color="#333333"><b>Select
        ...
        <tr>
            ...
            <td width="25%"><font color="#333333" size="2"
