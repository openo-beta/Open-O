...
//                                    }
                            ...
                            <tr>
                                ...
                                <td>
                                    <%
                                        String url = "ManageDocument.do?method=display&documentId=" + curdoc.getDocId() + "&documentDescription=" + curdoc.getDescription() + "&demog=" + moduleid + "&demoName=" + moduleName + "&docType=" + curdoc.getType() + "&observationDate=" + curdoc.getObservationDate() + "&providerNo=" + user_no + "&status=" + curdoc.getStatus() + (curdoc.getRemoteFacilityId() != null ? "&remoteFacilityId=" + curdoc.getRemoteFacilityId() : "");
                                    %>
