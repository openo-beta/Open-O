        ...
        <tr>
            <td align="left" valign="top" style="width: 400px">
                ...
                <fieldset>
                    ...
                    | <a
                        href="#"
                        onclick="LoadView('<%=Encode.forJavaScript(String.valueOf((String) doctypes.get(i3)))%>')"><%=view.equals((String) doctypes.get(i3)) ? "<b>" : ""%><%=Encode.forHtml(String.valueOf((String) doctypes.get(i3)))%><%=view.equals((String) doctypes.get(i3)) ? "</b>" : ""%>
                </a>
                    <%}%>
                </fieldset>
