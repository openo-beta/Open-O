...
<%
    ...
    String url = cp + "/documentManager/ManageDocument.do?method=viewDocPage&doc_no=" + docId + "&doc_desc=" + docDesc + "&curPage=1";
    String url2 = cp + "/documentManager/ManageDocument.do?method=display&doc_no=" + docId + "&doc_desc=" + docDesc;
