...
<form name="addToIntakeFrm" method="post" action="AddToIntake.jsp"
    ...
    +<input type="radio" id="elementType" name="elementType" value="6" onclick="mandSet(1);">answer compound</input>
    <br/>
    +<input type="radio" id="elementType" name="elementType" value="7" onclick="mandSet(0);">answer scalar
    choice</input> <br/>
    +<input type="radio" id="elementType" name="elementType" value="15" onclick="mandSet(0); makeDropbox();"> answer
    scalar choice (dropbox)</input> <br/>
    +<input type="radio" id="elementType" name="elementType" value="8" onclick="mandSet(0);">answer scalar text</input>
    <br/>
    +<input type="radio" id="elementType" name="elementType" value="13" onclick="mandSet(0);">answer scalar note</input>
    <br/>
    ...
    +<input type="radio" id="elementType" name="elementType" value="15" onclick="makeDropbox();"> answer scalar choice
    (dropbox)</input> <br/>
