        ...
        <tr>
            <td>
                <select name="box_item" size="9" onchange="copy_s(selectedIndex);">
                    ...
                    <option value="<%=ie.getId()%>"    <%=(ie.getId() == slct) ? "selected" : ""%>><%=ie.getElement()%>
                    </option>
                    <% } %>
                </select>
                <div style="display:none;">
                    <select name="box_item_2" size="9">
                        <% for (IntakeAnswerElement ie : items) { %>
                        <option value="<%=ie.getId()%>"    <%=(ie.getId() == slct) ? "selected" : ""%>><%=ie.getLabel()%>
                        </option>
                        <% } %>
                    </select>
                </div>
            ...
            <td>
                <input type="button" value="Move Up"
                       onclick="move('up', box_item.value);move('up', box_item_2.value);"/> <br>
                <input type="button" value="Move Down"
                       onclick="move('down', box_item.value);move('up', box_item_2.value);"/>
            </td>
        </tr>
        <tr>
            <td colspan="2">
