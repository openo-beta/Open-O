    ...
    <table cellpadding="0" cellspacing="0" width="40%" style="text-indent: 2px;">
        ...
        <tr style="background-color: #C2DFFF">
            <td>
                <table cellpadding="0" cellspacing="0" style="text-indent: 2px;">
                    ...
                    <tr>
                        <td>Facility(All clients in facility will be exported):&nbsp;</td>
                        <td>
        ...
        <tr style="background-color: #C2DFFF">
            <td>
                <table cellpadding="0" cellspacing="0" style="text-indent: 2px;">
                    <tr>
                        <td>Files to export:</td>
                    </tr>
                    <tr>
                        <td><input name="ai" type="checkbox" checked="checked">Agency Information</td>
                    </tr>
                    <tr>
                        <td><input name="lp" type="checkbox" checked="checked">List Of Programs</td>
                    </tr>
                    <tr>
                        <td><input name="mn" type="checkbox" checked="checked">Main</td>
                    </tr>
                    <tr>
                        <td><input name="pi" type="checkbox" checked="checked">Program Information</td>
                    </tr>
                    <tr>
                        <td><input name="gf" type="checkbox" checked="checked">Gambling Form</td>
                    </tr>
                    <tr>
                        <td><input name="nc" type="checkbox" checked="checked">Non Client Services</td>
                    </tr>
                </table>
            </td>
        </tr>
