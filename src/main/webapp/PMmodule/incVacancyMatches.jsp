    ...
    <tr>
        <td height="100%" width="30%">
            <table border="0" rules="rows" width="100%" height="50%">
                ...
                <tr width="100%">
                    <td><c:out value="${vacancyClientMatchForm.vacancy}"/></td>
                </tr>
            </table>
            <table border="0" rules="rows" width="100%" height="50%">
                <thead>
                ...
                <tr>
                    <td><c:out value="${vacancyClientMatchForm.template}"/></td>
                </tr>
            </table>
        </td>
    ...
    <td>
        ...
        <c:if test="${not empty requestScope.clientList}">
            <display:table class="simple" cellspacing="2" cellpadding="3"
                ...
                <display:column sortable="true" title="Days in WL" sortProperty="daysInWaitList"
                                defaultorder="ascending">
                    <c:out value="${client.daysInWaitList}"/>
                </display:column>

                <display:column sortable="true" title="Days since last contact" sortProperty="daysSinceLastContact"
                                defaultorder="ascending">
