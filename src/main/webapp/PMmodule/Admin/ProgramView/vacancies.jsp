    ...
    <tr class="b">
        ...
        <td>
            <select onchange="filterByStatus()" name="statusFilter" id="statusFilter">
                <option value="Active" <%=(statusFilter != null && statusFilter.equals("Active")) ? "selected=\"selected\"" : "" %>>
                    Active
                </option>
                <option value="Filled" <%=(statusFilter != null && statusFilter.equals("Filled")) ? "selected=\"selected\"" : "" %>>
                    Filled
                </option>
                <option value="Withdrawn" <%=(statusFilter != null && statusFilter.equals("Withdrawn")) ? "selected=\"selected\"" : "" %>>
                    Withdrawn
                </option>
                <option value=""  <%=(statusFilter != null && statusFilter.equals("")) ? "selected=\"selected\"" : "" %>>
                    Any
                </option>
            </select>
        </td>
    ...
    <tr class="b">
        ...
        <td style="text-align:center;">
            <select name="status" id="status<%=v.getId()%>">
                ...
                <option value="Withdrawn" <%=(v.getStatus().equals("Withdrawn")) ? "selected=\"selected\"" : "" %>>
                    Withdrawn
                </option>
            </select>
            &nbsp;
