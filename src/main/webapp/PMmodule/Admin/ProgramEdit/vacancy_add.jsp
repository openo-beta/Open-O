...
<table width="100%" border="1" cellspacing="2" cellpadding="3">
    ...
    <tr class="b">
        ...
        <td><input type="text" name="vacancyName" value="<%=Encode.forHtmlAttribute(String.valueOf(vacancyName))%>"
    ...
    <table width="100%" border="1" cellspacing="2" cellpadding="3">
        <tr class="b">
            ...
            <td><select name="vacancyStatus">
                <option value="Active" <%=(vacancyStatus.equalsIgnoreCase("Active")) ? "selected" : "" %> >Active
                </option>
                <option value="Withdrawn" <%=(vacancyStatus.equalsIgnoreCase("Withdrawn")) ? "selected" : "" %> >
                    Withdrawn
                </option>
                <option value="Filled" <%=(vacancyStatus.equalsIgnoreCase("Filled")) ? "selected" : "" %>>Filled
                </option>
            </td>
        </tr>
        <tr class="b">
