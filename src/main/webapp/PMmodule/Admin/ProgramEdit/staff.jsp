...
<!-- show current staff -->
<display:table class="simple" cellspacing="2" cellpadding="3" id="provider" name="providers" export="false" pagesize="0"
    ...
    <display:column sortable="false" title="">
        <a href="javascript:void(0);" onclick="deleteProvider('<c:out value="${provider.id}"/>');return false;">
            Delete </a>
    </display:column>
        ...
        <table width="100%" cellspacing="2" cellpadding="2">
            <c:forEach var="team" items="${provider.teams}">
                <tr>
                    ...
                    <td><a href="javascript:void(0);" onclick="removeTeam('<c:out value="${provider.id}"/>','<c:out
                            value="${team.id}"/>');return false;">Remove</a>
                </tr>
            </c:forEach>
        </table>
