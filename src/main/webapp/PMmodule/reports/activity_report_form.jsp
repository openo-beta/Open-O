    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="submit" value="export"
                       onclick="window.open('<%=request.getContextPath()%>/common/progress_dialog.jsp', '', 'height=300,width=500,location=no,scrollbars=no,menubars=no,toolbars=no,resizable=yes,top=200,left=400')"/>
            </td>
        </tr>
    </table>
</form>
        ...
        <tr style="vertical-align:top">
            ...
            <td>
                <select name="secRoleId">
                    ...
                    %>
                    <option value="<%=secRole.getId() %>"><%=secRole.getName()%>
                    </option>
                    <%
                        }
                    %>
            ...
            <td>
                ...
                <input type="submit" value="export"
                       onclick="alert('This report can take a while, please be patient.')"/>
            </td>
        </tr>
    </table>
</form>
