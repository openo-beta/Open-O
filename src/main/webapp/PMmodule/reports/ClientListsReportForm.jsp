    ...
    <table border="0" cellspacing="2" cellpadding="3">
        <tr>
            ...
            <td><select name="form.admissionStatus">
                ...
                %>
                <option value="<%=patientStatus.name()%>"><%=patientStatus.name()%>
                </option>
                <%
                    }
                %>
        ...
        <tr>
            ...
            <td><select name="form.providerId">
                ...
                %>
                <option value="<%=provider.getProviderNo()%>"><%=provider.getFormattedName()%>
                </option>
                <%
                    }
                %>
        ...
        <tr>
            ...
            <td>Start Date <input type="text" name="form.enrolledStartDate"
                                  size="15"/> (yyyy-mm-dd) - End Date <input type="text"
                                                                             name="form.enrolledEndDate" size="15"/>
                (yyyy-mm-dd)
            </td>
        </tr>
