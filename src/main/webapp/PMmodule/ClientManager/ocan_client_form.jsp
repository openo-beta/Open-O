...
<form id="ocan_client_form" name="ocan_client_form" action="ocan_client_form_action.jsp" method="post"
      onsubmit="return submitOcanClientForm()">
    ...
    <input type="hidden" id="completionDate" name="completionDate"
           value="<%=ocanStaffForm.getFormattedCompletionDate()%>"/>
    ...
    <table style="margin-left:auto;margin-right:auto;background-color:#f0f0f0;border-collapse:collapse">
        ...
        <tr>
            ...
            <td class="genericTableData">
                <input id="clientStartDate" name="clientStartDate" onfocus="this.blur()" readonly="readonly"
        ...
        <tr>
            ...
            <td class="genericTableData" class="{validate: {required:true}}">
                <input type="text" name="client_date_of_birth" id="client_date_of_birth"
                       value="<%=ocanStaffForm.getClientDateOfBirth()%>" class="{validate: {required:true}}"/>
            </td>
        </tr>
        ...
        <tr>
            <td class="genericTableHeader">1. Do you have any dependents other than children under 18, such as an
                elderly parent or beloved pet?
            </td>
            <td class="genericTableData">
            ...
            <td class="genericTableData">
                <input id="clientCompletionDate" name="clientCompletionDate" onfocus="this.blur()" readonly="readonly"
                       type="text" value="<%=ocanStaffForm.getFormattedClientCompletionDate()%>"> <img title="Calendar"
                                                                                                       ...
                                                                                                       border="0">
                <script type="text/javascript">Calendar.setup({
                    inputField: 'clientCompletionDate',
                    ifFormat: '%Y-%m-%d',
