...
<display:table class="simple" name="serviceAdmissions" uid="admission"
    ...
    <caisi:isModuleLoad moduleName="TORONTO_RFQ" reverse="true">
        <display:column sortable="false">
            <input type="button" value="Discharge"
                   onclick="select_program('<c:out value="${admission.programId}"/>','<c:out
                           value="${admission.id}"/>')"/>
        </display:column>
    </caisi:isModuleLoad>
...
<c:if test="${requestScope.do_discharge != null}">
    ...
    <table width="100%" border="1" cellspacing="2" cellpadding="3">
        ...
        <tr>
            ...
            <td><input id="dischargeDate" name="dischargeDate" onfocus="this.blur()" readonly="readonly" type="text"
                       value='<c:out value="${admission.formattedDischargeDate}"/>'> <img title="Calendar"
                                                                                          id="cal_dischargeDate"
                                                                                          src="<%=request.getContextPath()%>/images/cal.gif"
                                                                                          alt="Calendar" border="0">
                <script type="text/javascript">Calendar.setup({
                    inputField: 'dischargeDate',
                    ifFormat: '%Y-%m-%d',
                    button: 'cal_dischargeDate',
                    align: 'cr',
                    singleClick: true,
                    firstDay: 1
                });</script>
