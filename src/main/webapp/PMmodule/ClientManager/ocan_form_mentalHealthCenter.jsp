...
<div id="center_<%=centerNumber%>">
    <table>
        <tr>
            <td colspan="2">Mental Health Functional Centre <%=centerNumber %>
            </td>
        </tr>
        <tr>
            <td class="genericTableHeader">OCAN Lead</td>
            <td class="genericTableData">
                <select name="serviceUseRecord_OCANLead<%=centerNumber %>"
                        id="serviceUseRecord_OCANLead<%=centerNumber %>" class="{validate: {required:true}}">
        ...
        <tr>
            ...
            <td class="genericTableData">
                <select name="serviceUseRecord_orgLHIN<%=centerNumber %>"
                        id="serviceUseRecord_orgLHIN<%=centerNumber %>" onchange="changeOrgLHIN(this);"
        ...
        <tr>
            ...
            <td class="genericTableData">
                <select name="serviceUseRecord_service_delivery_lhin<%=centerNumber %>"
                        class="{validate: {required:true}}">
        ...
        <tr>
            ...
            <td class="genericTableData">
                <select name="serviceUseRecord_source_of_referral<%=centerNumber %>"
                        class="{validate: {required:true}}">
        ...
        <tr>
            ...
            <td class="genericTableData">
                <select name="serviceUseRecord_exitDisposition<%=centerNumber %>"
                        id="serviceUseRecord_exitDisposition<%=centerNumber %>">
