                ...
                <select name="admissionId">
                    <%
                        for (Admission admission : CdsForm4.getAdmissions(loggedInInfo.getCurrentFacility().getId(), currentDemographicId)) {
                            ...
                            if (cdsClientForm.getAdmissionId() != null && cdsClientForm.getAdmissionId().intValue() == admission.getId().intValue())
            ...
            <td class="genericTableData">
                <table>
                    <tr>
                        ...
                        <td><input type="text" name="initialContactDate" id="initialContactDate"
                                   value="<%=CdsForm4.getDateAsISOString(cdsClientForm.getInitialContactDate())%>"
                                   size="10"> <img src="<%=request.getContextPath()%>/images/cal.gif"
                                                   id="initialContactDate_cal"></td>
                    </tr>
                    <tr>
                        <td>Date of assessment / interview</td>
                        <td><input type="text" name="assessmentDate" id="assessmentDate"
                                   value="<%=CdsForm4.getDateAsISOString(cdsClientForm.getAssessmentDate())%>"
                                   size="10"> <img src="<%=request.getContextPath()%>/images/cal.gif"
                                                   id="assessmentDate_cal"></td>
                    </tr>
                </table>

                <script type="text/javascript">
                    Calendar.setup({
                        inputField: "initialContactDate",
                        ifFormat: "%Y-%m-%d",
                        showsTime: false,
                        button: "initialContactDate_cal",
                        singleClick: true,
                        step: 1
                    });
                    Calendar.setup({
                        inputField: "assessmentDate",
                        ifFormat: "%Y-%m-%d",
                        showsTime: false,
                        button: "assessmentDate_cal",
                        singleClick: true,
                        step: 1
                    });
                </script>
        ...
        <tr>
            <td class="genericTableHeader">
                ...
                <div style="font-weight:normal;font-size:smaller">
                    This shows all historical hospitalisations, the correct ones for the report will be automatically
                    calculated for base line (20) and current (21).
                    <br/><br/>
            ...
            <td class="genericTableData">
                <table>
                    <tr>
                        ...
                        <td>
                            Refused To Answer : <input type="checkbox"
                                                       name="refused21" <%="on".equals(CdsForm4.getSingleAnswer(cdsClientForm.getId(), "refused21")) ? "checked=\"checked\"" : ""%> />
                            <br/><br/>
                            <table style="border-collapse:collapse;border:solid black 1px">
                                <tr>
                                    <td class="genericTableHeader" style="border:solid black 1px;text-align:center"
                                        colspan="2">Add
                                    </td>
                                </tr>
                                <tr>
                                    <td>Admission Date</td>
                                    <td><input type="text" name="hospitalAdmission" id="hospitalAdmission" value=""
                                               size="10"> <img src="<%=request.getContextPath()%>/images/cal.gif"
                                                               id="hospitalAdmission_cal"></td>
                                </tr>
                                <tr>
                                    <td>Discharge Date</td>
                                    <td><input type="text" name="hospitalDischarge" id="hospitalDischarge" value=""
                                               size="10"> <img src="<%=request.getContextPath()%>/images/cal.gif"
                                                               id="hospitalDischarge_cal"></td>
                                </tr>
                                <tr>
                                    <td></td>
                            ...
                            <script type="text/javascript">
                                Calendar.setup({
                                    inputField: "hospitalAdmission",
                                    ifFormat: "%Y-%m-%d",
                                    showsTime: false,
                                    button: "hospitalAdmission_cal",
                                    singleClick: true,
                                    step: 1
                                });
                                Calendar.setup({
                                    inputField: "hospitalDischarge",
                                    ifFormat: "%Y-%m-%d",
                                    showsTime: false,
                                    button: "hospitalDischarge_cal",
                                    singleClick: true,
                                    step: 1
                                });
                                    ...
                                    var ajaxArgs =
                                        {
                                            ...
                                            parameters: {
                                                clientId: <%=currentDemographicId%>,
                                                hospitalAdmission: $(hospitalAdmission).value,
                                                hospitalDischarge: $(hospitalDischarge).value
                                            },
                                            asynchronous: false,
                                            onSuccess: updateHospitalisedListDisplay,
                                            onFailure: function (transport) {
        ...
        <tr style="background-color:white">
            <td colspan="2">
                ...
                Sign <input type="checkbox"
                            name="signed" <%=printOnly && cdsClientForm.isSigned() ? "checked=\"checked\"" : ""%>/>
