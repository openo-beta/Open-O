...
<script type="text/javascript"
        src="<%=request.getContextPath()%>/PMmodule/ClientManager/ocan_staff_form_validation.js"></script>
...
<form id="ocan_staff_form" name="ocan_staff_form" action="ocan_form_action.jsp" method="post"
      onsubmit="return submitOcanForm()">
    ...
    <br/>
    <% } %>
    <input type="hidden" name="client_date_of_birth" id="client_date_of_birth"
           value="<%=ocanStaffForm.getClientDateOfBirth()%>"/>
    <input type="hidden" id="clientStartDate" name="clientStartDate"
           value="<%=ocanStaffForm.getFormattedClientStartDate()%>"/>
    <input type="hidden" id="clientCompletionDate" name="clientCompletionDate"
           value="<%=ocanStaffForm.getFormattedClientCompletionDate()%>"/>
    <% if (prepopulate == 1) { %>
    ...
    <input type="hidden" name="client_1_1" id="client_1_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_1_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_1_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_1_comments" id="client_1_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_1_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_1_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_2_1" id="client_2_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_2_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_2_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_2_comments" id="client_2_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_2_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_2_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_3_1" id="client_3_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_3_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_3_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_3_comments" id="client_3_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_3_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_3_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_4_1" id="client_4_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_4_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_4_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_4_comments" id="client_4_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_4_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_4_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_5_1" id="client_5_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_5_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_5_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_5_comments" id="client_5_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_5_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_5_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_6_1" id="client_6_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_6_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_6_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_6_comments" id="client_6_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_6_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_6_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_7_1" id="client_7_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_7_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_7_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_7_comments" id="client_7_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_7_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_7_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_8_1" id="client_8_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_8_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_8_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_8_comments" id="client_8_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_8_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_8_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_9_1" id="client_9_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_9_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_9_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_9_comments" id="client_9_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_9_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_9_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_10_1" id="client_10_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_10_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_10_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_10_comments" id="client_10_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_10_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_10_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_11_1" id="client_11_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_11_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_11_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_11_comments" id="client_11_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_11_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_11_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_12_1" id="client_12_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_12_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_12_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_12_comments" id="client_12_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_12_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_12_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_13_1" id="client_13_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_13_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_13_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_13_comments" id="client_13_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_13_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_13_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_14_1" id="client_14_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_14_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_14_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_14_comments" id="client_14_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_14_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_14_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_15_1" id="client_15_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_15_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_15_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_15_comments" id="client_15_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_15_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_15_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_16_1" id="client_16_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_16_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_16_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_16_comments" id="client_16_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_16_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_16_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_17_1" id="client_17_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_17_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_17_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_17_comments" id="client_17_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_17_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_17_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_18_1" id="client_18_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_18_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_18_1", prepopulationLevel).get(0).getAnswer():""%>"/>


    <input type="hidden" name="client_18_comments" id="client_18_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_18_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_18_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_19_1" id="client_19_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_19_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_19_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_19_comments" id="client_19_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_19_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_19_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_20_1" id="client_20_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_20_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_20_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_20_comments" id="client_20_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_20_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_20_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_21_1" id="client_21_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_21_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_21_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_21_comments" id="client_21_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_21_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_21_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_22_1" id="client_22_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_22_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_22_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_22_comments" id="client_22_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_22_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_22_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_23_1" id="client_23_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_23_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_23_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_23_comments" id="client_23_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_23_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_23_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_24_1" id="client_24_1"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_24_1", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_24_1", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_24_comments" id="client_24_comments"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_24_comments", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_24_comments", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_hopes_future" id="client_hopes_future"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_hopes_future", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_hopes_future", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_hope_future_need" id="client_hope_future_need"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_hope_future_need", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_hope_future_need", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_view_mental_health" id="client_view_mental_health"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_view_mental_health", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_view_mental_health", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_sprituality" id="client_sprituality"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_sprituality", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_sprituality", prepopulationLevel).get(0).getAnswer():""%>"/>

    <input type="hidden" name="client_culture_heritage" id="client_culture_heritage"
           value="<%=OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_culture_heritage", prepopulationLevel).size()>0?OcanForm.getStaffAnswers(ocanStaffForm.getId(), "client_culture_heritage", prepopulationLevel).get(0).getAnswer():""%>"/>
    ...
    <table style="margin-left:auto;margin-right:auto;background-color:#f0f0f0;border-collapse:collapse">
        ...
        <tr>
            ...
            <td class="genericTableData">
                <input id="completionDate" name="completionDate" onfocus="this.blur()" readonly="readonly"
                       class="{validate: {required:true}}" type="text"
        ...
        <tr>
            ...
            <td class="genericTableData">
                <select name="reasonForAssessment" id="reasonForAssessment" class="{validate: {required:true}}">
                    ...
                    %>
                    <option <%=selected%>
                            value="<%=option.getOcanDataCategoryValue()%>"><%=option.getOcanDataCategoryName()%>
                    </option>
                    <%
                        }
                    %>
        ...
        <tr>
            <td class="genericTableHeader">If the Consumer Self-Assessment was not completed, why not? (select all that
                apply)
            </td>
            <td class="genericTableData">
        ...
        <tr>
            ...
            <td class="genericTableData">
                <input type="text" name="lastName" id="lastName" value="<%=ocanStaffForm.getLastName()%>" size="32"
                       maxlength="32"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="genericTableData">
                <input type="text" name="firstName" id="firstName" value="<%=ocanStaffForm.getFirstName()%>" size="32"
                       maxlength="32"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="genericTableData">
                <input type="text" name="postalCode" id="postalCode" value="<%=ocanStaffForm.getPostalCode()%>" size="8"
                       maxlength="8" class="{validate: {postalCode:true}}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="genericTableData">
                <input type="text" name="email" id="email" value="<%=ocanStaffForm.getEmail()%>" size="64"
                       maxlength="64"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="genericTableData">
                <input type="text" name="hcNumber" id="hcNumber" value="<%=ocanStaffForm.getHcNumber()%>" size="32"
                       maxlength="32"/>
                <input type="text" name="hcVersion" id="hcVersion" value="<%=ocanStaffForm.getHcVersion()%>" size="8"
                       maxlength="8"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="genericTableHeader">Do you have any issues with your immigration experience? (Select all that
                apply)
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with accommodation does the person receive from friends or
                relatives?
            </td>
            <td class="genericTableData">
                <select name="1_2" id="1_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with accommodation does the person receive from local
                services?
            </td>
            <td class="genericTableData">
                <select name="1_3a" id="1_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with accommodation does the person need from local
                services?
            </td>
            <td class="genericTableData">
                <select name="1_3b" id="1_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with getting enough to eat does the person receive from
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with getting enough to eat does the person receive from
                local services?
            </td>
            <td class="genericTableData">
                <select name="2_3a" id="2_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with getting enough to eat does the person need from local
                services?
            </td>
            <td class="genericTableData">
                <select name="2_3b" id="2_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with looking after the home does the person receive from
                friends or relatives?
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with looking after the home does the person receive from
                local services?
            </td>
            <td class="genericTableData">
                <select name="3_3a" id="3_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with looking after the home does the person need from local
                services?
            </td>
            <td class="genericTableData">
                <select name="3_3b" id="3_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with self-care does the person receive from friends or
                relatives?
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with self-care does the person receive from local
                services?
            </td>
            <td class="genericTableData">
                <select name="4_3a" id="4_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with self-care does the person need from local services?
            </td>
            <td class="genericTableData">
                <select name="4_3b" id="4_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">1. Does the person have difficulty with regular, appropriate daytime
                activities?
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives in finding
                and keeping regular and appropriate daytime activities?
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services in finding and
                keeping regular and appropriate daytime activities?
            </td>
            <td class="genericTableData">
                <select name="5_3a" id="5_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services in finding and
                keeping regular and appropriate daytime activities?
            </td>
            <td class="genericTableData">
                <select name="5_3b" id="5_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            ...
            <td class="genericTableData">
                <select name="5_education_program_status" id="5_education_program_status"
                        class="{validate: {required:true}}">
        ...
        <tr>
            <td class="genericTableHeader">Barriers in finding and/or maintaining a work/volunteer/education role
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives for
                physical health problems?
            </td>
            <td class="genericTableData">
                <select name="6_2" id="6_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services for physical
                health problems?
            </td>
            <td class="genericTableData">
                <select name="6_3a" id="6_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services for physical
                health problems?
            </td>
            <td class="genericTableData">
                <select name="6_3b" id="6_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            ...
            <td class="genericTableData">
                <select name="6_physical_health_concerns" id="6_physical_health_concerns"
                        class="{validate: {required:true}}">
        ...
        <tr>
            <td class="genericTableHeader">If Yes, please indicate the areas where you have concerns (Select all that
                apply)
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td colspan="2">
                <p>List of all current medications (including prescribed and alternative/over the counter medication)
                    This information is collected from a variety of sources, including self-report, and should be
                    confirmed by a qualified prescribing practitioner.
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives for these
                psychotic symptoms?
            </td>
            <td class="genericTableData">
                <select name="7_2" id="7_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services for these
                psychotic symptoms?
            </td>
            <td class="genericTableData">
                <select name="7_3a" id="7_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services for these
                psychotic symptoms?
            </td>
            <td class="genericTableData">
                <select name="7_3b" id="7_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">Have you been hospitalized due to your mental health during the past two
                years?
            </td>
            <td class="genericTableData">
                <select name="hospitalized_mental_illness" id="hospitalized_mental_illness"
                        class="{validate: {required:true}}">
        ...
        <tr>
            <td class="genericTableHeader">How many times did you visit an Emergency Department in the last 6 months for
                Mental Health Reasons?
            </td>
            <td class="genericTableData">
                <select name="visitEmergencyDepartment" id="visitEmergencyDepartment"
                        class="{validate: {required:true}}">
        ...
        <tr>
            <td class="genericTableHeader">1. Has the person had clear verbal or written information about condition and
                treatment?
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives in
                obtaining such information?
            </td>
            <td class="genericTableData">
                <select name="8_2" id="8_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services in obtaining
                such information?
            </td>
            <td class="genericTableData">
                <select name="8_3a" id="8_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services in obtaining such
                information?
            </td>
            <td class="genericTableData">
                <select name="8_3b" id="8_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives for this
                distress?
            </td>
            <td class="genericTableData">
                <select name="9_2" id="9_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services for this
                distress?
            </td>
            <td class="genericTableData">
                <select name="9_3a" id="9_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services for this
                distress?
            </td>
            <td class="genericTableData">
                <select name="9_3b" id="9_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives to reduce
                the risk of self-harm?
            </td>
            <td class="genericTableData">
                <select name="10_2" id="10_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services to reduce the
                risk of self-harm?
            </td>
            <td class="genericTableData">
                <select name="10_3a" id="10_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services to reduce the risk
                of self-harm?
            </td>
            <td class="genericTableData">
                <select name="10_3b" id="10_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives to reduce
                the risk that he or she might harm someone else?
            </td>
            <td class="genericTableData">
                <select name="11_2" id="11_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services to reduce the
                risk that he or she might harm someone else?
            </td>
            <td class="genericTableData">
                <select name="11_3a" id="11_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services to reduce the risk
                that he or she might harm someone else?
            </td>
            <td class="genericTableData">
                <select name="11_3b" id="11_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">1. Does the person drink excessively, or have a problem controlling his or
                her drinking?
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with drug misuse does the person receive from friends or
                relatives?
            </td>
            <td class="genericTableData">
                <select name="13_2" id="13_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with drug misuse does the person receive from local
                services?
            </td>
            <td class="genericTableData">
                <select name="13_3a" id="13_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with drug misuse does the person need from local
                services?
            </td>
            <td class="genericTableData">
                <select name="13_3b" id="13_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with addictions does the person receive from friends or
                relatives?
            </td>
            <td class="genericTableData">
                <select name="14_2" id="14_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a.How much help with addictions does the person receive from local
                services?
            </td>
            <td class="genericTableData">
                <select name="14_3a" id="14_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with addictions does the person need from local services?
            </td>
            <td class="genericTableData">
                <select name="14_3b" id="14_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with social contact does the person receive from friends or
                relatives?
            </td>
            <td class="genericTableData">
                <select name="15_2" id="15_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services in organizing
                social contact?
            </td>
            <td class="genericTableData">
                <select name="15_3a" id="15_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services in organizing
                social contact?
            </td>
            <td class="genericTableData">
                <select name="15_3b" id="15_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">1. Does the person have any difficulty in finding a partner or in maintaining
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with forming and maintaining close relationships does the
                person receive from friends or relatives?
            </td>
            <td class="genericTableData">
                <select name="16_2" id="16_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with forming and maintaining close relationships does the
                person receive from local services?
            </td>
            <td class="genericTableData">
                <select name="16_3a" id="16_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with forming and maintaining close relationships does the
                person need from local services?
            </td>
            <td class="genericTableData">
                <select name="16_3b" id="16_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with problems in his or her sex life does the person receive
                from friends or relatives?
            </td>
            <td class="genericTableData">
                <select name="17_2" id="17_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with problems in his or her sex life does the person
                receive from local services?
            </td>
            <td class="genericTableData">
                <select name="17_3a" id="17_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with problems in his or her sex life does the person need
                from local services?
            </td>
            <td class="genericTableData">
                <select name="17_3b" id="17_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with looking after the children does the person receive from
                friends or relatives?
            </td>
            <td class="genericTableData">
                <select name="18_2" id="18_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with looking after the children does the person receive
                from local services?
            </td>
            <td class="genericTableData">
                <select name="18_3a" id="18_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with looking after the children does the person need from
                local services?
            </td>
            <td class="genericTableData">
                <select name="18_3b" id="18_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with looking after other dependants does the person receive
                from friends or relatives?
            </td>
            <td class="genericTableData">
                <select name="19_2" id="19_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with looking after other dependents does the person receive
                from local services?
            </td>
            <td class="genericTableData">
                <select name="19_3a" id="19_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with looking after other dependents does the person need
                from local services?
            </td>
            <td class="genericTableData">
                <select name="19_3b" id="19_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with numeracy and literacy does the person receive from
                friends or relatives?
            </td>
            <td class="genericTableData">
                <select name="20_2" id="20_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with numeracy and literacy does the person receive from
                local services?
            </td>
            <td class="genericTableData">
                <select name="20_3a" id="20_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with numeracy and literacy does the person need from local
                services?
            </td>
            <td class="genericTableData">
                <select name="20_3b" id="20_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">1. Does the person lack basic skills in getting access to or using a
                telephone?
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives to make
                telephone calls?
            </td>
            <td class="genericTableData">
                <select name="21_2" id="21_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services to make
                telephone calls?
            </td>
            <td class="genericTableData">
                <select name="21_3a" id="21_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services to make telephone
                calls?
            </td>
            <td class="genericTableData">
                <select name="21_3b" id="21_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help with traveling does the person receive from friends or
                relatives?
            </td>
            <td class="genericTableData">
                <select name="22_2" id="22_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help with traveling does the person receive from local
                services?
            </td>
            <td class="genericTableData">
                <select name="22_3a" id="22_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help with traveling does the person need from local services?
            </td>
            <td class="genericTableData">
                <select name="22_3b" id="22_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services in managing his
                or her money?
            </td>
            <td class="genericTableData">
                <select name="23_3a" id="23_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services in managing his or
                her money?
            </td>
            <td class="genericTableData">
                <select name="23_3b" id="23_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">1. Is the person definitely receiving all the benefits that he or she is
                entitled to?
            </td>
            <td class="genericTableData">
        ...
        <tr>
            <td class="genericTableHeader">2. How much help does the person receive from friends or relatives in
                obtaining the full benefit entitlement?
            </td>
            <td class="genericTableData">
                <select name="24_2" id="24_2"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3a. How much help does the person receive from local services in obtaining
                the full benefit entitlement?
            </td>
            <td class="genericTableData">
                <select name="24_3a" id="24_3a"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td class="genericTableHeader">3b. How much help does the person need from local services in obtaining the
                full benefit entitlement?
            </td>
            <td class="genericTableData">
                <select name="24_3b" id="24_3b"
                        class="{validate: {required:function(element){return checkForRequired(element.id);}}}">
        ...
        <tr>
            <td colspan="2"><input type="button" value="Generate Summary" name="generate_summary_of_actions"
                                   id="generate_summary_of_actions"/></td>
