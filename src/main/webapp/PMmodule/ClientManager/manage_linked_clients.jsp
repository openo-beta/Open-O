...
<form action="manage_linked_clients_action.jsp">
    ...
    <table style="padding-left:20px" class="genericTable">
        ...
        <tr class="genericTableRow" style="background-color:#ccffcc">
            ...
            <td class="genericTableData"><img style="height:96px; width:96px"
                                              src="<%=request.getContextPath()+ManageLinkedClients.getLocalImageUrl(currentDemographicId)%>"
                                              alt="client_image_<%=currentDemographicId%>"/></td>
        ...
        <tr class="genericTableRow" style="background-color:#f3f3f3">
            ...
            <td class="genericTableData"><img style="height:96px; width:96px"
                                              src="<%=request.getContextPath()+temp.imageUrl%>"
                                              alt="client_image_<%=temp.linkDestination+'_'+temp.remoteLinkId%>"/></td>
