    ...
    <table width="100%">
        <tr>
            ...
            <td class="genericTableData" width="64%">
                <input id="referralDate" name="referralDate" onfocus="this.blur()"
                       class="systemData {validate: {required:true}}" type="text" readonly="readonly"
                       value="<%=ocanStaffForm.getReferralDate()==null?"":DateFormatUtils.ISO_DATE_FORMAT.format(ocanStaffForm.getReferralDate())%>">
            </td>
        </tr>
        <tr>
            <td class="genericTableHeader" width="36%">Admission Date</td>
            <td class="genericTableData" width="64%">
                <input id="admissionDate" name="admissionDate" onfocus="this.blur()"
                       class="systemData {validate: {required:true}}" type="text" readonly="readonly"
                       value="<%=ocanStaffForm.getAdmissionDate()==null?"":DateFormatUtils.ISO_DATE_FORMAT.format(ocanStaffForm.getAdmissionDate())%>">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="genericTableData" width="64%">
                <input id="dischargeDate" name="dischargeDate" onfocus="this.blur()"
                       class="systemData {validate: {required:false}}" type="text" readonly="readonly"
                       value="<%=ocanStaffForm.getDischargeDate()==null?"":DateFormatUtils.ISO_DATE_FORMAT.format(ocanStaffForm.getDischargeDate())%>">
            </td>
        </tr>
    </table>
